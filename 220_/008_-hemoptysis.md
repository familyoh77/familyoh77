...
graph TD
    ...
    E -- "YES" --> F["🔴 <u>응급 경로</u><br/>① 기도 확보(intubation 고려)<br/>② 출혈측 아래 측와위<br/>③ 산소 공급 ≥94%<br/>   (COPD: 88–92%)<br/>④ 즉시 응급실·ICU 전원<br/>⑤ CTA → BAE ± 기관지내시경"]
    ...
    K --> K1["🔴<u>입원·전원</u><br/>중등도 이상 객혈<br/>원인 불명 + 위험군<br/>항응고제 복용<br/>COPD·HF 동반"]
    K --> K2["🟡 <u>조기 의뢰(수일 내)</u><br/>반복 객혈<br/>CT 이상 또는 필요<br/>암·TB 의심"]
    K --> K3["🟢 <u>외래 추적</u><br/>젊은 비흡연자<br/>단발성 소량<br/>URI 상황<br/>CXR 정상"]

    style F fill:#ffcccc,stroke:#cc0000,stroke-width:2px
    style K1 fill:#ffcccc,stroke:#cc0000,stroke-width:1px
    style K2 fill:#fff3cd,stroke:#cc8800,stroke-width:1px
    style K3 fill:#d4edda,stroke:#28a745,stroke-width:1px
```
