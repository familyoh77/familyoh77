...
```mermaid
graph TD
    Start(["전제: Red flag 없음 / 구조적 심질환·치명적 부정맥 배제<br/>ECG 또는 모니터링으로 표현형 파악"]) --> Rhythm{리듬 표현형}

    Rhythm -->|"빠르고 규칙적<br/>갑작스럽게 시작·종료"| SVT["A. SVT 의심"]
    Rhythm -->|"완전 불규칙"| AF["B. AF 가능성"]
    Rhythm -->|"건너뜀·쿵 느낌"| PVC["C. PAC/PVC"]
    Rhythm -->|"서서히 시작<br/>점진적 빈맥"| Sinus["D. 동빈맥"]
    Rhythm -->|"정상 맥박인데<br/>두근거림 느낌"| Anxiety["E. 불안·과민"]
