...
* 만성 통증은 이 경로 자체가 변화(중추 감작 등)하여, 원래의 유해 자극이 약하거나 사라져도 통증이 지속·증폭되는 상태 (☞ [Central sensitization](001_-pain.md#undefined-2))

**진통제는 원인 치료가 아닌 통증 신호 차단**

* 대부분의 진통제는 통증을 유발한 근본 원인(조직 손상, 감염, 종양, 신경 압박 등)을 제거하지 않으며, 위 통증 경로 중 한 단계를 차단하여 증상만 완화하는 대증치료임(symptomatic treatment)
...
* 따라서 진통제로 증상이 조절되더라도 근본 원인 질환에 대한 평가·치료는 별도로 이루어져야 하며, "진통제에 반응한다"는 사실만으로 심각한 원인 질환을 배제할 수는 없음 (☞ [Red Flags](001_-pain.md#red-flags))

{% hint style="info" %}
**진통제 사용과 central sensitization의 연관성** : 심하고 지속적인 급성 통증을 충분히 조절하지 않고 방치하는 것-진통제 복용 여부 자체가 아니라, 통증이 조절되지 않은 채 지속되는 상태-은 central sensitization으로의 이행 위험을 높이는 요인으로 알려져 있음. 급성기 통증을 적절히 조절하는 것이 만성화 예방에도 중요한 이유가 여기에 있음. 다만 경미하거나 참을 수 있는 통증에서 진통제 복용 자체가 만성화를 예방한다는 근거는 아니며, 통증의 강도·기능 저하 정도에 맞추어 조절하는 것이 원칙임
{% endhint %}
...
<div align="center"><figure><img src="../.gitbook/assets/통증1.png" alt="" width="563"><figcaption><p><strong>시각적 아날로그 통증 스케일 (Visual Analogue Scale, VAS)</strong></p></figcaption></figure></div>
...
{% hint style="info" %}
아래는 통증 부위와 무관하게 적용되는 공통 red flag이다. 흉통·복통·두통 등 부위 특이적 red flag은 해당 증상별 챕터를 함께 참조한다. 척추/요통 관련 red flag은 하단 별도 표기.
{% endhint %}

<mark style="color:$danger;">**즉각 응급 조치 및 이송**</mark>

* 급격히 진행하는 신경학적 결손 또는 마비 → 척수/신경 압박
* 심한 통증 + 발열·빈맥·저혈압 등 패혈증 징후 → 괴사성 근막염, 화농성 관절염, 척추 감염
* 손상 부위 원위부의 창백·무맥·냉감·감각 저하 → 급성 사지 허혈 의심
* 외상 후 극심한 통증(수동적 신전 시 악화) + 긴장성 부종 → 구획 증후군 의심
* 방광 또는 장 기능 이상, 안장 부위 감각 이상 → 마미 증후군 시사 - 척추 통증에서 특히

<mark style="color:$warning;">**당일 또는 조기 의뢰**</mark>

* 악성 종양 병력이 있는 환자에서 새로 발생하거나 악화되는 통증
* 면역 저하 상태에서 새로 발생한 국소 심한 통증
* 주요 외상 후 심한 통증 (골절 의심), 특히 고령·골다공증 환자
* 신체 진찰 소견에 비해 현저히 심한 통증
