...
1. <mark style="color:$danger;">**척추 골절 (Fracture) 의심**</mark>&#x20;
   1. 외상 병력 : 주요 외상 또는 추락 사고 후 발생한 극심한 통증&#x20;
   2. 고위험군 : 고령자나 골다공증 환자에서 기침·가벼운 물건 들기 등 경미한 외상 후에도 심한 통증이 발생한 경우
2. <mark style="color:$danger;">**악성 종양 (Malignancy) 의심**</mark>&#x20;
   1. 과거력 : 악성 종양(암) 병력&#x20;
   2. 연령 : 20세 미만 또는 50세 이상에서 처음 시작된 통증&#x20;
   3. 통증 양상 : 휴식이나 치료에 반응하지 않고 점차 악화; 야간 또는 누운 자세에서 악화&#x20;
   4. 전신 소견 : 설명되지 않는 체중 감소, 야간 발한
3. <mark style="color:$danger;">**척추 감염 (Infection/Osteomyelitis) 의심**</mark>&#x20;
   1. 전신 증상 : 발열, 오한&#x20;
   2. 위험 인자 : 면역 저하 상태, 면역억제제 투여 중, 최근 세균 감염 병력 또는 정맥 주사제 남용 병력
4. <mark style="color:$danger;">**신경학적 응급 (마미 증후군 포함)**</mark>&#x20;
   1. 대소변 장애 : 방광 또는 장 기능 이상(실금 또는 저류)&#x20;
   2. 신경 결손 : 안장 부위(Saddle anesthesia) 감각 이상, 항문 괄약근 긴장도 저하&#x20;
   3. 진행성 신경 증상 : 하지의 뚜렷한 근력 약화, 감각 저하 또는 상하지의 이상 감각(paresthesia)
...
* 부작용 : 어지럼, 소양증, 낙상(특히 고령자), 진정, 항콜린 부작용(입마름, 구역, 변비, 소변 저류)
  ...
  * 오피오이드 유발 변비(Opioid-Induced Constipation, OIC): 내성이 생기지 않으므로 오피오이드 시작과 동시에 자극성 하제(Stimulant laxatives, 예: sennoside \[아락실], bisacodyl \[둘코락스])를 선제적으로 처방하는 것을 고려 (CDC 2022)
...
* 무릎 골관절염(Knee OA)에 대하여 전신 부작용을 줄이기 위해 경구 NSAID보다 국소 NSAID(외용제)를 우선 권고(AAOS 2021, ACR 2022)
