...
2. <mark style="color:$danger;">**악성 종양 (Malignancy) 의심**</mark>
   1. 통증 양상 : 휴식이나 치료에 반응하지 않고 점차 악화; 야간 또는 누운 자세에서 악화
   2. 전신 소견 : 설명되지 않는 체중 감소, 야간 발한
   3. 과거력 : 악성 종양 병력
   4. 연령 : 20세 미만 또는 50세 이상에서 처음 시작된 통증
3. <mark style="color:$danger;">**척추 감염 (Infection/Osteomyelitis) 의심**</mark>
   1. 전신 증상 : 발열, 오한
   2. 위험 인자 : 면역 저하 상태, 면역억제제 투여 중, 최근 세균 감염 병력, 정맥 주사제 남용 병력
4. <mark style="color:$danger;">**신경학적 응급 (마미 증후군 포함)**</mark>
   ...
   3. 진행성 신경 증상 : 하지의 뚜렷한 근력 약화, 감각 저하 또는 상하지의 이상 감각
