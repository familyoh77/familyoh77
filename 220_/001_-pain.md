...
* 만성 통증은 이 경로 자체가 변화하여, 원래의 유해 자극이 약하거나 사라져도 통증이 지속·증폭되는 상태 (☞ 아래 [Central sensitization](001_-pain.md#undefined-3) 참조)

<mark style="color:cyan;">**진통제의 작용 원리**</mark>

* 원인 치료가 아닌 통증 신호 차단 : 대부분의 진통제는 통증을 유발한 근본 원인(조직 손상, 감염, 종양, 신경 압박 등)을 제거하지 않으며, 위 통증 경로 중 한 단계를 차단하여 증상만 완화하는 대증치료임
...
* 진통제로 증상이 조절되더라도 근본 원인 질환에 대한 평가·치료는 별도로 이루어져야 하며, "진통제에 반응한다"는 사실만으로 심각한 원인 질환을 배제할 수는 없음

### <mark style="color:$danger;">🚩 Red Flags!</mark>

{% hint style="info" %}
통증의 강도만으로 응급도를 판단하지 않음.\
통증 부위와 관계없이 먼저 생리적 불안정, 급성 혈관·신경계 사건, 중증 감염, 출혈·외상 및 장기 폐색·파열 가능성을 평가.\
Red flag가 없더라도 임상적으로 중증 질환이 의심되면 해당 부위별 챕터에 따라 추가 평가.\
저혈압·의식 변화·호흡수 증가·저산소증 등은 통증의 원인과 무관하게 중증질환 가능성을 높이므로, 통증 평가에서 활력징후와 의식 수준을 우선 확인함.\
암 병력, 체중 감소, 야간 발한 등은 단독으로 응급 상태를 결정하지는 않지만, 통증의 지속·진행 및 다른 임상 소견과 결합하면 조기 원인 평가가 필요할 수 있음.
{% endhint %}

<mark style="color:$danger;">**즉각 조치**</mark>

* 저혈압·쇼크 징후, 저산소증·심한 호흡곤란, 청색증, 의식 변화 또는 실신 등 생리적 불안정 `쇼크` `호흡부전` `순환 붕괴`
* 갑자기 시작되어 수초\~수분 내 최고 강도에 도달한 이전과 다른 통증, 특히 흉부·등·복부·두부 통증 `ACS` `대동맥 박리` `지주막하출혈` `장기 파열/천공`
* 통증과 함께 새로 발생한 편측 마비, 언어·시야 장애, 보행 불능, 경련 또는 의식 변화 `뇌졸중` `경련성 질환`
* 흉부·상복부·등·턱·팔 통증에 호흡곤란, 식은땀, 오심 또는 실신이 동반되는 경우 `ACS` `대동맥 박리` `폐색전증`
* 갑작스러운 사지 통증과 창백·냉감·맥박 저하·감각 또는 운동 저하 `급성 사지 허혈`
* 진찰 소견에 비해 현저히 심한 통증, 빠르게 증가하는 부종·긴장 또는 신경혈관 이상 `구획 증후군`
* 복막 자극 징후, 토혈·혈변 등 활동성 출혈, 박동성 종괴 또는 장기 파열·폐색이 의심되는 소견 `복막염` `소화관 출혈` `대동맥류 파열` `장 폐색/천공`
* 중증 외상 후 통증과 출혈, 변형, 신경·혈관 이상 또는 활력징후 불안정 `중증 외상` `골절/탈구` `혈관 손상`
* 새로 발생한 배뇨 곤란·요저류·요실금·변실금 또는 직장 충만감 소실, 회음부·안장 부위 감각 저하, 항문 괄약근 긴장도 저하, 또는 급속히 진행하는 양측 하지 근력 저하 `마미증후군` `척수 압박`
  * 항문 괄약근 긴장도 저하는 마미증후군을 시사할 수 있으나 단독 진단 소견은 아니며, 정상이라고 해서 마미증후군을 배제할 수 없음 - 직장수지검사로 평가한 항문 긴장도는 진단 정확도가 낮고 위음성으로 인한 잘못된 안심의 위험이 있음. 배뇨·배변 장애나 안장 부위 감각 변화 중 한 소견만 있어도 임상적으로 의심해야 하며, 단일 소견이 정상이라는 이유만으로 배제하지 않음
* 진통제·opioid 사용 후 호흡 저하 또는 의식 저하 `Opioid 과다복용` `호흡억제`
...
* 적절한 초기 치료에도 호전되지 않거나 점차 악화하는 통증 `진단 재평가 필요`
* 설명되지 않는 체중 감소, 야간 발한, 지속되는 발열·피로와 동반된 통증 `악성 종양` `만성 감염`
* 휴식·야간 통증이 지속되면서 악성 종양, 감염 또는 염증성 질환의 위험 요인이 동반된 경우 `악성 종양` `감염` `염증성 질환`
* 활동성 암 병력 또는 과거 암 치료 부위에 발생한 새롭거나 진행하는 통증 `암 재발/전이`
* 반복되는 원인 불명 통증 또는 통증과 함께 기능·보행·수면·일상생활이 계속 저하되는 경우 `만성 통증 증후군`
* 지속하거나 확대되는 감각 이상·방사통 또는 새로운 자율신경계 이상 `신경병증성 통증` `자율신경계 이상`
...
### <mark style="color:orange;">통증 유형(기전) 분류</mark>
...
* 근육통·염증성·기계적/압박성 등 : 대부분 nociceptive mechanism에 속하는 하위 유형이며, 원인 평가와 치료 선택을 보조하는 임상적 분류임 - 약물 선택은 phenotype만이 아니라 원인·기전·위험도와 함께 결정함
...
#### <mark style="color:$primary;">선별 도구</mark>

* neuropathic 요소는 [DN4](https://pmc.ncbi.nlm.nih.gov/articles/PMC4740539/)(4점 이상 시 가능성 높음)·[painDETECT](https://www.jkna.org/upload/pdf/jkna-39-2Suppl-24.pdf)로 평가; nociplastic pain은 이 도구들로 진단 또는 배제하지 않고 임상 양상·병력으로 판단

***

```mermaid
flowchart TD
    A([통증 호소 환자]) --> B[공통 및 부위별\nRed Flags 평가]
    B -->|Tier 1| C[즉각 조치]
    B -->|Tier 2| C2[당일~수일 내 평가]
    B -->|Tier 3| C3[조기 평가 및 추적]
    B -->|없음| D[Pain Typing]
    C3 --> D
    D --> D1[<u>Nociceptive</u>\n쑤심·욱신거림·\n국소 압통]
...
* 통증의 파국화(catastrophizing) 방지를 위한 상담
  ...
  * 일부 만성 통증에서는 신경계의 통증 처리 변화가 통증의 지속과 증폭에 관여할 수 있음을 설명(모든 만성 통증이 이에 해당하는 것은 아님) - 통증이 곧 진행 중인 조직 손상을 의미하지는 않는다는 점을 이해시킴
...
* 통증 기전(mechanism) 분류 및 선별 도구는 위 `진단 > 통증 유형(기전) 분류` 참조
...
* 아래 [NSAIDs 섹션](001_-pain.md#nsaids) 참조
...
* 발작 역치 저하·세로토닌 증후군 주의; 경련 발생 위험이 있으므로 고령이나 간/신기능 저하자에서는 감량
  * MAOI, SSRI, SNRI, TCA 등 serotonergic 약물 병용 시 serotonin syndrome 및 발작 위험 증가
* 항콜린(항무스카린) 작용이 있어, 진경제, TCA 등 항콜린 작용이 있는 약물과 병용 시 변비·구갈·요저류·인지기능 저하 등 항콜린 부작용이 상승할 수 있음 - 항콜린제는 처방 빈도가 높으므로 병용 여부를 확인해야 함
...
- [ ] Tramadol은 "약한 opioid"로 분류되지만 중독·의존, 과다 복용 및 호흡억제 위험이 있어 다른 opioid와 마찬가지로 주의가 필요함. 현재 우리나라에서는 마약류 관리에 관한 법률상 마약류로 분류되지 않은 전문의약품임
...
* μ-opioid receptor partial agonist 및 κ-opioid receptor antagonist
* 신경병성 통증에 일부 근거, 신기능 저하 환자에서 상대적으로 유리
* 용법 : 저용량(5\~10 ㎍/h)으로 시작 → 효과 및 부작용을 관찰하며 증량; 1주 간격으로 교체 <mark style="color:blue;">\[노스판 패취]</mark>
* [급여기준](https://www.hira.or.kr/rc/insu/insuadtcrtr/InsuAdtCrtrPopup.do?mtgHmeDd=20171101\&sno=1\&mtgMtrRegSno=0034) : NSAID의 최대 용량에도 반응하지 않아 마약성 진통제를 필요로 하는 심한 통증에 1주 20㎍/h까지 인정. 1회 처방 당 최대 30일까지 인정
...
* 펜타닐 정제·패치제 처방 전 마약류 통합관리시스템([NIMS](https://www.nims.or.kr/))을 통한 최근 1년 투약 이력 확인은 법적 의무이다(2024.6.14. 시행)
  * 졸피뎀 등 이후 확대 대상 성분은 해당 시점의 법적 의무 또는 확인 권고 여부를 구분하여 적용한다(예: 메틸페니데이트·식욕억제제·졸피뎀은 권고 대상)
...
* 다음 중 하나라도 해당 시 → 처방 재검토 또는 전문의 협진
  ...
  * 과거 opioid use disorder(OUD) 또는 물질사용장애 병력
  * 최근 감량·금단 후 재투여, 교도소 출소 등으로 내성이 감소한 상태(과다복용 위험 증가)
...
* 아급성(1\~3개월) 및 만성(＞3개월) 통증 : 비아편유사제를 우선 고려. 불가피한 경우에만 사용
  * 초기 용량 예시 : 5\~10 MME(단일 용량) 또는 20\~30 MME/d - 개별 환자의 위험도·반응에 따라 조절
  * 50 MME/d 이상에서 과다 복용·사망 위험이 유의하게 증가하므로, 50 MME/d 도달·초과 전 이득·위험을 재평가
  * 치료 시작 또는 용량 증량 후 4주 이내에 이익과 위험을 재평가

<mark style="color:cyan;">**Naloxone 제공 또는 처방 제안 고려 기준**</mark>

* 다음 중 하나라도 해당 시 제공 또는 처방을 제안 \[CDC 2022]
  * MME ≥ 50/d
  * 호흡기 질환(COPD, 수면무호흡증) 동반
  * benzodiazepine 병용
  * 과거 opioid overdose 병력
  * 최근 감량·금단 후 재투여, 교도소 출소 등 내성이 감소한 상태
* 추가 위험 요인(CNS depressant 병용에 따른 호흡 억제 위험 증가)
  * gabapentinoid 병용
...
* 감량 속도는 환자의 임상 상황·복용 기간·치료 목표에 따라 개별화하며, 아래는 참고 가능한 예시일 뿐 고정된 공식으로 적용하지 않음
  * 1년 이상 복용 : 월 10% 또는 그보다 느린 감량이 더 잘 견뎌질 수 있음
  * 수주\~수개월 복용 : 주 10% 감량을 참고하되 원래 용량의 30%에 도달한 이후에는 더 느리게 조정 가능
* 급성 통증으로 단기 사용한 경우 (별도 기준, 마찬가지로 예시)
...
* 현재 opioid 총량을 바탕으로 대체 약물의 equianalgesic dose를 추정한 후 통상 25\~50%를 감량하여(즉 계산 용량의 약 50\~75%로) 시작; 부작용 및 효과를 관찰하며 개별 titration. Fentanyl·methadone 등은 단순 MME 비례 환산을 피함
...
* 불완전한 교차 내성과 개인별 약동학 가변성 때문에, 과다 복용을 피하기 위해 아래 환산계수로 계산된 용량보다 상당히 낮은 용량(통상 계산 용량의 50\~75%)으로 시작
* opioid-naive 여부, 투여경로, 신·간기능에 따라 실제 필요 용량이 크게 달라질 수 있음
* 이 환산계수는 아편유사제 사용장애(OUD) 관리와 관련된 용량 결정에는 적용 불가

<table data-full-width="true" data-search="false"><thead><tr><th width="188.631591796875">아편유사제</th><th width="275.78948974609375"></th><th width="108.9473876953125">환산계수¹⁾</th></tr></thead><tbody><tr><td><strong>정맥 주사(단회, 상호 등가)</strong></td><td>모르핀 (Morphine)</td><td>1.0</td></tr><tr><td></td><td>하이드로몰폰 (Hydromorphone)</td><td>6.6</td></tr><tr><td></td><td>펜타닐 (Fentanyl)</td><td>100²⁾</td></tr><tr><td><strong>정맥 주사 → 경구 전환</strong></td><td>모르핀 (Morphine)</td><td>3.0</td></tr><tr><td></td><td>하이드로몰폰 (Hydromorphone)</td><td>2.5–5.0</td></tr><tr><td></td><td>옥시몰폰 (Oxymorphone)</td><td>10</td></tr><tr><td></td><td>트라마돌 (Tramadol)</td><td>3.0</td></tr></tbody></table>
...
* TCA와 SNRI(duloxetine)는 neuropathic pain의 대표적인 1차 치료제로, 두 약물군 모두 임상적으로 의미 있는 진통 효과가 있음. 약물군 간 우열은 일관되지 않음
  * TCA는 항콜린성·심혈관계 부작용 및 과량복용 독성을, duloxetine은 오심·혈압 상승 및 간·신기능 등을 고려하여 환자 특성에 따라 선택
  * 고령·심혈관질환 위험이 높으면 duloxetine 등 SNRI 우선 고려
* 대상 : 다른 약물 요법으로 실패한 말초신경병증성 통증, 섬유근육통
* 신기능 주의 : duloxetine은 eGFR ＜30 환자에서 일반적으로 권장하지 않음 (약물 축적 및 부작용 위험 증가); 다른 SNRI/SSRI는 약제별 허가사항을 확인
...
* fluoxetine : 섬유근육통에 대한 근거는 duloxetine보다 제한적이며 국내 통증 적응증으로 승인되어 있지 않음(off-label); 20\~80 ㎎/d qd <mark style="color:blue;">\[푸로작]</mark>
...
* [급여기준](https://www.hira.or.kr/rc/insu/insuadtcrtr/InsuAdtCrtrPopup.do?mtgHmeDd=20170101\&sno=1\&mtgMtrRegSno=0004) : 우울 증상이 지속적으로 2주 이상 계속되는 경우에 상용량으로 60일 범위 내에서 인정함, 일부 상병에서 60일 이상 인정

### <mark style="color:orange;">Benzodiazepines</mark>

* 통증 자체 치료 목적으로는 권고되지 않으며, 특히 만성 통증에서는 위해가 이득보다 큰 것으로 평가됨 - 일반 통증 약물로 사용하지 않음
* opioid와의 병용은 호흡억제·사망 위험이 크게 증가하므로 원칙적으로 병용 금기 (☞ 아래 `주요 통증 약물 병용 금기 및 주의 리스트(DUR)` 참조)
* 불안·근육 긴장 등 통증과 무관한 별도 적응증이 있는 경우에 한해 최단 기간(＜2주) 사용을 고려하며, 통증에 대한 사용은 어느 경우에도 off-label임 (☞ [항우울제](../231_/213_-antidepressants-and-anxiolytics.md#benzodiazepine))
* 부작용 : 졸음, 의존성
...
* 부작용 : 어지럼/졸음(용량 의존; 저용량 시작-서서히 증량 시 완화), 말초 부종, 체중 증가, 도취감, 의존성/남용 가능성(특히 pregabalin); 영국은 규제 약물로 지정
  * 말초 부종·체중 증가는 고령자에서 더 빈번하고 두드러짐; 원인 불명의 하지 부종 평가 시 gabapentinoid 복용 여부를 반드시 확인
  * opioid 병용 시 호흡 억제로 인한 사망 위험 증가 - \[FDA] 심각한 호흡 억제 위험을 경고하고 처방 정보에 관련 경고를 추가함(Black Box Warning은 아님)
    * 병용이 불가피한 경우 각각의 용량을 최소화하고 호흡 억제 징후 면밀히 모니터링
    * 통증 외 다약제 처방 환자에서 inadvertent 병용에 주의
* gabapentin : 100\~300 ㎎ hs로 시작(이상반응 감소 목적) → 이후 1일 3회 분할하여 100 ㎎/3d씩 증량; 신기능 정상 시 신경병증성 통증에서 1주 이내 1,800 ㎎/d까지 증량 가능하며 3,600 ㎎/day를 초과하지 않음; 신기능별 용량은 아래 표 참조 <mark style="color:blue;">\[뉴론틴]</mark>
...
{% hint style="info" %}
**왜 eGFR이 아닌 CrCl인가?** CKD 진단·병기 분류나 일반적인 신기능 모니터링에는 CKD-EPI 기반 **eGFR**이 표준임. 그러나 gabapentin·pregabalin은 허가 당시 약동학 연구가 **Cockcroft-Gault CrCl**로 설계되어 있어, 허가사항의 신기능별 용량표도 CrCl 기준으로 되어 있음. 이 두 약제의 용량 조절 시에는 CrCl(Cockcroft-Gault)을 별도로 계산하여 적용함
{% endhint %}

<table><thead><tr><th width="138">CrCl (㎖/min)</th><th width="200">Gabapentin 1일 총 투여량</th><th>투여 방법</th></tr></thead><tbody><tr><td>≥80</td><td>900~2,400 ㎎/day</td><td>3회 분할</td></tr><tr><td>50~79</td><td>600~1,800 ㎎/day</td><td>3회 분할</td></tr><tr><td>30~49</td><td>300~900 ㎎/day</td><td>3회 분할</td></tr><tr><td>15~29</td><td>150~600 ㎎/day</td><td>3회 분할*</td></tr><tr><td>&#x3C;15</td><td>150~300 ㎎/day</td><td>3회 분할*, CrCl에 비례하여 추가 감량</td></tr><tr><td>혈액투석</td><td>초기 300~400 ㎎</td><td>4시간 혈액투석 후 200~300 ㎎ 투여; 비투석일 미투여</td></tr></tbody></table>

_\* 150 ㎎/d에 해당하는 경우 100 ㎎ × 3을 2일마다 투여 (뉴론틴캡슐 허가 기준)_\
✽_위 표는 국내 뉴론틴캡슐·리리카 허가사항을 기준으로 작성함 - 처방 전 현재 허가사항 확인을 권장_

<table><thead><tr><th width="140">CrCl (㎖/min)</th><th width="169">Pregabalin 시작용량</th><th width="185">최대용량</th><th>투여 방법</th></tr></thead><tbody><tr><td>≥60</td><td>150 ㎎/day</td><td>600 ㎎/day</td><td>2~3회 분할(BID or TID)</td></tr><tr><td>30~&#x3C;60</td><td>75 ㎎/day</td><td>300 ㎎/day</td><td>2~3회 분할(BID or TID)</td></tr><tr><td>15~&#x3C;30</td><td>25~50 ㎎/day</td><td>150 ㎎/day</td><td>1~2회 분할(QD or BID)</td></tr><tr><td>&#x3C;15</td><td>25 ㎎/day</td><td>75 ㎎/day</td><td>1일 1회(QD)</td></tr><tr><td>혈액투석 후 추가</td><td>25~100 ㎎</td><td>단회 투여(혈액투석 4시간 시행 후 추가 투여)*</td><td></td></tr></tbody></table>

_\* Pregabalin은 혈액투석으로 4시간 내 약 50%가 제거되므로, 위 1일 투여용량과 별도로 혈액투석 시행 후 보충 용량을 즉시 추가 투여_
...
* lamotrigine : 일반 신경병증성 통증에서 효과가 확립되어 있지 않으며(NICE CG173), 비전문 진료에서는 전문의 권고 없이 시작하지 않음; 삼차신경통 등 제한된 상황에서 전문의 판단하에 고려 가능
...
* 일반적으로 내약성은 양호하나 어지럼, 혼란, 두통이 발생할 수 있음
* memantine : 근거 제한적 - 일부 난치성(refractory) 통증에 off-label 고려(비급여)
  * 5 ㎎ qd, 2일마다 5 ㎎ 증량, 유지 10 ㎎ bid <mark style="color:blue;">\[에빅사]</mark>

### <mark style="color:orange;">근이완제</mark>

* 효과에 대한 입증은 전반적으로 부족함; 골관절염에 의한 통증에는 효과가 적음
* 급성기(2\~3주 이내)에만 적용, 만성 통증 환자에서의 장기 처방은 권고하지 않음
  * 통상적으로 근골격계 질환의 급성기(약 2\~4주 이내) 처방 시에만 급여 인정됨
* 부작용 : 졸음, 어지럼, 구역
...
* dexamethasone : 다른 스테로이드에 비하여 mineralocorticoid 작용이 적음 <mark style="color:blue;">\[덱사메타손]</mark>
  * 용량은 적응증(암성 통증의 신경 압박·완화의료 vs 염증성 질환 등)에 따라 차이가 커서 총론에서 단일 범위로 제시하지 않으며, 해당 원인 질환 챕터 또는 완화의료 지침의 용량을 따름
...
* <mark style="color:blue;">\[환인날트렉손]</mark> 25/50 ㎎, <mark style="color:blue;">\[파마날트렉손]</mark> 50 ㎎ (저용량 분할 사용 시 off-label)
...
## <mark style="color:green;">NSAIDs</mark>
...
* 소화성 궤양에 대한 대처
  ...
  * [misoprostol](../224_/073_-gidrugs.md#prostaglandin-e-analogue) : 위궤양 예방 효과; 소화불량 발생 가능; 200 ㎍ qid <mark style="color:blue;">\[싸이토텍]</mark>
  * [PPI](../224_/073_-gidrugs.md#proton-pump-inhibitor-ppi) : 다음 약제를 1일 1회 복용; omeprazole 20\~40 ㎎ <mark style="color:blue;">\[오엠피]</mark>, esomeprazole 40 ㎎ <mark style="color:blue;">\[넥시움]</mark>, lansoprazole 30 ㎎ <mark style="color:blue;">\[란스톤]</mark>, dexlansoprazole 30\~60 ㎎ <mark style="color:blue;">\[덱실란트 디알]</mark>, pantoprazole 40 ㎎ <mark style="color:blue;">\[판토록]</mark>, rabeprazole 20 ㎎ <mark style="color:blue;">\[파리에트]</mark>
    * [ ] [보험 적용 주의](https://www.hira.or.kr/rc/insu/insuadtcrtr/InsuAdtCrtrPopup.do?mtgHmeDd=20221201\&sno=8\&mtgMtrRegSno=0007). esomeprazole 20 ㎎, lansoprazole 15 ㎎, pantoprazole 20 ㎎, rabeprazole 5 ㎎ 등이 1일 1회 투여로 NSAID 투여 관련 상부 위장관 증상치료에 급여 인정됨- 약제별 확인 요
  * [H2-blocker](../224_/073_-gidrugs.md#h2-h2-receptor-antagonist-h2ra) : 고용량(상용량의 2배 용량)으로 NSAID에 의한 소화성 궤양 예방 효과

{% hint style="info" %}
**경구 NSAID 사용 시 PPI 병용 적응증**: 다음 중 하나 이상 해당 시 PPI 병용 권장\
□ 연령 ≥ 65세\
□ 소화성 궤양 또는 GI 출혈 병력\
...
<table data-header-hidden><thead><tr><th width="116.21051025390625"></th><th width="166.15789794921875"></th><th></th></tr></thead><tbody><tr><td><strong>위험 요인</strong></td><td><strong>권장 사항 및 약제</strong></td><td><strong>주의 및 금기</strong></td></tr><tr><td>심혈관 위험</td><td>국소 외용제 우선,<br>불가피 시 naproxen</td><td>COX-2 억제제(celecoxib 등)의 심혈관 위험은 약제·용량·기저 심혈관 위험도에 따라 다르며, 기존 심혈관질환·심부전이 있는 고위험군에서는 사용을 피하고 불가피한 경우 최저 유효 용량으로 신중히 사용 (절대 금기는 아니나 신중 사용; PRECISION trial 참고)</td></tr><tr><td>신장애 위험</td><td>국소 외용제 우선</td><td>fenoprofen 금기; eGFR &#x3C; 30 ㎖/min/1.73m² 시 모든 NSAIDs 금기; 이뇨제 병용 주의</td></tr><tr><td>위장관 위험</td><td>celecoxib, PPI 병용</td><td>ketorolac 피함, 고령자 주의</td></tr><tr><td>간 장애 위험</td><td>acetaminophen (≤2g/d)</td><td>sulindac 금기; diclofenac은 간독성 보고 빈도가 높아 주의 (간 장애 시 다른 NSAIDs도 원칙적으로 신중 사용)</td></tr></tbody></table>

### <mark style="color:orange;">주요 통증 약물 병용 금기 및 주의 리스트 (DUR)</mark>

<table data-search="false"><thead><tr><th width="104.7894287109375">약물군</th><th width="162.2105712890625">병용 주의/금기 약물</th><th width="153.842041015625">주요 위험</th><th>임상적 대처 방안</th></tr></thead><tbody><tr><td>Opioids¹⁾</td><td>Benzodiazepines</td><td>호흡 저하, 사망 위험</td><td>가급적 병용 금기. 최소 용량 처방</td></tr><tr><td>Tramadol</td><td>SSRIs, SNRIs, TCAs</td><td>세로토닌 증후군, 발작 위험 (TCAs는 경련 역치 저하 추가)</td><td>항우울제 병용 시 세로토닌 증상 및 경련 징후 관찰</td></tr><tr><td>Tramadol</td><td>MAOIs</td><td>세로토닌 증후군, 고혈압 위기</td><td>병용 금기. MAOI 중단 후 최소 14일 경과 후 사용</td></tr><tr><td>NSAIDs</td><td>Warfarin</td><td>위장관 출혈 위험 (INR 변화 여부와 무관)</td><td>PPI 병용 고려 및 INR 추적</td></tr><tr><td>NSAIDs</td><td>DOAC²⁾</td><td>위장관 출혈 위험</td><td>PPI 병용 고려; DOAC는 routine INR 추적 대상 아님</td></tr><tr><td>NSAIDs</td><td>Corticosteroids</td><td>위궤양/천공 위험</td><td>가능한 한 병용 회피가 우선; 불가피 시 위장관 위험 재평가 후 PPI 예방 및 최소 용량·최단 기간 병용</td></tr><tr><td>NSAIDs</td><td>ACEI/ARB + Diuretics (Triple Whammy³⁾)</td><td>급성 신손상</td><td>신기능(eGFR) 및 혈압 모니터링 필수. 3제 병용은 가급적 회피</td></tr><tr><td>NSAIDs</td><td>저용량 Aspirin</td><td>심혈관 보호 효과 감소 (ibuprofen에서 특히 문제)</td><td>immediate-release 저용량 aspirin은 ibuprofen보다 최소 30분 전에, 또는 ibuprofen 복용 후 최소 8시간 뒤 투여; 다른 NSAID는 약제별 상호작용을 고려</td></tr><tr><td>Pregabalin</td><td>Opioids</td><td>과도한 진정, 호흡 억제</td><td>각각의 시작 용량을 평소보다 감량</td></tr></tbody></table>

_¹⁾Opioid + Benzodiazepine 조합은 중추신경계 억제를 심화시켜 치명적인 호흡 정지를 유발할 수 있음. 환자가 기존에 수면제나 불안 해소제를 복용 중인지 반드시 확인_\
_&#xB2;⁾DOAC : rivaroxaban, apixaban, dabigatran 등 직접 경구항응고제_\
...
#### <mark style="color:$primary;">주요 약제의 급여 인정 적응증 및 기록 시 확인사항</mark>

{% hint style="warning" %}
아래 보험급여 기준·상병코드는 확인 시점의 HIRA 고시를 기준으로 정리한 것이며, 고시는 수시로 개정될 수 있음. 실제 처방·청구 전에는 반드시 HIRA 현행 고시 원문(고시 번호·시행일 확인)을 참조함\
...
> ```
> 에트라빌 10 ㎎/T 1T hs
> ※ 저용량으로 시작; 통증과 우울 동반 시 선택
> 타이레놀 이알 650 ㎎/T 필요시
> ```
>
> _✽TCA는 저용량에서도 통증에 대한 진통 효과를 나타내며, 우울증 치료 용량보다 낮은 용량으로 시작; 통증+우울 동반 시 두 증상을 함께 다룰 수 있음_
>
> **처방례 3. 만성 통증**
>
> ```
...
> **진통제 공통 주의사항**
>
> * 정기적으로 복용하도록 처방된 약은 정해진 간격으로 복용하면 더 적은 용량으로도 잘 조절될 수 있습니다. 필요할 때만 복용하도록 처방된 약은 정해진 최대 횟수 안에서 통증이 있을 때 복용하십시오.
...
> **오피오이드 (트라마돌, 코데인 등)**
>
> * 어지럼, 졸음이 생길 수 있으므로 운전이나 기계 조작을 삼가 주십시오.
> * 변비가 생기기 쉬우므로 충분한 수분 섭취와 채소 섭취를 늘리십시오.
...
통증을 적절히 조절하면 수면·활동·재활에 도움이 되며, 일부 상황에서는 통증이 오래 지속될 위험을 줄이는 데도 도움이 될 수 있습니다.
{% endhint %}
...
* **정해진 방법대로 복용** : 약은 처방된 방법과 간격에 따라 복용하십시오. 정기적으로 복용해야 하는 약과 필요할 때만 복용하는 약이 있으므로 임의로 복용 간격을 변경하지 마십시오
...
* 발열·오한, 원인 모를 체중 감소, 지속적인 야간 통증 등이 새롭게 나타나거나 악화되는 경우
* 처방받은 진통제를 사용해도 통증이 계속 심하거나 점점 악화되는 경우
* 통증으로 인해 자살 생각이 들거나 스스로를 해치고 싶은 마음이 드는 경우 - 즉시 병원을 방문하거나 자살예방상담전화 109(24시간, 무료)로 연락하십시오
