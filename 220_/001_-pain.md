...
* 소화성 궤양에 대한 대처
  ...
  * [misoprostol](../224_/073_-gidrugs.md#prostaglandin-e-analogue) : 위궤양 예방 효과; 소화불량 발생 가능; 200 ㎍ qid <mark style="color:blue;">\[싸이토텍]</mark> (☞ [위점막보호제](../224_/073_.md#prostaglandin-e-analogue))
...
{% hint style="info" %}
역사적/문헌상 비교 자료임 - rofecoxib·valdecoxib·lumiracoxib는 안전성 문제로 철수되었고 dipyrone은 국내 유통되지 않는 등, 현재 국내 처방 선택지를 의미하지 않음. 또한 NNT는 질환·용량·치료 기간·평가 지표에 따라 달라지므로, 서로 다른 조건에서 산출된 값을 단순 순위로 비교하지 않도록 주의
{% endhint %}
