...
* 임신 가능성이 있는 가임기 여성의 급성 하복부·골반통 ± 질출혈 → β-hCG 조기 확인; 양성이면 자궁외임신 배제. β-hCG 양성 + 혈역학적 불안정·복막자극·심한 통증이 있으면 파열된 자궁외임신을 의심하고 응급 산부인과 평가·수술을 지연하지 않음
...
* 기본 : CBC, 전해질, BUN/Cr, 간기능(AST/ALT/ALP/bilirubin), lipase (amylase보다 진단 정확도가 높아 우선 시행; 임상적으로 췌장염이 의심되면 증상 발생 시점과 관계없이 검사; lipase는 amylase보다 상승이 오래 지속되어(약 8\~14일 vs 3\~7일) 증상 발생 후 수일이 지나 내원한 경우에도 진단 유용성이 더 높음), UA
...
<p align="center"><strong>우상복부·상복부 복통의 평가 알고리듬</strong><br><em><mark style="color:$info;">현행 임상 접근에 맞게 재구성</mark></em></p>
...
* Diverticulitis : 구역, 구토; 수일간 지속
  * 면역정상 성인의 경증 비복잡 게실염(uncomplicated, Hinchey I)에서는 routine 항생제 사용에 반대하고 관찰·보존적 치료를 권고 (AVOD, DIABOLO trial 기반; ACG 2026 Colonic Diverticulitis Guideline에서 저위험 비복잡 게실염에 대한 공식 권고로 명시). 고위험 소견, 면역저하, frailty, 안전한 외래 관리가 어려운 경우에는 항생제 치료가 적절
...
<p align="center"><strong>하복부 복통의 평가 알고리듬</strong><br><em><mark style="color:$info;">현행 영상·치료 원칙에 맞게 재구성</mark></em></p>
...
* 고환염전(testicular torsion) : 남아의 하복부·서혜부 통증이 급성 음낭통으로 오인되지 않도록 외부 생식기 진찰 병행
...
* **자궁외임신 누락**
  ...
  * 임신 가능성이 있는 가임기 여성의 하복부·골반통에서는 임신 여부를 우선 확인; 임신이 확인되면 골반 초음파로 자궁외임신 배제
* **충수염 초기에 귀가**
...
>
> ```
> 트라마돌 캡슐 50 ㎎    q6-8h prn (일반 성인에서 총 400 ㎎/day를 초과하지 않음)
> 맥페란정 (metoclopramide) 10 ㎎    tid pc    — 오심 동반 시
> ```
>
> _✽ 진단 확인 전이라도 적절한 통증 조절은 표준 치료. 경증~중등도 통증은 acetaminophen 또는 원인에 적합한 NSAID를 우선 고려하고, opioid가 필요하면 최소 유효용량·최단기간 사용. Tramadol의 400 ㎎/day는 일반 성인의 상한선이지 목표 용량이 아님. 고령자, 신·간기능 저하에서는 감량 또는 투여 간격 연장이 필요하며, serotonergic drug 병용·간질 또는 경련 위험 약물 병용 시 주의_
