...
<table><thead><tr><th width="154">질환</th><th>복통 양상 및 진단 단서</th></tr></thead><tbody><tr><td>급성 심근경색</td><td>상복부 통증; 고령·당뇨·심혈관 위험 인자; ECG + troponin 필수</td></tr><tr><td>폐렴</td><td>하폐엽 폐렴에서 상복부·옆구리 통증 가능; 호흡기 증상, 흉부 X선</td></tr><tr><td>폐색전증</td><td>흉막 자극 시 복통 발생 가능; 호흡 곤란, D-dimer, CTA</td></tr><tr><td>당뇨병 케톤산증</td><td>미만성 복통, 구역·구토; 혈당·케톤·anion gap 확인 (SGLT2 억제제 사용자는 정상~경도 혈당에서도 가능 - euglycemic DKA)</td></tr><tr><td>대상포진</td><td>발진 전구기 편측 복통, 피부 과민(allodynia), 띠 모양(dermatomal) 통증; 수포 출현 시 확진</td></tr></tbody></table>
...
* 기능성 변비(functional constipation) : 1차 진료 소아 급성/재발성 복통의 매우 흔한 원인; 배꼽 주위 또는 하복부의 쥐어짜는 듯한 통증이 배변 후 씻은 듯이 호전되는 패턴이 특징적
  * red flag(체중 감소, 혈변, 발열, 야간통 등) 없이 이러한 패턴이면 기능성 변비를 우선 고려
...
<table><thead><tr><th width="168">질환</th><th>핵심 단서</th></tr></thead><tbody><tr><td>AAA 파열</td><td>고령·흡연·박동성 종괴·저혈압</td></tr><tr><td>장간막 허혈</td><td>AF·심혈관 병력·pain out of proportion</td></tr><tr><td>GI 천공</td><td>갑작스러운 극심한 통증·복막염 소견</td></tr><tr><td>자궁외임신</td><td>가임기 여성·β-hCG 양성</td></tr><tr><td>Acute MI</td><td>상복부 통증·심혈관 위험 인자·ECG 변화</td></tr></tbody></table>
...
graph TD
    ...
    G --> K["<u>5대 치명 질환 배제</u> <br>AAA/허혈/천공/<br>자궁외임신/MI"]
...
> ```
>
> _✽ NSAIDs가 1차 선택; 통증 재발 시 반복 투여 가능 (최대 5일). 고령·저체중·신기능 저하에서는 15 ㎎ 등 감량 고려. 신기능 저하·출혈 경향 있으면 opioid로 전환. 통증 조절 후 비조영 CT로 결석 확인 권장(임신 시 초음파 우선)_

> **처방례 2. 중등도\~중증 급성 복통 (비opioid 진통제로 불충분하거나 금기인 경우, 진단 미확정 상태에서의 단기 통증 조절)**
>
> ```
> 아세트아미노펜 650 ㎎ q6h prn - 1차 고려
> 트라마돌 캡슐 50 ㎎ 1회 투여 후 재평가; 필요시 q6-8h prn (일반 성인에서 최대400 ㎎/d)
> 맥페란정 10 ㎎ 오심 동반 시 필요할 때마다 투여
> ```
>
> _✽ 진단 확인 전이라도 적절한 통증 조절은 표준 치료이나, 진단 미확정 상태에서의 반복적 opioid 투여는 증상 변화 인지와 재평가를 방해할 수 있으므로 경증\~중등도는 acetaminophen 또는 원인에 적합한 NSAID를 우선 고려하고, tramadol은 비opioid로 불충분하거나 금기인 경우 최소유효용량·최단기간·재평가를 전제로 사용. Tramadol은 세로토닌 증후군·경련·어지럼·낙상 위험이 있어 serotonergic drug(SSRI/SNRI/MAOI 등) 병용·간질 병력자에서 주의; 항경련제(gabapentinoid) 또는 항콜린제(진경제) 병용 시 CNS 억제·호흡 억제 또는 진정·착란·변비 심화 위험이 상가적으로 증가하므로 병용 여부를 반드시 확인; 고령자, 신·간기능 저하에서는 감량 또는 투여 간격 연장 필요. Metoclopramide는 정규 반복 투여보다 오심 시 필요에 따라 사용하고, 장폐쇄가 의심되면 사용을 피하며 추체외로 증상(EPS) 발생 가능성을 설명. 진단 미확정 환자는 1회 투여 후 통증·전신 상태 재평가와 disposition 결정이 우선임_

> **처방례 3. 급성 췌장염 의심 - 응급실 이송/입원 평가 전 통증 조절**
>
> ```
> 트라마돌 캡슐 50 ㎎ q6h prn
> IV fluid (LR 우선) 병행 - 초기에는 적절한 수액을 투여하되 반복 재평가
> ```
>
> _✽ 급성 췌장염이 의심되면 응급실/입원 평가가 원칙이며, 아래는 이송 전 통증 조절의 예시임. 급성 췌장염은 원칙적으로 NPO를 유지하는 질환이 아니며, 구역·구토가 없고 임상적으로 안정되면 24\~48시간 이내 저지방 고형식으로 조기 경구 섭취를 시작 \[2024 ACG guideline]. 수액은 LR을 우선 고려하되 과도한 aggressive hydration보다 활력징후·BUN/Cr·소변량 및 임상 상태를 반복 평가하며 조절하고, 고령·심부전·CKD에서는 volume overload에 특히 주의. 췌장염에서 opioid 사용은 과거 Oddi 괄약근 경련 우려로 기피했으나 임상적 근거는 불충분하며 적절한 통증 조절이 우선. 중등도 이상은 입원 의뢰_
