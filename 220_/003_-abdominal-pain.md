...
* 통증이 지속적으로 악화되거나, 반복 구토로 경구 섭취가 불가능하거나, 새로운 발열·출혈·황달·국소 압통·복막 자극 소견이 나타나거나, 재평가 시 활력징후·진찰 소견이 변화
...
* 복부-골반 CT : 성인의 미분화 급성 복통, 특히 고령·전신상태 이상·혈관 위험 또는 중증 질환이 의심되는 경우 중요한 초기 영상검사. 충수염·게실염·폐쇄·천공 등 광범위한 원인을 평가할 수 있으며, 장간막 허혈·AAA 등 혈관질환이 의심되면 적절한 CTA protocol을 선택. 연령·임신 여부·통증 위치와 의심 질환에 따라 US 또는 MRI를 우선 선택할 수 있음
* MRI : 방사선 노출을 피해야 하는 임신·소아에서 초음파로 진단이 불명확한 충수염 평가에 유용; 담도계 평가에서는 MRCP가 담관·췌관을 비침습적으로 시각화하여 담석·협착 감별에 도움
...
* [ ] GERD·위염(gastritis)·기능성 소화불량(functional dyspepsia)은 해부학적으로 상복부(epigastric) 통증이나, 임상적으로 RUQ와 겹치는 경우가 많아 함께 기술함
...
- Fitz-Hugh-Curtis 증후군 : 젊은 여성에서 RUQ 통증; PID의 합병증으로 발생하는 간 주위염(perihepatitis) - 하복부 증상 없이 RUQ 통증만 있을 수 있어 담낭염과의 감별이 필요; PID 병력 또는 STI 위험 인자 확인
...
- 소화성 궤양 : 상복부 통증·쓰림, 식사와 연관될 수 있음; NSAID 사용력과 H. pylori 위험 확인
...
flowchart TD
    ...
    O -- No --> Q["췌장염·PUD·GERD<br>·기능성 소화불량 등 평가"]
...
* Diverticulitis : 구역, 구토; 수일간 지속
  * 정상 면역 성인의 비복잡 게실염(농양·유리천공·누공·폐쇄가 없는 국소 결장벽 염증 및 주변 지방 침윤; modified Hinchey Ia에 해당하며, 국소 농양이 동반된 Ib는 제외) : routine 항생제 사용에 반대하며 관찰·보존적 치료를 권고 \[ACG 2026 Colonic Diverticulitis Guideline, 저위험 비복잡 게실염에 대한 권고]. 고위험 소견, 면역저하, frailty, 안전한 외래 관리가 어려운 경우에는 항생제 치료가 적절
  * 첫 발병이거나 중증·진단이 불확실한 경우 CT로 진단을 확인; complicated diverticulitis 회복 후에는 대장내시경을 권고하고, uncomplicated disease도 alarm symptom이 있거나 대장암 검진이 최신 상태가 아니면 대장내시경을 고려 \[ACG 2026]
  * 우측 게실염 : 동양인에서 흔함; 충수염과 임상 양상 매우 유사 - CT로 감별 필요
  * 좌측 게실염 : 서구형의 전형적 위치(LLQ); 고령, 저섬유·고지방 식이 환자에서 호발
* Ischemic colitis (허혈성 결장염) : 주로 LLQ 또는 좌측 복통; 혈성 설사, 복통이 갑자기 시작; 고령, 동맥경화, 저혈압, 심방세동 환자에서 주의 - CT가 초기 평가에 유용하며, 필요시 대장내시경으로 확인. Acute mesenteric ischemia(CTA가 핵심)와는 구분되는 질환임
* Nephrolithiasis : 편측 옆구리 통증, 등 통증
  * 발열/패혈증 소견 + 요로폐쇄(수신증) 동반 = infected obstructed kidney → 비뇨기과적 응급, 즉시 감압(경피적 신루설치술 또는 요관 스텐트) 필요
...
flowchart TD
    ...
    B -- Yes --> C["β-hCG"]
    C --> D["양성"]
    D --> E["경질초음파 <br>± 산부인과 응급 평가<br>자궁외임신 우선 배제"]
    C --> F["음성"]
...
* 골반염(PID) : 양측 하복부 통증, 발열, 질 분비물; 자궁경부 운동통(cervical motion tenderness) - 골반염 진단의 핵심 신체 검진 소견; Fitz-Hugh-Curtis 증후군(간 주위염) 합병 시 RUQ 통증 동반 가능
* 난소낭종 파열 : 갑작스런 편측 하복부 통증; 성적 활동 또는 운동 후 발생 가능
* 난소 염전 : 갑작스런 심한 편측 하복부 통증, 구역, 구토; 경질초음파를 시행하되 정상 Doppler 혈류만으로는 배제하지 않으며, 임상적으로 강하게 의심되면 영상 결과와 관계없이 즉시 산부인과 응급 평가 및 진단적 복강경을 고려 → 응급
* 원발성 월경통 : 월경 시작 전후 하복부 경련성 통증; 요통, 오심 동반 가능

#### <mark style="color:$primary;">미만성 복통</mark>

* 복막염 : 움직이거나 흔들리면 악화, 반동 압통, 복부 강직
* 장 폐쇄 : 경련성 복통, 구역, 구토, 변비, 복부 팽만, 높은 음조의 증가된 장음 또는 무음; 성인 소장 폐쇄의 가장 흔한 원인(약 60\~70%)은 수술 후 유착(postoperative adhesion)이므로 복부 수술력 확인이 중요한 진단 단서
* GI 천공 : 갑작스런 심한 복통
* 복부 대동맥류(AAA) 파열 : 갑작스러운 심한 복통 또는 요통, 박동성 복부 종괴, 혈압 저하; 고령·흡연력·죽상동맥경화 병력이 있는 환자에서 강하게 의심 - 흡연력이 있는 여성에 위험 증가; 즉각 응급 처치 필요
...
* IBS : 배변과 연관된 반복성 복통(배변 후 호전 또는 악화 가능), 배변 빈도 또는 형태 변화 동반 (Rome IV 기준); Lactose intolerance(경련성 복통, 복부 팽만·가스, 설사)와 감별 필요
...
* 장중첩증(intussusception) : 주로 영유아, 간헐적 발작성 복통 + 무기력이 반복, 담즙성 구토, 혈변("currant jelly stool"); 초음파로 확인
...
* 고령(특히 ≥60\~65세), frailty, 심방세동·혈관 질환, 당뇨·CKD·면역 저하 등은 중증 질환의 비전형적 발현 위험을 높이는 risk modifier이므로 영상검사·관찰 역치를 낮춤; 임신 가능성이 있는 가임기 여성은 β-hCG 확인
...
* 응급실 또는 관찰 가능한 환경에서 serial examination 및 필요 시 반복 검사·영상 : 진단 불명확하나 중증 질환을 완전히 배제하기 어려운 경우(예: 초기 충수염 의심)
* 외래 추적 + 명확한 safety-net 설명 : 활력징후 안정, 중증 질환 가능성이 낮고 경증·기능성 가능성이 높은 경우 - "통증 악화, 발열, 구토 지속, 혈변 발생 시 즉시 재내원" 등 구체적인 재내원 기준을 제시
