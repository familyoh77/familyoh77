...
* 복용 중인 약물을 반드시 확인 : NSAIDs(소화성 궤양·천공), 스테로이드·이뇨제(췌장염), 항생제(항생제 관련 장염) 등은 복통의 직접적 원인이 될 수 있음
...
* 박동성 복부 종괴 (복부 대동맥류 파열 위험 - 고령 환자의 급성 복통 중 가장 치명적인 원인 중 하나)
...
* 기본 : CBC, 전해질, BUN/Cr, 간기능(AST/ALT/ALP/bilirubin), lipase(amylase보다 민감도·특이도 우수; 우선 시행), UA
* 추가 고려 : CRP/ESR(염증 평가), coagulation(출혈 의심), lactate(장간막 허혈 의심), glucose/ketone(당뇨 환자에서 DKA에 의한 가성 복막염 배제)
* 가임기 여성 : β-hCG (반드시 포함)
...
* Diverticulitis : 구역, 구토; 임상 증상은 기저 염증의 중증도에 의존; 수일간 지속
  * 우측 게실염(Rt-sided diverticulitis) : 동양인에서 서구형과 달리 우측 결장에 게실이 흔히 발생하며, 임상 양상이 충수염과 매우 유사함 - CT로 감별 필요
  * 좌측 게실염(Lt-sided diverticulitis) : 서구형의 전형적 위치(LLQ); 고령, 저섬유·고지방 식이 환자에서 호발
...
* GI 천공 : 갑작스런 심한 복통
* 복부 대동맥류(AAA) 파열 : 갑작스러운 심한 복통 또는 요통, 박동성 복부 종괴, 혈압 저하; 고령 남성에서 호발 - 즉각 응급 처치 필요
* Viral gastroenteritis : 상대적으로 덜 심한 복통, 설사, 구역, 구토
* 식중독 : 설사, 구역, 구토, 발열; 원인으로 의심되는 음식 섭취 경력
* 셀리악병 : 부피가 큰 설사, 나쁜 냄새의 지방변, 복부 가스
* IBS : 만성 복통, 배변 습관 변화; Lactose intolerance(경련성 복통, 복부 팽만·가스, 설사)와 감별 필요
...
* **진통제 복용 시 의료진과 상의하십시오** : 자의로 강한 진통제(특히 마약성 진통제)를 복용하면 증상 변화를 놓쳐 진단이 늦어질 수 있습니다. 통증이 심할 경우 반드시 의료진에게 알리십시오 — 진료 중 통증 조절은 의료진이 판단합니다
