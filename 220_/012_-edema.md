...
* 이미 이뇨제를 사용하고 있는 경우, **이뇨제 중단(diuretic withdrawal)을 먼저 시행**한 후 약물 치료를 고려함; 2\~4주 동안 복용 중단 및 저염식 병행
  * 이뇨제 중단 후 일시적으로 체중 증가가 나타날 수 있으나 수주 내 호전됨을 미리 설명

#### 이뇨제

* 이뇨제가 필요한 경우 최소 유효 용량으로, **단기 사용을 원칙**으로 투여 (☞ p.485)
...
## <mark style="color:orange;">핵심 복약 지도</mark>
