...
* 흉통의 정의 : 가슴 통증 뿐 아니라 가슴·어깨·팔·목·상복부·턱의 압박감, 조임, 무거움, 작열감을 포함
  * 고령자·당뇨병 환자에서는 흉통이 뚜렷하지 않을 수 있고 호흡곤란, 실신, 메스꺼움, 심한 피로감 등 협심증 동등 증상(anginal equivalents)이 두드러질 수 있음. 특히 75세 초과 환자에서 호흡곤란, 실신, 급성 섬망 또는 설명되지 않는 낙상이 있으면 ACS(acute coronary syndrome)를 고려
  * 여성에서도 흉통은 ACS의 가장 흔한 증상이며 남성과 비슷한 빈도로 나타나지만, 오심, 호흡곤란, 피로 등의 동반 증상이 더 흔할 수 있으므로 이를 비심장성으로 오인하지 않도록 주의
* 흉통 환자 진단의 관건은 Red flags 및 ACS 등 응급 의뢰 필요 여부를 판단하는 것임
...
* 니트로글리세린으로 호전된다는 사실만으로 허혈로 진단하면 안 됨 (식도 연축도 이에반응함)
* ✽ 허혈 가능성이 낮다고 해서 응급질환 가능성이 낮다는 의미는 아님; tearing·ripping 양상은 오히려 급성 대동맥 증후군(AAS)을 시사할 수 있으므로 별도로 감별할 것
...
* 공황장애, 불안장애
* 대상포진
  * 발진 출현 전(pre-eruptive) 수일\~1주간은 피부 분절 (dermatome)을 따르는 편측성 흉통만 나타나 ACS로 오인하기 쉬움; 통증 분포가 dermatome 패턴이면 감별이 필요; 피부 분절성 통증과 국소 allodynia(가벼운 접촉에도 심한 통증)는 대상포진 전구기를 시사할 수 있으나 특이적이지 않으며, 발진이 없으면 다른 원인을 배제할 수 없음
...
* 찢어지는(tearing)·칼로 베는 듯한(sharp/stabbing) 흉통이 갑자기 최대 강도로 시작되며 등·복부로 이동(migration) `대동맥 박리`
* 찢어지는 흉통 + 양측 상지 혈압 차이 ≥20 ㎜Hg (≥15 ㎜Hg도 의심 신호로 주의 깊게 관찰) 또는 비대칭적 맥박 `대동맥 박리` - 단, 민감도가 낮아 혈압 차이·맥박 비대칭이 없다고 박리를 배제할 수는 없음
* 흉통 + 새로 발생한 대동맥판 역류 잡음(좌측 흉골연의 고음성 이완기 잡음) - 근위부(Stanford A) 박리가 대동맥 근부까지 침범했음을 시사 `대동맥 박리`
* 흉통 + 신경학적 결손 (경동맥·척추동맥 침범 시사) `대동맥 박리`
* 심한 구토/구역질 직후 발생한 급성 흉통 ± 피하기종/호흡곤란/쇼크 `식도 파열`
* 편측 호흡음 소실 + 저혈압·빈맥 + 기관 변위 `긴장성 기흉`

<mark style="color:$warning;">**수 시간 내 평가 또는 응급실 의뢰**</mark>

* 휴식 시 흉통 발생 `불안정 협심증` `NSTEMI`
* 새로 발생하거나 악화된 야간·휴식 시 흉통, 특히 지속성 또는 진행성 `ACS`
...
* 진찰, vital sign (pulse oximetry 포함), 병력 청취, ECG / 실험실 / 영상 검사

#### <mark style="color:$primary;">ECG 검사</mark>

* 급성 흉통 환자에서 ECG는 처치 방향을 결정하는 핵심 도구임
* 12-Lead ECG : 명백한 비심장성 원인이 확인되지 않은 안정형 흉통 및 모든 급성 흉통 환자에서 시행. 외래에서 ECG를 시행할 수 없고 심장 원인을 배제하기 어려우면 응급실 의뢰
* 'Door-to-ECG 10분' : 내원 후 10분 이내 시행 및 판독하는 것이 긴요 \[2021 AHA/ACC]

<mark style="color:cyan;">**ECG 소견에 따른 처치 알고리즘**</mark>
...
flowchart TD
    ...
    G --> Q["STEMI 확인?"]
    Q -->|"예"| N1["STEMI<br>가이드라인 따름"]
    Q -->|"아니오<br>(심낭염·심근심막염 확인)"| P["해당 지침에<br>따라 처치"]
    style N fill:#d32f2f,color:#fff
    style N1 fill:#d32f2f,color:#fff
...
<mark style="color:cyan;">**hs-cTn (고감도 심장 트로포닌)**</mark>

* 급성 MI 진단의 현 표준 바이오마커; 기존 CK-MB·myoglobin은 1차 검사로 권고되지 않음
* hs-cTn의 99th percentile 상한치(URL)는 assay에 따라 다르며, 2026년 제5차 심근경색 보편적 정의(Fifth UDMI)부터는 심근손상 정의에 성별 특이(sex-specific) URL 적용이 원칙으로 명시됨(단일 URL 적용 시 여성에서 심근손상·MI가 과소 진단될 위험). 검사기관이 사용하는 assay의 성별 특이 99th percentile URL을 확인하여 적용할 것
...
* 부하 검사 정상(충분한 운동 또는 약물부하 조건 충족, 영상 품질 양호) 시 1년
* 이전 검사가 비-진단적이었거나 경도 이상 소견이 있었던 경우에는 새로운 증상 발생 시 재평가

### <mark style="color:orange;">위험도 평가 도구</mark>
...
#### <mark style="color:$primary;">Marburg Heart Score (MHS)</mark>
...
_✽ 위 확률은 원 코호트 연구에서 관찰된 값으로 모집단에 따라 달라질 수 있음. 문헌·임상 적용에 따라 ≤2점/≥3점의 이분법 또는 0\~2점/3점/4\~5점의 3단계 분류도 함께 사용되므로, MHS는 응급 ACS 배제 도구가 아니라 안정적인 외래 환자의 CAD 가능성 평가 보조 도구로만 사용_

#### <mark style="color:$primary;">INTERCHEST Rule</mark>
...
#### <mark style="color:$primary;">HEART Score</mark>

* ACS 단기 예후 예측 도구(흔히 30일 기준); AHA 권고 scoring tool
* History, ECG, Age, Risk factors, Troponin 5개 항목, 각 0\~2점, 총 0\~10점

<table data-search="false"><thead><tr><th width="113.57894897460938">항목</th><th width="48.4210205078125">점수</th><th width="594.0666809082031">기준</th></tr></thead><tbody><tr><td><strong>H</strong>istory</td><td>2</td><td>ACS가 매우 의심되는 병력(highly suspicious)</td></tr><tr><td></td><td>1</td><td>ACS가 중등도로 의심되는 병력(moderately suspicious)</td></tr><tr><td></td><td>0</td><td>ACS가 거의 의심되지 않는 병력(slightly suspicious)</td></tr><tr><td><strong>E</strong>CG</td><td>2</td><td>LBBB·LVH·digoxin에 의하지 않은 유의한 ST 편위(하강 또는 상승)</td></tr><tr><td></td><td>1</td><td>ST 편위 없는 LBBB, LVH, digoxin 효과, 또는 기존의 재분극 이상</td></tr><tr><td></td><td>0</td><td>정상</td></tr><tr><td><strong>A</strong>ge</td><td>2</td><td>≥65세</td></tr><tr><td></td><td>1</td><td>45~64세</td></tr><tr><td></td><td>0</td><td>&#x3C;45세</td></tr><tr><td><strong>R</strong>isk factors</td><td>2</td><td>≥3개의 심혈관 위험 인자* 또는 죽상동맥경화증(CAD, 뇌졸중, 말초혈관질환 병력)</td></tr><tr><td></td><td>1</td><td>1~2개의 위험 인자</td></tr><tr><td></td><td>0</td><td>위험 인자 없음</td></tr><tr><td><strong>T</strong>roponin</td><td>2</td><td>정상 상한치(ULN)의 3배 초과 상승</td></tr><tr><td></td><td>1</td><td>ULN의 1~3배 상승</td></tr><tr><td></td><td>0</td><td>정상 범위 이내</td></tr></tbody></table>
...
flowchart TD
    ...
    L -->|예| R["응급 처치와 이송 동시 진행<br>ACS / AAS / <br>PE / 긴장성 기흉<br>심낭압전 / 식도 파열"]
    L -->|아니오| C["진료 장소?"]
    C -->|외래| O["10분 이내 ECG 가능 시 시행<br>ACS·생명위협 원인 의심?"]
    C -->|응급실| T["ECG + hs-cTn 기반 CDP"]
    O -->|예| R
    O -->|아니오| K1["기타 심폐/<br>비심장 원인"]
    T --> Q["STEMI 또는<br>고위험 ACS 소견?"]
    Q -->|예| D["ACS 가이드라인 따름<br>즉시 응급실/<br>PCI 가능 병원 이송"]
...
<div align="left"><figure><img src="../.gitbook/assets/흉통10.JPG" alt="급성 흉통의 증상 및 병력에 따른 감별 흐름도"><figcaption><p><strong>급성 흉통의 증상·병력에 따른 감별</strong></p></figcaption></figure></div>

#### <mark style="color:$primary;">만성 흉통</mark>

<div align="left"><figure><img src="../.gitbook/assets/흉통11.JPG" alt="만성 흉통의 증상 및 병력에 따른 감별 흐름도"><figcaption><p><strong>만성 흉통의 증상·병력에 따른 감별</strong></p></figcaption></figure></div>

## <mark style="color:green;">통증 기원별 특징 및 감별</mark>
...
* ACS 의심 시 즉시 12-lead ECG를 시행하고 혈역학적 안정 여부, 임상 맥락, serial hs-cTn 결과를 함께 평가
* ACS/급성 허혈을 시사하는 ECG 소견 : 새로운 또는 동적인 ST elevation/depression, 새로운 또는 동적인 T-wave inversion 등; pathologic Q wave는 이전 또는 진행된 MI를 시사할 수 있으므로 임상 맥락과 이전 ECG를 함께 비교
  * new LBBB 단독은 더 이상 STEMI equivalent로 보지 않음; LBBB 또는 우심실 페이싱(RV paced rhythm) 동반 시 Sgarbossa 기준(또는 modified Smith-Sgarbossa 기준) 적용 권장 - 두 경우 모두 표준 ST 편위 판독이 제약되므로 동일하게 적용

<mark style="color:cyan;">**급성 심근경색 가능성**</mark>
...
* sPESI 0점: 저위험(30일 사망률 약 1%) → 다른 조건을 충족하면 외래 치료 또는 조기 퇴원 고려 가능
* sPESI ≥1점: 저위험군으로 분류되지 않음 → 입원 및 추가 위험도 평가 고려
  * PE에서 "고위험(high-risk PE)"은 혈역학적 불안정성이 핵심 기준이며, sPESI ≥1을 곧바로 고위험 PE로 지칭하지 않음
...
<mark style="color:cyan;">**근골격 원인에 의한 증상 특징**</mark>

* squeezing 또는 oppressive 통증이 아님
* 국소 압통; 압박으로 증상이 재현됨
* 자세 또는 움직임에 의해 영향 받음

<mark style="color:cyan;">**질환별 특징**</mark>
...
#### <mark style="color:$primary;">비-심폐 기원 흉통의 감별</mark>

<mark style="color:cyan;">**GERD vs 심장성 흉통 vs 근골격계 기원 통증 감별**</mark>
...
### <mark style="color:orange;">의뢰 전 초기 처치</mark>
...
* aspirin 162\~325 ㎎을 즉시 씹어서 투여 (loading dose) <mark style="color:blue;">\[바이엘아스피린정 500 ㎎]</mark>
  * 비장용정이어야 함. 장용정은 흡수가 지연되어 응급 시 효과가 떨어짐
  * 국내 유통되는 저용량 아스피린은 주로 100 ㎎ 장용정이므로 응급 loading 목적에는 부적합; 비장용 제제 구비 여부를 사전에 확인해 둘 것
  * 금기 : 아스피린/살리실산제에 대한 중증 과민반응, 아스피린-악화 호흡기질환(AERD) 병력, 활동성 중대 출혈 (단순 기관지천식·비강폴립 병력 자체가 모두 절대금기는 아니며, AERD를 의심하게 하는 단서로 평가)
  * ✽ 바이엘아스피린정 500 ㎎의 국내 허가사항에는 ACS 항혈소판 loading 적응증이 포함되어 있지 않으므로 이 용도의 사용은 허가사항 외(off-label) 사용에 해당함; 국제 지침상 162\~325 ㎎ 비장용 aspirin loading 자체는 표준 처치임
...
>
> ```
> 바이엘아스피린정 500 ㎎ 0.5T 1회 씹어서 복용
> 명문니트로글리세린설하정 0.6 ㎎ 1T 혀밑에서 녹여서 복용. 5분 간격 최대 3회
> ```
>
> _✽ 이 처방은 외래 귀가 처방이 아니라 응급실 이송 전 초기 처치임 - ACS 의심 환자는 처방 후 귀가시키는 것이 아니라 즉시 이송 대상임. aspirin은 반드시 비장용정 사용(국내 유통 저용량 제품은 대부분 100 ㎎ 장용정이므로 응급 loading에는 부적합); 아스피린/살리실산제 중증 과민반응, AERD(아스피린-악화 호흡기질환) 병력, 활동성 중대 출혈 시 금기(단순 천식·비강폴립 병력만으로는 절대금기 아님); 바이엘아스피린정 500 ㎎의 이 용도 사용은 국내 허가사항 외(off-label) 사용에 해당함. nitroglycerin은 국내 설하정 규격(0.3/0.6 ㎎)에 맞춰 0.6 ㎎으로 처방하며(스프레이 사용 시 1회 분무 = 0.4 ㎎), 국내 첨부문서상 급성 심근경색이 금기로 기재되어 있어 협심증 기왕 처방자의 자가 사용과 의료진 감독하 응급 사용을 구분함; 수축기 혈압 ＜90 ㎜Hg, 최근 PDE-5 억제제 복용(실데나필·바르데나필 24시간 이내, 타다라필 48시간 이내), 우심실 경색 의심 시 금기. 기존에 협심증으로 NTG를 처방받은 환자가 아니라면 임의 투여하지 말고 119/의료진 지시에 따를 것_

> **처방례 2. 응급 질환을 배제한 GERD 의심 흉통 (전형적 가슴쓰림·산 역류 동반 시)**
>
> ```
> 넥시움정 40 ㎎ 1T qd 식전 8주 (PPI trial)
> ```
>
> _✽ ACS·PE·대동맥 박리 등 생명 위협 원인을 충분히 배제한 후, 전형적인 가슴쓰림·산 역류가 동반된 경우에만 시행하는 진단적 치료 시험임(ACG GERD Guideline). PPI 반응이 있다고 GERD가 확진되는 것은 아니며, 반응이 없거나 재발 시 재평가 필요. 가슴쓰림·산 역류 없이 흉통만 있는 경우에는 PPI trial 반응만으로 GERD를 추정하지 말고 내시경·역류 검사 등 객관적 평가를 우선 고려 (☞_ [_GERD_](../224_/081_-gerd.md)_)_

> **처방례 3. 응급 질환을 배제한 근골격성 흉통**
>
> ```
> 타이레놀정 500 ㎎ 1~2T q6~8h (필요시)
> ```
>
...
이 체크리스트는 응급 상황 여부를 확인하고 의료진에게 증상을 정확히 전달하기 위한 도구입니다. **원인을 명확히 설명하기 어려운 새로운 흉통, 특히 갑자기 발생하거나 반복·지속되는 흉통은 아래 항목과 무관하게 반드시 진료를 받으십시오.**
...
* [ ] 지속: 쉬어도 통증이 가라앉지 않거나 반복되며 점점 심해진다

#### <mark style="color:$primary;">흉통 발생 시 이렇게 대처하세요</mark>

**1단계. 즉시 안정 + 119 신고**

* 활동을 멈추고 가장 편안한 자세로 앉거나 누워 안정을 취하십시오
* 새로 발생한 원인 불명의 흉통, 안정 시 발생한 흉통 또는 심근경색이 의심되는 흉통은 지속시간을 기다리지 말고 즉시 119에 신고하십시오
* **혼자 운전하여 병원에 가지 마십시오** (운전 중 의식 소실 위험)

**2단계. 처방받은 약물이 있다면 복용**

* 협심증으로 니트로글리세린을 처방받은 분은 위 **핵심 복약 지도**에 따라 설하정을 사용하십시오. 첫 투여 5분 후에도 증상이 지속되면 119에 신고하고, 추가 투여 때문에 신고를 늦추지 마십시오
* 심근경색이 의심되면 아스피린 복용 여부·용량은 119 또는 의료진의 안내에 따르십시오 (자세한 복용법은 위 핵심 복약 지도 참고)
