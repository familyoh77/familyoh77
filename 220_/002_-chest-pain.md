...
* 국소 압통; 압박으로 증상이 재현됨
  * [ ] 흉벽 압박으로 통증이 재현되더라도 ACS를 완전히 배제할 수는 없음
* 자세 또는 움직임에 의해 영향 받음
