...
* 구강 내 궤양·종괴, 경부 종괴 촉지
* 편측성 비강 악취 또는 혈성 비루 (비강·부비동 종양 배제)
* 반복적인 폐렴 또는 객혈 동반
...
* 위장관 : 소화불량, 위식도 역류(GERD; 역류·트림과 연관될 수 있으나 VSC 직접 생성 원인으로서의 근거는 제한적), 식도게실(특히 Zenker's diverticulum - 고령 환자에서 음식물이 게실에 고여 부패하며 심한 구취와 연하 곤란을 유발; 확진 검사는 식도 조영술(Barium swallow)이 우선이며, 내시경 선행 시 게실 천공 위험이 있어 주의 필요), 식도 저류(예: 이완불능증, 협착), 위암(체중 감소·연하곤란·출혈 등 alarm feature 동반 시 고려)
...
아래 3가지 중 2가지 이상 해당하면 구강 건조(xerostomia) 가능성을 의심하고 평가 → 구강 건조가 구취의 주요 원인일 수 있음
...
* CPC 함유 제품은 칫솔질 직후 사용 시 치아 착색 가능성이 있어 30분 간격 권장
...
> ※ 충분한 수분 섭취; 알코올 함유 가글은 구강 건조를 악화시킬 수 있어 피함
> ※ 클로르헥시딘의 장기 사용(치아 착색·미각 변화)에 유의하며, 별도로 알코올 함유 시판 가글은 구강 건조를 악화시킬 수 있어 피함
> ※ 증상 지속 시 치과적 평가 및 입안마름증 챕터 참고 (☞ [입안마름증](../222_/056_-dry-mouth-xerostomia.md))
...
> * 구취 관리에 효과가 입증된 주요 자가관리 방법입니다 — 매일 시행을 권고합니다
...
> - **단기 사용** — 치은염·치주염 등 명확한 구강 염증이 동반된 경우 클로르헥시딘 <mark style="color:blue;">\[헥사메딘 액]</mark>을 단기간 보조적으로 사용; 통상 2주 이내
...
* **혀 클리너** : 혀 클리너(tongue scraper)로 설태를 매일 제거하는 것이 구취 관리에 효과적입니다. 혀 뒤쪽에서 앞쪽으로 부드럽게 사용하십시오
