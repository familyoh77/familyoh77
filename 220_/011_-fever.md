...
*   시험적 치료 : 불가피한 경우 임상적 증거에 기초하여 시험적 치료 시행
    ...
    •소위 shoutgun approach(다제 처방)는 증상/징후를 모호하게 하여 진단을 어렵게 하고 의도하지 않은 문제를 일으킬 수
...
*   ibuprofen이나 acetaminophen이 효과가 없으면 상호 전환하여 투여

    •각각의 단독 투여로 효과 없으면 두 가지를 교대로 병용 투여
