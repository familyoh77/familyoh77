...
* 미온수 마사지(Tepid sponge bath, 30℃) : 체온을 낮추는 데 일시적 도움을 줄 수 있으나, 오한(shivering)과 스트레스를 유발하여 오히려 대사율을 높일 수 있음. 특히 소아에서는 보호자의 불안감을 가중시킬 수 있음. 환자가 원치 않거나 오한을 느끼는 경우 즉시 중단
...
* ibuprofen 또는 acetaminophen이 효과가 없으면 체중에 따른 충분한 용량이 투여 되었는지 확인하며, 상호 전환하여 투여할 수 있음
  * 각각의 단독 투여에도 불구하고 고열이 지속되어 심한 보챔이나 통증 등 컨디션 저하를 보이거나, 다음 투약 시간까지 간격이 많이 남았으나 다시 고열로 인해 힘들어할 때 두 가지를 2\~3시간 간격을 두고 병용할 수 있으나, 유효성에 대한 근거가 부족하고, 소아에서 교대 투여는 보호자의 실수나 불안감으로 인한 과량 투여 위험이 있으므로 주의가 필요함
...
> **아세트아미노펜 (타이레놀)**
>
> * 성인 기준 1회 500\~1,000 mg, 4\~6시간 간격으로 복용하십시오. 하루 최대 4,000 mg(간질환·음주자는 2,000 mg)을 초과하지 마십시오.
