...
| | 고전적 불명열 (Classic) | 병원성 불명열 (Nosocomial; Healthcare-associated) |
|---|---|---|
| **정의** | 체온 ≥38.3℃, 기간 ≥3주, ≥3회 외래 방문 또는 입원 3일 후에도 원인 불명 | 체온 ≥38.3℃, 기간 >3일, 입원 당시 발열 상태 또는 당시 잠복기 아님 |
| **환자 위치** | 지역 사회, 병원 | 급성 질환을 다루는 병원 |
| **흔한 원인** | 감염, 염증, 악성 종양, 습관성 고열 | 원내 감염, 수술 후 합병증, drug fever |
| **병력** | 여행, 접촉, 동물/벌레 노출, 약물, 예방접종, 가족력, 심장 판막 이상 | 수술, 시술, 장치 삽입, 해부학적 이상, 약물 |
...
*   ibuprofen이나 acetaminophen이 효과가 없으면 상호 전환하여 투여
    ...
    •각각의 단독 투여로 효과 없으면 두 가지를 교대로 병용 투여 (소아에서 교대 투여는 복잡한 투여 스케줄로 과량 투여 위험이 있어 주의 필요)
