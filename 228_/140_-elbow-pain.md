...
* 과사용(운동, 직업) : 손목을 움직이는 근육의 힘줄 기시부인 lateral/medial epicondyle에서 tendinopathy(epicondylitis) 발생
...
* plain radiography : tendinopathy 자체는 대부분 정상이나 만성 병변에서는 드물게 부착부 골극(enthesophyte)·연부조직 석회화 등 골성/석회화 변화가 관찰될 수 있음; 외상력, 운동 범위/기능의 유의미한 감소, 골성 병변 의심 시 고려
* Elbow extension test : 급성 외상 후 팔꿈치를 능동적으로 완전히 신전하지 못하면 골절 가능성이 높아 X-ray 시행을 권고; 단 소아에서는 이 검사 단독으로 골절을 배제할 수 없음
...
* CT : soft tissue calcification(예: myositis ossificans), intra-articular body 및 골성 병변 평가에 선택적으로 사용
...
* numbness, tingling → nerve entrapment 또는 radiculopathy(예: cubital tunnel syndrome, radial tunnel syndrome, cervical radiculopathy)
...
<p align="center"><em><mark style="color:$info;">Ref. Elbow pain: A guide to assessment and management in primary care. BJGP 2015;65(640). Fig 1. 치료 경로는 BESS patient care pathway: Tennis elbow (2023)의 운동치료 우선 및 corticosteroid/ESWT 비권고를 반영하여 수정.</mark></em></p>
...
* Rest : relative rest, 악화 동작 회피, counterforce bracing
* Ice : 동상 주의(피부에 직접 얼음이 닿지 않도록 함)
* 작업·운동 자세 교정 및 ergonomic modification
* 재활 치료, PT : 통증 허용 범위에서 점진적 resistance exercise(신전근/굴곡근의 concentric·eccentric 강화)와 스트레칭; 예: wrist extensor/flexor의 점진적 eccentric-concentric resistance exercise
...
> ```
> 유발 활동/부하 조절 지속
> 점진적 손목 신전근 스트레칭 및 resistance exercise(PT)  교육/시행
...
> **NSAID 사용 원칙**
>
> * 가능한 최소 유효용량으로 필요한 기간만 사용. 위장관·신장·심혈관 위험은 치료 기간과 기저 위험에 따라 증가하므로, 고령·소화성궤양 병력·항응고제 병용 등 고위험군에서는 단기간이라도 주의하고 필요 시 PPI 병용 또는 다른 진통 전략 고려
> * 위장 불편이 있으면 음식과 함께 또는 식후 복용할 수 있으나, 식후 복용이 위궤양·출혈 위험 자체를 없애는 것은 아님
> * 신기능 저하 환자, 임신부에서는 사용 제한
...
> **Bracing(보조대) 착용**
>
> * counterforce brace는 상과 원위 3\~4 ㎝ 부위에 착용해야 힘줄 부하가 효과적으로 분산됨; 취침 시에는 제거
...
* 테니스·골프 같은 운동, 컴퓨터 작업, 공구를 반복적으로 쥐는 직업 등에서 손목을 움직이는 근육의 힘줄이 팔꿈치에 붙는 부위(상과)에 미세한 손상이 반복되어 통증이 생깁니다.
* 팔꿈치 바깥쪽이 아프면 "테니스 엘보"(외측상과염), 안쪽이 아프면 "골프 엘보"(내측상과염)라고 부릅니다.

#### <mark style="color:$primary;">일상생활에서 어떻게 관리하나요?</mark>

* **통증을 유발하는 동작을 줄이십시오.** 무거운 물건을 손목을 편 채로 들거나, 반복적으로 손목을 비트는 동작을 피하십시오.
* **초기에는 얼음찜질을 하십시오.** 하루 2\~3회, 15\~20분씩 하되 피부에 직접 닿지 않게 수건으로 감싸십시오.
* **보조대(브레이스)를 활용하십시오.** 팔꿈치 아래쪽에 착용하면 일부 환자에서 활동 중 통증을 줄이는 데 도움이 될 수 있습니다.
* **통증이 줄어들면 스트레칭과 근력 운동을 시작하십시오.** 완전히 좋아지기를 기다리지 말고, 참을 만한 수준에서 서서히 시작하는 것이 회복에 도움이 됩니다.
