...
<figure><img src="../.gitbook/assets/손목-수근골 (1).png" alt="" width="466"><figcaption></figcaption></figure>
...
graph TD
    ...
    Trauma --> Acute["급성(2주 미만) - 명확한 외상/과사용력"]
    Trauma --> Chronic["아급성·만성(2주 이상) - 과사용, 전신질환, 과거 손상"]
    Acute --> XR["X선 우선 시행"]
    XR --> FxCheck["골절·탈구·아탈구 확인"]
    FxCheck --> Refer1["이상 소견 시 정형외과/수부외과 의뢰"]
    FxCheck --> Snuffbox["Snuffbox 압통 + X선 정상 시 scaphoid 골절 의심, 고정 + 조기 MRI/CT 또는 10~14일 후 재평가·X선"]
