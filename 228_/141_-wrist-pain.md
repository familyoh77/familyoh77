...
<figure><img src="../.gitbook/assets/손목3.png" alt=""><figcaption><p>Palm of the Rt hand (Ref. Hand and Wrist Injuries. AFP 2004;69(8). Fig 4)</p></figcaption></figure>
...
* 능동 및 수동 운동 범위 관찰
* 외상 시 개방창·변형을 확인하고 정중·척골·요골신경의 감각·운동, 손가락 관류(색, 온도, 모세혈관 재충만, 맥박)를 초기에 평가

### <mark style="color:orange;">특수 신체검사</mark>

<table><thead><tr><th width="160">검사명</th><th>검사 방법 [양성 소견]</th><th width="200">의심 상태</th></tr></thead><tbody><tr><td><a href="https://www.youtube.com/watch?v=0KXRcnQqGUc">Tinel test</a></td><td>환자의 손목 안쪽 중앙부를 tapping [정중신경 분포를 따라 통증·이상감각 발생 시 양성]</td><td>Carpal tunnel syndrome</td></tr><tr><td>Phalen test</td><td>1분간 손목을 완전 굴곡(양 손등을 붙임) [정중신경 분포를 따라 통증·이상감각 발생 시 양성]</td><td>Carpal tunnel syndrome</td></tr><tr><td>Reverse Phalen test</td><td>1\~2분간 손목을 완전 신전(양 손바닥을 붙임) [정중신경 분포를 따라 통증·이상감각 발생 시 양성]</td><td>Carpal tunnel syndrome</td></tr><tr><td><a href="https://www.youtube.com/watch?v=4Xb0uc53qCs">Carpal compression test</a></td><td>검사자가 엄지손가락으로 30초간 손목 안쪽 중앙부를 압박 [정중신경 분포를 따라 통증·이상감각 발생 시 양성]</td><td>Carpal tunnel syndrome</td></tr><tr><td>Eichhoff maneuver</td><td>엄지손가락을 손 안에 넣어 주먹을 쥐게 하고 손목을 수동적으로 ulnar deviation [radial styloid 부위 통증 시 양성; 이 방법은 Eichhoff maneuver이며, Finkelstein test와 구분함. Finkelstein 방식의 위양성률이 더 낮다는 보고가 있음(Wu et al. J Hand Microsurg 2018)]</td><td>de Quervain's tenosynovitis</td></tr><tr><td><a href="https://www.youtube.com/watch?v=1kJtO4NLzBY">Grind test</a></td><td>thumb metacarpal bone을 잡고 trapezium 쪽으로 압박하며 회전 [통증, crepitus]</td><td>1st CMC(trapeziometacarpal) 관절염</td></tr><tr><td>Lunotriquetral shear test</td><td>triquetrum을 손등에서, lunate을 손바닥에서 압박 [통증, crepitus]</td><td>Lunotriquetral ligament tear</td></tr><tr><td><a href="https://www.youtube.com/watch?v=32ywiqilGdg">Supination lift test</a></td><td>손바닥으로 탁자 아래를 받치고 탁자를 밀어 올리게 함 [통증]</td><td>TFCC injury</td></tr><tr><td>Ulnar fovea sign</td><td>척골 붓돌기(ulnar styloid)와 flexor carpi ulnaris 건 사이의 함요부(fovea)를 엄지로 직접 압박 [통증 유발 시 양성]</td><td>TFCC foveal 손상, ulnotriquetral ligament injury</td></tr><tr><td><a href="https://www.youtube.com/watch?v=FTIbOdQV164">Watson's test (Scaphoid shift test)</a></td><td>scaphoid tubercle을 손바닥면에서 압박하면서 손목을 ulnar→radial deviation [통증, clunk(압박을 풀 때 발생)]</td><td>Scaphoid instability, Scapholunate separation</td></tr></tbody></table>
...
<figure><img src="../.gitbook/assets/손목4.png" alt=""><figcaption><p>② Phalen test</p></figcaption></figure>

<figure><img src="../.gitbook/assets/손목5.png" alt=""><figcaption><p>③ Reverse Phalen test</p></figcaption></figure>

<figure><img src="../.gitbook/assets/손목6.png" alt=""><figcaption><p>⑦ Lunotriquetral shear test (Ref. UpToDate. 2011.)</p></figcaption></figure>
...
* 초음파 : 표재성 힘줄·건초염, 일부 인대 손상, 결절종 및 동적 힘줄 탈구 평가에 유용; 시술자에 따른 편차가 있으며 잠재 골절이나 복잡한 골성 병변을 배제하는 검사로 사용하지 않음
...
<table><thead><tr><th width="220">원인</th><th width="220">특징</th><th>검사</th></tr></thead><tbody><tr><td>신경학적(척골·정중·요골 신경 포착)</td><td>신경 분포에 따른 저림·감각 저하(운동 장애 동반 가능)</td><td>병력·신경학적 진찰 우선; 진단이 불확실하거나 중증도·다른 신경병증 평가가 필요한 경우 신경전도검사 등 고려</td></tr><tr><td>과거 손상(불유합, 무혈관괴사)</td><td>외상력(회복되지 않았던 손상)</td><td>X선 우선; 필요시 CT 또는 MRI</td></tr><tr><td>전신 질환(RA, amyloidosis, gout, CPPD)</td><td>다른 관절 증상, 부종, 지속적 통증</td><td>의심 질환에 따른 혈액검사; 급성 단관절염은 감염 배제를 위한 관절액 검사 우선 고려</td></tr><tr><td>Tendinopathy</td><td>움직임 시 통증</td><td>보통 불필요</td></tr></tbody></table>
...
<figure><img src="../.gitbook/assets/손목7.png" alt="증상과 병력에 따른 손·손목 문제의 감별"><figcaption><p>증상/병력에 따른 손·손목 문제의 감별</p></figcaption></figure>
...
<table><thead><tr><th width="200">상태</th><th>병력 및 진찰 소견</th></tr></thead><tbody><tr><td>Compartment syndrome</td><td>외상력(손상, 수술, 과격한 활동); 지속적인 아래팔 통증과 조임감; 얼얼함, 화끈거림, 무감각<br>이환된 구획의 압통 및 긴장감; 관련 근육의 수동 신장 시 통증 증가; 진행하는 이상감각·감각 저하. 창백·마비·맥박 감소/소실은 후기 소견일 수 있으며 맥박이 정상이어도 배제할 수 없음</td></tr><tr><td>손의 화농성 건초염/감염</td><td>최근 손상력; 감염과 염증의 전형적 증상<br>Kanavel 4징후 : ① 손가락 굴곡 자세, ② 손가락을 수동적으로 신전할 때 통증, ③ 손가락 균일한 종창, ④ 이환된 건초 전체의 압통</td></tr><tr><td>Long flexor tendon 파열</td><td>건의 열상; 강한 굴곡 수축<br>원위지 및 근위지 관절의 독립된 운동 상실; 이환된 근육의 촉지 실패</td></tr><tr><td>Lunate 골절/탈구</td><td>손으로 바닥을 짚고 넘어지거나 접질린 이력; 손목 전체의 통증<br>손목 신전 시 동작 끝부분에서 통증 유발; 쥐는 힘 감소 또는 물건을 잡을 때 통증</td></tr><tr><td>Scaphoid fracture</td><td>손을 편 상태로 넘어진 이력; 15\~30세 남성, 골다공증 여성<br>손목 주위 종창과 멍; anatomic snuffbox 및 주상골 결절의 압통; 손을 쥘 때 통증 증가</td></tr><tr><td>원위부 Radius(Colles') 골절</td><td>강하게 손목을 신전한 채 팔을 쭉 펴고 넘어진 경우; 젊은 남성 혹은 나이 든 여성<br>손목 종창; 손목을 중립위로 놓으려 함; 손목 신전 시 통증</td></tr><tr><td>요골두 골절(동반된 팔꿈치 손상)</td><td>손을 쭉 펴고 넘어진 이력<br>팔꿈치 관절 삼출(팔꿈치를 약간 굽힌 자세로 있으려 함); 회외·회내 능동적 관절 운동 시 통증 및 제한; 요골두 압통</td></tr><tr><td>레이노병</td><td>가족력; estrogen 치료 여성; 한랭 노출/동상; 교원혈관병 질환자<br>손가락 창백, 청색증, 충혈 홍반; 혈관수축제 복용력(β-차단제, 암페타민, 충혈완화제, 카페인)</td></tr><tr><td>복합부위통증증후군(CRPS)</td><td>손상 혹은 수술 이력; 유발 사건에 비례하지 않는 심한 작열감·찌르는·쑤시는 통증; 일반 진통제에 무반응; 2차적 통각과민·감각과민<br>종창, 온감, 홍반; 정상과 이환된 팔다리의 체온 차이</td></tr></tbody></table>
...
✽피부의 비대칭·불규칙 색소성 병변이 관찰되면 손목 통증의 일반적 원인과 별개로 피부 병변을 평가합니다.
...
* 원인 : 주로 과사용(gripping or grabbing; 도구 사용, golf club, tennis racket); 임신·수유기 여성에서 호발
* 증상 : 엄지손가락과 손목의 통증, 손목 부종, 주먹 또는 도구를 쥘 때 통증 또는 힘의 약화
* 검사 : 요골 붓돌기 압통과 Eichhoff maneuver 또는 Finkelstein test(서로 다른 검사 동작)
...
* 지속 증상 또는 불안정성 소견 시 MRI 및 수부외과 의뢰 고려
...
```mermaid
graph TD
    Start(["손목 통증"]) --> Trauma["외상력 확인"]
    Trauma --> Acute["급성 외상·골절/탈구 의심"]
    Trauma --> Chronic["비외상성 통증 또는 지속성 통증"]
    Acute --> NV["개방창·변형 및 신경·혈관 상태 확인"]
    NV --> Emerg["응급 징후 시 즉시 의뢰"]
    NV --> XR["골절·탈구 의심 시 X선"]
    XR --> FxCheck["골절·탈구·아탈구 확인"]
    FxCheck --> Refer1["골절·탈구 확인 시 손상에 맞춰 고정·의뢰"]
    FxCheck --> Snuffbox["X선 음성이나 주상골 골절 의심 시 고정 + 조기 MRI/CT 또는 10~14일 후 재평가·X선"]
    Chronic --> Hot["급성 열감·종창·운동 제한 시 패혈성 관절염 즉시 평가"]
    Chronic --> Neuro["신경 증상 동반(저림·감각저하)"]
    Chronic --> Local["국소 압통 부위 확인"]
    Neuro --> CTS["정중신경 분포 시 CTS 의심(Tinel/Phalen/carpal compression)"]
    Neuro --> Ulnar["척골신경 분포 시 Guyon's canal 증후군 의심"]
    Local --> Radial["요측 압통 시 de Quervain's, 1st CMC 관절염(Finkelstein/Grind test)"]
    Local --> UlnarSide["척측 압통 시 TFCC, ECU tendinopathy"]
    Local --> Dorsal["배측 압통 시 ganglion, intersection syndrome, Kienbock's Dz."]
    classDef startNode fill:#eeeeee,stroke:#888888,stroke-width:2px
    classDef mainNode fill:#f96,stroke:#e65100,stroke-width:2px
    class Start startNode
    class Trauma,FxCheck mainNode
```

<p align="center"><strong>손목 통증 평가 알고리듬</strong></p>

<p align="center"><em><mark style="color:$info;">Ref. Forman TA, et al. AFP 2005;72(9):1753-1758; Mirabelli MH, et al. AFP 2013;87(8):568-573; ACR Appropriateness Criteria Acute Hand and Wrist Trauma, Chronic Hand and Wrist Pain (2023 update).</mark></em></p>
...
* 국소(topical) NSAID : 경증 건초염·염좌의 국소 통증에 고려; 경구제보다 전신 노출은 적지만 신기능 저하 등 위험 요인이 있으면 사용 면적·기간과 병용약을 확인
...
> 동반 통증이 있을 때만 acetaminophen 또는 NSAID  단기간 필요시 사용(신경 압박 자체의 치료는 아님)
> ```
>
...
>
> ```
> 손목 부목으로 고정(상황에 따라 엄지 포함)
> 가능한 경우 조기 MRI(또는 CT) 고려
> 즉시 추가 영상이 어려우면 10~14일 후 임상 재평가 및 X선 재촬영
> ```
>
> _✽확진된 주상골 골절 중 일부는 초기 X선에 보이지 않는다. 낙상 후 snuffbox 또는 주상골 결절 압통 등으로 의심되면 음성 X선만으로 배제하지 말고 고정 및 추적 검사 일정을 정한다._
...
>
> * NSAID는 위장 장애를 줄이기 위해 식사와 함께 또는 식후에 복용할 수 있습니다. Acetaminophen은 식사와 관계없이 복용할 수 있습니다. 신기능 저하·소화성궤양 등 위험 요인이 있으면 NSAID 사용 여부를 먼저 확인하십시오.
> * 항응고제 복용 중인 환자는 NSAID 병용 시 출혈 위험이 증가할 수 있습니다.
> * 진통제는 필요한 최소 용량으로 짧게 사용하십시오. 통증이 지속·악화하거나 저림·근력 약화가 발생하면 약을 계속 복용하며 기다리지 말고 재평가받으십시오.

### <mark style="color:orange;">부목/보호대 및 시술 안내</mark>
...
> **스테로이드 국소 주사 관련 안내**
>
> * 주사 부위 감염·피부 탈색/위축, 드문 힘줄 손상 등의 가능성을 사전에 설명하십시오.
> * 손목터널증후군에서 국소 스테로이드 주사는 단기 증상 완화에는 도움이 되나 장기적 이득은 입증되지 않았습니다(AAOS 2024).
> * 결절종 흡인은 재발이 흔하므로(일부 연구에서 1년 내 50% 이상) 경과 관찰·흡인·수술의 선택지를 함께 설명하십시오.
...
* 드퀘르뱅 건초염이나 손목터널증후군에서 스테로이드 주사는 증상 완화에 도움이 될 수 있습니다. 효과의 지속 기간과 주사 부위의 피부 변화 등 위험을 의사와 상의해 결정하십시오.
