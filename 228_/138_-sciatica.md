...
* 중증 외상 후 발생 (골절 의심)
* 감염 의심 소견(예: 경막외농양) 또는 병력, IV 약물 사용력
* 암/면역 저하 병력 (전이성 척추 병변 의심)
* 설명할 수 없는 체중 감소
...
* 마미증후군 의심 시 : saddle/perineal sensation, 하지 신경학적 검사, 새로운 요폐(urinary retention)·배뇨감각 변화를 신속히 평가하고 즉시 MRI 의뢰
  ✽digital rectal examination(DRE)의 anal tone 검사는 민감도가 낮아(0.23\~0.53, 메타분석) 참고 소견으로만 활용하고, 단독으로 마미증후군을 배제하지 않음
* 하지 맥박 검사 : 혈관 질환과 감별
...
* 6주 이상 증상이 지속되고 수술·주사 등 침습적 치료를 고려할 정도인 경우 고려
* X선 : 진단적 가치가 높지 않음; 일률적 검사는 권고하지 않음
* MRI : 신경 이상 진단에 특히 유효; Red flags에 해당되면 조기 시행
* CT : 골격 이상 진단에 특히 유효
...
graph TD
    ...
    B -->|조기 의뢰 Tier: 외상·감염·종양 의심| D[조기 영상검사 + 당일 의뢰]
    B -->|Red Flag 없음| E[보존적 치료 시작<br/>활동 유지, NSAID, 물리치료]
    E --> F{6주 후 평가}
    F -->|호전| G[치료 지속 및 점진적 활동 복귀]
    F -->|호전 없음/악화| H[MRI 등 영상검사]
    H --> I{영상-임상 소견 일치 여부}
    I -->|불일치| M[진단 재평가]
    I -->|일치, 중증/진행성 신경학적 결손 또는 삶의 질 심각히 저해| J[수술적 치료 고려<br/>신경외과·정형외과 의뢰]
    I -->|일치, 급성·중증 통증 지속하며 비수술 치료 희망| K[Epidural steroid 주사 고려<br/>통증클리닉·재활의학과 의뢰]
...
<table><thead><tr><th width="90">단계</th><th width="230">핵심 치료</th><th>대상</th></tr></thead><tbody><tr><td>Step 1</td><td>Red Flag 선별, 활동 유지, NSAID</td><td>모든 환자 (첫 내원)</td></tr><tr><td>Step 2</td><td>운동/물리치료, 증상완화 목적 온·냉찜질</td><td>증상에 따라 초기부터, 또는 단기 자가관리로 충분히 호전되지 않는 경우</td></tr><tr><td>Step 3</td><td>영상검사, epidural steroid 주사 고려</td><td>6주 이상 지속, 침습적 치료 고려 시</td></tr><tr><td>Step 4</td><td>수술적 치료 의뢰</td><td>신경학적 결손 진행 또는 난치성 통증</td></tr></tbody></table>

### <mark style="color:orange;">6주 재평가 체크리스트</mark>

<table><thead><tr><th width="110">판정</th><th width="230">기준</th><th>조치</th></tr></thead><tbody><tr><td>호전</td><td>통증·ODI/NRS 감소, 기능 회복</td><td>현 치료 지속, 점진적 활동 복귀</td></tr><tr><td>정체</td><td>통증·기능 변화 없음, Red flag 없음</td><td>MRI 등 영상검사 고려; 영상-임상 소견이 일치하고 중증 신경근성 통증이 지속되면 epidural steroid 주사 고려</td></tr><tr><td>악화</td><td>신경학적 결손 진행, 통증 심화</td><td>영상검사 후 신경외과/정형외과 의뢰</td></tr></tbody></table>
...
* 물리 치료
* Red flag가 없고 증상이 안정적이면 우선 보존적 치료를 시행하며, 일반적으로 수주간 경과 관찰 후 영상검사·침습적 치료 필요성을 재평가
...
* 방법 : 베개를 베고 무릎을 90°구부리고 발을 엉덩이 폭만큼 벌리고 누움 → 한쪽 무릎을 가슴 쪽으로 당기고 다리 뒤를 양 손으로 잡음 → 천천히 무릎을 펴 다리를 세우고 20\~30초간 유지; 각 다리로 2\~3회 반복
...
* 이 동작 중 통증이 다리에서 허리 쪽으로 옮겨오면(centralization) 좋은 예후 신호로 볼 수 있음

#### <mark style="color:$primary;">Standing hamstring stretch</mark>

* 방법 : 똑바로 서서 한 다리를 안정된 물체에 올림 → 올려 놓은 다리를 쭉 펴고 발끝을 위로 향하게 함(ankle dorsiflexion) → 허리를 편 상태에서 편안하게 할 수 있는 정도로 앞으로 기울이고 20\~30초간 유지; 양쪽 다리로 각각 2\~3회 반복
...
NICE NG59는 근거 부족과 부작용 위험을 이유로 gabapentinoid(pregabalin, gabapentin 등) 사용을 권고하지 않음. 국내 외래에서는 NSAID 반응이 불충분할 때 2차 선택지로 제한적으로 시도되는 경우가 있으나, 좌골신경통에 대한 증상 개선 근거는 약하고 어지럼·졸림 등 부작용 발생률이 높으므로 신중히 투여할 것
{% endhint %}
...
* 급성·중증 좌골신경통에서 고려할 수 있으며, 위약 대비 단기(3개월 이내) 통증·기능 개선 효과가 있으나 평균 효과 크기는 작음(Cochrane 2020: 통증 약 5/100점, 기능장애 약 4/100점 개선 - 임상적으로 중요하지 않을 수 있는 수준); 장기 통증 개선 효과는 불확실함(Cochrane 2020; AAN systematic review 2025)
...
> ```
>
> _✽저용량 TCA는 만성 요통·중추성 민감화에 흔히 병용되나, 좌골신경통 자체에 대한 표준 치료로 확립된 근거는 아님(NICE NG59: no evidence on antidepressants for sciatica) - 임상적 판단 하에 개별화하여 사용하며, 6주 이상 지속되는 경우 처방 지속보다 진단 재평가·영상검사·전문 의뢰 여부를 함께 검토_
...
> * 위장관 출혈 병력, 항응고제 복용 중인 경우 사용 전 반드시 확인
...
> * 통증이 다리 아래쪽에서 허리 쪽으로 옮겨오는 방향(centralization)이 나타나면 호전의 좋은 신호임을 안내

> **언제 다시 병원을 방문해야 하나요?**
>
> * 배뇨/배변 조절이 어렵거나 항문 주위(회음부) 감각이 무뎌지는 경우 - 즉시 응급실 내원
> * 하지 위약이 급속히 진행되는 경우 - 즉시 내원
> * 6주간의 보존적 치료에도 증상 호전이 없는 경우
...
* 안내받은 스트레칭 운동을 통증이 없는 범위 내에서 꾸준히 시행하십시오.
...
* 소변이나 대변을 조절하기 어렵거나, 항문·회음부 주위 감각이 무뎌지는 경우
* 다리에 힘이 빠르게 빠지는 경우
* 원인 모를 체중 감소나 발열이 함께 있는 경우
