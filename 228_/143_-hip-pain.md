...
* 급성 비외상성 심한 고관절 통증, 체중 부하 불가 또는 현저한 수동 ROM 통증/제한 ± 발열·국소 열감/홍반 → 화농성 관절염 의심; 고령, 당뇨병, 면역저하, 최근 관절 시술/인공관절 치환술 병력이 있는 환자는 발열이 없어도 배제하지 않음
  ...
  * 여러 연구에서 CRP가 개별 지표 중 가장 민감하고 독립적인 예측 인자로 보고되며, 다른 기준이 미충족이어도 CRP 단독 상승이 화농성 관절염을 강하게 시사할 수 있음
  * 특히 4세 미만 영유아 및 *Kingella kingae* 감염에서는 전형적 발열·염증 소견이 뚜렷하지 않을 수 있어 Kocher-Caird criteria의 민감도가 제한적임(민감도 약 56.6%로 보고) → 임상적 의심이 있으면 기준 미충족만으로 안심하지 않음
* 급성 하지 위약·감각 소실, 또는 회음부 감각 저하/괄약근 기능 이상 동반 → cauda equina syndrome 의심, 응급 이송

<mark style="color:$warning;">**당일 또는 조기 의뢰**</mark>

* 의도하지 않은 체중 감소, 암 병력, 야간통 → 골 전이 등 악성 종양 의심
* 경미한 외상 후 지속되는 고령자의 통증 (X선 정상이어도 불현성 골절 배제 위해 조기 MRI 고려)
* 비만한 청소년의 급성/아급성 고관절·서혜부·무릎 통증(내회전 시 통증·제한) → SCFE 의심, 체중 부하 금지 후 즉시 정형외과 의뢰
...
* MRI : X선 검사 등으로 진단이 되지 않을 때(특히 대퇴골두 osteonecrosis, labral tear, 불현성 골절); labral tear 의심 시 고해상도 3-T hip protocol MRI로 평가 가능하며, 장비·임상 상황에 따라 MR arthrography 고려 _✽전통적으로 MR arthrography가 labral tear의 diagnostic test of choice로 여겨져 왔으나(AFP 2014), 최근에는 3-T non-arthrographic MRI의 진단 정확도가 개선되어 장비·판독 경험에 따라 우선 고려되기도 함_
...
* 관절 천자(joint aspiration) : 화농성 관절염이 의심되면 필수적으로 시행; 영상 유도하 활액 WBC/differential, Gram stain, 배양 등을 통해 확진 및 원인균 확인
...
* 소아 화농성 관절염 의심 시 : CBC, ESR, CRP (☞ Kocher-Caird criteria); 확진은 관절 천자를 통한 활액 백혈구·배양 검사

### <mark style="color:orange;">신체검사</mark>

<<<<<<< HEAD
_✽[hip anatomy](https://emedicine.medscape.com/article/1898964-overview), [thigh anatomy \[3D\]](https://www.healthline.com/human-body-maps/thigh#1)_
=======
...
>>>>>>> f23daa96cdc1e969d343a9a0fa31e11cf96693bc
...
* 관련 상태 : 전방/서혜부 통증 → 관절 내 병변(SCFE, FAI, osteonecrosis 등); 후방 통증 → piriformis syndrome(sciatic notch 압통 동반 시 지지); mechanical clicking/catching 동반 시 labral pathology 고려
...
* 고령자의 경도 외상 후 지속 통증에서 X선이 정상이어도 임상적 의심이 높으면 MRI를 조기에 고려 (☞ Red Flags)

***

```mermaid
graph TD
    Start([고관절 통증 환자]) --> RF{Red Flag 존재?}
    RF -->|Yes| ER[응급/즉시 정형외과 의뢰]
    RF -->|No| Loc{통증 부위}
    Loc -->|Anterior/groin| Ant[관절 내 병변 의심<br/>OA, FAI, labral tear, osteonecrosis]
    Loc -->|Lateral| Lat[GTPS 의심<br/>gluteal tendinopathy/bursitis, snapping hip]
    Loc -->|Posterior/buttock| Post[Piriformis, SIJ dysfunction,<br/>lumbar radiculopathy 연관통]
    Ant --> Img1[X선 → 진단 불명확 시 MRI]
    Lat --> PE1[병력·이학적 검사로 대개 임상 진단]
    Post --> Img2[요추/SIJ 평가]
...
<p align="center"><em><mark style="color:$info;">Ref. Evaluation of the Patient with Hip Pain. AFP 2014;89(1); Kocher MS et al. JBJS 1999</mark></em></p>
...
* 급성 경증 염좌·타박 및 일부 과사용성 연부조직 질환(경증 건병증·점액낭염 등)은 자기 제한적이며 보존적 치료(휴식, 활동 조절, 진통제, 물리 치료)로 호전; OA, FAI, labral tear, gluteal tendon tear, osteonecrosis 등은 자연 호전을 기대하기 어려워 별도 접근 필요
* 관절 내 병변(OA, labral tear, FAI 등)이 의심되거나 보존적 치료에 반응이 없으면 정형외과/스포츠의학과 의뢰 고려
* GTPS(외측 고관절 통증)는 hip abductor/gluteal strengthening 등 표적 운동치료 + 활동(부하) 조절이 1차 치료이며, 국소 스테로이드 주사보다 장기 예후가 우수한 것으로 보고됨(Mellor et al. BMJ 2018; 체계적 문헌고찰, Physiotherapy 2024); 주사는 급성기 통증 조절 목적의 보조 수단으로 고려
...
* 건/점액낭 주사에서 동일 부위 반복 주사는 건 약화 위험으로 지양; 동일 관절 반복 주사는 최소 3개월 간격을 원칙으로 하며, 연간 3\~4회를 초과하지 않도록 함
...
* 관절강내 또는 peritrochanteric/bursal corticosteroid injection : 진단적 겸 치료적 목적; 고관절은 심부 관절로 맹검(blind) 주사 시 정확도가 낮아 초음파(US) 또는 투시(fluoroscopy) 유도하 시행을 표준으로 권장; tendon substance 내 직접 주입은 피하며, 반응 불량·재발 시 정형외과/재활의학과 의뢰; 관절강내 주사는 RPOA 등 관절 손상 위험을 고려하여 반복 시행에 신중
...
M70.6 대전자 점액낭염 [Greater trochanteric pain syndrome/bursitis]

M76.0 둔부건염 [고관절 건병증]

M16 고관절증 [Osteoarthritis of hip]
...
> **국소 스테로이드 주사 관련 안내**
>
> * 동일 부위 반복 주사는 건 약화·파열 위험을 높일 수 있어 최소 3개월 간격, 연간 3\~4회 이내로 시행
...
> * 완전한 안정보다는 통증 범위 내에서의 활동 유지가 회복에 도움이 됨을 강조
...
* 관절 자체의 마모(퇴행성 관절염)나 관절 주위 힘줄·점액낭의 염증(건병증, 점액낭염), 근육 긴장 등이 흔한 원인입니다
...
* **완전히 쉬기보다는 통증이 심하지 않은 범위에서 걷기·수영·자전거 같은 운동을 꾸준히 하십시오.** 근력이 오히려 통증을 줄이는 데 도움이 됩니다. 밴드를 이용한 낮은 강도의 엉덩이 근력 운동(예: 옆으로 다리 들어올리기)도 도움이 될 수 있습니다.
...
* 걷지 못할 정도로 심한 통증이 갑자기 생긴 경우
* 열이 나면서 고관절이 붓고 뜨거운 경우
* 다리에 힘이 빠지거나 감각이 이상한 경우
* 넘어지거나 다친 후 통증이 지속되는 경우
