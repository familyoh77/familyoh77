...
* 감별의 핵심 단서 - **능동 vs 수동 관절운동범위**
  * 윤활낭염 : 능동 운동은 통증으로 제한되나, **관절 자체의 수동 운동범위는 상대적으로 보존되는 경우가 많음**(단, 심한 통증·주변 봉와직염 동반 시 다소 제한될 수 있음; 수동 운동범위가 보존되어도 관절 감염을 단독으로 배제할 수 없음)
...
* Fluctuant하고 발적·국소 열감·압통이 뚜렷한 급성 표재성 윤활낭염 → septic bursitis 의심, 당일 평가 및 항생제 치료; 가능하면 항생제 투여 전 안전한 경로로 낭액을 흡인하여 Gram stain·배양(흡인이 지연되거나 안전하지 않으면 치료를 지연하지 않고 경험적 항생제 개시)
...
* 국소 needle aspiration : crystal, Gram stain, 배양, WBC 검사; **감염 또는 crystal 질환 의심 시 고려**. 비감염성·비염증성 만성 표재성 종창에서 일률적인 흡인은 의인성 감염 위험 때문에 피함
  * 흡인은 초음파 유도하에 시행하면 정확도와 안전성이 높아짐
  * ✽비감염성 윤활낭염이 의심되더라도 덮고 있는 피부에 봉와직염(cellulitis)이 있는 경우 그 부위를 관통하는 천자는 가급적 피하고, 가능하면 감염되지 않은 피부를 통한 경로를 선택; 안전한 흡인 경로가 없더라도 감염 치료를 지연하지 않음
  * ✽낭액 WBC의 감염 진단 cutoff는 관절액(synovial fluid)만큼 표준화되어 있지 않고 증례 간 편차(범위 약 1,000\~165,000/µL)가 큼; 대체로 WBC > 3,000/µL 및 호중구 우세(>50%)가 감염을 지지하는 소견이나, **단일 수치만으로 감염 여부를 확정해서는 안 되며 반드시 임상 소견·Gram stain·배양 결과와 함께 종합 판단**. 결정이 확인되어도 동반 감염은 자동 배제되지 않으므로 감염이 의심되면 배양 결과도 확인
...
* 증상 : 팔꿈치의 현저한 국소 부종(골프공 모양); 관절 운동범위는 대개 보존되나 종창이 크거나 통증이 심하면 굴곡 시 불편할 수 있음
...
* 증상 : 슬개골 앞 또는 아래의 국소 부종·통증; 무릎 꿇기나 직접 압박 시 악화
* 원인 : 반복/지속적 무릎 압박·손상; housemaid's knee, nun's knee
* 감별 : 관절 내 삼출·관절염은 부종의 위치, 수동 운동 시 통증·제한, 관절 삼출 소견으로 감별; 편한 무릎 자세만으로 구분하지 않음
...
<table><thead><tr><th width="150">질환</th><th width="220">윤활낭염과의 차이점</th><th>핵심 감별 포인트</th></tr></thead><tbody><tr><td>화농성 관절염</td><td>관절강 자체의 감염</td><td>수동 운동범위까지 심하게 제한, 전 관절 부종, 관절액 흡인 필요</td></tr><tr><td>봉와직염(cellulitis)</td><td>피부·피하조직의 미만성 감염</td><td>경계가 불명확한 넓은 발적, 국한된 낭 부종 없음, 파동(fluctuance) 없음</td></tr><tr><td>통풍/CPPD 급성 발작</td><td>관절 또는 인접 조직의 결정 유발 염증</td><td>급성 통증과 종창; 관절액/낭액의 결정 검사로 확인하되 결정 양성만으로 감염 배제 불가</td></tr><tr><td>건염(tendinitis)</td><td>건 자체의 염증</td><td>특정 저항 운동 시 국소 압통, 낭 부종 없이 선상 압통</td></tr></tbody></table>
...
graph TD
    ...
    E --> F{조기 재평가·배양 결과}
    F -->|감염 치료 중 호전| H[계획한 치료 지속·재평가]
    F -->|악화·반응 불량| G[항생제 조정 + 필요시 반복 흡인/배농]
    F -->|감염 가능성 낮음| L[진단 및 치료 재검토]
    B -->|No| I{외상/직접 타박 또는 반복 압박·과사용 병력?}
    I -->|Yes| J[비감염성/만성 윤활낭염\n유발요인 회피 + 보호대 + 물리치료/NSAID]
    I -->|No, crystal 의심| K[통풍/CPPD 등 감별\n필요시 낭액 결정·배양 검사]
...
<p align="center"><em><mark style="color:$info;">저자 재구성(참고 문헌: Truong J, Ashurst JV. Septic Bursitis. StatPearls; Baumbach SF et al. Prepatellar and Olecranon Bursitis. Dtsch Arztebl Int. 2014)</mark></em></p>
...
* 필요시 bursa aspiration(특히 감염 의심 시); 스테로이드 주사는 감염 배제 후 선택적으로 고려(비감염성 표재성 윤활낭염에는 통상 권장하지 않음)
...
* ibuprofen 400 ㎎ tid(필요시 증량; 성인 최대 3,200 ㎎/일, 최소 유효 용량을 단기간 사용) <mark style="color:blue;">\[부루펜]</mark>
* naproxen 500 ㎎ bid <mark style="color:blue;">\[낙센]</mark>
* ✽NSAID 금기/신중 투여(신기능 저하, 소화성 궤양 병력, 항응고제 병용, 심혈관 질환) 시 acetaminophen으로 대체 고려

### <mark style="color:orange;">윤활낭 및 주위 조직 주사</mark>
...
* steroid : 감염 배제 후 고려; triamcinolone 40 ㎎/㎖ 0.5\~1.0 ㎖ <mark style="color:blue;">\[트리암시놀론 주]</mark>
  ...
  * 건에 인접한 부위(특히 retrocalcaneal bursa)는 건 손상·파열 위험을 고려해 신중히 시행; 건 내 주입 회피
...
* 외래 uncomplicated 사례에서 실용적으로 10\~14일이 흔히 쓰이나, 근거가 강한 고정 기간은 아니며 **임상 반응·배양 결과·면역상태·배농 여부를 반드시 함께 고려하여 개별화**; 외래 치료 시 24\~48시간 내 재평가를 계획하고 악화하면 즉시 재평가
...
M71.1 기타 감염성 윤활낭염(septic bursitis 등)

M71.5 달리 분류되지 않은 기타 윤활낭염
...
>
> ```
> 팔렉신 500 ㎎/Cap (cephalexin)  1Cap  qid  #10~14일
> ```
>
> _✽S. aureus 및 Streptococcus spp.를 표적; 가능하면 치료 전 낭액 배양 후 결과에 따라 조정. 24\~48시간 내 재평가하고 그 전에 악화하거나 전신 증상이 생기면 즉시 평가/의뢰_
...
> ```
>
> _✽감염 배제 후 시행; 임상/초음파 소견에 따라 대전자 주위 윤활낭 또는 적절한 건 주위 공간에 주사하되 건 내 주입은 피함. 표재성 부위(팔꿈치·슬개골 앞)에는 권장하지 않음. 반복 주사는 피하며 둔근 강화 운동 병행_
...
> * 항응고제 복용 중에는 의료진과 출혈 위험을 확인하고 NSAID 사용을 결정; 경피 NSAID와 경구 NSAID를 정규 병용하지 말고 한 가지 제형을 우선 사용

> **윤활낭 및 주위 조직 스테로이드 주사**
>
> * 감염이 배제된 경우에만 시행
> * 표재성 윤활낭(팔꿈치, 슬개골 앞)에서는 효과가 제한적이고 피부 위축·감염 위험이 있어 일반적으로 권하지 않음
> * 건 주변부(특히 아킬레스건 주변)에서는 건 손상·파열 위험을 고려하고 건 내 직접 주입을 피함

> **항생제 복용**
>
> * Septic bursitis로 항생제 처방 시 증상이 호전되어도 임의로 중단하거나 기간을 단축하지 말고, 정해진 재진 때 경과와 배양 결과에 따라 치료 기간을 확인
> * 24\~48시간 내 예정된 재평가를 받고, 그 전이라도 발적·부종·통증이 악화되거나 발열이 생기면 즉시 재내원
...
* 감염이 의심되어 항생제를 처방받은 경우, **증상이 좋아져도 임의로 중단하지 말고** 재진 때 안내받은 기간대로 복용하십시오.
* 감염 치료 중에는 **24\~48시간 내 예정된 재진을 받으십시오.** 그 전에 증상이 악화되면 바로 병원에 연락하거나 방문하십시오.
...
보호와 치료를 2\~4주간 시행해도 호전되지 않으면 예약 진료에서 원인과 치료 계획을 다시 확인하십시오.
