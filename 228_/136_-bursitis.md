...
```mermaid
graph TD
    A([관절 주변 국소 부종·통증]) --> B{감염 의심 소견?\n열감·홍반·뚜렷한 압통\n피부손상/관통상, 발열·오한, 면역저하}
    B -->|Yes| C{인접 관절 수동 운동범위 제한?}
    C -->|Yes 의심| D[화농성 관절염 의심\n즉각 응급 의뢰]
    C -->|No, 낭에 국한| E[Septic bursitis 의심\n가능하면 aspiration 후 경험적 항생제\n여의치 않으면 항생제 우선 개시]
    E --> F{임상 경과·배양 결과}
    F -->|호전/비감염 확인| H[치료 조정 또는 종료]
    F -->|불량/감염 확정| G[항생제 조정 + 필요시 반복 흡인/배농]
    B -->|No| I{외상/직접 타박 또는 반복 압박·과사용 병력?}
    I -->|Yes| J[비감염성/만성 윤활낭염\n유발요인 회피 + 보호대 + 물리치료/NSAID]
    I -->|No, crystal 의심| K[통풍/CPPD 감별\n흡인 crystal 분석]
