...
```mermaid
graph TD
    A["<b>전형적 CTS 증상</b><br/>정중신경 분포의 야간 저림·통증,<br/>flick sign, 감각 이상"] --> B["<b>병력 + 이학적 검사</b><br/>CTS-6 중심 평가"]

    B --> C1["<b>Sensory dysfunction</b><br/>제1~3수지 및 제4수지 radial portion의<br/>야간 저림·감각저하"]
    B --> C2["<b>Motor dysfunction</b><br/>thenar weakness/atrophy,<br/>thumb abduction·opposition 장애"]

    C1 --> D["임상 양상이 전형적이고<br/>CTS-6로 진단 가능한가?"]
    C2 --> D

    D -->|Yes| E["CTS 임상진단"]
    D -->|No / 감별 필요 / 중증도 평가가<br/>치료 결정에 영향| F["NCS/EMG ± 초음파<br/>다른 neuropathy 감별"]
    F --> E

    E --> G["진행성 신경손상?<br/>지속 감각저하, thenar weakness/atrophy,<br/>중증 electrodiagnostic abnormality"]
    G -->|Yes| H["수부외과 조기 의뢰<br/>수술적 감압술 고려"]
    G -->|No| I["야간 neutral wrist splint<br/>생활습관·작업방식 조정"]

    I --> J["4~8주 후 호전?"]
    J -->|Yes| K["보존 치료 지속·추적"]
    J -->|No / 재발| L["진단·중증도 재평가<br/>국소 steroid 주사 고려<br/>반응 없으면 지연 없이<br/>수부외과 의뢰/감압술"]

    E --> M["이차성 원인 의심?"]
    M -->|전신질환 의심| N["선택적 검사<br/>glucose/HbA1c, TSH, pregnancy test,<br/>RA 관련 검사 등"]
    M -->|종괴·외상 후 변형·골성 병변 의심| O["원인별 영상검사<br/>routine MRI는 권장하지 않음"]
    N --> P["기저 질환 치료"]
    O --> P

    classDef purple fill:#EAE4F2,stroke:#B3A2C7,color:#000
    classDef yellow fill:#FFF3CC,stroke:#D6C175,color:#000
    classDef green fill:#E2EFDA,stroke:#A9D08E,color:#000
    classDef pink fill:#FCE4D6,stroke:#F4B084,color:#000
    classDef blue fill:#DDEBF7,stroke:#9BC2E6,color:#000

    class A purple
    class B,C1,C2,D,F,G,J,M yellow
    class E,N,O green
    class H,L pink
    class I,K,P blue
```
...
<div align="left"><figure><img src="../.gitbook/assets/수근관1.png" alt=""><figcaption></figcaption></figure></div>
...
<div align="left"><figure><img src="../.gitbook/assets/수근관2.png" alt=""><figcaption></figcaption></figure></div>
