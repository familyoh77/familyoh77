...
* 연골, 윤활막, 인대, 연골 밑 뼈 등 관절을 구성하는 여러 구조물들에 병리학적 변화가 발생하여 관절의 통증 및 강직, 기능 제한이 발생한 만성 질환
...
| **항목**       | **RA (p.815)**       | **통풍 (p.825)**          | **결체조직질환 (p.834)**                  | **섬유근육통 (p.834)**            | **다발성 근육통**   |
| ------------ | -------------------- | ----------------------- | ----------------------------------- | ---------------------------- | ------------- |
| **진행 속도**    | 급성/아급성               | 급성                      | 아급성                                 | 만성                           | 수주 이내         |
| **성별/연령**    | 남:여 = 1:3, 모든 연령     | 남:여 = 3:1 (폐경 전 여성은 드묾) | 남:여 = 1:10, 20\~40세                 | 남:여 = 1:7, 30\~50세           | 남:여 = 1:2     |
| **관절 침범 양상** | 대칭적 양측 손발            | 단일 관절염, 주로 발허리발가락·발목·무릎 | 중증 대칭적                              | 널리 퍼진 형태                     | 어깨·다리 이음뼈     |
| **기타**       | 레이노병, 건조한 눈/입, 전신 이상 | 위험 인자: 비만, 음주, 이뇨제 치료   | 레이노병, 나비모양/혈관염 양상 발진, 전신 증상, 홍막성 홍통 | 수면 질 저하, 연조직 통증, 유발점, 다양한 증상 | 축두동맥염과 유사한 양상 |
...
![image](../.gitbook/assets/2fa7a881-ab3f-4126-bdd5-9a5d042106f9.JPG)

![골관절염의 ‘권고하지 않음’ 요법
Ref. ACR/AF. Guideline for the management of OA of the Hand, Hip, & Knee. 2019](../.gitbook/assets/ae1902c5-7413-4e1f-829e-bbe71e660f5f.JPG)
...
* glucosamine \[오스테민], chondroitin \[콘로인] : 무릎이나 엉덩이 OA에 대한 일부 연구에서 병용으로 효과가 있으나 다수의 연구에서 단독/병용 모두 위약과 차이 없음; 사용하는 경우에는 6개월 투여 후에도 명백한 효과가 없으면 중단할 것을 권고 (보험주의)
...
* 관절강으로부터의 steroid 유출을 줄이기 위하여 체중 부하 제한; 주사 후 3일간 용변/식사 외의 체중 부하를 피함. 2\~3주간 지팡이 등 보조 기구 사용
