...
* 경과 : 자연적으로 완전히 소실되는 단순한 self-limiting disorder로 보기는 어려움; 재발 또는 지속 증상이 흔하며 문헌에서는 70\~90%의 recurrent symptoms가 보고됨. 진단 후 5\~8년 추적 연구에서는 약 57%가 unfavorable recovery(지속 통증·기능 저하)를 보였음(Lankhorst 등); 2025 JOSPT prognosis systematic review에서도 장기 증상 지속과 예후 인자에 대한 근거가 정리됨
* 동반 심리적 부담 : 만성 PFP 환자에서 불안·우울 동반율이 일반 인구보다 높다는 보고 있음(약 절반에서 불안 증상, 약 1/5에서 우울 증상); 통증-기능 저하가 지속될 경우 심리사회적 요인 평가도 고려
...
* 근력 저하 및 유연성 감소 : quadriceps, hamstring, gastrocnemius 등
* 하지 정렬·구조 이상 : medial patellar facet 형성 부전, patella alta, 하지 malalignment, 슬개골 과운동성

#### <mark style="color:$primary;">위험 인자</mark>

* 여성, 청소년·젊은 성인 운동선수, 과활동
* tight lateral structure : lateral retinaculum, iliotibial band
* patellar hypermobility, 외상·수술 병력
...
* 슬개골 아탈구/탈구의 병력 또는 뚜렷한 불안정감 → 슬개대퇴 불안정성 의심(☞ apprehension test 양성)
* 안정 시에도 지속되는 통증, 야간통, 체중 감소 동반 → 골종양 등 감별 필요
* 외상 후 갑작스러운 tibial tubercle의 심한 통증·종창 및 신전 장애 → tibial tubercle avulsion fracture 등 급성 신전기전 손상 감별
...
<div align="left"><figure><img src="../.gitbook/assets/무릎3.png" alt="J sign 검사 방법을 보여주는 그림"><figcaption></figcaption></figure></div>
...
<div align="left"><figure><img src="../.gitbook/assets/무릎4.png" alt="Patellar mobility testing 검사 방법을 보여주는 그림"><figcaption></figcaption></figure></div>
...
<div align="left"><figure><img src="../.gitbook/assets/무릎5.png" alt="Patellar tilt test 검사 방법을 보여주는 그림"><figcaption></figcaption></figure></div>
...
```mermaid
graph TD
    Start(["앞무릎 통증 호소"]) --> A["병력 청취 및 신체검사"]
    A --> RF["Red Flag 확인<br>(급성 종창·신전 불능·감염징후·신경혈관 손상 등)"]
    RF --> C["즉각 조치/응급 평가"]
    RF --> D["Squat 시 슬개골 주위 통증 재현?<br>(JOSPT 2019 CPG 핵심 진단 기준)"]
    D --> E["감별진단 배제<br>(locking·삼출액·불안정성·국소 골압통 등)"]
    E --> F["슬개대퇴 통증(PFP) 진단"]
    F --> G["1단계: 활동 조절 + 환자 교육"]
    G --> H["2단계: 교육 + knee-targeted exercise 중심<br>± hip-targeted exercise 등 개별화"]
    H --> I["반응 평가"]
    I --> J["호전: 점진적 복귀 + 재발 예방"]
    I --> K["미호전: 영상검사 고려 + 정형외과 의뢰"]

    class RF,D,I question
    class C,K refer
    class F,G,H,J action
    class Start start

    classDef start fill:#eeeeee,stroke:#888888,stroke-width:2px
    classDef question fill:#fff9c4,stroke:#ffe082,stroke-width:2px
    classDef refer fill:#f96,stroke:#e65100,stroke-width:2px
...
<table><thead><tr><th width="90">단계</th><th width="260">핵심 치료</th><th>비고</th></tr></thead><tbody><tr><td>1단계</td><td>환자 교육 + 활동 조절(통증 유발 부하의 일시적 감량, 완전 중단이 아님)</td><td>모든 환자</td></tr><tr><td>2단계</td><td>교육 + knee-targeted exercise 중심의 운동 치료(대개 8\~12주 이상); 개별 평가에 따라 hip-targeted exercise 병합</td><td>1차 핵심 치료; 2024 Best Practice Guide는 환자 presentation에 따른 개별화를 강조. VMO 단독 분리 강화보다는 대퇴사두근 전체 및 고관절 복합체 강화에 집중</td></tr><tr><td>3단계</td><td>보조적 병용 : 기성 foot orthosis, 슬개골 테이핑/bracing, 도수치료, movement/running retraining, 통증으로 고부하 저항성 knee exercise 수행이 제한되는 경우 low-load high-repetition exercise + blood flow restriction(BFR) 병용 등</td><td>환자별 소견과 즉각적 반응을 바탕으로 선택; 운동·교육과 병행; BFR은 JOSPT 2019 CPG에서 이상반응을 모니터링하며 선택적으로 사용 가능(Grade F)하나 표준 운동 치료의 대체가 아닌 보조 방법</td></tr><tr><td>4단계</td><td>반응 없거나 구조적 이상(불안정성 등) 확인 시 정형외과 의뢰</td><td>수술은 드물며 불응성·구조적 원인이 명확한 경우로 제한</td></tr></tbody></table>

* 복수의 병인(근력·유연성·정렬 이상 등)이 동반되는 경우가 많아 복합적 접근이 원칙
...
* 초음파치료, 전기자극 등 electrophysical agents 단독 사용 및 슬개대퇴/무릎/요추 관절의 단독 도수 관절가동술은 권장되지 않음(JOSPT 2019 CPG Grade B; 2018 Consensus Statement, 5th International Patellofemoral Pain Research Retreat)
...
* 슬개골 테이핑/bracing, 연부조직 도수치료, 보행 재훈련(gait retraining)의 단독 효과는 근거가 불확실함(2018 Consensus Statement) - 운동 치료의 보조 수단으로만 고려
...
* Ice : 통증이 있을 때 1일 수회, 1회 약 15\~20분; 피부에 직접 얼음이 닿지 않도록 하며 냉손상에 주의 - 증상 완화 목적의 보조 수단
* Foot orthosis(기성품) : 단기 통증 감소를 위해 선택적으로 고려; 특히 즉각적인 증상 개선을 보이거나 발/하지 정렬 특성이 기여하는 환자에서 운동 치료와 병행
* 슬개골 테이핑/bracing : 운동 치료 초기 통증 감소를 위한 단기 보조 수단으로 시도해볼 수 있으나 단독 장기 효과 근거는 불확실(☞ 통증을 낮춰 운동을 가능하게 하는 일시적 수단으로 이해)
...
<figure><img src="../.gitbook/assets/무릎6.png" alt="무릎 컨디셔닝 프로그램(스트레칭·근력 강화 운동) 예시 그림"><figcaption></figcaption></figure>
...
* 국소 외용 NSAID : diclofenac gel <mark style="color:blue;">\[볼타렌 겔]</mark>, ketoprofen 첩부제 <mark style="color:blue;">\[케토톱]</mark> - 경구 NSAID 사용이 부담스러운 경우 고려할 수 있으나, PFP 자체에 대한 직접적인 효과 근거는 제한적임
...
* 수술적 치료(외측 지대 유리술, 정렬 교정술 등) : 표준 보존적 치료(운동 치료 포함 8\~12주 이상)에 반응하지 않고 명확한 구조적 이상(재발성 불안정성 등)이 확인된 불응성 사례에 한해 정형외과에서 제한적으로 고려; 근거 수준은 상대적으로 낮고 결과가 보존적 치료 대비 우월하다는 확립된 근거는 부족함
...
M22.4 연골연화증, 슬개골 (Chondromalacia patellae) - 연골연화 소견이 확인된 경우
...
>
> ```
> 타이레놀 이알 650 ㎎/T  1T  bid  필요시
> ```
>
> _✽경증에서는 통증 시 필요에 따라 acetaminophen 사용; 운동 치료(고관절·무릎 강화)를 1차 치료로 함께 안내_
...
>
> ```
> 볼타렌 겔  환부에 bid~tid 도포
> ```
>
> _✽경구 NSAID의 전신 부작용 위험이 높은 환자(운동선수 등)에서 국소 외용제가 대안이 될 수 있음; 청소년의 경우 제품별 국내 허가연령·주의사항을 확인하여 선택적으로 고려; 전신 부작용은 경구제보다 적으나 효과는 개인차가 있음_
...
> * NSAID는 위장관 부담이 있으므로 식후 복용 권장; 장기·고용량 사용 시 위장관 출혈·신기능 저하 위험이 있어 단기간(1\~2주 이내) 사용 원칙
> * 청소년·성장기 운동선수는 연령·체중에 맞는 용량을 사용하고, 탈수·신질환이 동반된 경우 특히 주의하며 최소 유효 용량·최단 기간 사용
> * 신질환·소화성 궤양 병력이 있는 환자는 acetaminophen 또는 국소 외용 NSAID 우선 고려
...
> * 무릎에 **물이 차거나(삼출액)**, 무릎이 **갑자기 걸리거나(locking)** 힘이 빠지며 주저앉는(giving-way) 증상이 새로 생긴 경우
> * 외상 후 무릎을 펴지 못하거나 심하게 붓는 경우 - 즉시 내원
...
무릎뼈(슬개골) 주위나 뒤쪽이 은근하게 아프고, 계단을 오르내리거나 오래 앉았다 일어설 때 더 아프다면 슬개대퇴 통증일 가능성이 높습니다. 무릎을 많이 써서 생기는 통증으로, 뼈나 인대가 심하게 손상된 것은 아니며 갑작스러운 운동량 증가, 무릎에 반복적으로 가해지는 부하, 근력·움직임 조절 등 여러 요인이 함께 영향을 줄 수 있습니다.
{% endhint %}
...
* 통증이 있는 부위에는 하루 몇 차례, 15\~20분씩 얼음찜질을 하면 도움이 됩니다(피부에 직접 닿지 않게 수건 등으로 감싸서 사용).
* 체중이 많이 나가는 경우 체중 감량이 무릎 부담을 줄이는 데 도움이 됩니다.
* 테이핑이나 기성 깔창은 일부 환자에서 초기 통증을 줄여 운동을 돕는 보조 수단으로 사용할 수 있지만 운동 치료를 대신할 수 없습니다. 초음파·전기자극 같은 물리치료 기계치료는 PFP의 핵심 치료로 권장되지 않습니다.
...
* 무릎에 물이 차서 붓거나, 갑자기 걸리는 느낌(locking)이 생긴 경우
* 무릎에 힘이 빠지며 갑자기 주저앉는 증상(giving-way)이 반복되는 경우
* 다치고 나서 무릎을 펴지 못하거나 심하게 붓는 경우
* 8\~12주간 활동 조절과 운동을 꾸준히 했는데도 전혀 호전이 없는 경우
