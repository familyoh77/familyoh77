...
* 흉통·발한·오심·호흡곤란을 동반한 어깨 통증(특히 좌측 또는 방사통) → 급성 관상동맥증후군(ACS) 의심 (연관통)
* 외상 후 심한 변형과 함께 원위부 맥박 소실, 감각 저하, 운동 마비 → 혈관·신경 손상 동반 골절/탈구 의심
* 급성 발열과 함께 어깨 주위의 뚜렷한 발적·부종·열감, 움직임을 전혀 견디지 못할 정도의 극심한 통증 → 화농성 관절염(septic arthritis)/골수염 의심
  * 감별 주의 : 급성 석회성 건염(calcific tendinitis)의 급성 발작기(resorptive phase)도 유사하게 국소 발적·열감과 극심한 통증, 때로 염증표지자 상승을 보일 수 있어 감염과 매우 유사할 수 있음. X선/초음파상 석회 침착 소견은 진단에 도움이 되나, 석회 소견이 있다는 이유만으로 감염을 배제해서는 안 되며, 발열·전신 증상 등 감염이 임상적으로 의심되면 관절천자(synovial fluid 분석·Gram stain·배양)를 반드시 시행하여 배제 (☞ 석회성 건염 참조)

<mark style="color:$warning;">**당일 또는 조기 의뢰**</mark>

* 외상 병력(특히 고령자 낙상, 청소년 apophysis 손상) → 골절·탈구 배제 위한 영상 검사 필요
* 발열을 동반한 어깨 통증 (국소 발적·부종이 뚜렷하지 않아도) → 감염성 관절염·골수염 감별
...
* 4\~6주간의 보존적 치료(활동 조절, 물리 치료, NSAID)에도 반응 없는 통증 → 영상 검사 및 전문과 의뢰 고려
...
* 치료 : 급성기에는 NSAID·냉찜질·arm sling으로 통증 조절이 우선(대부분 자연 재흡수); 아급성·만성 통증에는 초음파 유도 needle lavage/barbotage 또는 국소 steroid 주사 고려; 보존적 치료에 반응 없는 만성례에서 체외충격파치료(ESWT) 또는 수술적 제거 고려
...
* 치료 : 활동 조절, NSAID, 물리 치료가 1차; 동반된 RTC 병변 여부에 따라 치료 방침이 달라지므로 초음파/MRI로 동반 병변 확인 권장
...
* 위험 인자 : 외상, ≥40세, 앉아서 일하는 직업 또는 생활 습관, 장기간의 팔/어깨 활동 제한(예: 수술 후 팔 고정, 침대 생활, 잘 사용하지 않는 팔), 여성
  * 관련 질환 : 당뇨병(가장 흔함; 기전 불명), 갑상선 질환(갑상선기능저하증/항진증 등), Dupuytren contracture, 경추간판 질환, atherosclerosis, neurologic Dz.(예: stroke, 파킨슨병), 자가 면역 질환
...
```mermaid
graph TD
    A([어깨 통증]) --> B{Red Flag 평가}
    B -->|Tier 1: 즉각 조치 소견| C[즉각 조치/응급실]
    B -->|Tier 2: 당일·조기 의뢰 소견| C2[당일 또는 조기 평가·의뢰]
    B -->|Tier 3: 추적 필요 소견만| C3[계획된 영상검사/전문과 의뢰]
    B -->|없음| D{외상 병력?}
    D -->|"예, &lt;40세"| E[GH 탈구·불안정 의심]
    D -->|"예, &gt;40세"| F[AC 손상, RTC tear 의심]
    D -->|아니오| G{운동 범위 ROM 평가}
    G -->|능동·수동 모두 현저히 제한| H[Adhesive capsulitis 의심]
    G -->|능동 제한, 수동 보존| I[RTC 이상 의심]
    G -->|경도 제한, 서서히 진행| J[GH OA 의심]
    G -->|ROM 정상, 국소 압통 위주| K{통증 유발 동작}
    K -->|Cross-body 동작 시 악화| L[AC joint 이상 의심]
    K -->|고개 돌릴 때 통증·방사통| M[경추 신경근병증 의심]
    E --> N[영상 검사 + 정형외과 의뢰]
    F --> N
    H --> O[임상 진단, 보존적 치료]
    I --> P[초음파/MRI 고려]
...
* ✽동결견에서 관절강 내 corticosteroid 주사와 물리 치료 병합은 통증 및 기능 개선에 도움이 될 수 있음 (대한재활의학회 동결견 진료지침, 2025). 일부 RCT에서는 경과 관찰(watchful waiting)과 구조화된 물리 치료의 1년 기능 결과가 유사하게 보고되어(Siddiq BS, Martin SD, et al. AAOS 2024 Annual Meeting), 치료 강도는 통증 단계·기능 제한·환자 선호에 따라 개별화
...
> ```
>
> _✽급성 어깨 통증의 1차 선택. 위장관 부작용 위험(고령, 소화성 궤양 병력, 항응고제 병용)이 있으면 acetaminophen으로 대체_

> **처방례 2. NSAID 금기 또는 사용이 부적절한 경우**
>
> ```
> 타이레놀정 650 ㎎/T  2T  tid  pc
> ```
>
> _✽NSAID 금기(위장관 출혈, 신기능 저하, 항응고제 복용 등) 시 acetaminophen으로 대체. 해당 650 ㎎ 제형은 1일 6정(3,900 ㎎)을 초과하지 않도록 하며, acetaminophen 함유 복합제를 병용하는 경우 총 용량을 반드시 확인. 고령·간질환·잦은 음주 등에서는 더 낮은 최대 용량을 고려_

> **처방례 3. 심한 급성 통증, 다른 진통제로 조절되지 않을 때 예외적 단기 사용**
>
> ```
> 트리돌캡슐 50 ㎎/Cap  1Cap  prn (4~6시간 간격)
> ```
>
> _✽NSAID/acetaminophen 등으로 조절되지 않는 심한 급성 통증에서 예외적으로 매우 단기간 사용. 졸림·오심·변비, 의존·오남용 위험에 주의하고 SSRI/SNRI/TCA 등 세로토닌성 약물 병용 시 세로토닌 증후군 위험 설명_

> **처방례 4. 유착 관절낭염 급성 동통기, 약물 치료에 반응 부족**
>
> ```
...
> * 반복 주사는 가급적 제한하며, 특히 rotator cuff tear가 있거나 수술을 고려하는 환자에서는 반복 주사가 파열 진행·봉합술 결과에 부정적 영향을 줄 수 있어 신중히 판단
...
* **의사나 물리치료사가 알려준 스트레칭·강화 운동을 매일 꾸준히 하십시오.** 특히 어깨가 뻣뻣하게 굳은 경우, 코드만 진자 운동이나 벽 오르기 운동이 도움이 됩니다.
...
* 관절 내 주사를 맞은 경우, 1\~2일간 일시적으로 통증이 심해질 수 있으나 이후 호전되는 것이 일반적입니다.
