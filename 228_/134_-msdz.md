...
* **요통/하지통 + 새로 발생한 요폐·배뇨/배변장애 또는 회음부(saddle) 감각저하, 진행성 하지 근력저하** → 마미증후군(cauda equina syndrome) 의심, 즉시 응급 평가
* 암 병력자의 새 척추 통증에 보행장애, 하지 근력저하·감각저하 또는 배뇨·배변장애가 동반 → 전이성 척수압박 의심, 즉시 응급 평가 및 긴급 MRI
* 진통제로 조절되지 않는 심한 통증과 진행성 감각저하·근력저하 등 신경학적 이상 → 급성 신경 압박/손상 등 의심, 응급 평가

<mark style="color:$warning;">**당일~수일 내 평가**</mark>

* 새로 발생한 지속적·진행성 **비기계적 통증**, 특히 악성 종양 병력, 설명되지 않는 체중 감소 또는 국소 골성 통증·야간통이 동반되면 골전이·병적 골절 등 종양성 병변 평가; 척추 통증과 신경학적 증상이 동반되면 즉시 평가(위 참조)
* 발열·야간 발한·전신 쇠약 등을 동반한 근골격통 → 감염성·악성·전신 염증성 질환 평가; 급성 중증 감염이 의심되면 당일 평가
* **객관적 근력저하**가 확인되는 경우 → 염증성 근병증(idiopathic inflammatory myopathy) 또는 신경근육질환 평가
* 50세 이상에서 양측 어깨/고관절대 통증과 현저한 조조강직 → polymyalgia rheumatica(PMR) 고려. PMR에서는 통증으로 움직임이 제한될 수 있으나 객관적 근력저하는 전형적이지 않음. 새 두통·턱 파행·일과성 시력상실/시력저하가 있으면 거대세포동맥염을 의심하여 긴급 평가(시각 증상은 즉시 평가)

<mark style="color:$info;">**외래 추적 / 추가 평가 계획**</mark> <mark style="color:$info;">- 즉각 위험 낮으나 호전 없으면 의뢰</mark>

* 휴식 시 악화되거나 활동과 무관한 통증이 반복되더라도 진행성 통증·암/감염 의심 소견이 없으면 원인 재평가 계획 수립
* 원인이 불명확한 야간 통증이 반복되면 동반 위험인자를 재확인하고, 지속·악화되거나 암 병력·전신 증상 동반 시 평가 시점을 앞당김
...
* 대체로 깊거나 광범위한 통증
* 전형적으로 능동과 수동 움직임 모두에 제한 또는 통증
* 부종, 불안정, 변형, crepitus, locking 동반 가능

#### <mark style="color:$primary;">비관절 문제</mark>

* 대체로 능동 움직임에서 통증이 뚜렷하고 수동 움직임에서는 통증이 적으나, 수동운동 끝범위에서도 통증이 생길 수 있음
...
✽6주는 감별을 위한 편의상 기간 구분이며, 지속성 활막염이나 Red Flags의 평가·의뢰를 6주까지 미루는 기준이 아님
...
flowchart TD
    ...
    R -- "예" --> RE["골절·화농성 관절염·구획증후군<br>급성 사지 허혈·마미증후군·척수압박 등<br>즉시 평가/의뢰"]
    R -- "아니오" --> Q1{"관절 증상인가?"}
    ...
    Q3 -- "예" --> SA["화농성 관절염 우선 배제<br>발열 없어도 가능<br>지체 없이 관절천자/응급 의뢰:<br>세포수/감별·Gram/culture·crystal"]
    SA --> AC["감염 배제 후 감별<br>통풍/CPPD·외상/혈관절증 등"]
    Q3 -- "아니오" --> AP["급성 소수/다관절염 감별<br>반응성·바이러스성 관절염<br>결정성 질환·만성 관절염의 초발<br>지속성 활막염이면 조기 의뢰"]
...
* **급성 원인불명 단관절염**, 특히 화농성 관절염이 의심되면 혈액검사만으로 판단하지 말고 지체 없이 관절천자(또는 즉시 가능한 기관으로 의뢰)를 통해 활액 세포수/감별, Gram stain·배양, 결정 분석 등을 시행. 패혈증·패혈성 쇼크가 아니라면 가능한 한 항생제 투여 전 활액 및 혈액배양 검체를 채취하되, 패혈증 치료를 검체 채취 때문에 지연하지 않음
...
* 급성 단관절염에서는 발열 유무와 관계없이 화농성 관절염 가능성을 먼저 평가하고, 의심 시 지체 없이 관절천자 또는 즉시 가능한 기관으로 의뢰
* 병력·진찰만으로 확진이 어려운 경우 임상적 의심에 따라 ESR/CRP, 선택적 혈청검사, 관절 영상, 관절천자 등으로 보완
* 원인 불명의 지속성 활막염, 특히 손·발 작은 관절 또는 둘 이상의 관절 침범 시 **증상 기간이 6주 미만이거나 ESR/CRP 정상·RF/anti-CCP 음성이어도 검사 결과를 기다리며 의뢰를 지연하지 말고 류마티스내과 조기 의뢰**
...
M79.6 사지의 통증 Pain in limb

R29.8 신경계통 및 근골격계통의 기타 및 상세불명의 증상 및 징후 Other and unspecified symptoms and signs involving the nervous and musculoskeletal systems
...
* 허리·다리 통증과 함께 갑자기 소변이 잘 나오지 않거나 회음부 감각이 둔해지거나 다리의 힘이 점차 빠지는 경우
* 암 병력이 있고 새로 생긴 허리·등 통증과 함께 걷기 어렵거나 다리 감각·근력이 떨어지는 경우
* 팔·다리에 새로 힘이 빠지거나 감각이 둔해지는 증상이 진행하는 경우

**다음 증상은 조기에 진료받으세요**

* 암 병력이 있거나 이유 없이 체중이 줄면서 새로 생긴 지속적 통증·야간통이 있는 경우
* 50세 이상에서 양쪽 어깨·엉덩이 주위가 심하게 뻣뻣하고 아프면서 새 두통이나 씹을 때 턱 통증이 생긴 경우에는 당일 진료; 시력이 떨어지거나 잠시라도 보이지 않았다면 즉시 응급 평가
