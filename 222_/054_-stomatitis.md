...
| ----------------------------------- | ----------- | ----------------------------------- | ------------------------- | --------------- | -------------------- | ----------------------------------------------------- |
| 아프타 궤양                              | 바로 궤양       | 황백색 바닥, 붉은 경계, 둥글고 뚜렷함              | 비각화 점막 (볼, 입술 안쪽, 혀 아랫면)  | 매우 심함           | 1–2주 자연치유, 재발 반복     | 수포 없음, 비각화 점막, topical steroid 반응 좋음                  |
| 헤르페스 (HSV)                          | 수포 → 궤양     | 군집된 1–3 ㎜ 소수포, 파열 후 얕은 궤양           | 각화 점막 포함 (잇몸, 경구개, 입술 경계) | 심함              | 1–2주, 초감염 시 발열·림프절병증 | 수포 병력, 각화 점막, 전염성 있음                                  |
| 구강 칸디다증                             | 흰색 plaque   | 닦아내면 벗겨짐, 그 아래 발적·미란                | 혀, 볼 점막, 구개               | 화끈거림            | 항진균제에 빠른 반응          | scrapable, 위험인자 확인 (steroid 흡입제, DM, 틀니)              |
| 구강 편평태선 (OLP)                       | 레이스 모양 흰 병변 | 양측성 망상형 흰 선조(Wickham striae), 만성 경과 | 양측 볼 점막                   | 미란형은 심함         | 만성, 수개월–수년           | 양측성, 레이스형 흰 선, 중년 여성, 악성 전구 가능 → 의뢰                   |
| 백반증/홍반증 (Leukoplakia/Erythroplakia) | 흰색 또는 붉은 판  | 닦이지 않음, 불규칙 경계, painless            | 혀 측면, 구강저                 | 초기 무통증          | 지속·악화 (>2주)          | 흡연·음주 병력, painless, 단일, 2주 이상 → 악성 가능성 고려             |
| 구강암 (SCC)                           | 궤양/종괴       | indurated, rolled edge, 딱딱한 촉진      | 혀 측면, 구강저, 잇몸             | 초기 무통 → 진행 시 통증 | 지속 악화                | 2주 이상 비치유 단일 궤양, 경부 림프절 종대 → 즉시 의뢰                    |
| 약물 유발 궤양                            | 궤양          | 특정 약물 시작 후 발생, 비전형적 위치 가능           | 다양                        | 심함              | 원인 약물 중단 후 호전        | nicorandil, bisphosphonate, MTX, ICI, mTOR 억제제 복용력 확인 |
| 베체트병                                | 깊은 궤양       | 구강 + 생식기 궤양 동반, 반복성                 | 비각화 점막                    | 심함              | 반복 재발                | 생식기 궤양, 포도막염, 피부 병변 동반 → 류마티스내과 의뢰                    |
| SJS/TEN                             | 미란/수포       | 광범위, 다발성, 타 점막 및 피부 동반              | 광범위                       | 심함              | 급성 악화                | 발열, 결막·피부 병변 동반 → 응급                                  |
...
**구강 편평태선(OLP) - 미란형(Erosive OLP) 주의** : 미란형 OLP는 망상형에 비해 구강암으로의 악성 전환 위험이 상대적으로 높음. 단순 추적에 그치지 말고 6개월 간격 정기 추적 및 의심 병변 생검 시행 필요
{% endhint %}
...
<table><thead><tr><th width="113">감별점</th><th width="249">재발성 아프타성 구내염</th><th>헤르페스성 구내염</th></tr></thead><tbody><tr><td>호발 연령</td><td>청소년\~성인</td><td>소아(초감염), 성인(재발)</td></tr><tr><td>초기 병변</td><td>궤양 (수포 단계 없음)</td><td>다발성 수포 → 파열 후 궤양</td></tr><tr><td>호발 부위</td><td>볼, 입술 안쪽, 혀 아랫면, 연구개 (비각화 점막)</td><td>잇몸, 경구개, 입술 피부-점막 접합부 (각화 점막 포함)</td></tr><tr><td>전신 증상</td><td>드물다</td><td>초감염 시 발열·림프절병증 흔함</td></tr><tr><td>전염성</td><td>없음</td><td>있음 (수포기)</td></tr><tr><td>치료</td><td>국소 스테로이드, 대증 치료</td><td>증상 24\~48시간 내 항바이러스제; 스테로이드 금기</td></tr></tbody></table>
...
* **ISG 기준(**&#x49;nternational Study Group, 1990)
  * 구강 내 궤양이 1년 동안 ≥3번 재발하며 다음 4가지 중 ≥2개 해당 시 진단
  ...
  4. pathergy test 양성 : forearm과 back에 식염수 0.1 ㎖를 주입하거나 소독된 바늘로 찌르고 24\~48시간 후에 지름 ＞2 ㎜의 구진 또는 농포 형성
...
* sucralfate 액 : 점막 보호 기전; 아프타에서 healing 촉진 효과는 mixed evidence; 5\~10 ㎖ 1\~2분 린스 qid <mark style="color:blue;">\[아루사루민]</mark>
* rebamipide : 100 ㎎ tid <mark style="color:blue;">\[무코스타]</mark>; 일본 중심 데이터. 국내 사용은 있으나 아프타에서 근거 제한적
...
{% hint style="danger" %}
**알보칠(policresulen) 사용 금지** : 병소 및 주변 정상 조직에 화학적 손상을 일으켜 오히려 회복을 지연시킬 수 있음. 일상적 사용 권장하지 않음. 구매 가능하나 환자에게 사용 자제를 안내할 것.
{% endhint %}
