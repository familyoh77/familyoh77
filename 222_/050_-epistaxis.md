...
> ※ **비강 패킹 항생제 예방 투여** : Toxic shock syndrome(TSS) 예방 목적으로 비강 패킹을 유지하는 동안 항생제 투여가 관행적으로 시행되나, 근거는 불충분하며 일률적으로 권고하지 않음; 48시간 이내 제거 시 항생제 생략 가능, 패킹 장기화 또는 면역저하자에서는 개별 판단
