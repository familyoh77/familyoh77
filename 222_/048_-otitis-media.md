...
* RSV 단일클론항체(예: Nirsevimab <mark style="color:blue;">\[베이포터스]</mark>) : 본래 적응증은 RSV 하기도질환 예방이며, 이를 통해 영유아의 첫 AOM 발생 시기를 늦추고 항생제 노출을 줄이는 부수적 효과가 보고됨(AOM 예방 자체를 목적으로 한 적응증은 아님); 장기 면역 영향 및 비용-효과에 대한 추가 근거 축적 중
* RSV 모체면역 백신(예: Abrysvo <mark style="color:blue;">\[아브리스보]</mark>, 임신 28\~36주 접종) : 2026년 8월 국내 허가; 태반을 통한 항체 이행으로 출생 후 6개월까지 영아 RSV 하기도질환 예방 목적 — NIP 편입 및 급여 여부는 확인 필요
...
* 귀 증상 : 보통 편측 발생; 통증(보챔, 귀를 만짐), 전음성 청력 저하, 이명, 경미한 유양돌기 압통(단순 관련통으로 흔히 동반됨 — 발적·부종이 함께 있으면 유양돌기염 감별 필요, ☞ Red Flags)
...
{% hint style="info" %}
<mark style="color:red;">**합병증 없는 AOM 초치료 원칙 = Amoxicillin 고용량 우선**</mark>**.** Amoxicillin/clavulanate(오구멘틴)는 다음 상황에 한해 초치료로 선택: ⓵ 최근 30일 이내 amoxicillin 복용, ⓶ otitis-conjunctivitis syndrome, ⓷ amoxicillin 치료에 반응하지 않았던 재발성 AOM, ⓸ beta-lactamase 생성균 의심(H. influenzae, M. catarrhalis). 이외에는 amoxicillin을 먼저 사용하고 실패 시 amox-clav로 단계적 상향.
{% endhint %}
...
>
> ```
> 오구멘틴 듀오 시럽 457 ㎎/5 ㎖(Amox 80 ㎎/㎖)   8.4 ㎖   bid   × 10d
> 부루펜 시럽 20 ㎎/㎖                            7 ㎖    tid   × 3~5d
> ```
>
> _✽오구멘틴 듀오 1회 8.4 ㎖(Amox 기준 90 ㎎/㎏/d, 1일 1,350 ㎎ ÷ 2회분). 부루펜은 1회 7 ㎖(140 ㎎, 약 9.3 ㎎/㎏/회)로 5\~10 ㎎/㎏/회 범위 내 사용; 제제 농도가 다른 경우 반드시 재계산. 중증, 양측 이환, 최근 항생제 복용력 등 amox-clav 적응증 해당 시 고용량 요법 선택. **단순 비중증 AOM 초치료는 amoxicillin 단독이 원칙.** 발열·통증 지속 48\~72시간에도 호전 없으면 재내원_

> **처방례 2. AOM - 소아 15 ㎏, 오구멘틴 치료 실패 (48\~72시간 무반응)**
>
> ```
> 바난 시럽 10 ㎎/㎖   7.5 ㎖   bid   × 5~7d
> ```
>
> _✽cefpodoxime 10 ㎎/㎏/d 기준 1회 7.5 ㎖(1일 총 150 ㎎, 15 ㎖/d ÷ 2회분)로 전환 (cephalosporin 2차 선택). 초치료 실패 시 amoxicillin 내성 S. pneumoniae 또는 beta-lactamase 생성 H. influenzae 고려. 48시간 내 재내원 예약_
...
* 약물 치료(항생제·전신/비강 스테로이드·항히스타민제 등)는 OME 자체에는 권장되지 않음; 알레르기비염 등 별도 치료가 필요한 동반 질환이 있는 경우에 한해 해당 질환의 치료를 고려 — 보호자 불안이나 수술 거부 자체는 근거 없는 약물 치료의 적응증이 되지 않음
...
* 일반적으로 3개월 경과 관찰 후 해당 시 고려
  * 양측 OME ≥3개월 지속 + 청력 저하가 객관적으로 확인(documented hearing difficulties)된 경우 고막튜브삽입술 제안 [AAO-HNSF 2022] — 특정 dB 수치보다 청력 저하의 실재 여부와 기능적 영향(언어·학업·행동)을 우선 고려
  * 편측 OME에서는 이환 기간, 청력 수준, 동반 증상, 보호자 선호도 고려
...
{% hint style="info" %}
본 알고리듬의 청력 역치(20\~40 ㏈) 구간은 2014년 국내 지침 기준이며, 2022년 AAO-HNSF 개정 지침은 특정 dB 수치보다 "양측 OME ≥3개월 + 문서화된 청력 곤란(documented hearing difficulties)" 여부를 수술 결정의 핵심 기준으로 제시함. 실제 적용 시 최신 지침을 함께 참고할 것.
{% endhint %}
