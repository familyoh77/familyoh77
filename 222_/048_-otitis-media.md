...
* 낮은 사회경제적 상태
* 겨울철 : 호흡기 바이러스 활동과 관련
* 6개월\~2세 : 발생 빈도 가장 높은 연령 - 낮은 면역 기능, 비인두 림프 조직 풍부, 짧고 수평인 이관(E-tube), 누워서 자는 시간 많음
...
* 폐렴구균 백신 : 2026년 현재 국내 소아 국가예방접종(NIP) 표준은 PCV20(20가)으로 전환됨 (☞ [예방접종](../231_/210_-vaccination.md#pneumococcal-pneumonia))
  * PCV20은 PCV13 대비 7개 혈청형(8, 10A, 11A, 12F, 15B, 22F, 33F)을 추가 커버하며, 중이염 유발 빈도가 높은 혈청형을 포함하여 기존 백신 대비 AOM 예방에 기여할 것으로 기대됨
...
* RSV 단일클론항체(예: Nirsevimab) : RSV로 인한 상기도 감염 감소를 통해 중이염 발생을 일부 줄일 수 있다는 보고가 있으나, 장기 면역에 대한 영향 및 비용-효과 근거는 아직 제한적
...
* 기전 : 상기도 바이러스 감염 선행 → 이관(E-tube) dysfunction, clearance 저하 → fluid·mucus 축적 → 2차 세균 감염
...
* **확진** : 급성 발생의 주관적 증상이 있고, 객관적 징후(고막 소견 또는 고막운동성계측 이상)가 ≥1개 있는 경우
* **의증** : 주관적 증상은 있으나 객관적 징후가 분명치 않은 경우 \[대한이과학회]

> ✽진단 세부 기준(주관적 증상·객관적 징후 항목) 및 확진·의증 판정 기준 → 아래 치료 알고리듬 주석 참조
...
#### <mark style="color:$primary;">합병증이 없는 AOM의 항생제 적용 기준</mark>
...
* ✽설사 부작용이 문제인 경우, Amox:Clav = 14:1 제제(아목시클라브 ES) 고려 — 기존 4:1 제제 대비 clavulanate 함량이 낮아 위장 부작용 감소 기대
...
✽  성인 AOM에서 페니실린 알레르기 또는 초치료 실패 시 levofloxacin 500 ㎎ qd ×5\~7d 고려 가능 <mark style="color:blue;">\[크라비트]</mark> (보험 급여 확인 필요)
...
_\*급성 중이염 진단_\
&#xNAN;_(1) 주관적 증상 ⓵ 급성 발생(48시간 이내) ⓶ 국소 증상 : 이통·이루 ⓷ 전신 증상 : 귀를 만짐·울고 보챔·수면 장애·활동 저하·식욕 부진·발열_\
&#xNAN;_(2) 객관적 징후 ⓵ 고막 소견 : 팽륜·수포·발적·중이 삼출액·이루 동반 천공 ⓶ 고막운동성계측 B형 또는 C형_\
&#xNAN;_▶확진 : (1) 모두 만족 AND (2) 중 1개 이상 / 의증 : (1) 만족 BUT (2)가 불명확한 경우_
...
* 기전 : 중이 자극 → mucin 생성↑, 이관(E-tube) 기능 부전/폐쇄 → 중이 내 mucin-rich effusion 축적
...
* OME 단독 진단 시 약물 요법 없이 3개월간 경과 관찰 → 이후 고막 상태, 청력, 언어 발달 평가 후 추가 치료 결정 \[대한이과학회]
  * 단, 구개열·다운증후군·감각신경성 난청·언어 발달 지연 등 고위험군은 3개월 대기 없이 즉시 청력 검사 및 의뢰 고려 (☞ 아래 조기 조치 대상자)
