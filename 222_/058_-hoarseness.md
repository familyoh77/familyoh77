...
* 목소리의 질(quality), 음조(pitch), 음량(loudness), 발성 노력(vocal effort) 등의 변화를 총칭하는 증상
...
<table><thead><tr><th width="215">원인</th><th>세부</th></tr></thead><tbody><tr><td>급성 후두염</td><td>바이러스(가장 흔함), 세균 (☞ <a href="../223_/063_-laryngitis.md">후두염</a>)</td></tr><tr><td>성대 출혈</td><td>목소리 과사용·잘못된 발성, 항응고제 사용; shouting 후 갑작스런 실성</td></tr><tr><td>후비루</td><td>부비동염, 알레르기 (☞ <a href="053_-rhinosinusitis-sinusitis.md">부비동염</a>)</td></tr><tr><td>위식도역류 / 인후두역류</td><td>위산, 인두 자극 (☞ <a href="../224_/081_-gerd.md">위식도역류질환</a>)</td></tr><tr><td>경부 외상 / 기관삽관 후</td><td>직접 외상, 삽관 손상</td></tr><tr><td>갑상선 질환</td><td>갑상선저하증 (☞ <a href="../226_/105_-hypothyroidism.md">갑상선저하증</a>)</td></tr><tr><td>기능성 발성장애</td><td>hysterical aphonia, 심한 스트레스 (☞ <a href="../221_/031_-somatic-symptom-disorder.md">신체증상장애</a>)</td></tr></tbody></table>

#### <mark style="color:$primary;">만성 원인</mark>

<table><thead><tr><th width="215">원인</th><th>세부</th></tr></thead><tbody><tr><td>근긴장성 발성장애 (MTD)</td><td>가장 흔한 기능적 원인; 후두 구조 정상 + 후두 주변근 과긴장; 발성 피로</td></tr><tr><td>성대 결절(vocal nodule)</td><td>목소리 과사용·잘못된 사용 → 양측성·대칭성; 교사·가수에서 흔함</td></tr><tr><td>성대 폴립(vocal polyp)</td><td>과사용, 흡연, 알레르기 → 편측성이 많음</td></tr><tr><td>Reinke's edema</td><td>흡연(특히 여성)에서 특징적; 저음화 + 거친 목소리</td></tr><tr><td>노인성 음성 위축(presbyphonia)</td><td>성대 근육 위축 → 기식성 음성·발성 피로</td></tr><tr><td>만성 후두염</td><td>흡연, 만성 자극, LPR, 바이러스·세균</td></tr><tr><td>악성 종양</td><td>성문암(squamous cell Ca), 갑상선암의 되돌이후두신경(RLN) 침범</td></tr><tr><td>Recurrent respiratory papillomatosis</td><td>HPV 6/11형; 소아형 및 성인형</td></tr><tr><td>성대 마비(vocal fold paralysis)</td><td>종양(폐암·식도암·갑상선암), 갑상선·흉부·심장 수술 후 RLN 손상, 뇌경색, 퇴행성 질환</td></tr><tr><td>경련성 발성장애(spasmodic dysphonia)</td><td>국소 근긴장이상증</td></tr></tbody></table>

#### <mark style="color:$primary;">약물 유발 목쉼</mark>

* 흡입 스테로이드(ICS) : 후두 근육병증(myopathy) + 진균성 후두염 → dysphonia의 흔한 원인; fluticasone에서 budesonide보다 빈번
...
* 흡기 시 협착음(stridor) + 호흡 곤란 → 성대 부종·후두개염·기도 폐쇄
* shouting 직후 갑작스런 실성 → 성대 출혈
* 급성 삼킴 장애 + 흡인 증상(사레, 기침, 발열) → 흡인성 폐렴
...
* 빠른 진행 또는 삼킴 곤란 동반 → 악성 종양 또는 신경학적 원인
* 갑상선·흉부·심장 수술 또는 경부 방사선 치료 후 발생 → RLN 손상
* 흡인성 폐렴 기왕력 동반 목쉼 → 성대 마비·기능 이상
...
* 4주 이상 지속
* 흡연·과음력 있는 환자에서 2주 이상 지속&#x20;
* 6주 이상 지속되는 원인 불명의 목쉼
* 보존적 치료에 반응 없거나 치료 후 재발 반복
...
* 후두경 검사(laryngoscopy) : 목쉼 원인 파악을 위한 일차 시각화 검사
  * 후두경 없이 만성 목쉼에 경험적 치료를 단독 적용하지 말 것&#x20;
  * 3개월 이상 지속되거나 심각한 기저 질환 의심 시 후두경 검사 권고; 음성 치료 시작 전 시행하여 기질적 병변 여부 확인 필수
...
{% hint style="info" %}
**URI 후** 1주 정도 목쉼이 지속될 수 있으며, 이 경우 경과 관찰이 우선\
**속삭임**은 성대 긴장을 오히려 높이므로 쉰 목소리 회복에 도움이 되지 않음
{% endhint %}
...
* 저음화 + 흡연 / 여성 → Reinke's edema, 갑상선저하증, 성대 부종
* 떨리는 목소리 (리듬적 변화) → 본태성 진전, 파킨슨병
* 발성 피로, 말할수록 악화 → MTD, 성대 결절 초기, 신경근육 질환
* 발성 피로(fatigable) + 오후·저녁에 심해지는 일중 변동 → 중증근무력증(MG)
* 속삭임은 되는데 발성 불가 → 기능성(psychogenic) 발성장애
...
graph TD
    ...
    Start([최근 목소리 남용 또는<br/>URI · 알레르기 증상 이력?])

    Start -- yes --> A[Voice rest,<br/>충분한 수분 섭취,<br/>대증 치료]
    Start -- no --> B([최근 위식도 또는<br/>인후두역류 증상?])

    A --> A1([2주 내 호전?])
    A1 -- yes --> A2[대증 치료 유지;<br/>재발 시 후두경]
    A1 -- no --> A1b([고위험군?<br/>흡연·과음·객혈·종괴])
    A1b -- yes --> A3[후두경 검사]
    A1b -- no --> A1c[4주까지 지지요법 &<br/>vocal hygiene 지속]
    A1c --> A1d([4주 내 호전?])
    A1d -- yes --> A2
    A1d -- no --> A3

    B -- yes --> C[생활습관 교정 우선;<br/>증상 지속 시 PPI<br/>선택적 시험 치료]
    B -- no --> D[2주간 지지요법 &<br/>vocal hygiene;<br/>호전 없으면 후두경 고려]

    C --> C1([4주 내 호전?])
    C1 -- yes --> C2[생활습관 교정 유지;<br/>재발 시 후두경]
    C1 -- no --> C3[후두경 검사]
    ...
    class Start,B,A1,A1b,A1d,C1 yellow;
    class A,A2,A1c,C,C2,D blue;
    class A3,C3 green;
```
...
graph TD
    ...
    Start([고위험군?<br/>흡연, 과음, 장기 GERD,<br/>객혈, 경부 수술 후])

    Start -- yes --> L1[후두경 검사<br/>우선 시행]
    Start -- no --> Q2([최근 흡입 스테로이드 사용?])

    Q2 -- yes --> A[ICS 용량 감소 또는 중단;<br/>spacer 추가;<br/>budesonide로 전환 고려]
    Q2 -- no --> B([목쉼 유발 전신 질환?<br/>파킨슨병, 갑상선저하증 등])

    A --> A1([4주 내 호전?])
    A1 -- yes --> A2[ICS 유효 최소량 유지;<br/>재발 시 후두경]
    A1 -- no --> L2[후두경 검사]
    ...
    C --> C1([4주 내 호전?])
    C1 -- yes --> C2[기저 질환 치료 유지;<br/>재발 시 후두경]
    C1 -- no --> L4[후두경 검사]
...
<p align="center"><em><mark style="color:$info;">저자 편집; Ref. Adapted from Am Fam Physician 2017;96(11), Fig 2; modified per AAO-HNSF Clinical Practice Guideline: Hoarseness (Dysphonia), Otolaryngol Head Neck Surg 2018;158(1 Suppl):S1–S42</mark></em></p>
...
* 하루 2 ℓ 이상(음식·음료 포함) 수분 섭취; 실내 가습 유지 (습도 40\~60%)
...
{% hint style="danger" %}
**AAO-HNSF(2018) 권고 :** 후두경으로 원인 확인 전, 만성 목쉼에 경험적 항생제·경구 스테로이드 처방을 하지 말 것.\
LPR/GERD 진단 없이 목쉼에만 PPI를 경험적으로 처방하지 말 것.
{% endhint %}

#### <mark style="color:$primary;">경구 / IM 스테로이드</mark>&#x20;

* 대상 : 직업적 성대 사용자에서 즉각적 발성이 불가피한 경우, 또는 중증 염증성 부종(severe inflammatory edema)에서 단기에 한해 고려
* 엄격한 제한적 사용; 구조적 병변(특히 성대 출혈) 배제가 전제
* 금기 : 성대 출혈 의심, 감염성(특히 진균성) 후두염, 진단 불명 상태에서의 반복 사용
* prednisolone : 20\~40 ㎎/d, 1\~3일 단기 (short burst)
* dexamethasone IM : 단회, 빠른 onset이 필요한 경우

#### <mark style="color:$primary;">PPI</mark>&#x20;

* LPR 또는 GERD가 임상적으로 의심될 때만 시험적 치료; 생활습관 교정이 우선
  * 최근 다수의 RCT에서 LPR에 대한 PPI가 위약과 유의한 차이가 없거나 미미한 것으로 보고됨. Heartburn 동반, 아침 목쉼, 만성 throat clearing 등 GERD 증거가 있는 경우에 선택적으로 투여할 것
* omeprazole 20\~40 ㎎ qd\~bid; 시험 기간 8\~12주 (☞ [인후두역류](../223_/062_-laryngopharyngeal-reflux-lpr.md), [위식도역류질환](../224_/081_-gerd.md))
  * 4주 투여  후 증상 호전이 전혀 없다면 나머지 기간을 채우지 않고 조기 중단 및 후두경 검사 시행

#### <mark style="color:$primary;">점막 보습 보조</mark>

* guaifenesin (거담제) : 기관지 점액 점도 저하와 함께 성대 윤활에 보조적 도움이 될 수 있다는 의견; 근거는 제한적이지만 부작용이 거의 없어 충분한 수분 섭취와 병행하여 선택적으로 고려 가능

#### <mark style="color:$primary;">ICS 유발 dysphonia 관리</mark>

* ICS는 목쉼의 치료제가 아니라 원인임
* ICS 사용 중 목쉼 발생 시 다음의 조치 고려
  * spacer(보조흡입기) 추가 - 성대에 도달하는 스테로이드 양 감소 기대
...
#### <mark style="color:$primary;">Baclofen</mark>&#x20;
...
목쉰 소리는 성대(목소리를 만드는 두 개의 근육 주름)에 이상이 생겼을 때 나타납니다. 대부분은 바이러스 감염이나 목소리 과사용으로 인한 일시적 현상이지만, 4주 이상 지속되거나 흡연·음주력이 있다면 반드시 성대 검사가 필요합니다.
{% endhint %}
...
* **수분을 충분히 드십시오** - 하루 2 ℓ 이상(음식·음료 포함)의 물이 성대 점막을 촉촉하게 유지합니다.
...
* **역류가 원인**이라면 취침 2\~3시간 전 음식을 피하고, 카페인·술·탄산음료·신 음식을 줄이십시오.
