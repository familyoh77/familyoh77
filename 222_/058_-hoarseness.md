...
| 급성                                   | 원인                                                                     |
| ------------------------------------ | ---------------------------------------------------------------------- |
| 급성 [후두염](../223_/063_-laryngitis.md) | 바이러스, 세균                                                               |
| 성대 출혈                                | 목소리 과사용, 잘못된 사용                                                        |
| 후비루                                  | [부비동염](053_-rhinosinusitis-sinusitis.md), 알레르기                         |
| [위식도역류](../224_/081_-gerd.md)        | 위산                                                                     |
| 경부 외상                                | 외상                                                                     |
| 갑상선 질환                               | [갑상선저하증](../226_/105_-hypothyroidism.md)                               |
| 정신적 문제                               | [신체증상장애](../221_/031_-somatic-symptom-disorder.md), Hysterical aphonia |
...
*   steroid
    ...
    •저용량 흡입제 budesonide \[풀미코트] (☞ [천식](../223_/071_-asthma.md#inhaled-corticosteroid-ics)) (✽fluticasone은 자극 및 후두염의 원인이 되므로 피함)

    •바로 목소리를 내야 하는 직업인에 대하여 경구/IM steroid를 제한적으로 고려
*   고용량 PPI : 역류 질환에 대한 시험적 치료; 다른 원인을 배제한 후 full-strength로 1일 2회 최소 3개월 투여.

    예) omeprazole 40 ㎎ bid (☞ [인후두역류](../223_/062_-laryngopharyngeal-reflux-lpr.md), [위식도역류질환](../224_/081_-gerd.md))
