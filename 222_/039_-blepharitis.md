...
> &#xNAN;_✽moxifloxacin 점안액은 각막 침범 또는 중증 감염 의심 시 적용; 단순 MGD에서는 routine 사용을 권고하지 않음_
...
> * **눈꺼풀 세척(lid scrub)** : 마사지 직후, 유아용 무자극 샴푸를 물에 희석하거나 전용 눈꺼풀 세정제로 속눈썹 밑 눈꺼풀 가장자리를 면봉 또는 깨끗한 손가락으로 닦으십시오. **온찜질→마사지→세척의 순서**를 지키면, 열로 연화된 분비물이 가장 효과적으로 제거됩니다.
>
> 📹 **참고 동영상 (AAO)**
>
...
* **눈꺼풀 세척(lid scrub)** : 마사지 직후 유아용 샴푸를 희석한 물 또는 전용 세정제로 속눈썹 뿌리를 1일 2회 닦아 주십시오. **온찜질→마사지→세척 순서**를 지키면 효과가 가장 좋습니다.
