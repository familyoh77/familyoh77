...
```mermaid
graph TD
    A[면역 저하 상태] -- yes --> B["•국소 항균/steroid 복합제 x 7~14일<br/>•경구 quinolone x 7~10일<br/>•wick placement"]
    
    A -- no --> C{증상 수준}    

    C -- 중등증 --> D["[중등증]<br/>•중등도 통증/가려움<br/>•외이도 부분 폐쇄"]
    
    C -- 경증 --> E["[경증]<br/>•경증 불편감/가려움<br/>•경미한 외이도 부종"]
    
    C -- 중증 --> F["[중증]<br/>•중증 통증<br/>•외이도 폐쇄<br/>•발열, 귓바퀴 주위 발적, 
    림프절병증"]
    
    D --> G["국소 acetic acid/hydrocortisone 복합제<br/>x 수일"]
    E --> G
    
    F --> H{외이 밖으로 병변 확장}
    
    H -- yes --> I["•국소 항균/steroid 복합제 x 7~14일<br/>•경구 quinolone x 7~10일<br/>•wick placement"]
    
    H -- no --> J["•국소 항균/steroid 복합제 x 7~14일<br/>•wick placement"]
