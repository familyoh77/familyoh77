...
* 건강한 성인의 약 50%에서 *Candida* 균이 구강 내 상재하며, 숙주 방어 기전이 손상될 때 발병
...
* 원인균 : *Candida albicans* (대부분); 드물게 *C. glabrata*, *C. tropicalis*, *C. krusei* (☞ p.933)
...
* 광범위 항생제 (정상 구강 상재균 억제 → *Candida* 과증식)
...
* 영유아 (면역 체계 미성숙), 노인
  * 신생아 : 분만 시 산도 내 *Candida*에 노출되거나 수유 과정을 통한 감염 가능성 고려

## <mark style="color:green;">임상 양상</mark>

* 구강의 여러 부위에 각기 다른 형태로 발생 가능

<table><thead><tr><th width="175">형태</th><th width="295">특징</th><th>주요 발생 부위</th></tr></thead><tbody><tr><td><strong>Thrush</strong> (위막형)</td><td>흰색 curdlike plaque; 거즈로 닦으면 제거되고 발적·점상출혈 노출</td><td>혀, 볼 점막, 구개</td></tr><tr><td><strong>Erythematous (위축형)</strong></td><td>얇고 beefy한 발적 병소; 백색 위막 없이 발적만 나타나 놓치기 쉬움; 자각 증상 뚜렷한 편<br/><strong>정중능형설염 (Median Rhomboid Glossitis)</strong> : 이 형태의 특수 변형; 혀 중앙 후방부에 마름모꼴 발적과 유두 소실 → 설암 등으로 오인 주의</td><td>혀 등쪽, 틀니 접촉 점막</td></tr><tr><td><strong>Angular cheilitis (구각 입술염)</strong></td><td>구각의 균열·발적·삼출; 세균 혼합 감염 흔함; 철분·비타민 결핍, drooling 동반 가능</td><td>구각</td></tr><tr><td><strong>Hyperplastic form (증식형)</strong></td><td>흰색 두꺼운 반점; 거즈로 제거 불가; leukoplakia와 외관상 구분 불가 가능; 항진균제에 반응하지 않는 병소는 반드시 조직 생검 (epithelial dysplasia 가능)</td><td>볼 점막, 혀</td></tr></tbody></table>

### 원인별 임상형 맵핑

{% hint style="info" %}
**유발 인자와 발생 임상형의 연관성** — 진단 속도 향상에 활용
...
* 진단적 조작 : 거즈로 닦으면 제거되고, 노출된 점막에 발적·점상출혈·따가움 발생
  * ✽ 단, 거즈 제거 여부는 절대적 기준이 아님; erythematous type은 위막 없이 발적만, hyperplastic type은 *Candida*이지만 제거 안 됨 → atypical 병소에서는 KOH 또는 조직 생검 고려
...
* **연하통 (odynophagia)** 또는 흉골 뒤 작열감·통증 → 식도 칸디다증 의심; odynophagia가 dysphagia보다 더 특징적 (특히 면역저하자; 내시경 평가 필요)
* 면역저하자에서 발열 + **invasive device (중심정맥관 등)** 보유 → 침습성 칸디다증 (candidemia) 배제; 혈액 배양 및 입원 고려 (단, 구강 칸디다증만으로 candidemia 위험은 극히 낮음)
* 면역저하자(HIV, 항암 치료 중, 장기이식 수혜자)에서 급격히 악화되는 경우

<mark style="color:$warning;">**당일 또는 조기 의뢰**</mark>

* 원인 불명의 면역저하 상태 의심 → HIV 검사 등 감염내과 의뢰
* Hyperplastic form에서 항진균제 치료 2~3주 후에도 병소 지속 → leukoplakia·구강 암 감별 위해 구강내과·이비인후과 의뢰 (hyperplastic candidiasis 자체는 전암 병변 아니나, leukoplakia와 중복 시 epithelial dysplasia 가능)
* 모유 수유 영아의 반복 아구창 + 수유 어머니 유두 감염 동반 → 소아과·산부인과 협진

<mark style="color:$info;">**외래 추적 / 추가 평가 계획**</mark> <mark style="color:$info;">- 즉각 위험 낮으나 호전 없으면 의뢰</mark>

* 표준 치료(14일) 완료 후 호전 없는 경우 → fluconazole 내성 *Candida* (*C. krusei*, *C. glabrata*) 고려; 배양·감수성 검사
...
1. Leukoplakia를 candidiasis로 오진 — 거즈로 제거 여부 확인 필수; 안 닦이면 생검 고려
2. Erythematous type 놓침 — ICS 사용 환자에서 백색 위막 없이 혀 발적만 있어도 칸디다 의심; 정중능형설염을 설암으로 오인 주의
3. Angular cheilitis를 herpes labialis로 오진 — herpes는 수포·딱지, angular cheilitis는 구각 균열·삼출
4. 반복 칸디다증에서 DM·HIV 미평가 — 연 2회 이상 재발 시 반드시 HbA1c, HIV 확인
5. Chlorhexidine + nystatin 병용 처방 — chlorhexidine이 nystatin의 항진균 활성을 감소시킴 (in vitro 근거); 최소 2시간 간격 또는 병용 금지
{% endhint %}
...
| | 국소 항진균제 (1차) | 전신 항진균제 |
|---|---|---|
| **대상** | 경증~중등도, 면역 정상, 식도 증상 없음 | 중등도 이상, 면역저하, 연하통/흉통, 국소 치료 실패 |
| **약제** | nystatin, miconazole, clotrimazole | fluconazole 100~200 ㎎/d |
| **기간** | 7~14일 | 7~14일 (중증·면역저하자는 연장 고려) |
{% endhint %}
...
{% hint style="info" %}
**재발의 80%는 국소·사용 문제, 20%는 전신 — 안 낫으면 균종 확인**
...
* 배양·감수성 검사
* *C. glabrata* → dose-dependent susceptibility; 고용량 fluconazole (400 ㎎/d) 또는 itraconazole 고려
* *C. krusei* → fluconazole intrinsic resistance → itraconazole·voriconazole 전환
{% endhint %}
...
* **틀니 관리** :
  ...
  * 틀니 소독제 또는 chlorhexidine 용액에 밤새 침지 <mark style="color:blue;">\[헥사메딘 액]</mark> (보험기준 ☞ p.269)
...
* **Probiotics** : 구강 마이크로바이옴 정상화를 위한 *Lactobacillus* 제제가 재발 방지에 보조적으로 도움이 될 수 있다는 연구들이 있음; 현재 근거는 제한적이나 위험이 없으므로 보조적 고려 가능
...
* **핵심 원칙** : 약물의 구강 내 접촉 시간이 효과를 결정 (swish & swallow); 단순히 삼키면 효과 현저히 감소

#### <mark style="color:$primary;">Miconazole 구강 겔</mark>

* miconazole oral gel 20 ㎎/g : 약 2.5 ㎖ (50 ㎎)를 구강 각 부위에 적용; 식후 가능한 오래 물고 있다가 삼킴; qid ×7d + 호전 후 7d
* 생후 4개월 미만 영아 : 질식 위험으로 **사용 금지**; 4개월 이상 영아는 소량(1.25 ㎖)으로 시작

{% hint style="danger" %}
⚠️ Miconazole은 **CYP2C9 및 CYP3A4 억제제**로 다수의 약물과 상호작용:
...
#### <mark style="color:$primary;">Nystatin 현탁액</mark>
...
#### <mark style="color:$primary;">Clotrimazole</mark>
...
* 구각 입술염 : clotrimazole 크림 1% bid~tid 국소 도포 <mark style="color:blue;">\[카네스텐]</mark>
  * ✽ 구각 입술염은 세균 혼합 감염(*S. aureus*)이 흔하므로, 반응 불량 시 mupirocin 또는 fusidic acid 크림 추가 고려
...
#### <mark style="color:$primary;">Fluconazole (1차)</mark>

* fluconazole : 100~200 ㎎ PO 또는 IV qd ×7~14d <mark style="color:blue;">\[푸루나졸]</mark>
  * 중증 또는 면역저하자 : 최대 400 ㎎/d 고려 (IDSA 2016)

{% hint style="info" %}
**보험 기준 vs 권장 용량 차이 주의**\
보험 인정 기준은 50 ㎎/d이나 IDSA 권장 용량(100~200 ㎎/d)과 괴리가 있음. 실제 처방 시 삭감 사례가 발생할 수 있으므로, 처방 전 HIRA 최신 고시를 확인하고 진료 기록에 중증도 및 면역 상태를 명시할 것을 권장.
{% endhint %}

#### <mark style="color:$primary;">Itraconazole 경구 액제 (2차; fluconazole 내성 시)</mark>

* itraconazole oral solution (swish & swallow 방식) : 200 ㎎/d ×7~14d
  * *C. glabrata* (dose-dependent susceptibility) 또는 *C. krusei* (fluconazole intrinsic resistance) 감염 시 우선 고려
  * 공복 흡수 우수; 음식과 함께 복용 시 흡수 감소
  * 식도 칸디다증에도 효과적 (IDSA 2016)

{% hint style="info" %}
**최신 지견 — *Candida auris* (참고)**\
*C. auris*는 글로벌 이슈가 되는 다제내성 *Candida*로, 주로 혈류 감염을 일으킴. 구강에서 검출될 수 있으나 1차 진료에서 접할 가능성은 극히 낮음. 표준 항진균제에 광범위 내성 가능 → 면역저하 입원 환자의 반복 감염·치료 불응 시 감염내과에 균종 확인 의뢰.
{% endhint %}
