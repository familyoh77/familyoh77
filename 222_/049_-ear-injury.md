...
* 감염 징후 없으면 불필요; 절개 배농 후 연골 노출이 있거나 면역 저하 환자에서는 예방적 항생제를 고려할 수 있으나 routine 투여는 권고되지 않음; anti-pseudomonal 제제 선택에 대해서도 합의되지 않음 (☞ [외이염](047_-otitis-externa.md))
