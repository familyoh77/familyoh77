...
<table><thead><tr><th width="339.5555419921875">금지 행위</th><th>이유</th></tr></thead><tbody><tr><td>원판(단추형) 배터리에 세척(irrigation) 시행</td><td>습기가 전기 화학 반응을 가속시켜 조직 괴사 급속 진행</td></tr><tr><td>고막 천공에 aminoglycoside 점이제 사용</td><td>내이 직접 노출 → 비가역적 감각신경성 난청</td></tr><tr><td>이물 제거 3회 이상 반복 시도 (1\~2회 실패 시 이미 의뢰 대상)</td><td>외이도 부종 악화 → 이후 제거 더 어려워짐</td></tr><tr><td>이개혈종 흡인 후 bolster 고정 생략</td><td>dead space 잔존 → 높은 재발률 → cauliflower ear</td></tr><tr><td>바로 트라우마 시 forceful Valsalva 반복</td><td>중이 과압 → 외림프 누공·고막 천공 위험</td></tr></tbody></table>
...
* 다음 상황에서는 초진 시 아래 항목을 반드시 의무 기록에 기재하고 가능하면 사진 촬영·보관 (법적 분쟁 대비 초진 기록)
  ...
  * 귀 외상 (청력 평가) : 초진 시 음차 검사(Weber/Rinne) 결과를 기록 - 확정 진단 도구는 아니나, 영상 검사·PTA 시행 전 전음성/감각신경성 방향성을 파악하는 초진 소견으로서 추후 법적 분쟁 시 근거자료가 될 수 있음

### <mark style="color:orange;">귀 응급 상황 권장 대응 시점</mark>&#x20;

{% hint style="info" %}
아래 시간은 **절대적 cutoff가 아니라 권장 목표 시점**임. 이 시간을 넘겼다고 처치가 무의미해지는 것은 아니며, 핵심은 "가능한 한 지연 없이" 대응하는 것임.
{% endhint %}

<table><thead><tr><th width="174">상황</th><th width="140">권장 목표 시점</th><th width="166">지연 시 결과</th><th width="211">핵심 주의</th></tr></thead><tbody><tr><td><strong>원판(단추형) 배터리</strong></td><td><strong>가능한 한 즉시</strong> (목표 2시간 이내)</td><td>액화 괴사·조직 천공</td><td>절대 세척 금지, 즉시 응급실</td></tr><tr><td><strong>이개혈종</strong></td><td><strong>가능한 조기</strong> (수 시간\~수일; fluctuant하면 최대 7일까지 배액 고려)</td><td>연골 섬유화 → cauliflower ear</td><td>흡인 후 반드시 압박 고정</td></tr><tr><td><strong>폭발음·급성 음향 외상</strong></td><td><strong>가능한 조기</strong> (이상적으로 24\~48시간 이내; 근거 수준 제한적)</td><td>청력 회복 가능성 저하</td><td>소음 환경 즉시 이탈</td></tr><tr><td><strong>외상성 고막 천공</strong></td><td><strong>가능한 조기</strong> (건조 관리 즉시 시작)</td><td>2차 세균 감염·중이염</td><td>건조 유지, 귀 후비기 금지</td></tr></tbody></table>
...
| **Labyrinthine concussion** | 둔기 두부 외상, 폭행, 낙상                | dizziness + 불균형    | 있음 (SNHL 가능)      | 영상·이경 검사상 뚜렷한 구조 손상 없이도 발생 가능             | 즉시 의뢰      |
...
| **내이 감압병 (Inner-ear DCS)**  | 다이빙(특히 상승 중·직후)                 | vertigo + SNHL     | 있음                | 잠수 프로파일 이상(급상승·감압절차 미준수); PLF와 감별 어려움  | 즉시 의뢰(HBOT) |
...
* 단순 흡인만 시행하고 감염 징후가 없다면 항생제는 불필요
* 절개 배농을 시행한 경우, 최근 문헌(2025)에서는 7\~10일간의 예방적 경구 항생제 투여를 권장하는 추세임 - 성인은 연골막염의 주요 원인균인 Pseudomonas를 커버하는 fluoroquinolone(예: ciprofloxacin), 소아는 amoxicillin-clavulanate 등 피부 상재균 위주로 선택
* 기관·전문가에 따라 접근 차이가 있을 수 있으며, 연골 노출·면역저하 동반 시 더 적극적으로 고려 (☞ [외이염](047_-otitis-externa.md))

**흡인 vs 절개 배농**

* 발생 초기(대략 48시간 이내)이고 혈종이 작고 연성(fluctuant)이면 흡인(needle aspiration)을 시도할 수 있으나, 다음 중 하나라도 해당되면 절개 배농(incision and drainage)이 더 적절함
  * 응고되어 단단한 혈종, 혈종이 크거나(＞2 cm) 재발성, 발생 후 상당 기간(수일 이상) 경과
* 48시간이라는 숫자는 절대적 기준이 아님 - 여전히 fluctuant한 혈종은 발생 후 최대 7일까지도 배액을 시도해볼 수 있으나, 그 이후에는 조직화·육아조직 형성으로 흡인이 어려워지므로 이비인후과 의뢰를 고려함

***

### <mark style="color:red;">질병코드 - 이개혈종</mark>

H61.11 귓바퀴의 혈종

***

## <mark style="color:purple;">처방례 - 이개혈종</mark>

> **처방례 1. 절개 배농 후 예방적 항생제 (성인)**
>
> ```
> 시프로플록사신 500 ㎎/T   1T   bid   × 7일
> ```
>
> _✽연골막염의 주요 원인균인 Pseudomonas aeruginosa를 커버하기 위해 fluoroquinolone 계열 선택. 소아는 amoxicillin-clavulanate 등 피부 상재균 위주 항생제로 대체_

> **처방례 2. 연골막염 의심 (극심한 통증·발열·귀 전체 발적)**
>
> ```
> (즉시 이비인후과 의뢰 - 경구 fluoroquinolone 또는 IV 항생제 필요할 수 있음)
> ```
>
> _✽연골 괴사로 진행 시 영구적 변형 위험이 크므로 지체 없이 의뢰_

***

### <mark style="color:$success;">핵심 복약 지도 - 이개혈종</mark>

> **압박 고정(bolster) 관리 방법**
>
> * **처방된 기간(보통 7\~10일) 동안 압박 드레싱을 임의로 제거하지 마십시오.** 조기에 제거하면 재발률이 크게 높아집니다.
> * 드레싱이 흠뻑 젖거나 심한 통증·발열이 생기면 즉시 재내원하십시오.
> * 절개 배농 후 항생제를 처방받은 경우 처방 기간을 끝까지 복용하십시오.

> **스포츠 복귀 안내**
>
> * 압박 고정이 끝나고 완전히 회복된 후 복귀하십시오.
> * 재발 방지를 위해 복귀 시 귓바퀴 보호대(headgear) 착용을 권고합니다.

> **언제 다시 병원을 방문해야 하나요?**
>
> * 압박 고정 중 또는 제거 후 귀가 다시 부풀어 오르는 경우 (재발)
> * 극심한 통증, 발열, 귀 전체가 붉게 붓는 경우 (연골막염 의심) - 즉시 내원

***

### <mark style="color:blue;">환자 안내서 - 이개혈종</mark>

{% hint style="info" %}
**귀에 피가 고였어요 (이개혈종)**

권투·레슬링·유도 등 귀에 반복적인 충격이 가해지는 운동이나 외상 후, 귓바퀴 연골과 그 위를 덮은 막(연골막) 사이에 피가 고이는 상태입니다. 제때 치료하지 않으면 연골이 오그라들어 귀 모양이 영구적으로 변할 수 있습니다(일명 '만두귀', cauliflower ear).
{% endhint %}

#### <mark style="color:$primary;">치료는 어떻게 하나요?</mark>

* 병원에서 **주사기로 고인 피를 뽑아내거나(흡인) 절개하여 배출**시킵니다.
* 이후 **귀 모양을 만드는 압박 붕대(볼스터)**를 대고 봉합하여 7\~10일간 유지합니다. **이 압박이 재발을 막는 가장 중요한 과정입니다.**

#### <mark style="color:$primary;">치료 중 꼭 지켜야 할 것</mark>

* **압박 붕대를 스스로 풀거나 만지지 마십시오.**
* 다시 부풀어 오르거나 통증·발열이 심해지면 바로 병원에 오십시오.
* 같은 운동을 계속한다면 **귓바퀴 보호대(headgear)**를 착용하여 재발을 예방하십시오.

#### <mark style="color:$primary;">이럴 때는 즉시 병원을 방문하세요</mark>

* 치료 후 귀가 다시 부풀어 오를 때
* 귀 전체가 심하게 붓고 붉어지며 열이 날 때
* 참기 힘든 통증이 생길 때
...
* 4\~6주 후 고막 회복 확인 (1차 재평가)
* 2\~3개월이 지나도 회복되지 않으면 고막성형술 의뢰 고려
...
* 4\~6주 시점에 1차 재평가하고, 크기가 줄지 않거나 회복 소견이 없으면 계속 관찰하되 **2\~3개월이 지나도 자연 치유되지 않으면** 이비인후과에 의뢰하여 수술적 치료를 고려
...
* **코를 세게 풀거나 귀에 압력을 주는 행동(코 막고 힘주기 등)을 피하십시오.** 코가 막히면 한쪽씩 아주 약하게 푸십시오.
...
* 4\~6주 시점에 병원에서 회복 상태를 확인하며, 2\~3개월이 지나도 낫지 않으면 수술(고막성형술)로 복원할 수 있습니다.
...
* 다이빙 직후(특히 상승 중·직후) 발생한 청력 손실·어지럼은 barotrauma뿐 아니라 **내이 감압병(inner-ear decompression sickness)**도 감별해야 함 - 두 질환은 임상적으로 구분이 어려우며, 잠수 프로파일(깊이·시간·상승 속도, 감압 절차 준수 여부)을 함께 확인하고 고압산소치료가 가능한 기관으로 응급 의뢰
...
* 급성 음향 외상 : 발생 후 가능한 한 빨리(이상적으로 24\~48시간 이내) 고용량 steroid 투여 고려 - 조기에 시작할수록 유리하다는 관찰연구 근거가 있음
  * prednisolone 1 ㎎/㎏/d(최대 60 ㎎/d) × 7\~14d <mark style="color:blue;">\[소론도]</mark> → 이후 tapering
  * ✽급성 음향 외상에서 고용량 steroid는 널리 사용되나, 확립된 무작위대조군 연구 근거는 부족하며 대부분 후향적 관찰연구 수준임(완전 회복률 약 30% 내외로 보고). 72시간이 지나면 효과가 더 불확실해지는 것으로 알려져 있음
  ...
  * 반응이 불충분한 중증 환자에서는 상급기관에서 고압산소치료(HBOT) 병용을 스테로이드와 함께 고려하는 사례가 늘고 있으나(2024\~2025년 군진의학 자료), 국내 1차 진료에서 직접 시행할 치료는 아니므로 필요 시 상급병원 의뢰 시 언급
...
* 이어폰·헤드폰 : 최대 볼륨의 60% 이하, 60분 사용 후 휴식 (60-60 rule; 엄밀한 임상 근거보다는 널리 쓰이는 실용적 예방 팁)
...
소음 노출 후 생기는 이명은 **대부분 시간이 지나며 저절로 줄어드는 경우가 많습니다.** 귀의 신경 세포가 과도한 자극에서 회복되는 과정입니다. 단, 72시간이 지나도 지속되거나 청력 감소가 동반된다면 반드시 진료를 받으십시오.
{% endhint %}
