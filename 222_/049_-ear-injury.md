...
* 단순 흡인만으로는 재발률이 매우 높음. 흡인 후 반드시 bolster 드레싱 또는 관통 봉합으로 연골-연골막을 밀착시켜 dead space를 제거하는 것이 cauliflower ear 예방의 핵심임
...
3. 압박 유지 : 최소 7일간 유지 — 압박 불충분 시 재발률 매우 높음
...
* **원판(단추형) 배터리**
  * 전기분해로 강알칼리성 물질이 누출되어 수 시간 내 심각한 액화 괴사·천공 발생 가능
  * 절대 세척(irrigation) 금지 - 습기가 닿으면 전기 화학 반응이 가속화됨
  * 증상이 없어도 즉각 대응 - 관찰·대기 금지
  * 발견 즉시 응급실로 - 가급적 1시간 이내 제거
* **살아 있는 곤충** : 2% lidocaine 점이 또는 mineral oil로 마비·질식시킨 후 제거; 고막 천공 시 소독용 알코올 사용; lidocaine 점이는 mineral oil보다 빠르게 곤충을 마비시키고 통증 완화에도 효과적
...
* 고막 천공 시 점이용제 원칙
  ...
  * 반드시 fluoroquinolone 계열만 사용; fluoroquinolone은 이독성이 없으며 고막 천공 상태에서 FDA 승인을 받은 유일한 계열임
...
* 어리럼증, 난청이 동반되지 않는 압력 손상 시 진통제, Autoinflation, Decongestant 투여  → 수일 내 호전 여부 확인
* 어리럼증 또는 난청 동반 시 의뢰
