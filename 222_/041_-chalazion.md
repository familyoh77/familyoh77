...
* 기전 : meibomian 또는 Zeis gland의 지방 분해 산물 등에 의한 폐쇄 → lipid 축적 → 지질 분해 부산물 등에 의해 염증 유발(눈꺼풀 부종 및 홍반) → 섬유화; 수 주\~수개월에 걸쳐 성장
  * 감염 또한 chalazion으로 이어지는 폐색을 유발할 수 있음
* 호발 연령 : 30\~50세
* 경과 : 작은 병변은 자연 흡수되지만 지속되면 감염되고 통증이 발생할 수 있음; 불결한 위생과 관련하여 재발하거나 만성 경과를 보일 수 있음; 다래끼보다 더 오래 지속
