...
* 원 척도의 11개 만성질환은 고혈압, 당뇨병, 암(경미한 피부암 제외), 만성 폐질환, 심근경색, 울혈성 심부전, 협심증, 천식, 관절염, 뇌졸중, 신질환. 국내 타당화판(K-FRAIL 등)을 사용할 때는 해당 판본의 문항 표현과 질환 목록을 그대로 적용하며, 임의 번역 문항과 검증판 점수를 혼용하지 않음
* 선별 결과만으로 예후나 치료 제한을 결정하지 않고, 가역적 원인과 환자 목표를 평가
* 중재: 개인별 근력·유산소·균형 운동, 적절한 영양, 약물 최적화, 시력·청력 교정, 만성질환 관리와 사회적 지원

### <mark style="color:orange;">Clinical Frailty Scale(CFS)</mark>

* 병력·진찰과 기능상태를 종합해 1(매우 건강)에서 9(말기)까지 판정하는 임상 판단 기반 척도로, 예후 예측과 치료 부담 논의에 활용
* 급성질환·응급실·입원 상황에서는 급성질환 발생 약 2주 전의 기저상태를 기준으로 판정하며, 안정된 외래 환자에게 이 기준을 일률적으로 적용할 필요는 없음
* 공식 도표 또는 허가된 번역판을 사용
* CFS 점수만으로 치료 제한, 수술 배제 또는 연명의료 관련 결정을 하지 않으며, 예후·치료 부담 평가와 공동 의사결정을 보조하는 도구로 사용
...
### <mark style="color:orange;">4AT - 섬망 선별</mark>

* 각성도, AMT4(나이·생년월일·장소·연도), 주의력(월 역순 말하기), 급성 변화 또는 변동성의 4개 항목으로 약 2분 내 시행하며 별도 인증교육이 필요하지 않음
* ≥4점: 섬망 가능성 - 약물, 감염, 통증, 저산소증, 대사 이상 등 원인평가 시행
* 1～3점: 인지저하 가능성 - 추가 평가
* 0점: 섬망이나 인지저하 가능성이 낮으나 완전히 배제하지는 못함
* 선별검사이며 확진검사가 아님. 공식 한국어판을 사용
...
* 기립혈압은 최소 5분간 누워 안정한 후 일어서서 1분과 3분에 측정. 기립 3분 이내에 수축기혈압 ≥20 ㎜Hg 또는 이완기혈압 ≥10 ㎜Hg 하강하면 기립성저혈압으로 판정하며, 앙와위 고혈압이 있으면 수축기혈압 ≥30 ㎜Hg 하강 기준을 고려. 전형적 증상이 있으나 3분까지 정상이면 지연성 기립성저혈압을 고려
...
<table><thead><tr><th width="120">연령</th><th width="180">남성: 평균 미만</th><th>여성: 평균 미만</th></tr></thead><tbody><tr><td>60～64세</td><td>&#x3C;14회</td><td>&#x3C;12회</td></tr><tr><td>65～69세</td><td>&#x3C;12회</td><td>&#x3C;11회</td></tr><tr><td>70～74세</td><td>&#x3C;12회</td><td>&#x3C;10회</td></tr><tr><td>75～79세</td><td>&#x3C;11회</td><td>&#x3C;10회</td></tr><tr><td>80～84세</td><td>&#x3C;10회</td><td>&#x3C;9회</td></tr><tr><td>85～89세</td><td>&#x3C;8회</td><td>&#x3C;8회</td></tr><tr><td>90～94세</td><td>&#x3C;7회</td><td>&#x3C;4회</td></tr></tbody></table>
...
* 비타민 D는 결핍 또는 별도 적응증이 있을 때 보충하며, 낙상 예방만을 목적으로 모든 고령자에게 일률적으로 투여하지 않음
...
{% hint style="info" %}
**국내 고령 운전자 면허 관리 제도**\
만 75세 이상은 운전면허 갱신 주기가 3년이며 인지선별검사 등의 절차와 고령운전자 교통안전교육을 이수해야 합니다. 제2종 면허 소지자도 갱신기간에 70세 이상이면 정기 적성검사 대상입니다. 구체적인 검사·서류 절차는 한국도로교통공단의 최신 안내를 확인합니다. 야간·고속도로 운전 제한 등은 환자와 합의하는 자율적 위험감소 방안이며, 현행 제도상 법적으로 부과되는 조건부 면허가 아닙니다.
{% endhint %}
...
<p align="center"><em><mark style="color:$info;">저자 재구성. Ref. American Geriatrics Society and National Highway Traffic Safety Administration. Clinician's Guide to Assessing and Counseling Older Drivers, 4th ed. 2019; 국내 도로교통 관련 제도</mark></em></p>
...
* 최신 AWGS 2025는 생애 전반의 근육건강 개념을 강조하며 진단체계를 다음과 같이 개편
  ...
  * ‘중증 근감소증’ 분류는 삭제되었으나, ‘possible sarcopenia’는 자원이 제한된 지역사회 환경에서 조기 중재를 시작하기 위한 범주로 유지
  * 판정 범주: 선별 양성이나 악력이 정상이면 근감소증 위험(at risk), 악력 저하가 있으나 근육량을 측정하지 않았거나 근육량 감소가 확인되지 않으면 possible sarcopenia, 악력 저하와 근육량 감소가 모두 있으면 근감소증 확진
...
<table><thead><tr><th width="150">확진 지표</th><th width="120">50～64세 남</th><th width="120">50～64세 여</th><th width="120">65세 이상 남</th><th>65세 이상 여</th></tr></thead><tbody><tr><td>악력</td><td>&#x3C;34 kg</td><td>&#x3C;20 kg</td><td>&#x3C;28 kg</td><td>&#x3C;18 kg</td></tr><tr><td>DXA ASM/신장²</td><td>&#x3C;7.2 kg/m²</td><td>&#x3C;5.5 kg/m²</td><td>&#x3C;7.0 kg/m²</td><td>&#x3C;5.4 kg/m²</td></tr><tr><td>BIA ASM/신장²</td><td>&#x3C;7.6 kg/m²</td><td>&#x3C;5.7 kg/m²</td><td>&#x3C;7.0 kg/m²</td><td>&#x3C;5.7 kg/m²</td></tr><tr><td>DXA ASM/BMI</td><td>&#x3C;0.80</td><td>&#x3C;0.55</td><td>&#x3C;0.73</td><td>&#x3C;0.52</td></tr><tr><td>BIA ASM/BMI</td><td>&#x3C;0.90</td><td>&#x3C;0.63</td><td>&#x3C;0.83</td><td>&#x3C;0.57</td></tr></tbody></table>
...
* 근감소증 위험(at risk)으로 분류된 경우 연 1회 악력을 재평가하고, 악력이 저하되거나 임상적 적응증이 생기면 확진평가를 다시 시행
* 대상자와 무관하게, 주요 입원이나 새 질환처럼 근육소모가 빨라질 수 있는 사건 후에는 다시 평가
...
* 사용 언어와 대상군에서 타당화된 판본을 선택하고 해당 판본의 문항 표현을 그대로 적용
...
{% hint style="danger" %}
⚠️ **의료인은 노인복지법 제39조의6에 따른 신고의무자입니다.** 직무상 노인학대를 알게 되거나 의심할 상당한 이유가 있으면 신고해야 합니다.

* 노인학대 신고·상담: **1577-1389**(중앙노인보호전문기관)
* 현재 신체적 위험 또는 범죄가 진행 중인 경우: **112**
{% endhint %}

{% hint style="info" %}
**돌봄 자원 연계 실무**

* 노인장기요양보험: 국민건강보험공단에 인정신청 후, 공단 요청에 따라 의사소견서를 발급
* 치매안심센터: 인지선별검사, 등록·관리, 돌봄자 교육과 쉼터
* 노인맞춤돌봄서비스: 안전확인, 생활교육, 일상생활 지원
* 지역 보건소, 노인복지관, 재가돌봄 자원
{% endhint %}
...
* 중대한 질환이나 허약이 진행하면 대리결정자, 선호하는 돌봄 장소, 연명의료 관련 의사를 미리 논의. 사전연명의료의향서는 19세 이상 성인이 지정 등록기관에서 본인이 작성하고, 연명의료계획서는 말기환자 또는 임종과정에 있는 환자의 의사에 따라 담당의사가 작성함
...
> ```
>
> _✽위 내용은 고정 처방이 아닌 감량 예시이다. 제형과 사용 가능한 함량, 복용기간, 원래 적응증, 금단 위험과 환자 반응에 따라 감량 폭·간격을 조정한다. 2025년 미국 다학회 공동지침(Joint Clinical Practice Guideline on Benzodiazepine Tapering)은 초기 감량 속도를 1일 용량의 5～10%/2～4주로 권고하며, 통상 2주당 25%를 넘지 않도록 한다. 저용량을 3개월 미만 사용한 환자는 더 빠르게 감량할 수 있다. 감량의 목표가 반드시 완전 중단일 필요는 없으며, 위해가 이득을 넘지 않는 용량까지 줄이는 것도 목표가 될 수 있다. 65세 이상에서는 지속해야 할 설득력 있는 이유가 없다면 일반적으로 감량을 고려하되, 개인별 이득·위험 평가는 유지한다. 강제 감량은 권장하지 않으며 환자·돌봄자와 목표와 속도를 공동 결정한다._
