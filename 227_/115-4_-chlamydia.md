...
{% hint style="info" %}
**Doxy-PEP(노출 후 예방요법)** — 세균성 STI(매독·클라미디아·임질) 공통 예방 전략으로, 클라미디아 감염 감소 효과가 가장 크게 보고됨 (☞ [성매개질환 총론](115-1_-STD.md)) 참조
{% endhint %}
...
> ```
>
> _✽ 체중 ≥150 ㎏이면 용량이 달라짐 (☞ [임질](115-2_-gonorrhea.md) 챕터 참조); 임질과 클라미디아 공동감염이 흔해 동시 치료 원칙_
