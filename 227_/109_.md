...
* 무뇨(anuria, ＜100 ㎖/day) 또는 급격한 Cr 상승(48시간 내 ≥0.3 ㎎/㎗ 상승 또는 7일 내 기저치 대비 ≥1.5배) → 급성콩팥손상(AKI)
...
* 신규 발견된 고도 증가 알부민뇨(A3, uACR ＞300 ㎎/g)
...
* 중등도 증가 알부민뇨(A2, uACR 30\~300 ㎎/g) 또는 eGFR 60\~89(G2)의 첫 발견
...
* [만성콩팥병](112_-chronic-kidney-disease-ckd.md)(CKD) : 콩팥의 구조 또는 기능 이상이 3개월 이상 지속되며 건강에 영향을 미치는 경우; eGFR과 uACR(urine Alb/Cr ratio) 두 축으로 병기 분류 (☞ [만성콩팥병](112_-chronic-kidney-disease-ckd.md#ckd-heat-map-g-a), [단백뇨](111_-proteinuria.md#undefined-1))
...
```mermaid
graph TD
    Start[AKI 의심: <br/>Cr 상승 또는 요량 감소] --> A[병력·약물·활력징후 확인]
    A --> B[방광스캔/콩팥초음파로<br/> 폐쇄 여부 확인]
    B -->|폐쇄 있음| Post[Postrenal AKI 수신증, <br/>전립선비대, 종양 등]
    B --->|폐쇄 없음| C[FeNa, 요침사, 병력 검토]
    C -->|저혈량·저혈압, 이뇨제/<br/>ACEi/ARB, FeNa 1% 미만, <br/>bland sediment| Pre[Prerenal AKI 탈수, <br/>심부전, 패혈증 등]
    C -->|erythrocyte cast, <br/>dysmorphic RBC, 단백뇨| Int1[Intrinsic AKI - <br/>사구체성 GN, 혈관염]
    C -->|granular <br/>muddy-brown cast| Int2[Intrinsic AKI - <br/>ATN 허혈, <br/>신독성 약물/조영제]
    C -->|eosinophiluria, <br/>발진, 약물력| Int3[Intrinsic AKI - <br/>AIN 약물 유발]
...
class Post,Pre,Int1,Int2,Int3 pink
```
...
* 대상 : 불확실한 진단, 비전형적 증상, complicated UTI 의심, 신우신염 의심, 임신, 남성, 초치료 실패, 재발, 항생제 내성균 의심, 도뇨관 유치, 증상이 있는 ＞65세에서 항생제 투여 결정 시(IDSA - 연령 자체가 아닌 증상 유무가 배양 적응증의 핵심)
  * 항생제 내성 위험군 : 비뇨생식기 이상, 콩팥 손상, 최근 6개월 동안 ＞7일 입원, 최근 내성 지역 여행, 이전 UTI 내성
...
* 요 시험지봉 단백 검사는 미세알부민뇨(중등도 증가 알부민뇨로 용어 변경 ☞ [단백뇨](111_-proteinuria.md#undefined-1)) 단계를 놓칠 수 있어, 당뇨병·고혈압 등 CKD 고위험군 선별에는 uACR을 우선 시행
...
<table data-search="false"><thead><tr><th width="335.2381591796875">현미경적 소견</th><th>관련 질환</th></tr></thead><tbody><tr><td>fatty cast</td><td>단백뇨(＞3.5 g/d)</td></tr><tr><td>백혈구, leukocyte cast with bacteria</td><td>요로 감염</td></tr><tr><td>백혈구, leukocyte cast without bacteria</td><td>콩팥 조직 내 질환</td></tr><tr><td>normal-shaped(isomorphic) erythrocyte</td><td>비사구체성 혈뇨(non-glomerular bleeding)</td></tr><tr><td>dysmorphic erythrocyte</td><td>사구체성 혈뇨(glomerular bleeding)</td></tr><tr><td>erythrocyte cast</td><td>사구체 질환</td></tr><tr><td>waxy, granular or cellular cast</td><td>진행된 만성 콩팥 질환</td></tr><tr><td>eosinophiluria</td><td>약물 유발성 급성 콩팥 조직 내 질환 의심(Hansel stain으로 확인) - 단, 민감도·특이도가 낮아 참고 소견이며 진단적 가치는 제한적</td></tr><tr><td>hyaline cast</td><td>비-콩팥 질환 : 탈수, 이뇨제 원인 의심</td></tr></tbody></table>
...
{% hint style="info" %}
**약물 용량 조절 기준 :** FDA 2020년 개정 가이던스 이후, 대부분의 약물은 콩팥 기능 저하 시 용량 조절 기준으로 Cockcroft-Gault CrCl 대신 \*\*eGFR(CKD-EPI)\*\*을 사용하도록 권장됨. 다만 DOAC(예: dabigatran) 등 임상시험이 CrCl 기반으로 설계된 일부 약물은 여전히 Cockcroft-Gault 공식을 따라야 하며, 국내 실무에서는 HIRA 급여 기준·약제 첨부문서가 CrCl(Cockcroft-Gault)을 요구하는 경우가 있음(약제별 기준을 개별 확인 필요).
{% endhint %}
...
* eGFR = 142 × min(Scr/κ, 1)<sup>α</sup> × max(Scr/κ, 1)<sup>-1.200</sup> × 0.9938<sup>연령</sup> \[× 1.012 if female]
...
* eGFRcr-cys = 135 × min(Scr/κ, 1)<sup>α</sup> × max(Scr/κ, 1)<sup>-0.544</sup> × min(Scys/0.8, 1)<sup>-0.323</sup> × max(Scys/0.8, 1)<sup>-0.778</sup> × 0.9961<sup>연령</sup> \[× 0.963 if female]
...
{% hint style="info" %}
**MDRD**는 CKD-EPI 이전에 널리 쓰였던 공식으로, 현재는 CKD-EPI 2021이 1차 권장식으로 대체되었으며 MDRD는 참고 수준으로만 남아 있음.\
...
* 원인 불명의 급성콩팥손상(AKI) - 거의 항상 초음파 적응증
...
* 담당의사가 재검사나 추가 검사(소변 알부민 비율, 초음파 등)를 권할 수 있으며, **재검은 보통 3개월 간격**으로 시행하고, 그 이상 이상 소견이 지속되면 만성 콩팥병을 의심하게 됩니다.
