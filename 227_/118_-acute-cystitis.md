...
* 방광에 국한된 급성 하부요로감염
* 다른 이름 : 국소 요로감염(local UTI), lower UTI, simple/uncomplicated cystitis
* 정의 (질병관리청·대한항균요법학회, 요로감염 항생제 사용지침, 2025) : 배뇨통·빈뇨·절박뇨·치골상부 압통·육안적 혈뇨 등 방광에 국한된 급성 요로 증상이 있으면서 농뇨(≥10 백혈구/HPF) 또는 세균뇨(≥10⁵ CFU/mL)가 확인될 때 진단
  * ✽전형적인 배뇨통·빈뇨를 보이는 건강한 여성에서는 요검사 없이도 임상적으로 진단 가능하며, 요검사는 진단을 지지하는 소견으로 활용함(IDSA, EAU, NICE 공통 입장)
* 분류 : 기존에는 "단순(uncomplicated) vs 복잡(complicated)"을 여성·기저질환 유무로 구분했으나, 2025년 IDSA·EAU·국내 지침은 **"국소 요로감염(방광 국한) vs 전신 요로감염(방광을 넘어 진행, 발열 등 전신 증상 동반)"**으로 재분류함
  * **당뇨병, 면역저하, 남성이라는 사실 자체는 더 이상 자동으로 "복잡성" 요인이 아니며, 전신 증상 유무가 분류의 핵심 기준임**(IDSA 2025)
  * 다만 본 챕터는 일차 진료에서 흔히 접하는 여성의 국소 요로감염을 중심으로 서술하며, 남성·임신부·전신 요로감염(신우신염)은 별도 고려가 필요(☞ [요로 감염](113_-urinary-tract-infection.md#undefined-13))
* 전염 경로 : 회음부·요도·항문으로부터의 상행 감염
* 합병증 : 신우신염(전신 요로감염)으로의 진행
  * ✽과거 국내 자료에서 "방광염의 30%가 신우신염으로 진행"으로 기술되어 왔으나, 최근 대규모 코호트·메타분석에서는 항생제 치료 시 진행률이 **1% 내외(0.5~2%)**로 보고됨; 무치료 시에도 진행률은 낮은 편(2% 내외)이나 증상 지속 기간이 길어짐
...
{% hint style="info" %}
**국내 원인균 항생제 감수성 (대한요로생식기감염학회, 2023년 전국 감시자료; Yu SH, et al. Investig Clin Urol 2025)**\
국소 요로감염에서 분리된 E. coli의 항생제 감수성 : nitrofurantoin 98.9%, fosfomycin 96.8%, cefotaxime 82.4%, ciprofloxacin 50.9%, TMP-SMX 68.1%\
✽ciprofloxacin·TMP-SMX 내성률이 국내에서도 30% 내외로 높아, 경험적 1차 약제로는 권장되지 않음
{% endhint %}
...
* 발열·오한과 함께 빈맥, 저혈압, 의식 변화 등 패혈증/패혈성 쇼크 의심 소견 → 전신 요로감염(신우신염)·요로패혈증 의심, 즉시 응급 평가
* 급성 요폐(urinary retention), 특히 남성 → 폐쇄성 원인 감별 위해 즉시 의뢰
* 임신부에서 발열 동반 방광염 증상 → 신우신염·조산 위험, 즉시 산과 의뢰

<mark style="color:$warning;">**당일 또는 조기 의뢰**</mark>

* 발열(≥38℃) 또는 옆구리 통증, 늑골척추각 압통 동반 → 신우신염 의심, 당일 평가·요배양·필요시 영상 검사
* 남성에서 방광염 유사 증상 + 골반/음경 통증, 배뇨 지연·점적(dribbling) → 세균성 전립선염 의심, 비뇨의학과 의뢰
* 당뇨병·면역저하 환자에서 치료 24~48시간 내 반응이 지연되는 경우 → 조기 재평가
* 임신부의 세균뇨(유증상/무증상) 확인 → 산과 협진하여 치료

<mark style="color:$info;">**외래 추적 / 추가 평가 계획**</mark> <mark style="color:$info;">- 즉각 위험 낮으나 호전 없으면 의뢰</mark>

* 1차 경험적 항생제 치료 48~72시간 후에도 증상 호전 없음 → 요배양·감수성 재확인 후 항생제 조정
* 최근 6개월 내 2회 이상 또는 최근 12개월 내 3회 이상 재발 → 재발성 방광염 평가(비뇨의학과 의뢰 고려)
* 폐경 후 여성의 반복 감염 → 질 에스트로겐 등 예방 전략 고려
* 고령자의 섬망·기능 저하만으로는 UTI로 단정하여 항생제를 시작하지 말 것 → 국소 요로 증상이나 전신 감염 소견 동반 여부 재확인 후 결정(☞ 임상 양상 참조)
...
* 배양 검사 : 전형적인 국소 요로감염에서는 일반적으로 불필요
  ...
  * 진단 기준 : ≥10⁵ CFU/mL(2025 국내 지침 기준)
    * ✽과거 Kass 기준(≥10⁵ CFU/mL)은 무증상 세균뇨 진단 기준에서 유래하였으며, 증상이 있는 여성에서는 ≥10³ CFU/mL도 임상적으로 의미 있다고 간주됨(IDSA); 다만 **국내 2025 지침의 공식 진단 기준은 여전히 ≥10⁵ CFU/mL**이므로 처방·기록 시 이를 기준으로 함
...
{% hint style="info" %}
**5단계 경험적 항생제 선택 접근법 (질병관리청 요로감염 항생제 사용지침, 2025)**\
0단계 증상에 따른 질환 분류(국소 vs 전신) → 1단계 중증도(패혈증 여부) 평가 → 2단계 내성균 위험 인자 평가(최근 6개월 내 항생제/입원력, 요양시설 거주, ESBL 분리력 등) → 3단계 환자별 고려사항(알레르기, 신기능, 약물 상호작용) → 4단계(패혈증 시) 기관 항생제 감수성 결과 활용
{% endhint %}

### <mark style="color:orange;">치료 방침</mark>

* 국소 요로감염은 **기저질환 유무와 관계없이 동일한 1차 경험적 항생제**(nitrofurantoin 또는 fosfomycin)를 사용(2025 국내 지침)
* ciprofloxacin 등 fluoroquinolone은 부작용(건염·건파열, QT 연장, 저혈당 등)과 내성 문제로 1차 약제에서 제외되었으며, 국내 급여기준상으로도 1차 약제 치료 실패 시에만 사용 가능
...
* 수분 섭취 권장(과도한 강제 이뇨는 근거 부족)
  * ✽평소 수분 섭취가 하루 1.5L 미만인 폐경 전 여성에서 하루 1.5L를 추가 섭취하면 재발이 48% 감소한다는 RCT 근거가 있음(Hooton, et al. JAMA Intern Med 2018)
...
### <mark style="color:orange;">재발성 방광염(6개월 내 ≥2회 또는 12개월 내 ≥3회) 예방 — AUA/CUA/SUFU 2025 개정 지침</mark>
...
* Methenamine hippurate <mark style="color:blue;">\[유로렉스]</mark> : 항생제 예방요법 대비 비열등 근거(예 : ALTAR trial)가 있어 대안으로 고려 가능; 1,000 mg bid; 국내 급여 기준은 별도 확인 필요
...
<table><thead><tr><th width="70">구분</th><th width="180">성분명 [상품명]</th><th width="160">용법</th><th>최소 투여 기간·비고</th></tr></thead><tbody><tr><td>1차</td><td>nitrofurantoin [니트로푸란토인]</td><td>50~100 mg qid† (식후·취침 전)</td><td>5일; CrCl &lt;30 금기, 임신 38주 이후 금기, 신우신염엔 부적절</td></tr><tr><td>1차</td><td>fosfomycin [모노롤]</td><td>3 g 1회(공복 또는 취침 전)</td><td>1일; 대부분의 신기능에서 용량 조절 없이 사용 가능(중증 신부전 자료는 제한적), 신우신염엔 부적절</td></tr><tr><td>대안</td><td>TMP/SMX [셉트린]</td><td>160/800 mg bid</td><td>3일; 국내 내성률 약 30%로 가능하면 배양 확인 후 사용; CrCl &lt;30은 국내 지침상 사용 금기(해외 일부 자료는 중증 신부전에서 감량 사용을 언급하나, 국내 기준으로는 회피 권장)</td></tr><tr><td>대안</td><td>ciprofloxacin* [씨프로바이]</td><td>250~500 mg bid</td><td>3일; 1차 약제 치료 실패·알레르기 시에만(국내 급여기준상 1차 약제 사용 불가)</td></tr></tbody></table>

_†국내에는 macrocrystal/monohydrate 서방형 제형이 유통되지 않아, 국제 지침의 100 mg bid×5일 대신 국내 허가 제형(immediate-release) 기준 50~100 mg qid×5일을 사용함; 1일 4회 복용은 순응도 저하의 흔한 원인이므로, 순응도가 우려되는 환자에서는 fosfomycin 단회 요법을 우선 고려할 수 있음_

_\*FDA는 다른 치료 선택지가 있는 경우 uncomplicated infection에서 fluoroquinolone 사용 제한을 권고함(건염·건파열, 대동맥류/박리 위험, QT 연장, 저혈당, 말초신경병증 등)_
...
{% hint style="danger" %}
**⚠️ pivmecillinam은 국내 미허가 약물임(2026년 기준)**\
국제 지침에서 1차 약제로 언급되나 국내에는 의약품으로 유통되지 않아 처방 불가
{% endhint %}

### <mark style="color:orange;">기타</mark>

* 항진균제 : 칸디다 감염 시
  * fluconazole : 200 ㎎/d ×2주 <mark style="color:blue;">\[푸루나졸]</mark> (☞ p.931)
* 진경제 (☞ p.371)
