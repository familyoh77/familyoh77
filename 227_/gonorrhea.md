...
```mermaid
graph TD
    A([요도/자궁경부/인두/직장 증상 또는 고위험 노출]) --> B[검체 채취: NAAT 1차 ± 배양]
    B --> C{임균 양성?}
    C -- No --> D[다른 원인 감별]
    C -- Yes --> E{합병증 징후?<br>DGI/PID/부고환염 등}
    E -- No --> F[ceftriaxone 500 ㎎ 단회 IM/IV]
    E -- Yes --> G[입원, 전문과 협진, 정맥 항생제]
    F --> H{클라미디아 배제됨?}
    H -- No --> I[+ doxycycline 100 ㎎ bid ×7일]
    H -- Yes --> J[치료 종료 안내 및 파트너 치료]
    I --> J
...
{% hint style="info" %}
**Doxy-PEP(노출 후 예방요법)** — 세균성 STI(매독·클라미디아·임질) 공통 예방 전략으로 (☞ [성매개질환 총론](/broken/pages/b8f8ecfadcc9bc4ff57032c41289d8b3fe2e36c0)) 참조
{% endhint %}
...
* Chlamydia 및 Gonorrhea 감염에 대하여 치료 (☞ [급성 부고환염](/broken/pages/436a76c7dbdd8a8027f2e1e4ef3255369ed182ae))
