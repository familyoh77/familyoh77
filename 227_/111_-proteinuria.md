...
| **구분**             | **uACR (㎎/g)** | **uPCR (㎎/g)** | **요 시험지봉 검사** |
| ------------------ | -------------- | -------------- | ------------- |
| **정상\~경도 증가 (A1)** | <30            | <150           | \~±(trace)    |
| **중등도 증가 (A2)**    | 30\~300        | 150\~500       | ±\~1+         |
| **고도 증가 (A3)**     | >300           | >500           | >1+           |
...
<p align="center"><em><mark style="color:$info;">Ref. Ref. 대한의학회, 일차의료용 근거기반 만성콩팥병 임상진료지침, 2022, 표 2; KDIGO 2012 CKD Guideline, Chapter 1, Table 7(PCR·요 시험지봉 환산 기준, 2024 개정판에서도 유지)</mark></em></p>
...
* 시험지봉 검사 1+ 이상 : 첫아침 소변으로 uPCR(또는 uACR)과 요검사를 함께 시행
  * uPCR ≤200 ㎎/g(필요 시 uACR <30 uACR ＜30 ㎎/g 참고)이고 요검사 정상이면 일과성 또는 기립성 단백뇨 가능성이 높으므로 1년 후 재검 고려
...
* 발열·복통을 동반한 신증후군 환자 → 자발성 세균성 복막염 유사 감염

<mark style="color:$warning;">**당일 또는 조기 의뢰**</mark>

* 신증후군 3주징의 신규 발생
* 단백뇨와 혈뇨가 함께 확인되는 경우(uACR ≥300 ㎎/g 또는 단백뇨 ≥0.3 g/d 상당의 유의한 단백뇨 + 혈뇨 - 사구체 질환 강력 의심)
* 임신부에서 신규 단백뇨 발생, 특히 고혈압 동반 시 → 전자간증
* eGFR의 급격한 저하(CrCl 감소)를 동반한 유증상 단백뇨
...
graph TD
    ...
    Ortho -->|음성| Isolated
    Isolated --> Follow6mo[혈압 측정, 요검사, 콩팥 기능검사; 매 6개월]
