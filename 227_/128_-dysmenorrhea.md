...
* 골반통 + 자궁경부 운동통/자궁 압통/부속기 압통 ± 발열·비정상 질분비물 → PID 의심; 임상적으로 의심되면 치료를 지연하지 않음(당일 평가·치료 ± 중증도에 따라 부인과 의뢰)
* 초경 직후부터 시작된 심한 주기적 통증, 특히 원발성 무월경 또는 월경혈 배출 장애가 동반되는 경우 → 폐쇄성 뮐러관 기형 감별
* 자궁 내 장치(IUD) 삽입 후 새로 발생한 심한 통증 → malposition/partial expulsion, perforation, PID 및 임신(특히 ectopic pregnancy) 감별
...
* 검사 항목 : 필요에 따라 임신 검사, STI 검사(임질, 클라미디아) 및 골반 초음파 시행. MRI는 심부 자궁내막증·선근증 또는 해부학적 이상 평가 등에 선택적으로 사용. 영상검사가 음성이어도 표재성 자궁내막증은 배제되지 않음. SOGC 2025에서는 laparoscopy를 여전히 진단의 gold standard로 기술하지만, ESHRE 2022 등 최근 지침에서는 임상 증상과 영상검사에 기반한 추정 진단 및 경험적 치료를 허용하고 diagnostic laparoscopy를 일률적인 확진 절차로 요구하지 않음. 경험적 치료 실패, 진단 불확실 또는 수술적 치료가 필요한 경우 laparoscopy 고려
* STI 위험 요인이 있는 골반통은 PID·자궁경부염 등을 고려하여 STI 검사 및 골반 진찰 시행
...
* ibuprofen : 400 ㎎ q6\~8h <mark style="color:blue;">\[부루펜]</mark>
...
* <mark style="color:blue;">\[미레나]</mark> 자궁 내 장치 : levonorgestrel 52 ㎎ LNG-IUS(초기 방출속도 약 20 ㎍/24h) 자궁 내 삽입; 삽입 후 5년간 유효. 피임 목적 삽입은 비급여이나, 월경과다증으로 확진되거나 월경곤란증으로 생리주기당 1\~2일간 일상생활이 불가능한 경우 급여 인정(HIRA 고시 제2013-127호) — 급여 여부는 원발성/2차성 구분이 아니라 증상의 중증도 기준임에 유의
...
* omega-3 fatty acid, magnesium, vitamin B1, zinc 등은 일부 연구에서 효과가 보고되었으나 근거의 질과 일관성이 부족하여 일상적으로 권고하기 어려움
...
* 수술 여부 결정 전 2차성 원인 및 비부인과적 골반통 원인을 포함한 충분한 재평가 필요
