...
* 심한 증상, 치료에 반응하지 않음
* 신장 이상 동반(예: Cr↑)
* 전립선 암 의심 소견 : 배뇨 시 통증/작열감, 혈뇨, 사정 시 통증, 정액 감소, 혈성 정액, PSA↑

## 진단

#### 기본 평가

* 병력 청취 : 비뇨기계 수술력, 외상, 요로 감염, 혈뇨, 요도 협착, 요폐, 신경학적 질환, 당뇨병, 약물 복용 병력(α-교감 신경 작용제, 부교감 신경 억제제), 성 기능 장애, 전립선 질환 가족력
* 증상 평가 : 국제 전립선 증상 점수표(IPSS)
* 직장수지검사 : enlarged, firm, non-tender prostate
* U/A
* PSA(전립선 특이 항원) 검사 : BPH 환자의 30\~50%에서 상승; 3.2 ng/㎖ 이상 시 암에 대한 감별 고려; 직장수지검사, 경직장 초음파 검사, 또는 정액 사정 24시간 이내에는 PSA 검사는 피함
...
*   free PSA : 혈액 내에 다른 단백질과 결합되지 않은 PSA. PSA는 혈중에서 α1-antichimotrypsin이나 α2-marcroglobulin등과 결합되어 존재하며, 30% 가량은 free form으로 존재; 정상 DRE & 총 PSA가 상승(4\~10 ng/㎖)되어 있는 경우의 암 위험도 추정 및 치료 반응, 재발 모니터링에 유용 에 유용; total PSA 4\~10 ng/㎖인 경우 free PSA＞ 25% 시 암 위험 8%,
...
지난 한 달 동안에 대하여 다음을 평가\
•배점 : ①\~⑥에 대하여 5번의 배뇨 중 없다=0점, 1번=1점, ＜절반=2점, 절반=3점, ＞절반=4점, 거의 항상=5점; ⑦에 대하여 없다=0점, 1번=1점, 2번=2점, 3번=3점, 4번=4점, 5번 이상=5점
...
아무 문제없다, 괜찮다, 대체로 만족한다, 반반이다, 대체로 괴롭다, 견딜 수 없다.
...
<figure><img src="../.gitbook/assets/BPH1.png" alt=""><figcaption><p>BPH1.png</p></figcaption></figure>
...
| **선택성**       | **성분명 \[상품명]**       | **용법**                       |
| ------------- | -------------------- | ---------------------------- |
| Non-selective | doxazosin \[카두라 엑스엘] | 1\~8 mg qd                   |
| Non-selective | terazosin \[하이트린]    | 1\~10 mg qd                  |
| Non-selective | alfuzosin \[자트랄]     | 10 mg qd                     |
| Selective     | tamsulosin \[하루날 디]  | 0.4\~0.8 mg qd (보험기준 0.2 mg) |
| Selective     | silodosin \[트루패스]    | 8 mg qd                      |
| Selective     | naftopidil \[플리바스]   | 25\~75 mg qd                 |

* 기전 : 하부 요로 평활근의 α1-adrenergic receptor 차단 → 방광 경부 및 전립선 평활근 이완(방광 출구 이완), 요속 개선; 전립선의 크기에는 영향 없음
...
\[보험기준] ①IPSS 점수 ≥8점 & ②초음파검사상 전립선 크기 ≥30 ㎖ or 직장수지검사상 중등증 이상의 BPH 소견 or PSA ≥1.4 ng/㎖; 약제 투여 중 1회/12개월 이상 PSA 검사
...
<figure><img src="../.gitbook/assets/BPH2.png" alt=""><figcaption><p>BPH2.pnd</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/BPH3.png" alt=""><figcaption><p>BPH3.pnd</p></figcaption></figure>
