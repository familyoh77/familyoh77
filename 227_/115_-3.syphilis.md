...
* 정의 (CDC STI Treatment Guidelines, 2021) : _Treponema pallidum_ 감염에 의한 만성 전신성 성매개질환
* 다른 이름 : lues
...
과거 azithromycin 2 g 단회 요법이 대체제로 쓰인 적이 있으나 현재는 권장되지 않음. _T. pallidu&#x6D;_&#xC758; macrolide 내성이 광범위하게 보고되어 CDC 2021 지침은 다른 대체제(doxycycline, ceftriaxone)를 모두 사용할 수 없는 극히 예외적 상황에서만 고려하도록 제한함. 사용 시 밀착 혈청 추적이 필수.
{% endhint %}
...
{% hint style="info" %}
**Doxy-PEP(노출 후 예방요법)** - 세균성 STI(매독·클라미디아·임질) 공통 예방 전략으로, 매독에서도 유의한 감염 감소 효과가 보고됨 (☞ [성매개질환 총론](115_-1.STI.md)) 참조
{% endhint %}
