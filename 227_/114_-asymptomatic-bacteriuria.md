...
* 소변에 염증세포(WBC) 및 inflammatory cytokine이 존재할 수 있으나 이는 진단 기준이 아니며, 증상 유무만으로 요로감염과 구분함
* 농뇨(pyuria)가 동반되더라도 증상이 없으면 항균제 치료의 적응증이 아님\[IDSA 2019]
...
* fosfomycin 3 g ×1회 — ESBL 생성균 등 다제내성 Enterobacterales에서 고려; **임신 중 안전성 자료가 제한적이므로 1차 선택제가 아닌 대안으로만 사용** <mark style="color:blue;">\[모누롤]</mark>
