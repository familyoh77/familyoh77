...
```mermaid
graph TD
    A([자궁경부염 의심<br/>점액농성 분비물·접촉출혈·골반통]) --> B{발열·심한 하복통·<br/>부속기 압통?}
    B -->|Yes| C[PID 의심<br/>☞ 골반염 챕터로 이동]
    B -->|No| D[NAAT: Chlamydia/Gonorrhea/Trichomonas<br/>+ HIV·매독 검사]
    D --> I{경험적 치료가 필요한가?<br/>추적관찰 불확실 / NAAT 불가 / 고위험}
    I -->|아니오, 저위험+추적가능| J[NAAT 결과 확인 후 치료]
    I -->|예| E{임균 감염 위험 높음?<br/>임균 파트너·최근 노출·지역 고유병률}
    E -->|Yes| F[ceftriaxone 500 mg IM 1회<br/>+ doxycycline 100 mg bid ×7d]
    E -->|No| G[doxycycline 100 mg bid ×7d<br/>단독 치료]
    F --> H[3개월 후 재검<br/>성 파트너 평가 및 치료]
    G --> H
    J --> H
