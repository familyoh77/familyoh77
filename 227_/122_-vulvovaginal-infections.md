...
graph TD
    ...
    Candidapath --> Candidatx["칸디다증 치료<br>(azole계)"]
    TVpath --> TVtx["트리코모나스 치료<br>+ 성 파트너 동반 치료"]
    Atrophypath --> Atrophytx["국소 estrogen 치료"]
    style RedFlag fill:#fff9c4,stroke:#ffe082
    style Exam fill:#fff9c4,stroke:#ffe082
    style pH fill:#fff9c4,stroke:#ffe082
    style Start fill:#eeeeee,stroke:#888888,stroke-width:2px
    style RF_pos fill:#f96,stroke:#e65100,stroke-width:2px
```
