...
![image](images/c5d4a464-5bca-4545-aedf-922f1ff26282.JPG)
...
#### 혈당 검사 유의 사항 ![image](images/a5e7f150-f890-4355-a19c-24ef8dc6eb40.png)
...
- A1C false variation : 수혈, Hb variants, Vit C 복용
    ...
    ![image](images/e113174d-e0a9-4875-900d-d1bd3684976d.png)
...
- ‘하나의 당뇨병 선별검사 결과가 당뇨병전단계에 해당하는 
성인이 당뇨병이 의심되는 경우 다른 방법의 선별검사’로 추가검사를 시행
...
- ‘모든 T2DM 성인에게 대사이상지방간질환의 평가를 권고’, ‘대사이상지방간질환을 평가하기 위한 일차 선별검사로 ALT
    ...
    ![image](images/3ffc3ed7-d642-4603-a523-832491c850c8.png)

    ![image](images/28ac7eee-c0dc-4ddc-91b0-2ea82e28fd59.png)
...
- 낮은 당지수(glycemic index) 및 당부하지수(glycemic load) 식품 권고
    ...
    ![image](images/47eb31aa-bf9c-4ebd-8d44-402395104faa.JPG)
...
- 측정 시간 : 식사 전후, 취침 전, 새벽, 운동 전후, 저혈당 의심, 위험한 일 수행 전, 기타 필요시
  ...
  • ‘공복 시’, ‘저혈당이 의심될 때, 저혈당
에서 정상혈당으로 회복될 때까지, 고혈당이 의심될 때’에도 측정 
...
※ 인슐린 치료를 하는 T2DM 성인 환자에서 실시간연속혈당측정장치 사용은 다음 두 가지 경우로 구분하여 권고함.
  ...
  ① 다회
인슐린 주사 또는 인슐린 펌프를 사용하는 T2DM 환자는 실시간연속혈당측정장치를 상시적으로 사용하도록 권고 [일반적권고]

  ②기저 인슐린 치료를 
하는T2DM 환자는 실시간연속혈당측정장치를 상시적으로 사용하도록 권고[제한적권고]
...
![image](images/2b9b6bce-6c8f-4be3-8ac8-b90c1ad987fd.png)

![image](images/41a6ba90-fa69-43ef-9a23-2a68e7697c25.png)
...
- 영양 상태 평가
  ...
  •Short nutritional assessment questionnaire (SNAQ) : 입원 환자 대상
    ...
    ![image](images/022b79b3-0e77-467d-ae2a-e3438a778d8d.JPG)
...
※ GDM 환자가 출산 후 상담 및 T2DM 예방 관리를 받는다면 1단계 접근법이 비용 효율적임 [ADA]
  ...
  ![image](images/fb14ec3f-9304-488d-ad5a-a03f983d899b.png)
