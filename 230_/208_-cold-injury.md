# 국소 냉손상 Local Cold Injuries

이 챕터는 국소 냉손상 중 **동결성 냉손상인 동상(frostbite)**, 습하고 얼지 않는 저온에 장시간 노출되어 발생하는 **비동결성 냉손상(nonfreezing cold injury; NFCI, 침수족·참호족)**, 비동결성 염증성 병변인 **동창(pernio, chilblains)**을 다룬다. 중등도·중증 저체온증과 생명 위협 외상이 있으면 국소 병변보다 먼저 치료하고, 경증 저체온증은 전신 재가온과 국소 냉손상 처치를 동시에 시행할 수 있다.
...
```mermaid
flowchart LR
    ROOT["동상 의심"] --> SYS["중등도·중증 저체온증 또는<br/>생명 위협 외상?"]
    SYS -->|예| SYS_TX["전신 응급상태를<br/>우선 치료"]
...
1. 중등도·중증 저체온증과 생명 위협 외상을 먼저 치료한다. 경증 저체온증은 전신 재가온과 동상 처치를 동시에 시행할 수 있다.
...
### <mark style="color:orange;">입원·의뢰 원칙</mark>

* 표재성 동상은 관류와 감각이 회복되고 진행성 허혈·감염 소견이 없으면 외래 또는 단기 관찰 후 관리할 수 있다.
* 심재성 동상은 초기 입원 치료를 원칙으로 하며 tPA·iloprost·수술 또는 집중 창상관리가 가능한 전문센터와 즉시 협의한다.
* 현저한 부종은 구획증후군을 평가하고 입원 관찰한다. 거주지에서 상처관리·재평가를 받기 어렵거나 기저질환·동반손상이 있으면 입원 문턱을 낮춘다.
...
### <mark style="color:orange;">해동 후 수치료</mark>

* 전문적인 창상관리 단계에서는 표재 세균과 느슨한 괴사조직 제거를 위해 하루 1~2회 37~39℃ 수치료를 고려할 수 있다.
* 임상결과 개선을 입증한 시험은 없고 최적 온도·시간·기간도 확립되지 않았다. 이는 아직 얼어 있는 조직을 녹이는 초기 신속 재가온과 구분하며, 재관류 치료를 지연해서는 안 된다.

### <mark style="color:orange;">산소와 수액</mark>

* 정상 혈액량을 유지하되 과도한 수액을 일률적으로 투여하지 않는다. 의식이 명료하고 구토가 없으면 경구 수분을 우선할 수 있다.
* 저산소증이 없는 환자에게 산소를 일률적으로 투여하지 않는다. 산소포화도 &lt;88%, 고도 4,000 m 이상 또는 다른 독립적인 산소투여 적응증이 있을 때만 보조 산소를 고려한다.
...
* 보습제·연고·기름을 바르는 것은 동상 예방 효과가 입증되지 않았고 오히려 위험을 높일 가능성이 있으므로 방한 의복을 대신하여 사용하지 않는다.
...
* 감각저하가 지속되는 발은 반복 외상·궤양 위험이 있으므로 적절한 신발·깔창·보조기와 매일 피부 점검을 교육한다.
* 조기에 재활의학·수부외과·족부외과·통증의학 등 다학제 평가를 고려한다.

## ￭ 비동결성 냉손상 Nonfreezing Cold Injury

## <mark style="color:green;">일반 사항</mark>

* 비동결성 냉손상(NFCI)은 습하고 얼지 않는 저온에 손·발이 장시간 노출되어 발생하는 신경혈관 손상으로, 침수족(immersion foot)·참호족(trench foot)이 대표적이다.
* 흔히 15℃ 미만의 물이나 차갑고 습한 환경에 수시간~수일 노출된 뒤 발생한다. 동상과 달리 조직 내 얼음 결정은 형성되지 않는다.
* 동창처럼 단순한 염증성 피부병변이 아니며, 초기 피부 변화가 회복된 뒤에도 신경병성 통증·한랭과민·다한증이 장기간 지속될 수 있다.

## <mark style="color:green;">원인 및 위험 인자</mark>

* 젖은 양말·신발, 차갑고 습한 환경 또는 냉수에 장시간 노출
* 움직이지 않은 채 손·발을 아래로 내린 자세, 조이는 신발·의복에 의한 압박
* 부적절한 방한·건조 기회, 탈진·영양 부족, 저체온증
* 군인·등산객·야외근로자·수상활동자, 노숙인 또는 젖은 신발을 장시간 벗기 어려운 사람
* 이전 비동결성 냉손상 병력

## <mark style="color:green;">임상 양상</mark>

### <mark style="color:orange;">4단계 임상경과</mark>

<table><thead><tr><th width="150">단계</th><th>주요 소견</th></tr></thead><tbody><tr><td>1단계<br>저온 노출 중</td><td>30분 이상 지속되는 무감각, ‘나무토막 같은’ 느낌, 창백·백색, 서투른 동작·보행 또는 고유감각 저하; 후기에는 말초맥박이 감소할 수 있음</td></tr><tr><td>2단계<br>노출 종료·초기 재가온</td><td>얼룩진 창백·청색, 차갑고 무감각한 상태와 부종; 초기에는 맥박이 감소하나 이후 도약맥이 될 수 있고 모세혈관 재충만은 지연됨</td></tr><tr><td>3단계<br>충혈기</td><td>밝은 적색 부종, 심한 통증·통각과민, 도약맥과 모세혈관 재충만 지연; 수일~수주 지속하며 중증에서는 6~10주까지 지속 가능</td></tr><tr><td>4단계<br>후기</td><td>외관은 정상화될 수 있으나 한랭과민, 감각저하·신경병성 통증, 다한증, 복합부위통증증후군(CRPS) 등이 수개월~수년 지속 가능</td></tr></tbody></table>

* 압박받아 생존하지 못한 부위에는 수포·변색·괴사가 발생할 수 있으나, 합병증이 없는 NFCI 자체는 첫 2~3일 이후 계속 진행하는 질환이 아니다.
* 감각신경병증 때문에 작은 외상·궤양·감염을 알아차리지 못할 수 있다.

### <mark style="color:$danger;">🚩 Red Flags!</mark>

<mark style="color:$danger;">**즉각 조치 또는 응급실 이송**</mark>

* 중등도·중증 저체온증, 의식저하, 호흡·순환 불안정 또는 중증 외상
* 긴장된 구획, 심한 통증 또는 수동 신전 시 통증, 진행하는 감각·운동장애 등 구획증후군 의심
* 맥박 소실, 급격한 허혈·괴사 또는 감염된 조직과 함께 패혈증이 의심되는 경우

<mark style="color:$warning;">**당일 응급실·외과 평가**</mark>

* 압박 부위의 수포·검은 변색·조직괴사, 심한 부종 또는 조절되지 않는 통증
* 첫 2~3일이 지난 뒤에도 증상이 악화하거나, 한쪽에 국한된 홍반·열감·농성 분비물 등 감염이 의심되는 경우
* 부은 발로 보행하기 어렵거나 동상·압박손상·심부감염을 배제하기 어려운 경우

<mark style="color:$info;">**외래 추적 / 추가 평가 계획**</mark> <mark style="color:$info;">- 즉각 위험 낮으나 호전 없으면 의뢰</mark>

* 실온에서 수동적으로 재가온한 뒤 부종·통증이 안정되고 진행성 허혈·감염 소견이 없는 경우
* 노출 후 1주 이상 감각저하·이상감각·통증이 지속하면 다른 말초신경병증 원인을 평가하고 신경과·통증의학과 의뢰를 고려

## <mark style="color:green;">진단</mark>

* 병력과 진찰로 진단한다. 차갑고 습한 환경에서 손·발이 수시간~수일 차갑고 무감각했던 병력이 핵심이다.
* 재가온 후 증상이 없고 진찰이 정상이며 지속되는 신경학적 이상이 없으면 NFCI 가능성이 낮다.
* 저온 노출 후 1주 이상 신경학적 증상·징후가 지속되고 당뇨병성 신경병증, 신경 압박, 영양결핍 등 다른 말초신경병증 원인이 배제되면 NFCI를 지지한다.
* 첫 2~3일 이후 증상이 새로 악화하면 이를 NFCI의 자연경과로 간주하지 말고 감염, 압박손상, 구획증후군, 동상 등 다른 원인을 찾는다.
* 확진하는 특이 혈액검사나 영상검사는 없다. 외상이 의심되면 단순방사선검사를 시행하고, CT·MRI 등은 동반 손상을 평가할 때만 선택한다. CTA·MRA·동위원소 관류검사를 NFCI 자체의 진단에 일률적으로 시행하지 않는다.

### <mark style="color:orange;">감별진단</mark>

* 동상 : 조직이 단단하고 왁스처럼 창백·황색을 띠며, 해동 전에는 동결 상태이다. NFCI가 있던 조직이 이후 실제로 얼면 두 손상이 함께 발생할 수 있다.
* 압박손상·구획증후군 : 조이는 신발·의복과 부종이 함께 있을 때 발생할 수 있으며 국소 조직손실·괴사를 일으킨다.
* 감염 : 보통 비대칭·일측성이며 경계가 비교적 뚜렷하고 전신증상이 동반될 수 있다.
* 레이노현상 : 추위에 경계가 분명한 창백이 발작적으로 나타나지만 재가온 후 후유증 없이 회복한다.
* 따뜻한 물 침수족(warm water immersion foot) : 15~32℃ 물에 장시간 노출된 뒤 생기며 한랭 노출 없이 발생한다. 건조·거상 후 대개 수일 내 후유증 없이 회복한다.

## <mark style="background-color:$warning;">Management</mark>

### <mark style="color:orange;">초기 치료</mark>

1. 중등도·중증 저체온증, 동상 및 생명 위협 동반손상을 먼저 치료한다.
2. 젖은 의복·양말·신발과 압박 물품을 제거하고 추가 냉각을 막는다.
3. **실온에서 수동적으로 재가온**하면서 공기 중에 건조하고 환부를 거상한다.
4. 온수 침수, forced air, heating pad 등 적극적 재가온과 얼음주머니를 이용한 냉각은 시행하지 않는다.
5. 부은 발은 원칙적으로 딛지 않는다. 대피를 위해 불가피하면 두꺼운 양말과 조이지 않는 신발로 보호한다.
6. 환부는 공기 중에 노출하거나 가볍고 느슨한 드레싱을 적용하며 압박을 피한다.
7. 피부손상이 있으면 표준 지침에 따라 파상풍 예방접종 필요성을 평가한다.

## <mark style="color:green;">약물 치료</mark>

### <mark style="color:orange;">통증 치료</mark>

* 거상·압박 회피가 충혈기의 통증을 줄일 수 있다. 일반 진통제는 필요에 따라 사용할 수 있으나 NSAID와 opioid는 단독으로 신경병성 통증을 충분히 완화하지 못하는 경우가 많다.
* 통증이 지속하면 amitriptyline을 저용량 취침 전부터 시작하여 연령·동반질환·항콜린성 부작용과 반응에 따라 증량할 수 있다. 원 논문에는 50~100 mg 취침 전 용량이 제시되어 있으나 이를 일률적인 시작용량으로 적용하지 않는다.
* Amitriptyline의 효과가 불충분하거나 부적합하면 gabapentin 등 신경병성 통증 치료제를 고려한다.
* 만성 신경병성 통증 또는 CRPS는 통증의학과·신경과·재활의학과에 의뢰한다.

### <mark style="color:orange;">발열과 항생제</mark>

* 노출 후 12~36시간에 38~38.5℃ 정도의 단독 미열이 나타날 수 있다. 다른 감염 소견이 없으면 이 발열만으로 항생제를 투여하지 않는다.
* 예방적 항생제는 투여하지 않는다. 수포의 이차감염, 봉와직염, 농양 또는 감염된 괴사조직이 확인될 때만 배양검사와 감염 형태에 따라 치료한다.
* 봉와직염은 우선 staphylococci와 streptococci를 표적으로 치료한다. 장기간 침수, 오염된 상처, 습윤 환경 또는 배양결과 등 녹농균 위험이 있을 때만 Pseudomonas 항균 범위를 추가한다.
* 조직괴사가 의심되면 항생제만 투여하지 말고 응급 외과 평가를 시행한다.
* Iloprost의 급성 NFCI 조직 보존 효과와 iloprost·capsaicin 8% patch의 만성 통증 효과는 근거가 불충분하여 일상적으로 권하지 않는다.

## <mark style="color:green;">장기 관리 및 예방</mark>

* 만성 신경병성 통증, 감각저하, 한랭과민, 다한증, CRPS 및 반복 외상·감염을 추적한다.
* 지속되는 신경병증은 전문의 평가를 의뢰하며, 필요한 경우 소섬유신경병증 평가를 위한 피부 생검 등을 전문기관에서 고려할 수 있다. NFCI를 확진하는 단일 검사는 없다.
* 감각이 둔한 손·발은 매일 피부를 확인하고 조이지 않는 신발과 적절한 보조기·보호구를 사용한다.
* 차갑고 습한 환경의 노출시간을 줄이고 정기적으로 따뜻하고 건조한 장소로 이동한다. 손·발을 아래로 늘어뜨린 채 움직이지 않는 자세를 피한다.
* 젖은 환경에서는 가능한 한 발을 건조하게 유지하고 마른 양말로 하루 2~3회 갈아 신는다. 보온성이 있으면서 조이지 않는 의복·신발을 사용한다.
* 밀폐형 vapor-barrier 신발이나 조이는 neoprene 양말은 내부 습기와 압박을 증가시킬 수 있으므로 장시간 습윤 노출에서 피한다. 기름·grease를 손·발에 발라 예방하지 않는다.
* 이전 NFCI 병력이 있으면 차갑고 습한 환경의 재노출을 피하고, 직업상 불가피하면 증상이 없고 한랭 반응이 정상인지 전문적으로 평가한 뒤 단계적으로 복귀한다.

<p align="center"><em><mark style="color:$info;">Ref. Prevention and Treatment of Nonfreezing Cold Injuries and Warm Water Immersion Tissue Injuries: A Supplement to the Wilderness Medical Society Clinical Practice Guidelines, 2023</mark></em></p>
...
* 동창과 달리 장시간의 습윤 저온 노출 후 발생하는 신경혈관 손상이다. 앞의 **비동결성 냉손상** 항목에 따라 실온에서 수동적으로 재가온·건조·거상하며 온수나 직접 열원을 사용하지 않는다.
...
> **신경병성 통증 치료 (비동결성 냉손상)**
>
> * Amitriptyline·gabapentin은 졸림과 어지럼을 일으킬 수 있으므로 운전·기계조작과 음주를 피하고 임의로 증량하지 않는다.
> * 장기간 지속되는 통증·한랭과민·감각저하는 약만 반복하기보다 신경과·통증의학과 평가를 받는다.

> **항생제·국소 스테로이드**
>
> * 동상·비동결성 냉손상·동창의 상처에 항생제나 국소 스테로이드를 임의로 사용하지 않는다.

> **언제 다시 병원을 방문해야 하나요?**
>
> * 해동 후 출혈성 수포, 검은 변색, 지속되는 감각저하나 청색증이 나타나는 경우
> * 비동결성 냉손상 후 부종·통증이 첫 2~3일 이후 악화하거나 한쪽에 홍반·열감·고름이 생기는 경우
...
{% hint style="info" %}
**침수족·참호족은 뜨거운 물로 급히 데우지 마십시오**

차갑고 젖은 양말·신발을 오래 착용한 뒤 발이 무감각하고 붓는 것은 비동결성 냉손상일 수 있습니다. 동상과 달리 뜨거운 물에 담그거나 난방기구로 급히 데우면 통증과 부종이 심해질 수 있습니다.
{% endhint %}

#### <mark style="color:$primary;">비동결성 냉손상은 어떻게 관리하나요?</mark>

* 젖은 양말·신발을 벗고 실온에서 자연스럽게 따뜻해지도록 하면서 발을 말리고 심장보다 높게 두십시오.
* 따뜻한 물, 헤어드라이어, 온풍기, heating pad를 사용하지 말고 얼음찜질도 하지 마십시오.
* 부은 발로 걷지 마십시오. 대피를 위해 불가피하면 두꺼운 마른 양말과 조이지 않는 신발로 보호하십시오.
* 통증이 줄어도 감각이 둔하면 상처를 알아차리지 못할 수 있으므로 매일 피부를 확인하십시오.

#### <mark style="color:$primary;">이럴 때는 즉시 진료받으세요</mark>

* 검은 변색·수포·괴사, 맥박 소실 또는 빠르게 심해지는 부종·통증
* 첫 2~3일이 지난 뒤에도 악화하거나 한쪽에만 홍반·열감·고름이 생기는 경우

#### <mark style="color:$primary;">가까운 시일 내 진료가 필요합니다</mark>

* 무감각·통증·한랭과민이 1주 이상 지속되는 경우
