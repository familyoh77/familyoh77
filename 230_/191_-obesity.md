...
* \~65세에는 연령 증가에 따른 자연적인 체중 증가가 일어나지만, 이는 주로 지방량 증가에 의한 것이며 제지방량(fat-free mass)은 오히려 감소함
* ≥65세에서는 비만과 사망률의 관련성이 감소. 과체중 환자가 마른 사람보다 사망률이 낮음 (= 비만 역설, obesity paradox); 고령에서 약간의 체지방은 근육 소모 완충, 영양 예비력 제공, 낙상 시 쿠션 역할을 할 수 있어 무조건적인 감량보다 근육량 보존이 더 중요한 치료 목표가 될 수 있음
