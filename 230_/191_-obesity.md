...
* 아시아인과 서양인의 차이 : ⓵ 유전적 다형성 - 지방 분포, 지방세포 분화, 지질 대사에 관여하는 유전자(PPARG, ADIPOQ, FTO 등)의 변이 빈도가 인종 간에 실제로 다름 - 아시아인은 내장지방 축적 경향이 강함. ⓶ 골격 체형의 차이 - 아시아인은 골격이 작고 근육량이 적음; 서양인이 아시아인보다 동일 BMI에서 내장 지방 비율이 낮은(3\~5%) 체성분 차이를 반영하여 아시아인보다 완화된 기준을 적용&#x20;
  * 아시아인에서는 '마른 비만(metabolically obese normal weight)'이 서양인보다 훨씬 흔함

#### <mark style="color:$primary;">체지방률</mark>

* WHO, 대한비만학회 : 남 ≥25%, 여 ≥35%
...
* 비만 역설 (obesity paradox) : ≥65세에서는 비만과 사망률 관련성이 감소하며, 과체중 환자가 마른 사람보다 사망률이 낮음; 고령에서 약간의 체지방은 근육 소모 완충, 영양 예비력 제공, 낙상 시 쿠션 역할을 할 수 있어 무조건적인 감량보다 근육량 보존이 더 중요한 치료 목표가 될 수 있음
...
* 과잉 지방 축적, 대사·기능 이상 없음

**임상 비만**(clinical obesity)&#x20;

* 장기 기능 장애 또는 일상 기능 저하 동반
...
* 수주\~수개월 내 급격한 체중 증가(＞5 ㎏/월) → 2차성 원인(갑상선저하증, 쿠싱증후군, 약물 유발)
* BMI ≥40 또는 BMI ≥35 + 중증 합병증(T2DM, 고혈압, OSA 등)&#x20;
* 심한 수면무호흡 증상(야간 호흡 정지 목격, Epworth Sleepiness Scale ≥16)&#x20;
* 중증 폭식장애·야간 폭식증 + 정신과적 문제&#x20;
...
* **선택** : TSH (2차성 원인 배제), hs-CRP/ferritin (염증 지표; 일반 CRP는 비만 환자의 만성 저강도 염증을 감지하기에 감도가 부족), 요산
...
* [**MASLD**](../224_/093_-nafld.md) **단계별 접근** : 복부 초음파(지방간 유무) → FIB-4 계산(섬유화 위험) → 고위험 시 의뢰(FibroScan/생검 등)
...
<table><thead><tr><th width="138.42108154296875">표현형</th><th width="179.47369384765625">특징</th><th width="181.57891845703125">우선 고려 치료</th><th>실전 포인트</th></tr></thead><tbody><tr><td><strong>식욕 과다형</strong><br><strong>(Hungry brain)</strong></td><td>항상 배고픔, 식후 포만감 부족, 야식·간식 빈번</td><td>GLP-1 RA, tirzepatide, phentermine/topiramate</td><td>포만감 회복이 핵심; 단순 칼로리 제한만으로 실패하기 쉬움</td></tr><tr><td><strong>폭식·보상형</strong><br><strong>(Reward eating)</strong></td><td>스트레스성 폭식, 음식 craving, 감정 섭식</td><td>CBT, naltrexone/bupropion, 정신건강의학과 협진</td><td>"의지 부족"보다 보상 회로(reward circuitry) 문제로 접근</td></tr><tr><td><strong>대사 이상형</strong><br><strong>(Metabolic obesity)</strong></td><td>T2DM, MASLD, 고TG혈증, 복부 비만 동반</td><td>Semaglutide, tirzepatide</td><td>체중 감소 외 cardiometabolic benefit 중요</td></tr><tr><td><strong>지방식 과다형</strong></td><td>튀김·패스트푸드·야식 위주, 지방 섭취 많음</td><td>Orlistat + 식이 교육</td><td>지방변 부작용이 dietary feedback 역할 가능</td></tr><tr><td><strong>좌식 생활형</strong><br><strong>(Sedentary)</strong></td><td>활동량 부족, 좌식 스크린 시간(screen time)↑, 근육량 감소</td><td>운동 처방, 활동량 증가 전략</td><td>NEAT(비운동 활동 열생성) 증가 중요</td></tr><tr><td><strong>근감소 동반형</strong><br><strong>(Sarcopenic obesity)</strong></td><td>고령, 근육량 감소, 체력 저하</td><td>고단백 식이 + 저항성 운동 우선</td><td>"체중 감소"보다 근육 보존(lean mass preservation) 우선</td></tr><tr><td><strong>수면무호흡 연관형</strong></td><td>OSA, 심한 코골이, 주간 졸림</td><td>체중 감량 + 수면다원검사 + CPAP 고려</td><td>수면 개선 시 식욕·인슐린 저항성도 개선 가능</td></tr><tr><td><strong>약물 유발형</strong></td><td>항정신병제·steroid·insulin 이후 체중 증가</td><td>원인 약물 재평가</td><td>가능 시 weight-neutral 약제로 변경 검토</td></tr></tbody></table>
...
주사제 GLP-1 제제는 비용 부담과 주사 기피로 인해 장기 치료 지속률이 낮다(1년 내 중단 약 50%, 3년 유지율 약 8%). 이를 보완하기 위해 경구용 제제가 개발되었으며, 2026년 현재 두 계열이 임상에 진입해 있다.

<table><thead><tr><th width="170">구분</th><th width="200">세마글루티드 경구제 <mark style="color:blue;">[리벨서스 / 경구 위고비]</mark></th><th>오르포글리프론 <mark style="color:blue;">[파운다요]</mark></th></tr></thead><tbody><tr><td>계열</td><td>펩타이드 기반 GLP-1 RA</td><td>비펩타이드 소분자 GLP-1 RA</td></tr><tr><td>흡수 기전</td><td>흡수 촉진제(SNAC) 활용, 위 점막 흡수</td><td>소분자 화학 합성; 위장관 내 안정적 흡수</td></tr><tr><td>복용 조건</td><td>소량의 물(120 ㎖ 이하)로 공복 복용; 복용 후 30분간 음식·음료·타 약물 금지</td><td>음식·물 섭취 제한 없음</td></tr><tr><td>체중 감소</td><td>주사제 세마글루티드 대비 효과 다소 낮음</td><td>ATTAIN-1: −7.8\~−12.4% (비당뇨 과체중/비만)</td></tr><tr><td>혈당 강하</td><td>PIONEER-1: 위약 대비 HbA1c·체중 유의 개선</td><td>ACHIEVE-1: HbA1c −1.24\~−1.48%</td></tr><tr><td>심혈관 근거</td><td>SOUL 연구: T2DM + ASCVD/CKD에서 심혈관 혜택 입증</td><td>미확립 (심혈관·신장 보호 연구 진행 중)</td></tr><tr><td>직접 비교</td><td>—</td><td>ACHIEVE-3: 리벨서스 대비 혈당·체중 우월; 이상반응으로 인한 중단률은 파운다요가 더 높음</td></tr><tr><td>국내 허가</td><td>리벨서스 허가·출시; 경구 위고비는 미허가(2026년 기준)</td><td>미허가(2026년 기준)</td></tr></tbody></table>

{% hint style="info" %}
향후 경구용 GLP-1 제제의 중심은 **비펩타이드 소분자 제제**로 이동할 것으로 전망된다. 화학 합성 방식은 생산 단가를 낮출 수 있어 장기 치료 접근성 개선에 유리하며, 복용 조건이 자유로워 순응도 향상도 기대된다. 현재 비만한 T2DM 환자에서 DPP-4 억제제를 대체할 1차 경구 옵션으로 주목받고 있다.
{% endhint %}
...
\* 금연이 수술 전·후 합병증을 최소화 \* 수술 전 폐쇄수면무호흡증 검사 및 치료 고려
...
**경구용 GLP-1 수용체 작용제 — 리벨서스 (세마글루티드 정)**
