...
{% hint style="info" %}
COVID-19 이후, SARS-CoV-2도 감기 유사 증상으로 발현될 수 있으므로 임상적 판단에 포함. 국내에서는 인플루엔자·COVID-19 신속 항원 검사가 외래에서 용이하게 시행 가능함.
{% endhint %}
...
#### <mark style="color:orange;">공기 입자를 통한 감염</mark>

* 전염 가능성 낮음: 공기 흡입 감염에는 직접 접촉 대비 20배의 균 농도가 필요; 기침/재채기 입자에는 매우 적은 양의 바이러스가 존재하므로 공기 전파 감염은 극히 낮음
* ✽ influenza virus는 공기 전파가 상대적으로 많음
...
* 일반적 경과: 인후통 또는 목 간지럼 → 1\~3일 후 맑거나 점성의 콧물, 코 막힘, 재채기 → 3\~4일 후 진한 농성의 콧물, 기침 → 자연 치유; 약물 치료가 경과를 변경시키지 못함
...
* 기침이 3주 이상 지속 (감염 후 기도 과반응성, 천식 등 감별 필요)
* 알레르기 비염, 혈관운동성 비염, 약물 비염 등 감별이 필요한 경우
* 흡연자에서 증상 지속 시
...
* [폐렴](068_-pneumonia.md): 세균성 폐렴은 드묾
...
```mermaid
graph TD
    Start(["급성 상기도 증상<br/>콧물·코막힘·인후통·기침"]) --> Eval["임상 평가"]

    Eval --> RedFlag{"🚩 Red Flags<br/>존재?"}

    RedFlag -- "예" --> Refer["즉각 조치·의뢰<br/>(응급 또는 전문과)"]

    RedFlag -- "아니오" --> Duration{"증상 지속 기간"}

    Duration -- "≤10일" --> VirURI["바이러스성 상기도 감염<br/>(감기) 가능성 높음"]

    VirURI --> Symptom["증상별 대증 치료<br/>• 휴식·수분·영양<br/>• 발열·통증 → 해열진통제<br/>• 기침 → 진해제(필요시)<br/>• 콧물·코막힘 → 항히스타민제/울혈 제거제"]

    Symptom --> Monitor["경과 관찰<br/>10~14일"]

    Duration -- "10~14일<br/>호전 없음" --> Complication["합병증 평가<br/>• 세균성 부비동염<br/>• 중이염<br/>• 폐렴"]

    Duration -- "＞14일<br/>또는 악화" --> Extended["추가 검사 또는 의뢰<br/>• CBC, CRP<br/>• X-ray (흉부/부비동)<br/>• 알레르기·천식 평가"]

    Monitor --> Resolved{"호전?"}
    Resolved -- "예" --> End(["자연 치유"])
    Resolved -- "아니오<br/>10~14일 경과" --> Complication

    Complication --> AbxConsider["항생제 치료 고려<br/>(☞ 비부비동염/중이염 챕터)"]
...
* 인플루엔자 예방 접종 (독감·감기 혼동 감소, 합병증 예방)
...
* 감기 기침에 대하여 일관성 있는 유의미한 효과를 보이는 진해제는 없음; 일률적 사용 비권고
...
* 효과: 전반적으로 논란; 일부 연구에서 guaifenesin, bromhexine이 유의미한 효과 보임; 소아에서는 입증 불충분
...
* 효과: 바이러스 증식 억제 (실험실 연구); 일부 연구에서 증상 중증도 및 유병 기간 단축
* 증상 발생 24시간 이내 시작 시 더 효과적 (Cochrane 2021)
* 시럽 또는 사탕 (lozenge)으로 공급
* 부작용: 쓴맛, 구역
* 충분하지 않은 근거와 부작용을 고려하여 일반적으로 권고하지 않음

#### <mark style="color:orange;">비타민 C (vitamin C)</mark>

* 효과: 규칙적 투여 시 증상 중증도 및 유병 기간 소폭 감소; 임상적 의미는 제한적
...
* 결핍 시 상기도 감염 위험 증가
* 충분한 비타민 D 상태에서 추가 보충의 감기 예방 효과는 입증되지 않음 (VITAL trial 2022)
...
* 효과: 감기 중증도, 유병 기간 및 발병 횟수 감소 기대; 일부 소아 연구에서 긍정적 결과 있으나 일관성 없음
...
> ```
>
> _✽ 소아는 항상 체중 기반 용량 산정; 항히스타민제 병용 시 진정 효과 누적 주의; ＜2세에서 진해제·항히스타민제 사용 금지_

***

### <mark style="color:$success;">핵심 복약 지도</mark>

* **항히스타민제 (1세대)** — 졸음 부작용이 있으므로 복용 중 운전·기계 조작·음주를 삼가도록 안내; 소아에서 역설적 흥분이 나타나면 즉시 복용 중단
* **비내 코 울혈 제거제** — 반동성 비염 예방을 위해 하루 2회 이내, 연속 4일을 초과하여 사용하지 않도록 안내
* **codeine 함유 복합제** — ＜12세에서 사용 금지; 졸음·변비 발생 가능; 음주 금지
* **acetaminophen** — 간 손상 예방을 위해 하루 4,000 ㎎을 초과하지 않도록 안내; 다른 감기 복합제와의 acetaminophen 중복 성분 확인 필요
* **항생제는 필요 없음** — 감기는 바이러스 감염이므로 항생제가 효과 없음을 명확히 설명; 불필요한 항생제 요구를 거절할 수 있음을 안내
...
* 38.5℃ 이상 고열이 3일 (소아) 또는 5일 (성인) 이상 지속될 때
* 숨쉬기가 힘들거나 숨이 빠를 때
