...
graph TD
    ...
    I --> O["<u>LPR 추정</u><br/>생활 습관 교정 먼저<br/>지속 시에만 PPI trial 고려"]
    J --> P["<u>ICS 기술 교정</u><br/>spacer + 양치<br/>진균 의심 시 fluconazole"]
    ...
    T --> V[공통 기본 관리<br/>수분 ≥1.5–2 L · 흡연·카페인·알코올 회피<br/>편안한 낮은 음성 사용 <br/>· 습도 유지]
    U --> V
    O --> V
    P --> V
    Q --> V
