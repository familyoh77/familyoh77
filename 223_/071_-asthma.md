...
{% hint style="info" %}
**PEF의 역할**: PEF는 spirometry의 대체 진단 검사가 아니라 변동성 추적 및 자가 모니터링 도구로 사용한다. 4세 이후 적용 가능.\
