...
## <mark style="color:green;">천식 표현형 (Asthma Phenotypes)</mark>
...
### <mark style="color:orange;">생물학적 제제 선택 체계 (Biologic Selection Framework)</mark>
...
* 폐 기능 검사에서 건강한 사람보다 큰 변동성
  * 예)
    1. 기관지 확장제 흡입 후 FEV₁이 기저치의 >12% & >200 ㎖ 증가 (성인 기준; 소아 12세 미만은 예측치의 >12% 증가를 기준으로 함 — 절대량 200 ㎖ 기준 미적용)
...
* AND 호기 기류 제한 확인 : FEV₁이 감소했을 때 FEV₁/FVC 또한 정상 하한치 대비 감소 확인 (정상 참고치: 성인 >0.75\~0.8, 소아 >0.9)
...
2. 가변적 호흡기 증상(+), 기류 제한(-) 상태 : 기관지 확장제 사용을 중단(SABA 사용 시 4시간, ICS-LABA bid 24시간, ICS-LABA qd 36시간)하거나 증상 시 spirometry 재평가
   1. if FEV1 >70% 예측치 : ICS-containing Tx. 단계 감량 및 2\~4주 후 재평가
   2. if FEV1 <70% 예측치 : 3개월 동안 ICS-containing Tx. 단계 증량 후 재평가
3. 호흡기 증상이 거의 없고 정상 폐 기능, 가변적 기류 제한 없음 : 기관지 확장제 중단 후 재검. 정상이면 다른 질환 고려
4. 지속적인 호흡 곤란과 비가역적 기류 제한(+) 상태 : 3개월간 ICS-containing Tx. 단계 증량 후 평가. 반응 없으면 의뢰, 천식-COPD 중복 가능성 고려
...
#### <mark style="color:$primary;">천식 가능성이 낮은 특징</mark>
...
{% hint style="info" %}
**PEF의 역할**: PEF는 spirometry의 대체 진단 검사가 아니라 **변동성 추적 및 자가 모니터링 도구**로 사용한다. 4세 이후 적용 가능.\
**일중 변동 계산식**: (하루 중 최고치 − 최저치) ÷ 평균값 × 100 (%). 2주 측정 평균 >10% 이상 시 천식 시사.
{% endhint %}
...
<table><thead><tr><th width="160">FeNO 수치</th><th>해석</th></tr></thead><tbody><tr><td>&lt;25 ppb</td><td>eosinophilic inflammation 가능성 낮음; ICS 감량 고려 가능</td></tr><tr><td>25–50 ppb</td><td>intermediate — 임상 맥락 및 증상과 함께 해석 필요</td></tr><tr><td>&gt;50 ppb</td><td>T2 airway inflammation 가능성 높음; ICS 반응 좋음, biologic 적응증 평가</td></tr></tbody></table>
...
#### <mark style="color:$primary;">주요 감별 질환 비교 패널</mark>

<table><thead><tr><th width="160">특징</th><th width="140">천식</th><th width="140">COPD</th><th width="140">성대 기능 장애 (VCD)</th><th>심부전</th></tr></thead><tbody><tr><td>증상 가변성</td><td>+++ (높음)</td><td>+ (낮음)</td><td>+++ (발작적)</td><td>— (지속적)</td></tr><tr><td>야간 증상</td><td>흔함</td><td>가능</td><td>드묾</td><td>흔함 (야간 호흡곤란)</td></tr><tr><td>Wheeze 특성</td><td>호기성</td><td>호기성</td><td>흡기성 (stridor)</td><td>심장성 (습성)</td></tr><tr><td>기관지확장제 반응</td><td>좋음 (FEV₁ >12%↑)</td><td>부분적</td><td>없음</td><td>없음</td></tr><tr><td>FEV₁/FVC</td><td>정상↔감소 (가역적)</td><td>감소 (비가역적)</td><td>정상</td><td>정상↔감소</td></tr><tr><td>흡연력</td><td>무관</td><td>흔함</td><td>무관</td><td>무관</td></tr><tr><td>진단 단서</td><td>아토피, 가족력, 야간 악화</td><td>>40세, 흡연, 만성 가래</td><td>발성 시 악화, throat clearing</td><td>S3, 하지 부종, BNP↑</td></tr></tbody></table>
...
<table><thead><tr><th width="330">질문 내용 (지난 4주 기준)</th><th width="80">1점</th><th width="80">2점</th><th width="80">3점</th><th width="100">4점</th><th width="80">5점</th></tr></thead><tbody><tr><td>1. 직장·학교·집에서 활동 시 천식으로 인하여 지장을 받은 시간?</td><td>항상(all)</td><td>대부분(most)</td><td>약간(some)</td><td>아주 조금</td><td>없음(none)</td></tr><tr><td>2. 얼마나 자주 호흡 곤란이 있었습니까?</td><td>하루 두 번 이상</td><td>하루 한 번</td><td>주 3\~6번</td><td>주 1\~2번</td><td>없음</td></tr><tr><td>3. 천식 증상으로 밤에 잠에서 깨거나 일찍 일어났습니까?</td><td>주 4일 밤 이상</td><td>주 2\~3일 밤</td><td>주 한 번</td><td>주 한두 번</td><td>없음</td></tr><tr><td>4. 살부타몰 같은 응급 흡입기를 얼마나 자주 사용했습니까?</td><td>하루 3번 이상</td><td>하루 1\~2번</td><td>주 2\~3번</td><td>주 한 번 이하</td><td>없음</td></tr><tr><td>5. 천식을 얼마나 잘 조절했다고 평가하겠습니까?</td><td>전혀 조절 못함</td><td>잘 조절 못함</td><td>다소 조절</td><td>잘 조절</td><td>완벽하게 조절</td></tr></tbody></table>

#### <mark style="color:$primary;">천식 증상 관리 수준</mark>

<table><thead><tr><th width="270">최근 4주 동안 다음 사항 유무</th><th width="130">'충분한 조절'</th><th width="130">'부분 조절'</th><th>'조절 안 됨'</th></tr></thead><tbody><tr><td>주간 천식 증상이 ≥3회/주 발생</td><td rowspan="4">해당 없음</td><td rowspan="4">1\~2개 해당</td><td rowspan="4">3\~4개 해당</td></tr><tr><td>천식 때문에 밤에 잠에서 깨어난 날이 있다</td></tr><tr><td>≥3회/주 완화제 사용이 필요하다</td></tr><tr><td>천식 때문에 어떤 활동에도 제한을 받는다</td></tr></tbody></table>

#### <mark style="color:$primary;">중증도에 따른 증상/징후</mark>

<table><thead><tr><th width="180">구분</th><th width="150">경증</th><th width="160">중등증</th><th>중증</th></tr></thead><tbody><tr><td>호흡 곤란 발생</td><td>걷는 동안</td><td>휴식 중</td><td>휴식 중</td></tr><tr><td>대화</td><td>일상 대화 가능</td><td>짧은 문장 가능</td><td>단어만 가능</td></tr><tr><td>각성도</td><td>약간 흥분</td><td>흥분</td><td>흥분</td></tr><tr><td>호흡수</td><td>증가</td><td>증가</td><td>종종 >30/분</td></tr><tr><td>부호흡근 사용</td><td>usually not</td><td>commonly</td><td>usually</td></tr><tr><td>쌕쌕거림</td><td>중등도; 호기 끝</td><td>loud; 호기 전체</td><td>loud; 호흡 전체</td></tr><tr><td>맥박수</td><td>&lt;100/분</td><td>100\~120/분</td><td>&gt;120/분</td></tr><tr><td>Pulsus paradoxus</td><td>&lt;10 mmHg</td><td>10\~25 mmHg</td><td>20\~40 mmHg</td></tr><tr><td>치료 단계</td><td colspan="3">Step 1\~2 ⇦ ──────────────────── ⇨ Step 5</td></tr></tbody></table>
...
{% hint style="danger" %}
⚠️ **Silent chest (청진상 호흡음 소실) = 임박한 호흡 부전(impending respiratory failure) 징후.** wheezing 감소가 호전처럼 보일 수 있으나, 폐포 환기가 극감한 상태임. 즉시 응급 이송이 필요하다.\
**ABGA 소견**: 중증 천식에서는 과호흡으로 PaCO₂가 낮아야 정상이다. **"정상" PaCO₂ (35\~45 mmHg)는 호흡근 피로로 인한 환기 저하를 의미하는 불길한 징후**로, 즉각적인 처치가 필요하다.
{% endhint %}
...
<table><thead><tr><th width="220">위험 인자</th><th>치료 전략</th></tr></thead><tbody><tr><td>≥1개의 급성 악화 위험 인자</td><td>• 규칙적 ICS 처방 확인<br>• 생활 지침서 보유 확인<br>• 흡입제 사용 횟수와 방법 확인<br>• 교정 가능한 위험 인자 확인</td></tr><tr><td>지난 1년간 ≥1회의 심각한 급성 악화</td><td>• ICS-formoterol 유지 및 완화 요법 고려<br>• 교정 위험 인자 없다면 '단계 올림'<br>• 급성 악화 위험 인자 확인</td></tr><tr><td>담배 노출</td><td>• 금연 권고 및 정보 제공<br>• 잘 조절되지 않는 천식에 고용량 ICS 고려</td></tr><tr><td>낮은 FEV₁ (&lt;60%)</td><td>• 고용량 ICS 3개월 ± OCS 2주 고려<br>• COPD 등 다른 폐질환 감별<br>• 호전 없으면 의뢰</td></tr><tr><td>비만</td><td>• 체중 감량<br>• OSA, GERD에 의한 증상과 천식 증상 감별</td></tr><tr><td>정신적 문제</td><td>• 정신 건강 평가<br>• 불안감에 의한 증상과 천식 증상을 구분하도록 교육</td></tr><tr><td>음식 알레르기</td><td>• 음식 회피 요법; epinephrine 주사제 준비</td></tr><tr><td>알레르겐 노출</td><td>• 회피 요법; 천식에 대한 면역 치료 효과는 제한적</td></tr><tr><td>가래 호산구 증가</td><td>• 증상 조절 단계와 무관하게 ICS 증량</td></tr></tbody></table>
...
* 흡입 도구 종류 : pMDI(>8세), breath actuated pMDIs(>7세), DPI(>5세), soft mist inhaler, nebulizer
...
<table><thead><tr><th width="230">환자 상황</th><th>추천 흡입기</th></tr></thead><tbody><tr><td>조작 coordination 불량 (고령, 소아)</td><td>DPI 또는 breath-actuated MDI (BAI)</td></tr><tr><td>흡입력 불충분 (중증 악화, 영아)</td><td>MDI + spacer 또는 nebulizer</td></tr><tr><td>고령자, 악력 저하</td><td>Soft mist inhaler 또는 DPI (낮은 저항성)</td></tr><tr><td>일반 성인, 흡입력 충분</td><td>DPI 또는 pMDI+spacer</td></tr><tr><td>모든 환자</td><td>흡입 기술을 매 방문 시 재확인 — 잘못된 사용이 치료 실패의 주요 원인</td></tr></tbody></table>
...
<table><thead><tr><th width="200">구분</th><th width="240">특징</th><th>종류</th></tr></thead><tbody><tr><td><strong>조절제 (Controller)</strong></td><td>• 기도 염증 완화, 증상 조절, 악화 예방<br>• 매일 규칙적으로 지속 사용</td><td>• 흡입 steroid (가장 효과적)<br>• 흡입/경구 지속성 β-작용제<br>• 크로몰린제<br>• 항류코트리엔제<br>• 경구 steroid<br>• 항IgE항체, 단클론항체</td></tr><tr><td><strong>완화제 (Reliever)</strong></td><td>• 신속한 기도 확장으로 현재 증상 개선<br>• 필요시 사용</td><td>• 흡입/경구 속효성 β-작용제 (SABA)<br>• 저용량 ICS-formoterol (선호)<br>• 흡입 항콜린제</td></tr></tbody></table>
...
* 반응이 부족할 경우 : ① 사용 방법 확인, ② 증량보다 다른 계열 조절제 추가가 일반적으로 효과적이며 부작용 적음(예: ICS + LABA)
...
<table><thead><tr><th width="180">기전</th><th width="240">성분명 [상품명]</th><th>선택 기준</th></tr></thead><tbody><tr><td><strong>Anti-IgE</strong></td><td>omalizumab <mark style="color:blue;">\[졸레어 주]</mark></td><td>혈청 IgE 상승, 알레르기성 천식</td></tr><tr><td><strong>Anti-IL-5</strong></td><td>mepolizumab</td><td rowspan="2">혈중 eosinophil ≥300/µL<br>또는 가래 호산구 ≥3%</td></tr><tr><td><strong>Anti-IL-5R</strong></td><td>reslizumab, benralizumab</td></tr><tr><td><strong>Anti-IL-4Rα</strong></td><td>dupilumab <mark style="color:blue;">\[듀피젠트]</mark></td><td>FeNO↑ &amp;/or eos↑, OCS 의존 (6세 이상)</td></tr><tr><td><strong>Anti-TSLP ★</strong></td><td>tezepelumab <mark style="color:blue;">\[테즈스파이어]</mark></td><td>표현형 무관 (중증 불응성 천식 전반)</td></tr></tbody></table>
...
{% hint style="info" %}
**패러다임 전환**: 경증 천식에서도 SABA 단독 사용은 중증 악화 위험 증가와 관련된다. GINA 2024는 **모든 단계에서 증상 기반 저용량 ICS-formoterol 사용을 SABA보다 우선 권고**한다.
{% endhint %}
...
<table><thead><tr><th width="130">성분명</th><th width="250">흡입제</th><th width="260">네불라이저용 액</th><th>작용 (hr)</th></tr></thead><tbody><tr><td><strong>salbutamol</strong></td><td>1\~2 puffs, 100 µg/puff <mark style="color:blue;">\[벤토린 에보할러]</mark></td><td>2.5 mg/2.5 ml/A <mark style="color:blue;">\[벤토린 네뷸]</mark></td><td>4–6</td></tr></tbody></table>
...
<table><thead><tr><th width="140">성분명</th><th width="220">흡입제</th><th width="230">네불라이저용 액</th><th>작용 (hr)</th></tr></thead><tbody><tr><td><strong>ipratropium</strong></td><td>2\~3 puffs tid\~qid</td><td>250 µg/1 ml/A, 500 µg/2 ml/A <mark style="color:blue;">\[아트로벤트]</mark></td><td>6–8</td></tr></tbody></table>
...
<table><thead><tr><th width="100">　</th><th width="170">Step 1</th><th width="190">Step 2</th><th width="190">Step 3</th><th>Step 4</th></tr></thead><tbody><tr><td>증상 상태</td><td>≤1회/월 증상, 악화 위험 인자(-)</td><td>≥2회/월 but &lt;5d/주</td><td>거의 매일 증상 or ≥1회/주 기상</td><td>조절되지 않는 중증 상태, or 급성 악화</td></tr><tr><td><strong>Track 1</strong> (선호)</td><td>필요시 저용량 ICS-FMT</td><td>필요시 저용량 ICS-FMT</td><td>저용량 ICS-FMT 유지(매일)¹⁾</td><td>중간 용량 ICS-FMT 유지(매일)¹⁾</td></tr><tr><td></td><td colspan="4"><strong>완화제: 필요시 저용량 ICS-FMT (AIR)²⁾</strong></td></tr><tr><td><strong>Track 2</strong> (대체)</td><td>필요시 SABA with 저용량 ICS³⁾</td><td>저용량 ICS 유지(매일)</td><td>저용량 ICS-LABA 유지(매일)</td><td>중/고용량 ICS-LABA 유지(매일)</td></tr><tr><td></td><td colspan="4"><strong>완화제: 필요시 SABA (단독 사용 금지) or ICS-SABA²⁾</strong></td></tr></tbody></table>
...
<table><thead><tr><th width="230">약물 치료</th><th>악화된 천식을 위해 단기(1–2주) 변경</th></tr></thead><tbody><tr><td colspan="2"><strong>평소 사용 완화제 증량</strong></td></tr><tr><td><strong>저용량 ICS-FMT</strong>¹⁾</td><td>필요시 사용 저용량 ICS-FMT의 사용 빈도를 늘림</td></tr><tr><td><strong>SABA</strong></td><td>SABA 사용 횟수를 늘림. MDI의 경우 스페이서 사용</td></tr><tr><td colspan="2"><strong>평소 사용 유지 치료 늘림</strong></td></tr><tr><td><strong>ICS-FMT 유지 & 완화</strong>¹⁾</td><td>유지 용량을 두 배로 늘림 및 필요시 완화제로 추가 사용</td></tr><tr><td><strong>ICS 유지 + SABA</strong></td><td>ICS 4배 증량 고려</td></tr><tr><td><strong>ICS+다른 LABA + SABA</strong></td><td>ICS+LABA를 한 단계 높임</td></tr><tr><td colspan="2"><strong>경구 스테로이드 추가 및 진료</strong></td></tr><tr><td><strong>경구 스테로이드(OCS)</strong></td><td>중증 악화(PEF 또는 FEV₁ &lt;60% 예측치), 또는 48시간 이상 치료 반응 없는 경우 OCS 추가</td></tr></tbody></table>

¹ low dose budesonide or beclomethasone with formoterol; formoterol 최대 72 µg/d\
중증 악화 시 5–10일간 prednisolone 40–50 mg/d; 2주 이내 tapering 불필요
