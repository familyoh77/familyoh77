...
#### <mark style="color:$primary;">초감염 결핵 (Primary tuberculosis)</mark>

* 결핵균 감염 후 잠복결핵을 거치지 않고 바로 발생한 결핵

#### <mark style="color:$primary;">잠복결핵감염 (Latent TB infection, LTBI)</mark>

* 체내에 소수의 살아 있는 결핵균이 존재하지만 임상 증상이 없고 균이 외부로 배출되지 않아 타인에게 전파되지 않는 상태
* 면역학적 검사(TST, IGRA)에서는 양성이나 가래 결핵균 검사와 흉부 X선 검사에서는 음성

#### <mark style="color:$primary;">활동성 결핵</mark>
...
#### <mark style="color:$primary;">전염성 결핵</mark>
...
#### <mark style="color:$primary;">재활성화 결핵 (Reactivation TB)</mark>

* LTBI 상태에서 면역 기전이 약해지면서 결핵균이 활성화되어 결핵이 발병한 상태
* 일생 동안 LTBI의 5\~10%가 재활성화되며, 발병 사례의 ½이 감염 후 첫 2년 내 발생

#### <mark style="color:$primary;">자연 치유된 결핵 병변 (Spontaneously healed TB lesion)</mark>
...
* 결핵성 수막염 의심: 극심한 두통·의식 변화·경부 강직·광선 공포증
* 속립성 결핵(miliary TB) 의심: 고열·전신 소모증·흉부 X선 속립성 음영
* 결핵성 심낭염 의심: 심낭 삼출, 쇼크 전구 증상

<mark style="color:$warning;">**당일 또는 조기 의뢰**</mark>

* 다제 내성 결핵(MDR-TB) 의심: 치료 4개월 후에도 배양 양성, 이전 치료 실패력, INH/RIF 내성 확인
...
* 2주 이상 지속되는 원인 불명의 기침 → 결핵 검사 시행
* 표준 치료 중 호전 없음: 치료 2개월 후 객담 배양 양성 지속
* 치료 중 ALT 3\~5×ULN 이하 경도 상승 또는 경미한 위장 증상 → 모니터링 강화
...
#### <mark style="color:$primary;">진단 및 조치</mark>
...
graph TD
    ...
    Step1["3회 최소 2회 의 객담 도말 및 배양 검사<br/>+ 1회의 Xpert MTB/RIF 또는 NAAT"]

    Case1["AFB 도말 +<br/>Xpert MTB/RIF + 또는 NAAT +"]
    Case2["AFB 도말 -<br/>Xpert MTB/RIF + 또는 NAAT +"]
    Case3["AFB 도말 +<br/>Xpert MTB/RIF - 또는 NAAT -"]
    Case4["AFB 도말 -<br/>Xpert MTB/RIF - 또는 NAAT -"]
    ...
    style Start fill:#f3f0ff,stroke:#d0bfff
    style Step1 fill:#ebfbee,stroke:#8ce99a
    style Case1 fill:#fff9db,stroke:#fab005
    style Case2 fill:#fff9db,stroke:#fab005
    style Case3 fill:#fff9db,stroke:#fab005
    style Case4 fill:#fff9db,stroke:#fab005
    style Result1 fill:#fff5f5,stroke:#ffc9c9
    style Result2 fill:#fff5f5,stroke:#ffc9c9
    style Result3 fill:#fff5f5,stroke:#ffc9c9
    style Result4 fill:#fff5f5,stroke:#ffc9c9
```
...
\*임상 증상 또는 영상 검사상 폐결핵이 의심되지만 도말 및 PCR 검사가 모두 음성이면서 NTM 항생제에 반응이 없는 경우 '도말 음성 폐결핵'으로 정의하고 결핵 치료를 시행할 수 있음
...
* 유도객담 채취: 가래가 잘 나오지 않는 경우 고려; 네뷸라이저로 고장성 식염수를 15\~30분간 흡입 후 기침을 자극하여 가래를 얻음
...
#### <mark style="color:$primary;">Xpert</mark><sup><mark style="color:$primary;">®<mark style="color:$primary;"></sup> <mark style="color:$primary;"></mark><mark style="color:$primary;">MTB/RIF</mark>
...
<table><thead><tr><th width="240">대상</th><th>양성 기준</th></tr></thead><tbody><tr><td>일반</td><td>경결 ≥10 ㎜</td></tr><tr><td>HIV 감염자</td><td>경결 ≥5 ㎜</td></tr><tr><td>신생아 (BCG 접종)</td><td>경결 ≥10 ㎜</td></tr><tr><td>신생아 (BCG 미접종)</td><td>경결 ≥5 ㎜</td></tr><tr><td>강양성</td><td>경결 ≥15 ㎜, 또는 경결 크기에 상관없이 수포(B)·소수포(V)·괴사(N) 동반</td></tr></tbody></table>
...
활동성 결핵은 ≥6개월의 복합 항결핵제 요법이 필수이며, 진단 즉시 관할 보건소에 신고한다. 1차 의료기관에서는 표준 초치료 처방, 약물 부작용 모니터링, 잠복결핵 치료를 담당한다. 다제 내성 결핵, 치료 실패, 중증 폐외 결핵, 중증 간질환자는 전문 의료기관에 의뢰한다.
...
1. 최소 2주간의 결핵 치료 시행 (전염력은 치료 개시 2주 내에 급속히 감소함)
...
* 생후 4주 이내의 모든 신생아에게 시행
* 금연·금주 권고 (특히 항결핵제의 간독성을 고려하여 치료 기간 중 금주)

### <mark style="color:orange;">잠복결핵감염 (LTBI)</mark>

LTBI 양성 환자는 평생에 걸쳐 5\~10%에서 활동성 결핵이 발생한다 (이들 중 ½은 감염 후 2년 이내에 발생).

**선별 검사 대상**

<table><thead><tr><th width="130">권고 강도</th><th>대상</th></tr></thead><tbody><tr><td>시행</td><td>전염성 결핵 환자 접촉, HIV 감염, 면역억제제/TNF 길항제/생물학적 제제/소분자 억제제 투여(예정), 흉부 X선 상 과거 치료력 없는 자연 치유 결핵 병변, 규폐증</td></tr><tr><td>권고</td><td>스테로이드 장기 투여, 투석, 혈액암, 의료기관 종사자</td></tr><tr><td>고려</td><td>당뇨병, 고형암, 위절제술(예정)</td></tr><tr><td>제외</td><td>과거 활동성 결핵 또는 LTBI로 치료한 환자, LTBI 검사 양성으로 확인된 자 (이 경우 검사가 유용하지 않음)</td></tr></tbody></table>
...
```mermaid
graph TD
    A([LTBI 검사 양성]) --> B{활동성 결핵 배제}
    B -->|배제 실패| C([활동성 결핵 치료])
    B -->|배제 완료| D["기저 검사<br/>CBC·LFT·간염 검사"]
    D --> E{RIF 사용 가능?}
    E -->|아니오 간질환·약물 상호작용 등| F["9H 또는 6H<br/>INH 단독 9~6개월"]
    E -->|예| G{기간/방법 선택}
    ...
    style A fill:#f3f0ff,stroke:#d0bfff
    style C fill:#fff5f5,stroke:#ffc9c9
    style H fill:#ebfbee,stroke:#8ce99a
    style I fill:#ebfbee,stroke:#8ce99a
    style J fill:#ebfbee,stroke:#8ce99a
    style K fill:#ebfbee,stroke:#8ce99a
    style F fill:#ebfbee,stroke:#8ce99a
```
...
<table><thead><tr><th width="100">요법</th><th width="220">처방</th><th width="110">기간</th><th>비고</th></tr></thead><tbody><tr><td>4R (표준)</td><td>Rifampicin 단독</td><td>4개월</td><td>INH 내성/부작용 시 선택, 완료율 높음</td></tr><tr><td>3HR</td><td>INH + Rifampicin</td><td>3개월</td><td>표준 선택지</td></tr><tr><td>9H</td><td>INH 단독</td><td>9개월</td><td>RIF 사용 불가 시 (간질환, 약물 상호작용)</td></tr><tr><td>6H</td><td>INH 단독</td><td>6개월</td><td>9H에 비해 효과 다소 낮음</td></tr><tr><td>3HP</td><td>INH + Rifapentine 주 1회</td><td>3개월 (12주)</td><td>대체 요법; 전문가 처방 권고</td></tr><tr><td>1HP (최신)</td><td>INH + Rifapentine 매일</td><td>1개월 (28일)</td><td>BRIEF TB 연구 근거; 전문가 처방 권고</td></tr></tbody></table>
...
<table><thead><tr><th width="150">분류</th><th>정의 및 예시</th></tr></thead><tbody><tr><td>가족 접촉자</td><td>전염 가능 기간에 같은 주거 공간에서 생활한 접촉자 (가족, 군 내무반, 요양 시설·기숙사 같은 방)</td></tr><tr><td>밀접 접촉자</td><td>밀폐 공간에서 장시간 직접 접촉 (연속 8시간 이상 또는 누적 40시간 이상)</td></tr><tr><td>일상 접촉자</td><td>가족·밀접 접촉자 이외; 일반적으로 조사 생략 (역학 조사반 판단 시에만 시행)</td></tr></tbody></table>

{% hint style="info" %}
≤96개월 소아 결핵 환자의 경우 폐외 결핵이더라도 접촉자 검진 시행 (가족 전염원 확인 목적). 대형 강의실·복도 등 넓은 공간에서의 전염 가능성은 낮음.
{% endhint %}
...
* \[부작용] 시신경증: 시력 저하, 적록 색맹, 중심 암증, 주변 시각 장애; 용량·투여 기간과 관련. 신기능 저하 또는 ≥25 ㎎/㎏/d 투여 시 위험 증가
* <12세 금기
...
* \[부작용] 통풍: 발작은 드묾; 통풍 환자 또는 ≥2개월 사용 시 요산 모니터링
...
### <mark style="color:orange;">내성 결핵</mark>
...
<table><thead><tr><th width="220">부위</th><th width="200">치료 요법</th><th>비고</th></tr></thead><tbody><tr><td>결핵성 수막염</td><td>2HREZ/7~10HR(E)</td><td>사망·신경학적 후유증 위험 높음; 스테로이드 보조 요법 권고</td></tr><tr><td>결핵성 심낭염</td><td>2HREZ/4HR(E)</td><td>스테로이드 보조 요법 추가</td></tr><tr><td>결핵성 복막염, 장 결핵, 속립성 결핵, 비뇨생식기 결핵</td><td>2HREZ/4HR(E)</td><td>복막: 복강경 복막 생검으로 진단</td></tr><tr><td>결핵성 흉막염</td><td>2HREZ/4HR(E)</td><td>흉수 ADA >40 IU/L 의심 소견; 흉수 多·loculated 시 흉수 배액 고려</td></tr><tr><td>기관지 결핵</td><td>폐결핵 동일</td><td>기관지 협착 주의; 협착 위험 높으면 스테로이드 고려</td></tr><tr><td>림프절 결핵</td><td>2HREZ/4HR(E)</td><td>조직 검사 및 배양 시행; 적절한 치료에도 호전 없으면 제거</td></tr><tr><td>골·관절 결핵</td><td>6~9개월</td><td>약제 무반응·감염 진행·신경 손상 시 수술</td></tr></tbody></table>
