...
* 면역 저하자 및 만성질환자: 신부전, 당뇨병, 규폐증, HIV 감염, 위절제술 또는 공회장우회술 시행 or 예정, 면역억제제·TNF 대항제 또는 장기간 스테로이드(prednisone ≥15 ㎎/d × ≥1달) 사용 or 예정
...
class Result1,Result2,Result3,Result4 pink
    style Step1 fill:#fff9c4,stroke:#f39c12
...
* 양전 판정 기준
  ...
  2. <19세
     ...
     2. 전염력이 높은 전염원, 긴밀·장기간 접촉, <5세 또는 면역 저하자, 이전 결과 5\~9 ㎜ → 이전 결과보다 ≥6 ㎜ 증가
...
```mermaid
graph TD
    Start(["흉부 X선/CT상<br/>활동성 결핵 가능성이 낮은 <br/>치유 결핵 소견¹⁾"])
    Q1["과거 적절한<br/>결핵 치료력?"]
    HasTx["비활동성 결핵"]
    Exam["<u>검사</u><br/>· 과거 흉부 X선과 비교<br/>· 세균학적 검사 예: 가래<br/>· 경과 관찰"]
    ActiveTb["활동성 결핵"]
    ActiveTx["결핵 치료"]
    Inactive["비활동성 결핵"]
    Q2["결핵 발병<br/>고위험군?"]
    ...
    Q2 -->|고위험군²⁾| HighRisk
    Q2 -->|고위험군 아님| NotHigh
    NotHigh -->|LTBI⊖| LTBINeg
    NotHigh -->|LTBI⊕| LTBIPos

    style Start fill:#eeeeee,stroke:#888888,stroke-width:2px
    classDef yellow fill:#fff9c4,stroke:#f39c12
    class Q1,Q2,NotHigh yellow
    classDef pink fill:#fde8f0,stroke:#e91e8c
    class HasTx,Inactive pink
classDef sky fill:#e3f2ff,stroke:#2196f3
class LTBINeg sky
classDef blue fill:#d0e8ff,stroke:#1a6abf
class LTBIPos,HighRisk,ActiveTx blue
style ActiveTb fill:#ffcdd2,stroke:#c62828,stroke-width:2px
