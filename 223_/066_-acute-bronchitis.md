...
```mermaid
graph TD
    A([기침 환자]) --> B{Red Flag?<br/>빈호흡·빈맥·발열<br/>호흡 보조근·저산소증}
    B -- "있음" --> C[즉각 평가<br/>폐렴 의심 → X선<br/>입원·응급 의뢰]
    B -- "없음" --> D{기침 기간?}
    D -- "＞8주" --> E[만성 기침 평가<br/>천식·GERD·UACS·결핵]
    D -- "3~8주" --> PIC[Post-Infectious Cough<br/>기도 과민 반응]
    ...
    G1 -- "발작성 기침 ≥2주<br/>whoop/기침 후 구토" --> P[백일해 의심<br/>PCR + macrolide<br/>전파 차단 목적]
    ...
    style PIC fill:#e1f5fe,stroke:#01579b,stroke-width:2px
```
