...
<table><thead><tr><th width="105.26312255859375">기간</th><th width="216.84210205078125">분류</th><th>핵심 의미</th></tr></thead><tbody><tr><td>＜3주</td><td>급성 기침 / 급성 기관지염</td><td>대부분 바이러스성; 대증 치료</td></tr><tr><td>3~8주</td><td>아급성 기침 / PIC</td><td>기도 과민 반응 지속; ICS trial 고려</td></tr><tr><td>＞8주</td><td>만성 기침</td><td>천식·GERD·UACS·결핵 등 체계적 감별 필요</td></tr></tbody></table>

{% hint style="info" %}
**PIC (Post-Infectious Cough)** : 바이러스 기관지염 후 기도 점막 손상과 일시적 기관지 과민 반응이 3\~8주까지 지속되는 상태. 세균 감염이 아니므로 항생제는 불필요하며, reassurance와 기관지 과민 반응 완화가 치료의 핵심
{% endhint %}
...
* 빈호흡(＞24회/분) + 빈맥(＞100회/분) + 발열(＞38℃) → 폐렴
  * 고령자·면역 저하자는 열과 호흡에 있어 더 낮은 역치에서도 폐렴 가능성을 고려할 것
...
* 고열(＞39℃) + 화농성 가래 + 흉부 국소 청진 이상 소견 → 폐렴
* 2주 이상 지속되는 발작성 기침 + 흡기성 whoop 또는 기침 후 구토 → 백일해
* 고령·면역 저하·만성 폐질환 환자에서 증상 악화
* 혈담 지속 또는 체중 감소 동반 → 결핵, 폐 종양
...
* 영상 검사 : 흉부 X선 - ≥3주 지속 시 권고; 폐렴·종양 등의 감별이 필요한 경우 시행
  * 3주 미만이라도 다음의 경우 조기 시행 고려 : 65세 이상 고령자, 심부전·당뇨·면역 저하 등 기저 질환자에서 기침 + 발열 동반 시 폐렴 배제 위해 조기 촬영 적극 검토
* 백일해 의심 시 : 비인두 도말 PCR 또는 배양; 발병 후 3주 이내에 시행

{% hint style="info" %}
**폐렴 배제를 위한 CRP point-of-care 해석**

CRP는 세균성 감염의 rule-in 도구가 아닌 rule-out 보조 도구로 활용

* CRP ＜20 ㎎/L → 폐렴 가능성 낮음; 항생제 처방 억제 근거
* CRP 20\~100 ㎎/L → 임상 소견과 종합 판단 필요 (단독 결정 금지)
* CRP ＞100 ㎎/L → 폐렴·세균성 하기도 감염 적극 배제 필요; 흉부 X선 시행

　_(단위 주의 : 위 기준은 ㎎/L 단위)_

_<mark style="color:$info;">Ref. European Respiratory Journal, GRACE network; NICE NG120, 2023</mark>_
{% endhint %}
...
<table><thead><tr><th width="105">소견</th><th>급성 기관지염</th><th>폐렴</th><th>천식 악화</th></tr></thead><tbody><tr><td>병태 핵심</td><td>바이러스성 기도 염증 + 일시적 기관지 과민</td><td>폐포 감염</td><td>가역적 기도 협착</td></tr><tr><td>발병</td><td>URTI 후 점진적</td><td>급성·아급성, 점점 악화</td><td>반복적 / trigger 기반</td></tr><tr><td>기침</td><td>초기 dry → productive</td><td>productive (±rust/green)</td><td>dry ± 야간 기침</td></tr><tr><td>가래 양상</td><td>점액성·화농성 혼재; 색으로 세균 감별 불가</td><td>화농성 또는 rust색(폐렴구균); 녹색(그람음성)</td><td>점액성·희고 끈적함; 소량</td></tr><tr><td>발열</td><td>없음 또는 미열</td><td>고열 흔함</td><td>드묾</td></tr><tr><td>호흡 곤란</td><td>경미</td><td>뚜렷함</td><td>발작적</td></tr><tr><td>청진</td><td>diffuse rhonchi / wheeze (기침 후 변함)</td><td>focal crackle / 호흡음↓</td><td>diffuse wheeze</td></tr><tr><td>Vital sign</td><td>정상</td><td>빈호흡·빈맥·발열</td><td>빈호흡 ± 빈맥</td></tr><tr><td>SpO₂</td><td>정상</td><td>감소 가능</td><td>중등도↓ (중증 시 저산소)</td></tr><tr><td>흉부 X선</td><td>정상</td><td>침윤(+)</td><td>정상</td></tr><tr><td>치료 반응</td><td>시간 경과로 호전</td><td>항생제 필요</td><td>SABA 반응 빠름</td></tr></tbody></table>
...
graph TD
    A([기침 환자]) --> B[Red Flag?]
    B -- "있음" --> C[즉각 평가<br/>폐렴 의심 → X선<br/>입원·응급 의뢰]
    B -- "없음" --> D[기침 기간?]
    D -- "＞8주" --> E[만성 기침 평가<br/>천식·GERD·UACS·결핵]
    D -- "3~8주" --> PIC[PIC<br/>기도 과민 반응]
    D -- "＜3주" --> F[폐음 정상<br/>Vital sign 안정?]
    F -- "예" --> G[급성 기관지염 <br/>임상 진단]
    F -- "아니오" --> C
    PIC --> PIC2[1st: Reassurance<br/>2nd: SABA trial<br/>3rd: ICS 저용량 2~4주<br/>4th: GERD·UACS 평가]
    G --> G1[병인 분류]
    G1 -- "바이러스성<br/>대부분" --> V[대증 치료<br/>항생제 ❌]
    G1 -- "인플루엔자 의심<br/>48h 이내+유행기" --> FLU[oseltamivir 고려]
    G1 -- "발작성 기침 ≥2주<br/>whoop/기침 후 구토" --> P[백일해 의심]--> P1[PCR + macrolide<br/>-전파 차단 목적]
    G1 -- "COPD·고령·면역 저하<br/>폐렴 overlap 불확실" --> HI[제한적 항생제<br/>신중 평가]
    V --> SX[wheezing /<br/>objectve bronchospasm?]
    SX -- "있음" --> SABA[SABA 흡입제]
    SX -- "없음" --> SUP[수분·휴식<br/>NSAID/acetaminophen<br/>진해제 단기]
style A fill:#eeeeee,stroke:#888888,stroke-width:2px
classDef yellow fill:#fff9c4,stroke:#f39c12
class B,D,F,G1,SX yellow
classDef pink fill:#fde8f0,stroke:#e91e8c
class E,G,PIC,P pink
classDef sky fill:#e3f2ff,stroke:#2196f3
class PIC2,P1,SABA,SUP,V,FLU,HI sky
...
* "세균성 기관지염"은 독립적 entity로 거의 인정되지 않음; 화농성 가래는 세균 감염의 신뢰할 수 있는 지표가 아니며 (바이러스 감염에서도 발생), 단순 기관지염에서 항생제를 처방하는 근거로 사용해서는 안 됨. 항생제 처방은 아래 예외 상황에만 엄격히 제한
* 항생제 고려 예외 상황 (3가지)
...
{% hint style="danger" %}
**항생제 요청 환자 응대 - Delayed Prescription 전략**\
...
* 가습 : 습도(40\~60%) 유지는 도움이 될 수 있으나 일관된 근거 부족; 가습기 사용 시 위생 관리 필수 (곰팡이·세균 번식 주의); 뜨거운 가습기는 화상 위험이 있으며 WHO는 가습기 사용을 권장하지 않음
* 꿀(honey) : 성인 기침에서 dextromethorphan과 유사하거나 그 이상의 효과를 보인 RCT 근거 있음; 저렴하고 부작용 없어 1차 대안으로 권장 가능; 영아 보툴리누스증 위험으로 1세(12개월) 미만 영아에서는 금기
...
* codeine 제제: 급성 기관지염에서 사용 비권장 (avoid) - 효과 미입증, 호흡 억제 위험(특히 고령자), 남용·의존 우려; 많은 가이드라인에서 완전 기피 권고
  * Codeine - 18세 미만 소아·청소년 금기 : CYP2D6 유전자 다형성에 따른 morphine 과다 전환 시 호흡 억제 사망 사례 보고. 12세 미만에서 절대 금기; 12\~18세에서도 원칙적으로 금기**️**

### <mark style="color:orange;">점액 용해제</mark>

* 급성 기관지염에서 근거 매우 약함; routine use 비권장 - 가래 불편감 완화 목적의 제한적 사용에 한함
...
* Objective bronchospasm(기관지 경련의 객관적 증거: wheezing + 기류 제한)이 있을 때만 유용; 단순 기침에서 routine use 비권장
...
{% hint style="info" %}
**국내&#x20;**_**Mycoplasma pneumoniae**_**&#x20;Macrolide 내성 주의**\
한국을 포함한 동아시아 지역에서 \_M. pneumoniae\_의 macrolide 내성률이 80\~90% 이상으로 매우 높음. Macrolide 치료 후 48\~72시간 내 임상적 반응이 없으면 내성을 고려하여 전환:\
...
* COPD 급성 악화 / bacterial superinfection 의심 (고위험군, 폐렴 배제 후):
  ...
  * 또는 amoxicillin-clavulanate 875/125 ㎎ (1,000 ㎎) bid × 5일 (순응도↑, 효과 동등) <mark style="color:blue;">\[오구멘틴듀오포르테]</mark>
  * doxycycline 100 ㎎ bid × 5일 (atypical 동반 의심 시)
  * 사용 시 5일로 제한 권고; 신기능 저하(CrCl ＜30 ㎖/min) 시 용량 조절 필수
...
* oseltamivir : 75 ㎎ bid × 5일 <mark style="color:blue;">\[타미플루]</mark>
  * 신기능 저하 시 용량 조절 : CrCl 10\~30 ㎖/min → 75 ㎎ qd; 혈액투석 환자는 별도 조절
* 구역·구토 부작용 주의 (식후 복용으로 경감)
* 인플루엔자 신속항원검사(RAT) 또는 임상 진단 기반으로 처방; 음성이더라도 유행기·고위험군에서 임상적 판단으로 처방 가능

### <mark style="color:orange;">흡입 스테로이드 (ICS)</mark>&#x20;

* Post-Infectious Cough (PIC)
* 적응 : 급성 기관지염 후 3\~8주 지속되는 기침 (PIC) + 기도 과민 반응 소견
* ICS 전 단계 (UACS 동반 의심 시) : 후비루에 의한 기침 기여 가능성이 있는 경우 1세대 항히스타민제(예: chlorpheniramine 4 ㎎ tid) ± 코 울혈 제거제 병용을 먼저 시도할 수 있음 - 근거는 제한적이나 UACS 감별 겸 치료로 고려
