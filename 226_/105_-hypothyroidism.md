...
* T4 및 T3는 혈중에서 결합단백질과 결합한 상태로 순환하며, 이 중 **TBG**가 결합능의 약 70\~75%를 담당(transthyretin·albumin은 결합친화도가 낮아 영향 미미) - 따라서 TBG 농도 변화가 total T4/T3에 영향(free T4·TSH는 대개 보상되어 유지)
  * TBG 저하 시 : 만성 간질환, 신증후군, 영양 결핍 등에서 감량 고려(☞ 위 "검사 결과에 영향을 주는 요인" 표의 s-TBG↓ 약물 참고)
  * TBG 상승 시 : 임신, estrogen 노출 등에서 증량 고려(☞ 위 표의 s-TBG↑ 약물 참고)
...
_✽본 섹션은 2026 American Thyroid Association(ATA) 임신·산욕기 갑상선질환 가이드라인(Thyroid 2026;36(5):481-544, 2017판 개정)을 반영함_
