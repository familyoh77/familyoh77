...
* 일상적인 1차 치료 또는 T3 단독요법은 원칙적으로 권고하지 않음 - levothyroxine 또는 그 부형제에 대한 알레르기·불내성이 확인된 경우에 한해 예외적으로 고려
...
* 조절 목표
  * TSH : 검사실 분기별(trimester-specific) 참고구간이 있으면 최우선 사용; 없는 경우 대안으로 1·2분기 TSH 0.1\~4.0 mIU/L을 사용(3분기는 비임신 참고치 적용 가능)
    * [ ] 과거 적용하던 "비임신 상한에서 0.5 mIU/L 감산" 방식의 보정 공식은 현성 갑상선저하증의 최대 46%를 다른 범주(무증상/정상/저T4혈증)로 오분류할 수 있음이 확인되어 더 이상 권장하지 않음
...
2013\~2015년 국민건강영양조사 기준 집단(갑상선질환·가족력 없음, 갑상선자가항체 음성, 비임신) 분석에 근거하여 한국인 TSH 참고치를 0.6\~6.8 mIU/L로 제시 - 국제적으로 흔히 쓰이는 4.0\~5.0 mIU/L 상한보다 높음(많은요오드 섭취와 연관)\
