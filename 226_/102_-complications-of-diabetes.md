...
* **항혈소판제** \[ADA 2025]:
  * 증상성 PAD 또는 ASCVD 동반 시 → aspirin 100 ㎎ qd <mark style="color:blue;">\[아스피린 프로텍트]</mark> 또는 clopidogrel 75 ㎎ qd <mark style="color:blue;">\[플라빅스]</mark>
...
* **SGLT2i · GLP-1 RA**: MACE 및 MALE(major adverse limb events) 감소 효과 입증 \[ADA 2025]
  * GLP-1 RA는 하지 절단 위험을 낮출 수 있다는 신규 근거가 제시되고 있음 - PAD 동반 T2DM 환자에서 혈당 관리 약제 선택 시 고려 요소로 추가 (ADA 2026)
* 생활습관: 금연(필수), DASH 식이
...
* **진단 기준**: eGFR <60 mL/min/1.73㎡ 또는 중등도 이상 알부민뇨(uACR ≥30 ㎎/g, 구 미세알부민뇨) 또는 기타 신손상 소견이 **3개월 이상 지속**될 때 CKD로 진단 (☞ 만성콩팥병 챕터)
  * 당뇨병성 망막병증 등 다른 당뇨병 미세혈관 합병증이 동반되어 있으면 신장 생검 없이도 **당뇨병콩팥병증(DKD)으로 추정 진단** 가능; 그렇지 않은 경우(특히 급격한 신기능 악화, 활동성 요침사, 망막병증 없는 T1DM) 다른 신장 질환 감별 고려
...
<table><thead><tr><th width="200">항목</th><th width="220">T1DM</th><th>T2DM</th></tr></thead><tbody><tr><td>uACR (u-Alb/Cr ratio)</td><td>진단 후 5년째부터 매년</td><td>진단 즉시, 이후 매년</td></tr><tr><td>eGFR (s-Cr 기반)</td><td>동일</td><td>동일</td></tr><tr><td>혈압</td><td>매 방문마다</td><td></td></tr><tr><td>지질(TC/LDL/HDL/TG)</td><td>매년</td><td></td></tr></tbody></table>
