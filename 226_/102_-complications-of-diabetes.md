...
#### <mark style="color:$primary;">합병증의 분류</mark>
...
* 진단 기준 : eGFR <60 ㎖/min/1.73㎡ 또는 중등도 이상 알부민뇨(uACR ≥30 ㎎/g, 구 미세알부민뇨) 또는 기타 콩팥 손상 소견이 3개월 이상 지속 (☞ [만성콩팥병](../227_/112_-chronic-kidney-disease-ckd.md))
...
* **임의뇨** 우선(아침 첫 소변 권장); uACR >500 ㎎/g이면 Prot/Cr ratio 병용 가능
  * 검사 전 24시간 이내 격렬한 운동, 발열, 요로감염, 심한 고혈당, 심한 고혈압, 생리 중 채뇨는 알부민뇨를 일시적으로 상승시킬 수 있어 해석에 주의 - 가능하면 이런 상황을 피해 재검
* 3\~6개월 간격 3회 검사에서 ≥2회 양성 → '중등도 알부민뇨(구 미세알부민뇨)' 확진
* uACR ≥300 ㎎/g &/or eGFR 30\~60 → 연 2회 검사
...
### <mark style="color:orange;">치료 방침 - 4-pillar 접근법 (KDA 2025 · KDIGO 2024 · ADA 2026)</mark>

{% hint style="info" %}
**KDA 2025 핵심 권고** - 당뇨병콩팥병증 치료의 우선 약물:

1. **알부민뇨가 있거나 eGFR이 감소한 경우** → **A1C 수치와 무관하게** 신장 이익이 입증된 SGLT2i를 우선 사용하고 금기·부작용 없는 한 유지 \ - 단순 혈당강하제가 아니라 **신장 보호 치료**로서의 위치가 강조됨
2. **SGLT2i는 신대체 요법을 시작하기 전까지 유지** 가능 \\
3. **알부민뇨(+), eGFR 감소, 정상 혈청 칼륨**인 T2DM 환자 → **비스테로이드 미네랄코티코이드수용체길항제(finerenone)** 고려 \\
...
{% hint style="danger" %}
⚠️ ACEI와 ARB 병용(dual RAS blockade)은 고칼륨혈증·급성 신장 손상 위험으로 **권고되지 않음**
{% endhint %}

{% hint style="info" %}
**SGLT2i·nsMRA 동시 시작 (ADA 2026 Recommendation 11.9)** - RAS 차단제를 사용 중인 T2DM 환자에서 uACR ≥100 ㎎/g이고 eGFR 30\~90인 경우, SGLT2i와 nsMRA(finerenone)를 순차적이 아닌 **동시에 시작하는 것을 고려**할 수 있음. 신장 결과 연구에 참여한 대상자 대부분이 이미 RAS 차단제로 최적화된 상태였다는 근거에 기반; 동시 시작 시 s-K 모니터링을 더욱 면밀히 시행
{% endhint %}
...
* eGFR ≥20 → SGLT2i 처방; 첫 투여 후 eGFR 일시적 감소 ≤30%이면 지속; **신대체 요법 시작 전까지 유지 가능** \\
...
* **1차 약물**: ACEI 또는 ARB
  ...
  * **정상 혈압 + 정상 알부민뇨인 당뇨병 환자에게 예방적 목적의 ACEI/ARB 투여는 권고되지 않음** (ADA/KDA 공통)
...
* **단백질 섭취** \[KDA 2025]: 일반적 제한 불필요; 과다 섭취(>1.3 g/kg/d)와 엄격한 제한(< 0.6 g/kg/d) 모두 피함 ; 투석 중에는 1.0\~1.2 g/kg/d 유지
