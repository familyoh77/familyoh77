...
#### <mark style="color:$primary;">4-pillar 접근법</mark>

* KDIGO 2024는 4가지 핵심 약물(SGLT2i, RAS 차단제, statin, finerenone)의 동시·조기 시작을 권장하는 4 pillar 접근법을 제안
...
{% hint style="info" %}
**KDA 2025 핵심 권고** - CKD 치료에서 RAS 차단제 및 statin에 추가하여 권고

1. 알부민뇨가 있거나 eGFR이 감소한 경우 : A1C 수치와 무관하게 신장 이익이 입증된 **SGLT2i**를 우선 사용하고 금기·부작용 없는 한 유지; 단순 혈당강하제가 아니라 신장 보호 치료로서의 위치가 강조됨
2. 알부민뇨(+), eGFR 감소, 정상 혈청 칼륨인 T2DM 환자 : **비스테로이드 미네랄코티코이드수용체길항제**(finerenone) 고려
3. 심혈관 위험이 높은 T2DM 환자 → 알부민뇨 진행 억제를 위해 **GLP-1 RA** 고려 \[제한적권고]
{% endhint %}
...
graph LR
    ...
    자가 관리</u><br/>식이 조절·운동·
    금연·체중 조절"]
    B["<u>1차 약물 (Pillar 접근법)</u><br/>SGLT2i (eGFR≥20, 심장·신장 보호 목적 시 단독 1차 선택 가능)<br/>Metformin (T2DM, eGFR≥30, 혈당 조절 목적) · RAS 차단제 · Statin<br/><i>※ KDA 2025: 장기 보호 적응증 시 
    Metformin 병용 여부와 
    무관하게 SGLT2i 우선</i>"]
    C["<u>심장·신장 보호 약물 추가</u><br/>ns-MRA/finerenone
    (알부민뇨 지속 시)<br/>GLP-1 RA (심혈관·신장 
    고위험 또는 SGLT2i 불가)"]
    D["<u>위험 요소 통합 관리</u><br/>혈당·혈압·
    지질 목표 달성"]
    E["<u>3~6개월마다 
    위험 요인 재평가</u><br/>혈압·uACR·
    eGFR·s-K 모니터링"]
...
<p align="center"><strong>CKD 환자의 신장-심장 위험 인자 관리</strong></p>
