...
* **WIfI 병기 분류**: 상처(Wound)·허혈(Ischemia)·발 감염(foot Infection) 3개 축을 각각 0\~3등급으로 평가하여 조합하는 병기 체계로, 당뇨발 병변의 중증도뿐 아니라 말초동맥질환(PAD) 중증도 평가, 궤양 치유 가능성 예측, 절단 위험도 평가에 활용도가 확대되고 있음
...
{% hint style="danger" %}
⚠️ **Euglycemic DKA**: SGLT2i 사용 중 전신 상태 불량한 경우 혈당이 정상이더라도 DKA를 반드시 고려. DKA의 약 10%는 혈당 <200 ㎎/㎗로 발현됨 \[ADA 2025]. 수술 전 SGLT2i는 3\~4일 전 중단 필수.
{% endhint %}
...
* 혈당 ≥300 ㎎/㎗ + 과일향 날숨 + 구토/호흡 곤란/의식 변화 → **즉시 응급실 이송**
...
* 혈당 >250 ㎎/㎗ (euglycemic DKA는 <200 ㎎/㎗도 가능)
