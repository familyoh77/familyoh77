...
* **항혈소판제**: aspirin 100 mg qd <mark style="color:blue;">[아스피린 프로텍트]</mark>; CVD 병력 있는 aspirin 알레르기 → clopidogrel 75 mg/d <mark style="color:blue;">[플라빅스]</mark>
* **혈당·혈압·지질 통합 관리** (☞ 당뇨병콩팥병증 치료 방침 참조)
* **SGLT2i · GLP-1 RA**: MACE 및 MALE(major adverse limb events) 감소 효과 입증 [ADA 2025]
* 생활습관: 금연(필수), 규칙적 유산소 운동, DASH 식이
...
graph TD
    ...
    B["<b>1차 약물 (Pillar 접근법)</b><br/>Metformin (T2DM, eGFR≥30) · SGLT2i (eGFR≥20)<br/>RAS 차단제 (고혈압/알부민뇨) · Statin"]
    ...
    style E fill:#e8c060,stroke:#8a6020,color:#333
```
...
* **목표**: **130/80 mmHg 미만** \[KDA 2025 단일 목표; ESPRIT·BPROAD 연구 근거] (✽이전 단백뇨 유무에 따른 이중 기준에서 단일 목표로 통일)
  ...
  * \[ADA 2025] 심혈관·신장 고위험 시 수축기 혈압 **<120 mmHg** 권장
* **1차 약물**: ACEI 또는 ARB
...
* **단백질 섭취**: 제한할 필요는 없으며, 신장 질환이 있는 경우에 과다 섭취나 엄격한 제한은 피함 \[무작위대조군연구, 일반적권고] (✽KDA 2025 수정 — 기존 <0.8 g/kg/d 제한 권고에서 변경); 투석 중에는 1.0\~1.2 g/kg/d 유지
* 저염식: Na <2 g/d (소금 5 g)
* BMI <25 목표; 규칙적 운동, 금연 필수
* 영양제·한약·민간요법 복용 전 반드시 주치의 상의

{% hint style="info" %}
빈혈 발생 위험이 비당뇨 CKD 대비 2배 → 조혈 치료 필요성 주기적 평가
{% endhint %}
...
graph TD
    ...
    3rd["3차 약제 (오피오이드계)<br/>통증 지속 시 단독 또는 병합 요법<br/>oxycodone CR 10~40 mg bid [옥시콘틴 서방] OR<br/>tramadol 50~400 mg/d [트리돌]"]
...
* **α-lipoic acid** <mark style="color:blue;">[치옥타시드]</mark>, **γ-linolenic acid** <mark style="color:blue;">[에보프림]</mark>: 병인 치료 역할; 일부 연구에서 DPN 증상 완화
...
* **회피 약물**: GLP-1 RA, opioid, anticholinergics, TCA, pramlintide, DPP-4i
...
* **수액**: 중증 신장 손상 없으면 N/S 1~1.5 L/h로 1~2시간 투여 시작
