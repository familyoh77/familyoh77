...
* 유병률(2021\~2022년 통합 기준) : 우리나라 ≥30세에서 당뇨병 15.5%(남 18.1%, 여 13.0%), 당뇨병전단계 41.4%(남 43.8%, 여 38.5%) _\[당뇨병 fact sheet 2024]_; T2DM이 전체 당뇨병의 90% 이상 차지 _\[IDF 2025]_
* 호발 연령
...
* 독립된 공식 분류라기보다 성인에서 서서히 진행하는 자가면역성 T1DM 표현형을 지칭하는 임상 용어임. ADA 분류에서는 발병 연령과 관계없이 자가면역성 β-cell 파괴에 의한 당뇨병을 T1DM으로 분류함
...
<mark style="color:cyan;">**영양실조 관련 당뇨병 (Type 5 diabetes, malnutrition-related diabetes)**</mark>

* IDF가 2025년 별도 유형으로 공식 인정; 저체중·만성 영양실조 배경에서 발생하는 인슐린 결핍성 당뇨병으로 주로 저소득국에서 보고됨. ADA 공식 분류나 KCD에는 아직 별도 반영되지 않았으며 국내 임상 의의는 제한적이나 용어 문의 시 참고

## <mark style="color:green;">원인 및 위험 인자</mark>

* **공통** : 유전, 1촌 가족(first-degree relative)
* **T1DM** : 가장 확립된 위험 인자는 T1DM 가족력과 고위험 HLA 유전형이며, 췌도 자가항체(GAD65, IA-2, ZnT8, IAA) 양성은 자가면역 과정 및 진행 위험을 나타내는 표지자임. Enterovirus 감염, Vit D 결핍 및 일부 주산기 인자는 관찰연구에서 연관성이 보고되었으나 개인의 발병 원인으로 단정할 수 없음. Congenital rubella 등 감염에 의한 당뇨병은 다른 특정형 당뇨병으로 구분함
* **T2DM**
...
* 구역/구토, 복통, 깊고빠른 호흡(Kussmaul), 과일향 호흡, 의식 변화와 함께 고혈당 또는 케톤 양성 → **DKA 의심; 즉시 응급 평가**. DKA 확진에는 당뇨병/고혈당 외에 케톤혈증과 대사성 산증 확인이 필요하며, 가능하면 요중 케톤보다 혈중 β-hydroxybutyrate를 측정함 - 상세 진단·치료·Red Flags 3단계는 (☞ [당뇨병 합병증 - DKA](102_-complications-of-diabetes.md#당뇨병케토산증-diabetic-ketoacidosis-dka))의 기준을 우선 적용
  ...
  * 발열 등 급성 질환 중 혈당이 상승하고 케톤이 양성이면 혈당 수치만으로 중증도를 판단하지 말고 당일 응급 평가
* 혈당 ≥600 ㎎/㎗와 심한 탈수·의식 혼탁 → **HHS 의심; 즉시 응급 평가**. 확진에는 고삼투압과 유의한 케톤혈증·산증이 없거나 경미함을 확인해야 함 (☞ [당뇨병 합병증 - HHS](102_-complications-of-diabetes.md#고삼투압고혈당상태-hyperosmolar-hyperglycemic-state-hhs))
...
* 혈당 ＞240 ㎎/㎗ + 소변/혈중 케톤 양성이나 위의 응급 기준(구토·호흡곤란·의식변화 등) 미해당. 케톤이 증가하거나 구토·복통·호흡곤란·탈수·의식 변화가 발생하면 즉시 응급실로 이송 - 자세한 기준은 102번 DKA 챕터 참조
* 원인 불명 혈당 급상승 또는 반복되는 저혈당 (＜54 ㎎/㎗)
* 급성 발적 또는 감각 이상을 동반한 새로운 신경병증 증상
* 당뇨발 : 궤양, 봉와직염, 심한 허혈성 통증
* 신기능 급격 악화 (eGFR 급감, 요소 질소 상승)

<mark style="color:$info;">**조기 평가 및 추적**</mark> <mark style="color:$info;">- 즉각 위험 낮으나 호전 없으면 의뢰</mark>

* 생활 습관 교정 및 2제 이상 혈당 강하제에도 A1C 목표 미달
* 미세알부민뇨(중등도 알부민뇨) 새로 발견 또는 단백뇨 증가 (☞ [단백뇨](../227_/111_-proteinuria.md#undefined-1))
...
_\_²⁾ 75 g OGTT 2시간 후 혈당_\
³⁾ _각 진단 기준은 합병증 위험 자료를 기반으로 설정된 독립적인 절단값이며, 동일 환자에서 공복 혈당·OGTT 2시간 혈당·A1C가 서로 정확히 환산되는 값은 아님_

* 명백한 고혈당 증상이 없는 경우에는 두 번째 비정상 결과로 신속히 확인함. 동일 검체 또는 동일 시점에 시행한 서로 다른 검사 두 가지가 모두 진단 기준에 해당하거나, 동일 검사가 서로 다른 시점에 두 번 진단 기준에 해당하면 진단할 수 있음. 검사 결과가 불일치하면 진단 기준을 넘은 검사를 우선 반복
...
* 공복 : 최소 8시간 칼로리 섭취를 하지 않은 상태. 지나치게 긴 공복, 급성 질환, 스트레스 및 평소와 다른 식사·활동은 결과에 영향을 줄 수 있으므로 표준화된 조건에서 검사
* 식후 2시간은 식사 개시부터 2시간째를 의미(경구 당 부하 검사도 마시기 시작부터)
* 혈당 측정은 정맥 혈장 혈당을 이용하는 것을 원칙으로 함
* 검체와 식사 상태에 따라 전혈·혈장 및 정맥혈·모세혈관혈 사이에 차이가 있으므로 진단에는 표준화된 검사실 정맥 혈장 포도당을 사용
  * 일반적으로 손끝 전혈을 측정하는 혈당계는 혈장 혈당 값으로 보정되어 표시됨
* 신속 혈당 검사는 저산소증, 말초관류 저하, hematocrit 및 약물·당류 간섭의 영향을 받을 수 있으며 간섭 물질과 오차 방향은 기기·측정 원리에 따라 다름. 임상상과 맞지 않으면 해당 기기 설명서를 확인하고 검사실 혈장 혈당으로 재확인
...
* **적혈구 수명 연장으로 A1C가 높아질 수 있는 경우** : 철결핍·Vit B12·folate 결핍 빈혈 등
* **적혈구 수명 단축으로 A1C가 낮아질 수 있는 경우** : 급만성 실혈, 용혈성 빈혈, erythropoietin 치료, 임신 2·3분기/산욕기, 투석 등
* **방향이 일정하지 않거나 검사법 의존적인 경우** : 수혈, Hb variants, 진행된 CKD/uremia, 고중성지방혈증·고빌리루빈혈증, 일부 약물·보충제. 혈당 자료와 불일치하면 사용한 검사법의 간섭 여부를 확인하고 fructosamine/glycated albumin 또는 CGM 지표를 보조적으로 고려
...
* 감별 검사 : islet auto-Ab(인슐린, glutamic acid decarboxylase(GAD), islet antigen 2(IA-2), zinc transporter 8(ZnT8)), c-peptide
  * C-peptide는 주로 인슐린 치료 중이면서 당뇨병 유형이 불확실한 환자의 분류에 사용함. 무작위 검체를 식후 5시간 이내에 동시 혈당과 함께 측정할 수 있으며, ＜200 pmol/L은 심한 인슐린 결핍을 지지하고, 200\~600 pmol/L은 불확정, ≥600 pmol/L은 T2DM을 강하게 지지함. 단일 수치만으로 확진하거나 인슐린을 중단하지 않음
    * [ ] 단위 환산 참고 : 1 ng/㎖ ≒ 331 pmol/L; 0.6 ng/㎖ ≒ 200 pmol/L; 1.8 ng/㎖ ≒ 600 pmol/L
    * [ ] 경계값 해석 시 인슐린 치료 여부, 유병 기간, 임상 맥락을 함께 고려해야 함; 단일 수치로 확정 진단은 위험
    * [ ] 국내 자료의 공복 C-peptide 200/330 pmol/L 절단값은 보조적으로 참고할 수 있으나, 검사 조건·유병 기간·신기능과 인슐린 치료 여부를 함께 해석하고 국제 알고리듬의 200/600 pmol/L 구간과 혼용하여 확정 진단하지 않음
...
Start([T1DM 의심 성인¹⁾])
Islet[islet 자가항체 검사²⁾]
T1Support[자가면역성 T1DM을<br>강하게 지지³⁾]
MonoCheck[단일유전자 당뇨병의 특징?⁴⁾]
GeneTest[가능하면 유전자 검사]
Unclear[분류 불명확<br>임상상에 따라 안전하게 치료]
InsulinCheck[인슐린 치료 중이며<br>진단 후 3년 초과?]
Cpep[C-peptide + 동시 혈당⁵⁾]
Low[＜200 pmol/L<br>심한 인슐린 결핍 지지]
Mid[200~600 pmol/L<br>불확정; 추적 재평가]
High[≥600 pmol/L<br>T2DM을 강하게 지지]
Follow[임상 경과를 추적하며<br>필요 시 재평가]

Start --> Islet
Islet -->|양성| T1Support
Islet -->|음성³⁾| MonoCheck
MonoCheck -->|있음| GeneTest
MonoCheck -->|없음| Unclear
Unclear --> InsulinCheck
InsulinCheck -->|Yes| Cpep
InsulinCheck -->|No| Follow
Cpep --> Low
Cpep --> Mid
Cpep --> High
...
class Islet,GeneTest,Cpep lightGreen
classDef yellow fill:#fff9c4,stroke:#ffe082
class MonoCheck,InsulinCheck yellow
classDef pink fill:#fde8f0,stroke:#e91e8c
class T1Support,Low,Mid,High,Follow pink
```

<p align="center"><strong>T1DM 의심 환자의 진단 알고리듬</strong></p>

_¹⁾ T1DM 의심 기준(다음 중 하나 이상) : 젊은 발병 연령, BMI＜25 또는 의도치 않은 체중 감소, DKA 또는 현저한 고혈당, 급속한 인슐린 치료 전환, 당뇨병 유형에 대한 불확실성. 연령과 BMI를 기계적인 진단 기준으로 사용하지 않음_\
\_²⁾ GAD 항체를 우선 검사; 음성 시 IA-2, ZnT8 추가 검사(가능한 경우)\
_\_✽IAA(인슐린 자가항체)는 외인성 인슐린 치료 시작 전 검사에서만 해석 가능 - 치료 시작 후에는 자가면역 반응과 인슐린 노출에 의한 반응성 항체를 구별할 수 없음_\
\_³⁾ 단일 항체 양성은 임상상·항체 종류·역가와 위양성 가능성을 함께 판단하고 필요 시 확인 검사. 성인 발병 T1DM의 5\~10%는 자가항체 음성일 수 있음\_\
\_⁴⁾ Monogenic diabetes 특징: 강한 가족력(다세대에 걸친 상염색체 우성 양상), 경미하고 안정적인 고혈당, 젊은 발병 연령, 상대적으로 적은 인슐린 요구량 등\_\
\_⁵⁾ C-peptide는 주로 인슐린 치료 중이면서 분류가 불확실한 환자에서 사용.\
_\_✽검사 조건: 식후 5시간 이내 무작위 C-peptide와 동시 혈당을 측정할 수 있음. 동시 혈당 ＜72 ㎎/㎗이면 재검하고, DKA 등 고혈당 응급상황 후 2주 이내에는 검사하지 않음. 진행된 CKD에서는 제거 감소로 수치가 높게 측정될 수 있음. 검사 전 인슐린을 중단하지 않으며 결과만으로 인슐린 치료를 중단하지 않음_\
\_✽한국인 기준값(국내연구) : 공복 C-peptide 200/330 pmol/L 절단값은 보조적으로 참고할 수 있으나, 국제 알고리듬의 200/600 pmol/L 구간과 혼용하여 확정 진단하지 않음 \[KDA]\
\_✽분류가 불확실하면 임상 경과와 함께 추적 재평가하며, 고혈당 악화 위험이 있는 환자에서 인슐린을 성급히 중단하지 않음_
...
<table><thead><tr><th width="100">병기</th><th width="304">특징</th><th>비고</th></tr></thead><tbody><tr><td>Stage 1</td><td>islet 자가항체 ≥2개 양성 + 정상 혈당</td><td>무증상; 평생 임상적 T1DM 발생 위험이 매우 높으나 진행 속도에는 개인차가 있음</td></tr><tr><td>Stage 2</td><td>대개 islet 자가항체 ≥2개 양성 + 이상 혈당(dysglycemia; 공복 100~125, OGTT 2시간 140~199, A1C 5.7~6.4% 또는 기준치 대비 A1C 10% 이상 상승)</td><td>무증상; Stage 3 진행 위험이 높으므로 전문 평가 및 추적</td></tr><tr><td>Stage 3</td><td>당뇨병 진단 기준 충족 + 증상(다뇨, 다음, 체중 감소) 동반 가능</td><td>임상적 T1DM; 인슐린 치료 필요</td></tr></tbody></table>

_Ref. Jacobsen LM, Schatz DA. Type 1 Diabetes: A Review. JAMA 2026._

{% hint style="info" %}
**단일 IA-2 자가항체 양성자의 추적 (ADA 2026)** - IA-2만 단독 양성인 경우 이를 곧바로 Stage 2로 분류하지는 않지만, Stage 3 진행 위험이 높아 다중 자가항체 양성자와 유사하게 면밀히 모니터링함. 자가항체 양성이 확인된 무증상 성인·소아는 병기 평가와 추적 계획을 위해 조기 의뢰가 중요함 (ADA 2026 Recommendation 2.8a/2.8b/2.9).
{% endhint %}

{% hint style="info" %}
**Teplizumab (anti-CD3 단클론항체)** - 미국 FDA 2022년 승인, 8세 이상의 Stage 2 T1DM에서 Stage 3(임상적 발병)로의 진행을 지연시키는 질병 조절 면역치료제. 주요 무작위대조군연구에서 Stage 3 진행까지의 중앙값은 48.4개월(위약군 24.4개월)이었음. 국내 허가·도입 여부는 처방 시점에 식약처 허가사항을 확인
{% endhint %}
...
<table><thead><tr><th width="194">지표</th><th width="200">목표</th><th>의미</th></tr></thead><tbody><tr><td>TIR (70~180 ㎎/㎗)</td><td>＞70% (하루 약 17시간)</td><td>목표 혈당 범위 내 시간</td></tr><tr><td>TAR (＞180 ㎎/㎗)</td><td>&#x3C;25%</td><td>고혈당 시간 (<em>Time Above Range)</em></td></tr><tr><td>TAR (＞250 ㎎/㎗)</td><td>&#x3C;5%</td><td>심한 고혈당 시간</td></tr><tr><td>TBR (&#x3C;70 ㎎/㎗)</td><td>&#x3C;4%</td><td>저혈당 시간 (<em>Time Below Range)</em></td></tr><tr><td>TBR (&#x3C;54 ㎎/㎗)</td><td>&#x3C;1%</td><td>2단계(임상적으로 유의한) 저혈당 시간</td></tr></tbody></table>

_✽고령·고위험군(저혈당 위험이 높거나 기대여명이 제한된 경우)에서는 TIR ＞50%, TBR(＜70 ㎎/㎗) ＜1% 등으로 목표를 완화하여 개별화함_
...
* 대사이상지방간질환(MASLD) 평가 : 모든 T2DM 성인에게 MASLD 평가를 권고 \[KDA]
  ...
  * T2DM + MASLD/MASH 동반 시 : MASH에 대한 이익이 입증된 GLP-1 RA 또는 GIP/GLP-1 이중작용제(tirzepatide)를 혈당·비만 치료 목적으로 고려. Resmetirom은 비간경변 MASH와 F2\~F3 섬유화가 확인된 성인에서 간 전문의 관리하에 고려하며, 국내 허가·도입 여부는 처방 시점에 확인 (☞ [MASLD](../224_/093_-nafld.md))
...
_✽검사 시점은 당뇨병 유형·유병 기간과 이전 결과에 따라 조정함. 특히 안저검사와 uACR/eGFR은 T2DM에서는 진단 시부터, T1DM에서는 일반적으로 진단 5년 후부터 시행하며, 정상 안저 소견과 안정된 혈당이 지속되면 안과검사 간격을 1\~2년으로 연장할 수 있음._

#### <mark style="color:$primary;">예방접종</mark>

* 연령·과거 접종력·동반 질환별 적응증에 따라 [B형간염](../231_/210_-vaccination.md#b-hepb), [폐렴구균](../231_/210_-vaccination.md#pneumococcal-pneumonia), [독감](../231_/210_-vaccination.md#influenza), 대상포진, COVID-19 및 RSV 백신 접종
  * 대상포진 : 당뇨병 자체는 우선 접종 대상 기준이 아니나 연령 기준(예: 50세 이상)에 해당하면 재조합 대상포진 백신 접종 권고
...
* [지중해식 식단](../231_/217_-nutritiondiet-guideline.md#undefined-6) : 채소·콩류·견과류·씨앗·과일·전곡류와 생선/해산물을 충분히 섭취하고, 주된 지방으로 올리브유를 사용하며, 붉은 고기·가공육·첨가당을 제한. 당뇨병 또는 심혈관 예방을 위해 음주를 새로 시작하도록 권고하지 않음
* 탄수화물, 단백질, 지방의 이상적인 고정 비율은 없으며 총열량, 식품의 질, 치료 목표·선호·동반 질환에 따라 개별화
...
* 항산화제, ω-3, Vit, 무기질 보충 : 혈당 개선 목적의 일상적 보충은 권고 안 함
  ...
  * Vit D 결핍은 일반 원칙에 따라 교정하되, 당뇨병 예방만을 목적으로 Vit D 보충제를 일률적으로 권고하지 않음
...
* 심한 당뇨망막병증은 망막출혈·망막박리 위험 때문에 고강도 또는 Valsalva를 유발하는 운동을 회피하고, 심한 말초신경병증이나 활동성 발 질환에서는 체중부하 운동을 조정. 안정된 무증상 CVD 고위험 환자에게 고강도 운동을 일률적으로 금지하지 말고 증상·운동 강도·기저 체력에 따라 평가 및 개별화

#### <mark style="color:$primary;">운동 전 혈당 수준에 따른 대처</mark>

<table><thead><tr><th width="148">혈당 수준</th><th>대처 방법</th></tr></thead><tbody><tr><td>&#x3C;90 ㎎/㎗</td><td>인슐린 또는 저혈당 유발 약제 사용자는 운동 전 빠르게 흡수되는 탄수화물 15~30 g을 섭취하고 재측정. 짧은 운동이나 인슐린·저혈당 유발 약제를 사용하지 않는 환자에서는 불필요할 수 있음</td></tr><tr><td>90~150 ㎎/㎗</td><td>대개 운동 가능. T1DM 또는 인슐린 치료 환자의 장시간 유산소운동에서는 인슐린 작용 시간·운동 강도·예상 시간에 따라 개별화한 탄수화물 보충 계획 적용</td></tr><tr><td>150~250 ㎎/㎗</td><td>대개 운동 가능. 운동 중 혈당 추세를 확인하고 불필요한 탄수화물 섭취는 피함</td></tr><tr><td>250~350 ㎎/㎗</td><td>T1DM, SGLT2 억제제 사용 또는 증상이 있으면 케톤 검사. 중등도 이상의 케톤 또는 몸이 좋지 않으면 운동하지 않고 고혈당·케톤증을 교정. 케톤이 없고 상태가 양호하면 저~중강도 운동을 신중히 고려</td></tr><tr><td>≥350 ㎎/㎗</td><td>운동을 연기하고 케톤과 급성질환을 평가. 케톤이 없더라도 수분 보충과 개인별 교정 인슐린 계획에 따라 혈당을 먼저 교정하며, 총 인슐린 용량을 일률적으로 50% 감량하지 않음</td></tr></tbody></table>

_✽위 표는 특히 T1DM 또는 인슐린·저혈당 유발 약제를 사용하는 환자의 안전 지침이며, 탄수화물과 인슐린 조정은 평소 운동 반응을 바탕으로 개별화함._
...
* 비만 수술 고려 기준 \[제한적권고] : BMI ≥30 ㎏/㎡인 T2DM 환자가 비수술 치료로 체중 감량, 혈당 조절 또는 대사이상지방간질환 개선에 실패한 경우 비만 수술을 고려
  * ✽국내 건강보험 급여 기준(수술 종류·BMI 구간·동반 질환 요건)은 KDA 권고와 별도로 정해지므로 HIRA 고시를 반드시 확인할 것
...
{% hint style="info" %}
GLP-1 RA(세마글루타이드·터제파타이드 등)의 국내 공급·급여 상태는 빠르게 변화 중이므로(2026년 기준 일부 성분 급여 등재 절차 진행), 처방 전 최신 HIRA 고시와 성분별 허가사항을 확인할 것.
{% endhint %}

<table data-search="false"><thead><tr><th width="220">임상 상황 / Phenotype</th><th>우선 고려 약제</th></tr></thead><tbody><tr><td>비만 우세 (체중 감량 필요)</td><td>GLP-1 RA (semaglutide <mark style="color:blue;">[오젬픽]</mark>, liraglutide <mark style="color:blue;">[빅토자]</mark>), GIP+GLP-1 RA (tirzepatide <mark style="color:blue;">[마운자로]</mark>)</td></tr><tr><td>ASCVD 동반 또는 고위험</td><td>심혈관 이익이 입증된 GLP-1 RA(liraglutide, semaglutide, dulaglutide <mark style="color:blue;">[트루리시티]</mark>) 또는 SGLT2i</td></tr><tr><td>심부전(HF) 동반</td><td>SGLT2i (empagliflozin <mark style="color:blue;">[자디앙]</mark>, dapagliflozin <mark style="color:blue;">[포시가]</mark>); A1C 무관하게 우선 사용<br>· 증상성 HFpEF + 비만 동반 시: HFpEF 이익이 입증된 GIP/GLP-1 이중작용제(tirzepatide <mark style="color:blue;">[마운자로]</mark>) 또는 GLP-1 RA(semaglutide)를 비만·혈당 치료 계획에 포함 고려</td></tr><tr><td>CKD 동반 (알부민뇨·eGFR 감소)</td><td>심장·신장 이익이 입증된 SGLT2i를 A1C와 무관하게 우선 고려; 진행된 CKD(eGFR ＜30)에서는 비신배설 GLP-1 기반 약제를 우선 고려 가능. T2DM+CKD에서 최대내약 ACEI/ARB에도 알부민뇨가 지속되고 eGFR·혈청 K 조건을 충족하면 finerenone <mark style="color:blue;">[케렌디아]</mark> 고려</td></tr><tr><td>허혈성 뇌졸중 동반</td><td>GLP-1 RA 또는 pioglitazone 고려(KDA 2025 신규); pioglitazone은 심부전·부종·골절 위험을 평가</td></tr><tr><td>MASLD/MASH 동반</td><td>생검 확인 MASH 또는 간섬유화 고위험군: MASH에 대한 이득이 입증된 GLP-1 RA를 혈당 관리 목적으로 우선 사용; pioglitazone <mark style="color:blue;">[액토스]</mark> 또는 GLP-1/GIP 이중작용제(tirzepatide)도 고려 가능. 비간경변 MASH와 F2~F3 섬유화가 확인된 성인에서 resmetirom <mark style="color:blue;">[레즈디프라]</mark>을 간 전문의 관리하에 고려; 국내 허가·도입 여부는 처방 시점에 확인</td></tr><tr><td>저혈당 위험 높음</td><td>DPP-4i, GLP-1 RA, SGLT2i (SU/glinide 회피)</td></tr><tr><td>비용 제한</td><td>Metformin, SU (glipizide <mark style="color:blue;">[글루코트롤]</mark> 등 단기 작용제 선호)</td></tr><tr><td>단순 혈당 강하 (합병증 없음)</td><td>Metformin <mark style="color:blue;">[다이아벡스]</mark> 기반 + 필요시 DPP-4i 또는 SGLT2i 추가</td></tr></tbody></table>
...
* 갑상선 촉진
* 안저 검사 : T2DM은 진단 시, T1DM은 일반적으로 진단 5년 이내에 첫 동공확대 안저검사를 시행. 망막병증이 없고 혈당이 안정적이면 1\~2년 간격으로 연장할 수 있고, 이상이 있으면 중증도에 따라 더 자주 검사
* 피부 검사(인슐린 주사 부위 포함)
* 발 평가(족부 맥박 포함)
...
* 지난 1년 내 평가하지 않았으면 다음 검사를 고려 : 지질, 간 기능, TSH\*, uACR, eGFR. 신장 선별은 T2DM에서 진단 시부터 매년, T1DM에서는 일반적으로 진단 5년 후부터 매년 시행\
...
{% hint style="info" %}
CGM은 인슐린 치료, 저혈당 위험, 혈당 변동, HbA1c 신뢰도 저하 등에서 적극적으로 제안할 수 있으나, 모든 환자에게 의무적으로 적용하는 검사는 아님. 도입 전 해결하려는 임상 문제, 환자의 사용 능력·선호, 부담·비용과 국내 급여 기준을 확인하고 이득을 주기적으로 재평가할 것.
{% endhint %}

* 대상 : 인슐린을 사용하거나 저혈당 유발 약제를 투여받는 환자, 혈당 변동·저혈당·HbA1c 불일치 등에서 CGM이 관리에 도움이 되고 안전하게 사용할 수 있는 환자에게 진단 시점부터 그 이후 언제든지 사용을 제안
  * \[고려] 비인슐린 치료 중인 T2DM 성인에서도 CGM 사용을 고려할 수 있음; 기저 인슐린만 사용하는 T2DM 환자에서도 CGM 고려 확대 (ADA 2026)
  * 근거의 크기 : 인슐린 사용 T2DM에서 CGM은 손끝 혈당 측정 대비 HbA1c를 평균 **약 0.3%p** 낮춤(다수 메타분석 종합, 중등도 근거 수준); 비인슐린 치료군에서도 유사한 −0.3\~0.4%p 개선이 보고되나, **중증 저혈당(3자 도움 필요) 발생을 줄인다는 무작위 연구 근거는 아직 없음**(사건 자체가 드물어 검정력 부족) _\[JAMA Intern Med 2026]_
  * 삶의 질·당뇨병 distress·저혈당 공포 등 환자 보고 결과는 여러 메타분석에서 대조군과 유의한 차이가 없었으며, 환자 만족도만 일부 연구에서 개선됨
...
* 인슐린 치료를 하는 T2DM 성인 환자에서 실시간 연속혈당측정장치 권고
  ...
  3. 고위험 직업군(상업 운전자, 중장비·건설 근로자 등) - 안전 목적의 저혈당 조기 발견; 생리적 타당성은 강하나 직접적 RCT 근거는 부족함
  4. HbA1c 신뢰도가 낮은 경우(중증 빈혈, 겸상적혈구병, 진행된 CKD, 잦은 수혈 등) - CGM 기반 TIR/GMI를 보조 지표로 활용
  5. Ramadan 등 장기 금식 기간 중 인슐린·저혈당 유발 약제를 사용하는 환자 - 국제 컨센서스에서 강하게 권고되며 금식 중 저혈당 발생률 증가가 보고됨

<mark style="color:cyan;">**당뇨병이 없거나 당뇨병전단계·비만 목적의 CGM 사용**</mark>

* CGM은 당뇨병이 없는 사람에게도 식이·활동이 혈당에 미치는 영향을 파악하는 웰니스 도구로 마케팅되고 있으나, 이 목적에 대한 근거는 부족함 _\[JAMA Intern Med 2026]_
* 과체중·비만·당뇨병전단계 대상 연구들에서 체중, BMI, 총 열량 섭취의 유의한 변화는 확인되지 않았음(다수 소규모 RCT 종합)
* 당뇨병이 없는 사람에서는 표준화된 정상 혈당 변동 범위가 확립되어 있지 않고, 동일한 식사에도 개인 간 식후 혈당 반응 편차가 매우 커서 특정 음식에 대한 "혈당 스파이크"를 임상적으로 해석하기 어려움
* 잠재적 위해 : 불필요한 불안, 과도한 식이 제한, 섭식 문제 악화 위험이 있으나 아직 충분히 연구되지 않았음 - prediabetes·비만·웰니스 목적의 CGM 사용은 신중히 접근할 것

#### <mark style="color:$primary;">Glycated protein (fructosamine) or Glycated albumin</mark>

* 반감기가 짧아 최근 2\~4주간의 혈당 상태를 반영
* A1C가 신뢰하기 어려운 상황에서 최근 혈당 상태를 평가하는 유용한 대체·보조 지표이나, 당뇨병 진단 기준으로 사용하지 않으며 A1C만큼 표준화되어 있지 않음
* 대상 : 혈당과 A1C 결과가 상충하거나 A1C에 영향을 주는 요인이 있는 경우, 최근 당 상태를 평가하고자 하는 경우 고려. 저알부민혈증·단백소실·간질환·갑상선질환 등 단백질 대사 이상에서는 해석에 주의 (보험 기준 확인)
...
* T2DM에서 통상적인 혈당강하제를 중단한 뒤 최소 3개월이 지나 측정한 A1C가 ＜6.5%로 유지되면 '관해(remission)'로 정의 \[ADA 2021]. 10% 이상의 체중 감량, 비만대사수술 및 집중적 생활습관 중재는 관해를 유도할 수 있는 방법이지만 정의의 필수조건은 아님. 관해 후에도 재발과 합병증 위험이 남으므로 적어도 매년 A1C와 합병증을 추적
* 장기 경과 : ARMMS-T2D 연구에서 7년 시점 관해율은 대사수술군 18.1% vs 생활습관/약물치료군 6.2%였음 _(JAMA 2024)_; 관해를 처음 달성한 환자의 35\~50%는 결국 재발을 경험한다는 보고가 있어, 관해 달성 이후에도 장기적인 추적 관찰이 필요함을 뒷받침함 \[ADA 2026]

```mermaid
graph TD
    A(["T2DM 진단"]) --> B["개별화 치료<br/>생활습관·체중 관리<br/>필요 시 비만대사수술"]
    B --> C["A1C &lt;6.5% 도달?"]
    C -->|YES| D["약제 중단의 이익·위험과<br/>별도 심장·신장·비만 적응증 평가"]
    D --> E["통상적 혈당강하제 중단 후<br/>최소 3개월째 A1C &lt;6.5%?"]
    E -->|YES| F["당뇨병 관해<br/>(Remission)"]
    E -->|NO| G["•혈당강하제 재개<br/>•목표 재설정"]
    F --> H["적어도 매년 A1C와<br/>합병증 추적"]
    H --> I["A1C &lt;6.5% 유지?"]
    I -->|YES| H
    I -->|NO| G
    C -->|NO| J["•생활 습관 강화<br/>•약물 치료 조정"]
...
### <mark style="color:orange;">T1DM 동반 비만 관리</mark>

* 비만(BMI ≥30 ㎏/㎡, 아시아계 ≥27.5 ㎏/㎡)이 동반된 T1DM 성인에서는 일반 성인과 동일한 비만 관리 전략(GLP-1 RA 기반 치료 및/또는 대사수술)을 적용할 수 있음 (ADA 2026 Recommendation 8.29 신규)
  * 공동 의사결정에 따라 개별화; 저혈당·케톤증 위험에 대한 교육 및 모니터링 강화 필요 (상세 약물 선택 ☞ [당뇨병 약물 치료](101_-antidiabetics.md#1형-당뇨병-t1dm))
...
1. ＜70 ㎎/㎗ 시 포도당 15\~20 g 투여. 사탕·주스 등은 제품별 영양표시에서 당 함량을 확인
2. 포도당 투여 15분 후 저혈당 지속 시 포도당 반복 투여
3. 혈당이 정상으로 회복되면 음식 섭취; 다음 식사까지 1시간 이상 남은 경우 복합탄수화물 + 단백질(예: 크래커 + 치즈, 우유) 추가 섭취

{% hint style="danger" %}
**중증 저혈당(의식 저하, 경련)** : 환자가 스스로 경구 섭취 불가 시 보유한 glucagon 제제의 허가 용법에 따라 투여하고 119 이송. 가족/동거인에게 보관 위치와 사용법을 미리 교육하며, 국내 유통 제형은 처방 시점에 확인할 것.
{% endhint %}
...
* 혈당을 평소보다 자주(일반적으로 2\~4시간마다) 측정하고, T1DM 또는 SGLT2 억제제 사용자는 고혈당·구역·복통·권태가 있으면 혈중 또는 소변 케톤을 확인
* **T1DM의 기저 인슐린은 금식 중에도 중단하지 않음**. 혈당과 섭취량에 따라 추가 교정 및 식사 인슐린은 사전에 정한 sick-day plan에 따라 조절
* 약제별 일시 중단
  * **Metformin** : 지속적인 구토·설사, 탈수, 저산소증 또는 AKI 위험이 있으면 보류하고 회복 후 신기능과 섭취 상태를 확인하여 재개
  * **SGLT2 억제제** : 급성 중증질환·탈수·금식·수술 전후에는 euglycemic DKA 예방을 위해 중단. 계획 수술 전에는 일반적으로 3일 전(ertugliflozin은 4일 전)부터 중단하고, 임상적으로 안정되고 정상적인 경구 섭취가 재개된 뒤 투여
  * **SU/glinide** : 식사를 못하거나 저혈당 위험이 높으면 보류
  * **GLP-1 기반 약제** : 지속적인 구토·심한 위장관 증상 또는 탈수가 있으면 일시 중단 고려
* 탈수 예방을 위해 물 또는 무가당 음료를 조금씩 자주 섭취하고, 식사를 못하면서 인슐린을 사용하는 경우 저혈당 예방을 위한 탄수화물 섭취 계획을 적용
* 약제를 임의로 중단·재개하지 않도록 평상시에 환자별 sick-day plan과 연락 방법을 교육

<mark style="color:cyan;">**입원 치료 고려 대상**</mark>

* 중등도 이상의 케톤 또는 케톤 증가, 반복 구토·복통·호흡곤란, 의식 변화, 심한 탈수, 수분 섭취 불가, 교정에도 지속되는 현저한 고혈당·저혈당 → 응급실 평가
...
* 목표 혈압
  * \[대한당뇨병학회 2025, 대한고혈압학회 2026] ＜130/80 ㎜Hg
  * \[ADA 2026] ＜130/80 ㎜Hg; 임신 시 110\~135/85 ㎜Hg
    * 심혈관 또는 신장 위험이 높은 환자에서는 안전하게 달성 가능하다면 수축기 혈압 ＜120 ㎜Hg를 목표로 하도록 권장 _(BPROAD, NEJM 2024)_
* 선택 약제 : ACEI/ARB, thiazide 유사 이뇨제, dihydropyridine CCB 등 1차 항고혈압제 중 동반 질환에 따라 선택
  * 단, uACR(소변Alb/Cr ratio) ≥30 ㎎/g 또는 eGFR ＜60의 CKD가 있거나 관상동맥질환이 동반된 경우에는 ACEI 또는 ARB를 우선 고려
  * 혈압 ≥150/90 ㎜Hg인 경우 처음부터 서로 다른 계열의 2제 병용 요법 고려

```mermaid
graph TD
    A(["첫 혈압 ≥130/80 <br/>& <150/90 ㎜Hg"]) --> B["생활습관중재 &<br/>1제 요법 시작"]
    D(["첫 혈압 <br/>≥150/90 ㎜Hg"]) --> E["생활습관중재 &<br/>2제 요법 시작"]
    B --> F["Albuminuria or CAD?"]
    E --> G["Albuminuria or CAD?"]
    F -->|NO| H["1제 요법:<br/>•ACEI or ARB<br/>•CCB<br/>•Diuretic"]
    F -->|YES| I["ACEI or <br/>ARB으로 시작"]
    G -->|NO| J["다음 중 2 선택:<br/>•ACEI or ARB<br/>•CCB<br/>•Diuretic"]
    G -->|YES| K["다음으로 선택:<br/>•ACEI or ARB<br/>& •CCB or Diuretic"]
    H --> L[["혈압 및 부작용 평가"]]
    I --> L
    J --> L
    K --> L
    L -->|목표 달성| M["치료 유지"]
    L -->|목표 달성 실패| N["보완적 약물군의 약제 병용:<br/>•ACEI or ARB<br/>•CCB<br/>•Diuretic"]
    L -->|부작용 발생| O["다른 약제로의 변경 검토:<br/>•ACEI or ARB<br/>•CCB<br/>•Diuretic"]
    N --> P["혈압 및 부작용 평가"]
    O --> P
    P -->|목표 달성| Q["치료 유지"]
    P -->|"목표 달성 실패 or<br/>부작용 발생"| R["•Mineralocorticoid Receptor Antagonist 추가 고려;<br/>•의뢰"]

style A fill:#fef4f8,stroke:#f06baf
style D fill:#fcd4e6,stroke:#e0448e
classDef yellow fill:#fff9c4,stroke:#ffe082
class F,G,L,P yellow
classDef sky fill:#e3f2ff,stroke:#2196f3
class B,E,H,I,J,K,N,O sky
classDef blue fill:#d0e8ff,stroke:#1a6abf
class M,Q blue
style R fill:#fde8f0,stroke:#e91e8c
```
...
* T2DM+CKD에서 최대내약 ACEI/ARB 치료에도 알부민뇨가 지속되고 eGFR·혈청 K가 허가 기준을 충족하면, 당뇨병콩팥병증 진행 억제를 위해 심혈관 및 신장 이익이 입증된 nonsteroidal mineralocorticoid receptor antagonist(finerenone)를 고려. 시작 및 증량 후 혈청 K와 eGFR 모니터링
* 심혈관 위험이 높은 T2DM 환자에서, 알부민뇨의 진행 억제를 위해 심혈관 및 신장 이익이 입증된 GLP-1 RA를 권고
* 진행된 CKD(eGFR ＜30) 환자에서는 저혈당 위험이 낮고 심혈관 이익이 입증된 비신배설 GLP-1 기반 약제를 선호할 수 있음. 투석 환자에서도 시작·유지를 고려할 수 있으나 근거 수준이 낮고 경험이 제한적이므로 영양 상태·위장관 부작용을 면밀히 관찰하고 국내 성분별 허가사항을 확인
...
* GDM은 임신의 약 3\~14%에서 발생하며 진단 기준과 대상 집단에 따라 차이가 큼
* GDM의 영향 : 임신고혈압, 분만 시 손상, 난산, 임산부 당뇨병 발생과 관련; 거대아, 신생아 저혈당, 신생아 골절, 신경 손상 등 주산기 합병증 등 유발; 자녀의 비만 및 당뇨병 위험 증가
* **임신당뇨병(GDM)**은 임신 전 명백한 당뇨병이 없던 여성에서 임신 중 진단된 경우이며, **임신 전 당뇨병(T1DM/T2DM)**과는 망막검사·aspirin·분만 후 약제 조정 등 관리가 다르므로 구분함
...
* 목표 혈당 : 공복 또는 식전 ＜95 ㎎/㎗, 식후 1시간 ＜140 ㎎/㎗, 식후 2시간 ＜120 ㎎/㎗
...
* 안저 검사 : **임신 전 T1DM/T2DM**에서는 임신 전 또는 첫 임신 진료 시 안저검사를 시행하고, 망막병증 정도에 따라 임신 중 및 출산 후 1년까지 추적. 단순 GDM에서는 일률적 검사가 필요하지 않음
* 자간전증 예방 : **임신 전 당뇨병** 등 고위험 임신부에서 금기가 없으면 임신 12\~16주부터 저용량 aspirin 100\~150 ㎎/d 고려
* prenatal vitamin은 일반 산전관리 지침에 따라 투여. Folic acid 400 ㎍/d를 기본으로 하되 고위험군은 별도 용량을 적용하며, iodine은 국내 섭취량·갑상선질환을 고려하여 필요 시 potassium iodide **150 ㎍/d**를 개별적으로 결정

#### <mark style="color:$primary;">항당뇨병제</mark>

* 인슐린 : 생활 요법으로 목표 혈당에 도달하기 어려운 경우 인슐린 치료 시행
  * GDM에서 임신 중 시작한 인슐린은 대개 분만 직후 중단하고 혈당을 재평가함
  * 임신 전 당뇨병에서는 출산 직후 인슐린 요구량이 급감하므로 임신 전 용량·분만 직후 혈당·수유 여부를 바탕으로 감량하며, 특히 T1DM에서는 기저 인슐린을 중단하지 않음
* 인슐린이 임신 중 약물 치료의 우선 선택이며, 경구 혈당강하제를 일률적인 1차 치료로 사용하지 않음. 약제별 임신 자료와 국내 허가사항을 확인
* 인슐린을 사용할 수 없거나 안전한 투여가 어려운 일부 환자에서 충분한 설명과 공동 의사결정 후 metformin을 고려할 수 있음. 태반기능부전, 전자간증 또는 태아성장제한 위험이 있으면 사용하지 않음

#### <mark style="color:$primary;">출산 후 관리</mark>

* **최근 GDM 병력이 있는 여성**은 출산 4\~12주 후 75 g OGTT 시행을 권고 → 정상인 경우 이후 1\~3년마다 당뇨병 선별 검사
...
* 진단 즉시 약물 요법을 적극적으로 고려
  ...
  * 당뇨병 증상이 없고 A1C ＜8.5%인 경우 metformin 단독 요법으로 치료; 목표 미달 시 기저 인슐린 병용 또는 소아청소년 T2DM 적응증이 있는 추가 약제(예: 일부 SGLT2i·GLP-1 RA 등 해외에서 10세 이상 소아 적응증이 승인된 성분)를 고려하되 국내 소아 적응증·허가사항을 확인
* 비만 치료 목적으로 liraglutide를 고려할 때에는 당뇨병 치료 적응증과 비만 적응증의 제품·용량·연령이 다르므로 국내 허가사항을 확인
...
_Complex / Intermediate : ≥3개의 만성 질환 동반 or 2+ ADL 장애 or 경도 이상의 인지 장애_\
_Very complex / Poor health : 장기요양 or 말기 질환 or 중등도 이상의 인지 장애 or 2+ ADL 장애_

{% hint style="info" %}
1\. 반복/유의미한 저혈당 또는 치료 부담이 높은 경우 덜 엄격한 목표, 즉 더 높은 A1C 목표를 설정할 수 있음
...
* 공복 혈당 &/or A1C : 당뇨병이 없는 경우 매년 검사를 기본으로 하되 기대여명·기능 상태와 검사 결과에 따라 개별화
...
2. General health tests : 지질 패널 등 기본 검사를 시행하고, ECG·BMD·abdominal aortic aneurysm 초음파는 증상·연령·성별·흡연력·골절 위험 등 일반 적응증에 따라 선택
...
* 환자의 상태에 따른 조절 목표 설정
* 치료 방법, 저혈당 위험 및 자가 관리 능력에 따라 혈당 측정 빈도를 개별화
* **저혈당 발생 주의** : 고령자는 저혈당 위험이 높고, 저혈당을 스스로 잘 인지하지 못하므로 치료 중재 및 목표 혈당 설정에 주의를 요함
  * 즉시 저혈당 처치 기준은 혈당 ＜70 ㎎/㎗. 반복되는 현저한 고혈당, 측정 한계 초과, 구토·탈수·의식 변화 또는 경구 섭취 불량은 별도의 신속 평가 대상
...
* 판정 : 0\~1점 = 영양 위험 낮음, 2점 = 중등도 영양 위험; 영양 중재 필요, ≥3점 = 높은 영양 위험; 영양 중재 및 영양사 평가
* 영양실조 또는 그 위험이 있는 환자에서는 충분한 열량·단백질 섭취와 치료요법 단순화를 우선하며, 엄격한 식사 제한으로 섭취량이 더 감소하지 않도록 함
...
* 즉시 조치 대상 : 혈당 ＜70 ㎎/㎗
* 신속 평가 대상 : 반복되는 현저한 고혈당, 구토, 증상이 있는 고혈당, 탈수 또는 구강 섭취 불량. 혈당 70\~100 ㎎/㎗ 자체는 저혈당이 아니며, 저혈당 위험 약제 사용자는 혈당 추세와 증상을 함께 확인

<table data-search="false"><thead><tr><th width="110">종류</th><th width="160">고령 영향</th><th width="260">Stages 3~5 CKD 동반 환자</th><th>CVD 동반 환자</th></tr></thead><tbody><tr><td>Insulin</td><td>저혈당</td><td>clearance↓, 저혈당 위험↑, gastroparesis; 용량 조절, 식후 속효성 인슐린 투여 고려</td><td>TZD 병용 시 체액 저류</td></tr><tr><td>Metformin</td><td>GI 불내성, Vit B12 결핍; 저혈당 없음</td><td>eGFR &#x3C;45 시 시작하지 않으며, 사용 중인 경우 1 g/d로 감량; eGFR &#x3C;30 시 중단; 급성 신 손상 위험 시 중단(조영제, 저혈압, sepsis, shock, hypoxia)</td><td>• 관상동맥질환 환자에서 유익<br>• 안정된 심부전 자체는 금기가 아니나, 급성 비대상성 심부전·저산소증·쇼크에서는 일시 중단</td></tr><tr><td>SU</td><td>저혈당, 체중 증가; glyburide 회피</td><td>• Glyburide: eGFR &#x3C;60 시 회피<br>• Glimepiride: eGFR &#x3C;30 시 회피<br>• Glipizide: eGFR &#x3C;30 시 주의</td><td>• 저혈당이 주된 위험; 부정맥·뇌졸중을 직접 유발한다고 단정하지 않음</td></tr><tr><td>TZD</td><td>골절 증가, 체액 저류, 체중 증가; 저혈당 없음</td><td>체액 저류, 골절 증가; 용량 조절 필요 없음</td><td>• 체액 저류(심부전 악화 위험)<br>• Pioglitazone: 일부 ASCVD 이득 자료가 있으나 심부전·부종·골절 위험을 함께 평가</td></tr><tr><td>DPP-4i</td><td>저혈당 없음</td><td>• Sitagliptin: eGFR ≥45 - 100 ㎎/d; eGFR 30~＜45 - 50 ㎎/d; eGFR ＜30 또는 투석 - 25 ㎎/d<br>• Saxagliptin: eGFR ＞50 - 2.5~5 ㎎/d; eGFR ≤50 - 2.5 ㎎/d<br>• Alogliptin: eGFR ＞60 - 25 ㎎/d; eGFR 30~60 - 12.5 ㎎/d; eGFR &#x3C;30 - 6.25 ㎎/d<br>• Linagliptin: 용량 조절 필요 없음</td><td>• Saxagliptin: 심부전 위험↑</td></tr><tr><td>SGLT2i</td><td>탈수; 저혈당 없음; Empagliflozin: 심혈관 사고 및 CKD 진행↓; SGLT2i 공통: 체액 감소·생식기 진균감염 주의</td><td>• SGLT2i: 심장·신장 보호 목적에서는 적응증이 있는 환자에서 일반적으로 eGFR ≥20부터 시작을 고려하고 투석·이식 전까지 유지 가능; 성분별 국내 허가사항 확인<br>• 혈당강하 효과는 eGFR ＜45에서 감소하므로 심장·신장 보호 적응증과 혈당강하 목적을 구분<br>• 급성질환·탈수·금식·수술 전후에는 euglycemic DKA 예방을 위해 일시 중단<br>• 만성 사용은 AKI 위험을 증가시키는 것으로 보지 않으나 시작 초기 eGFR 감소와 체액 상태를 모니터링<br>• 상세 성분·용량은 ☞ [당뇨병 약물 치료](101_-antidiabetics.md) 및 최신 국내 허가사항 참조</td><td>• 심부전·심혈관 이익이 입증된 SGLT2i를 성분별 적응증에 따라 선택</td></tr><tr><td>AGi</td><td>GI 부작용; 저혈당 없음</td><td>s-Cr ＞2 ㎎/㎗ 시 회피(연구 부족)</td><td>(AGi = α-Glucosidase inhibitors)</td></tr><tr><td>Glinide</td><td>저혈당; 끼니를 거르는 사람에게 유용</td><td>• Nateglinide: 신기능 저하 시 저혈당 위험을 고려하여 신중 투여; 국내 허가사항 확인<br>• Repaglinide: eGFR &#x3C;30 - 주의</td><td>• 저혈당이 주된 위험; 부정맥·뇌졸중을 직접 유발한다고 단정하지 않음</td></tr><tr><td>GLP-1 RA</td><td>GI 부작용; 저혈당 없음</td><td>• Exenatide: eGFR &#x3C;30 - 회피<br>• Liraglutide, Dulaglutide, Semaglutide: 용량 조절 불필요<br>• Lixisenatide: eGFR &#x3C;15 - 회피<br>✽성분별 국내 유통·공급 여부는 변동될 수 있어 처방 시점에 확인 필요</td><td>• Liraglutide, Semaglutide: CVD 사고↓</td></tr></tbody></table>

### <mark style="color:orange;">CKD 또는 CVD가 있는 고령 당뇨병 환자에서의 약물 특성</mark>

#### <mark style="color:$primary;">고혈압</mark>

* 1차 선택: ACEI/ARB, thiazide 유사 이뇨제 또는 dihydropyridine CCB. 알부민뇨·eGFR 감소 또는 관상동맥질환이 있으면 ACEI/ARB 우선
...
* ≥80세 또는 기대 여명이 짧은 환자에서는 기존 ASCVD, frailty, 기능 상태, 치료 부담 및 기대여명을 고려하여 LDL-C 목표와 치료 강도를 개별화
* 1차 선택 : statin
* 대체 또는 추가 : ezetimibe 또는 PCSK9 억제제
* 공복 TG ＞500 ㎎/㎗ : 이차 원인을 교정하고 췌장염 위험을 줄이기 위해 fibrate 또는 처방용 고용량 omega-3를 고려. 일반 건강보조용 fish oil과 심혈관 위험 감소 적응증의 고순도 EPA를 구분
* statin은 T2DM 발생 위험을 소폭 높일 수 있지만 심혈관 이득이 더 크므로 이 이유만으로 중단하지 않음. 혈당은 일반적인 당뇨병 관리 계획에 따라 모니터링

#### <mark style="color:$primary;">기타</mark>

* Congestive heart failure : TZD(rosiglitazone, pioglitazone)는 체액 저류로 증상성 심부전을 악화시킬 수 있어 회피. DPP-4 억제제는 계열 전체가 아니라 saxagliptin 등 성분별 심부전 자료와 허가사항을 확인
* ASCVD : 출혈 위험에 대한 주의깊은 평가 후 CVD 2차 예방을 위한 저용량 aspirin(100 ㎎/d; ADA 기준 75\~162 ㎎/d) 투여 권고
...
* **눈 검진** : 기본적으로 정기적인 동공확대 안저검사를 시행하되, 망막병증이 없고 혈당이 안정적이면 1\~2년 간격으로 연장할 수 있으며 이상 소견이 있으면 더 자주 추적
...
_✽실제 진료에서는 단순 상위코드보다 망막병증·신장합병증·신경병증·순환계합병증 등 환자에게 확인된 합병증에 맞는 E10/E11 세부코드를 우선 선택하며, 당뇨병이 확진된 환자에게 R73.0을 대신 사용하지 않음._
...
> **처방례 3. T2DM + ASCVD (심혈관 이익 입증 약제 포함 고려)**
>
> ```
...
> ```
>
> _✽ ASCVD 동반 시 심혈관 이익 입증 GLP-1 RA(dulaglutide, liraglutide, semaglutide) 또는 SGLT2i를 포함한 치료 우선(KDA 2025). 구역은 처음에 흔하며 4주 후 대부분 경감; 0.75 ㎎ qwk 유지 또는 1.5 ㎎ qwk로 증량 가능. GLP-1 RA 병용의 정확한 급여 인정 단계·조건은 HIRA 고시를 반드시 확인할 것._
...
> ```
>
> _✽ KDA 2025: 과체중/비만인 당뇨병전단계 성인에서 metformin 사용을 고려할 수 있음 \[제한적권고] - 기존 연령 제한(30\~70세) 삭제. 매년 혈당 상태 재평가. 국내에서 당뇨병전단계는 metformin의 허가 적응증이 아니므로 이 사용은 허가 외(off-label)·비급여 처방에 해당함 - 충분한 설명과 동의 후 결정._
...
* 생식기 진균감염(외음부·질 또는 귀두의 가려움, 발적, 분비물)이 증가할 수 있습니다. 배뇨통·빈뇨·발열 등 요로감염 증상이 있으면 진료를 받으십시오.
* **급성 질환·수술 전후·심한 탈수 시 주치의에게 연락 후 일시 중단 여부를 확인하십시오** (드물지만 euglycemic DKA 위험).
* 당뇨발 상처·궤양·감염 또는 하지 허혈 증상이 있으면 약제와 관계없이 즉시 진료를 받으십시오. 절단 위험에 관한 주의는 성분별 허가사항과 환자의 말초동맥질환·족부질환 위험을 함께 확인합니다.
...
* 저혈당 증상(식은 땀, 손 떨림, 어지럼, 공복감)이 생기면 포도당 15 g을 즉시 섭취하십시오. 사탕·주스는 제품별 당 함량을 영양표시로 확인합니다.
* 인슐린은 개봉 전에는 냉장 보관하고, 개봉 후 보관 온도와 사용기간은 제품별 허가사항을 따릅니다(제품에 따라 약 28\~56일 등 차이가 있음).
...
* 대처 : 포도당 15 g 즉시 섭취(사탕·주스는 영양표시의 당 함량 확인) → 15분 후 재측정 → 호전 없으면 반복
...
혈당 조절이 불안정하거나 치료를 변경한 경우에는 대개 3개월마다, 목표에 안정적으로 도달한 경우에는 약 6개월마다 당화혈색소를 검사합니다. 눈(안저), 콩팥(uACR·eGFR), 발 신경, 혈압과 지질 검사의 시작 시점과 간격은 당뇨병 유형·유병 기간·이전 검사 결과에 따라 담당 의사와 정하세요.
