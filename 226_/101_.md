...
&#xNAN;_<mark style="color:$info;">Ref. KDA 당뇨병 진료지침 제9판. 2025. 표 6-2.1; ADA Standards of Medical Care in Diabetes 2025</mark>_
...
{% hint style="danger" %}
**Euglycemic DKA (정상 혈당 케톤산증)** : 혈당이 정상(180\~250 ㎎/㎗ 이하)이어도 발생 가능하므로 혈당 정상=안전 으로 판단하지 말 것.
...
¹⁾ ASCVD, CKD에 심혈관·신장 보호 효과 입증. ²⁾ 심부전에 적용. \
³⁾ 이 eGFR 범위에서는 혈당 강하 효과는 제한적임. ⁴⁾ 10 ㎎ 용량 사용
...
¹⁾ eGFR ≥50에서 용량 조절 필요 없음. ²⁾ eGFR ≥45에서 용량 조절 필요 없음\
...
\*pioglitazone은 MASLD/MASH(대사기능장애 관련 지방간 질환)에서 T2DM 성인의 일차 약제 후보로 고려할 수 있음 \[제한적권고] - 체중 증가·부종·골절 위험을 고려하여 개별화
...
※ miglitol <mark style="color:blue;">\[미그보스]</mark>: CrCl <25 또는 s-Cr >2 시 금기; 국내에서는 비급여 전환 이후 당뇨병 치료보다 오프라벨 비만 치료 목적으로 주로 처방되는 특수한 위치의 약제임
...
* <mark style="color:blue;">\[직듀오 서방]</mark> dapagliflozin/MTF · <mark style="color:blue;">\[다파메트 서방]</mark> dapagliflozin/MTF · <mark style="color:blue;">\[자디앙듀오]</mark> empagliflozin/MTF · <mark style="color:blue;">\[엔블로멧 서방]</mark> enavogliflozin/MTF
...
* <mark style="color:blue;">\[네시나액트]</mark> pioglitazone/alogliptin · <mark style="color:blue;">\[액토스메트]</mark> pioglitazone/MTF · <mark style="color:blue;">\[듀비메트 서방]</mark> lobeglitazone/MTF · <mark style="color:blue;">\[듀비엠파]</mark> lobeglitazone/empagliflozin (TZD+SGLT2i 조합; 2025년 허가)
...
* **dapagliflozin/sitagliptin/MTF**: <mark style="color:blue;">\[다파시타엠]</mark> · <mark style="color:blue;">\[실다파엠]</mark> 등 — 2023년 시장 진입 이후 10개사 이상이 경쟁하는 대표적인 SGLT2i+DPP-4i+MTF 3제 복합제 시장 (제네릭 다수 추가 출시 중)
* **empagliflozin/linagliptin/MTF**: <mark style="color:blue;">\[엠시폴민]</mark> 등
* <mark style="color:blue;">\[듀비메트 에스서방]</mark> lobeglitazone/sitagliptin/MTF
* <mark style="color:blue;">\[듀비엠폴서방정]</mark> lobeglitazone/empagliflozin/MTF (TZD+SGLT2i+MTF 조합; 2026년 허가)

{% hint style="info" %}
✽ SGLT2i+DPP-4i+MTF 3제 복합제는 2023년 급여 기준 확대 이후 제네릭 출시가 매우 활발한 영역으로, 위 목록에 없는 품목(포시타엠, 자누플로멧, 시타칸다플메트, 다파이제 서방 등)도 다수 존재함 — 처방 시 최신 등재 현황 확인 권장
{% endhint %}
...
* 주의: 췌장염 과거력, 급성 신장 손상, 중증 간장애, 신장애, **중증 위마비를 포함한 중증 위장관 질환(권장되지 않음)**, **당뇨병성 망막병증(특히 semaglutide - 급격한 혈당 강하 시 망막병증 악화 보고; 망막병증 병력 있는 환자에서 안과 모니터링 강화 권고)**; **DPP-4i와는 병용하지 않음**
  * **눈 건강 관련 근거는 상반됨 (ADA 2026)**: 비동맥염성 앞허혈시신경병증(NAION), 녹내장, 신생혈관 황반변성(AMD), 당뇨망막병증 진행과의 연관성이 보고되나 연구 간 결과가 일치하지 않음; liraglutide·semaglutide·dulaglutide는 무작위연구에서 경미한 망막병증 악화와 연관되었다는 보고가 있어 치료 시작 전후 안과 평가·추적을 개별화
* 금기: 갑상선 수질암 또는 MEN2의 과거력 또는 가족력
* ASCVD 확인 또는 위험 인자가 있는 경우 심혈관 질환 예방 효과가 입증된 GLP-1 RA 추천
* **증상성 HFpEF + 비만 동반 시**: 심부전 관련 증상 개선 &/or 이벤트 감소 효과가 입증된 GLP-1 RA를 A1C와 무관하게 치료 계획에 포함 (ADA 2026 Recommendation 9.9b)
* **생검 확인 MASH 또는 간섬유화 고위험군**: MASH에 대한 이득이 입증된 GLP-1 RA를 혈당 관리 목적으로 우선 사용 (ADA 2026 Recommendation 9.13a)
...
* A1C 감소: \~2.0\~2.5%(GLP-1 RA 대비 우월); 체중 감소: 최대 \~15\~22% (SURMOUNT-1)
  * T2DM 환자 대상 SURMOUNT-2에서도 위약 대비 체중 9.6\~11.6%, A1C 1.55\~1.57% 추가 감소 - **현재 승인된 약제 중 가장 강력한 혈당·체중 감소 효과**로 ADA 2026에서 소개됨
...
* tirzepatide <mark style="color:blue;">\[마운자로]</mark>: 2.5 ㎎ qwk SQ → 4주마다 증량(5→7.5→10→12.5→15 ㎎/wk)
  ...
  * **증상성 HFpEF + 비만 동반 T2DM**: 심부전 관련 증상 개선 및 이벤트 감소 효과가 입증되어 A1C와 무관하게 혈당 치료 계획에 포함 권고 (ADA 2026 Recommendation 9.9a - GLP-1/GIP 이중작용제를 HFpEF 1차 선택으로 명시한 신규 권고)
  * **경구피임약 복용 여성 주의**: 위 배출 지연으로 경구피임약 흡수가 저하될 수 있음 - **투여 시작 후 4주간 및 매 증량 후 4주간** 비경구 피임법으로 전환하거나 차단(barrier) 피임법을 병행 (ADA 2026)
...
* 미국 FDA가 승인한 **유일한 T1DM 비-인슐린 보조 약제**; 위 배출 지연 및 식후 글루카곤 분비 억제를 통해 인슐린 최적화 후에도 목표 미달 시 추가 고려되는 약제
* 부작용(구역·구토·식욕 저하)과 식사마다 추가 주사가 필요하다는 번거로움으로 실제 사용 빈도는 낮음
* **2026년 7월 현재 국내 미도입** - 처방 대상 약제가 아니며 국외 문헌 이해를 위한 참고 정보로만 수록함 _\[JAMA 2026 Type 1 Diabetes Review]_
* ⚠️ 위마비(gastroparesis) 환자에서는 위 배출을 추가로 지연시키므로 회피 대상 약물임 (☞ [당뇨병위마비](102_-complications-of-diabetes.md#당뇨병위마비-diabetic-gastroparesis))
...
{% hint style="info" %}
**최신 동향** - CGM과 AI/머신러닝의 결합으로 당뇨병 관리가 '사후 대응(고혈당 발생 후 조치)'에서 '미래 혈당 예측 기반 선제 대응'으로 전환되고 있음. LSTM 등 딥러닝 기반 단기 혈당 예측 모델, 대규모 CGM 데이터로 학습한 foundation model(예: GluForm), 식이·활동 데이터를 결합한 개인 맞춤형 중재 등이 연구 단계에서 임상 적용 단계로 이행 중이며, 가장 빠르게 실용화된 영역이 아래 AID(자동 인슐린 주입) 시스템임. 아직 학회 공식 권고에는 반영되지 않은 연구 동향이므로 참고용으로 활용 _\[대한당뇨병학회 KDA Weekly Brief 2026년 17호]_
{% endhint %}
...
{% hint style="info" %}
※ 과이화 작용 증상(체중 감소, 다음, 다뇨)이 동반된 고혈당의 경우 인슐린 치료를 시행; A1C 9%를 기준으로 인슐린 치료 유무를 결정하는 것은 근거가 빈약하고 현실에 맞지 않음. 과이화 작용이 있을 때는 A1C 9% 이하에서도 인슐린을 사용해야 하고, A1C 9% 이상이더라도 인슐린 치료가 반드시 필요한 것은 아닐 수 있음 (KDA 2025)
{% endhint %}
...
✽**Insulin-only bionic pancreas(예: iLet)** : 체중만 입력하면 별도의 탄수화물 계산(carbohydrate counting) 없이 완전 자동으로 인슐린을 조절하는 차세대 AID. 기존 hybrid closed-loop 대비 환자의 입력 부담이 크게 줄어듦(NEJM 2022 다기관 RCT). 국내 도입 여부는 기기별로 확인 필요\
Ref. ADA. Standards of Medical Care in Diabetes. 2025. Fig 9-1; KDA 당뇨병 진료지침 제9판. 2025. 그림 6-1.1
{% endhint %}

### <mark style="color:orange;">인슐린 용량 계산 공식 (민감도 인자 · 탄수화물 비율)</mark>

* **인슐린 민감도 인자(Insulin Sensitivity Factor)** : 속효성/초속효성 인슐린 1단위가 낮추는 혈당(㎎/㎗) ≈ **1800 ÷ 체중(㎏)**
* **탄수화물 비율(Carbohydrate Ratio)** : 인슐린 1단위에 해당하는 탄수화물량(g) ≈ **450 ÷ 체중(㎏)**
  * 예) 체중 45 ㎏인 환자 : 민감도 인자 ≈ 40 ㎎/㎗/U(즉, 목표보다 150 ㎎/㎗ 높으면 약 4 U 추가), 탄수화물 비율 ≈ 10 g/U
* 위 공식은 초기 용량 추정을 위한 경험적 근사치이며, 실제 반응에 따라 개별 조정이 필수적임 _\[JAMA 2026 Type 1 Diabetes Review, Figure 3 각주]_
...
* **인슐린을 사용하는 모든 T1DM 및 T2DM 성인에게 AID 사용을 제안** - 기저 인슐린만 사용 중인 T2DM 환자도 목표 미달 시 대상에 포함 (ADA 2026 Recommendation 7.25a/b 확대)
* 빈번한 혈당 검사가 필요한 환자에서 간헐적 스캔 CGM(isCGM)을 고려 (✽ADA 2026부터는 isCGM을 별도 범주로 다루지 않고 과거 옵션으로만 언급하며, 현재는 실시간 CGM(rtCGM)·일반의약품 CGM(OTC-CGM)·전문가용 CGM(professional CGM) 3분류를 사용; ☞ [당뇨병](100_-diabetes-mellitus.md))
