...
### <mark style="color:orange;">인슐린 용량 계산 공식 (탄수화물 비율 · 민감도 인자)</mark>

_\[JAMA 2026 Type 1 Diabetes Review]_
...
* 예) "체중 45 ㎏, 식전 혈당 250 ㎎/㎗, 목표 혈당 100 ㎎/㎗, 섭취 예정 음식의 탄수화물량 50 g (영양성분표 또는 교환표를 이용하여 산출)"&#x20;
  1. CR = (450 ÷ 45) = 10 g/U
     * 식사 인슐린(meal bolus) = 50 g ÷ 10(CR) = 5 U
  2. ISF = (1800 ÷ 45) = 40 ㎎/㎗/U&#x20;
     * 교정 인슐린 = 150(목표보다 높은혈당) ÷ 40(ISF) ≈ 4 U&#x20;
  3. 총 식전 인슐린 = 총 9단위
* 위 공식은 초기 용량 추정을 위한 경험적 근사치이며, 실제 반응에 따라 개별 조정이 필수적임. 식후 혈당이 지속적으로 목표를 벗어나면 CR 자체를 재조정 - 식후 혈당이 반복적으로 높으면 CR을 낮추고(예: 10→8 g/U, 더 많은 인슐린 투여), 반복적으로 낮으면 CR을 높임(예: 10→12 g/U)
...
_<mark style="color:$info;">Ref. KDA 당뇨병 진료지침 제9판. 2025. 표 6-2.8; ADA Standards of Medical Care 2025</mark>_
