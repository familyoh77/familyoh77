...
### <mark style="color:orange;">혈액 검사</mark>

* TSH를 포함한 갑상선기능검사를 초기 검사로 시행하고, TSH가 낮으면 갑상선스캔을 시행
...
### <mark style="color:orange;">갑상선 초음파검사</mark>
...
_✽경부 림프절전이 의심, 명백한 갑상선외부침범, 확인된 원격 전이, 수질암 의심 등 불량한 예후 인자가 있으면 크기와 무관하게 병리진단검사 시행. 작은(＞0.5\~≤1 ㎝) 높은의심 결절이 되돌이후두신경 경로·후내측 피막에 인접한 경우 성인에서도 병리진단검사 권고; 소아는 크기가 작아도 높은의심이면 임상 소견을 고려해 시행. 양성(K-TIRADS 2) 결절은 지속적 성장 또는 비수술적절제·수술 예정인 경우 생검 가능._
...
* 비정형·여포종양·악성의심 등 미결정 결절에서 임상적 위험 요소, 세포검사 결과, 초음파 소견, 환자 선호도를 고려하여 시행&#x20;
...
### <mark style="color:orange;">Levothyroxine 억제 요법</mark>
...
### <mark style="color:orange;">비수술적 절제 치료</mark>

* 반복 병리진단검사에서 양성이라도 ① 압박증상, ② 미용적 문제, ③ 자율기능성 결절(갑상선기능항진증 동반) 중 하나에 해당하면 치료를 고려 - 수술, 방사성요오드, 비수술적절제(에탄올·고주파·레이저절제술) 중 임상 특성·동반질환·환자 선호를 고려해 선택
