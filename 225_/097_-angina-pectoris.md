...
* **만성 관상동맥병(chronic coronary disease, CCD)** : 이전의 "stable ischemic heart disease(SIHD)" 개념을 대체하는 광의의 용어 \[AHA/ACC 2023]; 폐쇄성/비폐쇄성 CAD, 이전 MI/재관류술, 비침습적 검사로 진단된 허혈성 심장병, 만성 협심 증후군 등 포함 — ✽ ESC는 동일한 개념 범위를 "만성 관상동맥증후군(chronic coronary syndromes, CCS)"으로 명명함(2019년부터); CCD와 CCS는 각각 미국·유럽 학회가 쓰는 동의어에 가까운 용어로, 본 챕터에서는 AHA/ACC 표기를 기본으로 사용
...
* 저항 훈련 : 주 2회
* 최대 심박수의 70%를 넘지 않는 강도가 일반적 기준이나, ESC 2024 CCS 가이드라인은 일률적 기준보다 **운동 부하 검사 결과 기반 개별화**를 강조함; 가능하면 운동 부하 검사로 개인별 한계를 확인 후 처방
...
> _※ 모니터링 : 복용 초기 기립성 저혈압·서맥 증상(어지럼, 실신성 전조) 확인; 휴식 시 맥박 55~60회/분 목표로 용량 조절_
...
> _※ 모니터링 : 어지럼·변비 등 부작용, QTc 연장 여부(특히 CYP3A 억제제 병용 시)_
...
> _※ 모니터링 : 간기능·CK(statin), 기침/고칼륨혈증(ACEi), 위장 출혈 징후(aspirin); 3~6개월 후 LDL-C 재평가_
...
> _※ 모니터링 : 생식기 진균감염·요로감염(SGLT2i), 탈수/체위성 저혈압 위험(이뇨제 병용 시), eGFR 추적_
