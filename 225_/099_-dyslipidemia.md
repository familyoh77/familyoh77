...
{% hint style="info" %}
아래는 \*\*진단 분류(NCEP ATP III 기준 체계)\*\*이며, 위험도별 **치료 목표치**는 별개 개념임 - 치료 목표치는 [Management 섹션의 관리 목표치 표](099_-dyslipidemia.md#관리-목표치) 참조.
{% endhint %}
...
graph TD
    ...
    B -->|고위험군| D[LDL 목표 &lt;70 ㎎/㎗]
    B -->|중등위험군| E[LDL 목표 &lt;100 ㎎/㎗]
    B -->|저위험군| F[LDL 목표 &lt;116 ㎎/㎗]
    N[["Risk enhancer 존재 시<br/>(조기 가족력, Lp(a)↑, CAC&gt;0,<br/>만성 염증질환 등)<br/>저위험군도 statin 고려"]] -.-> F
    C --> G[생활 습관 중재 + 고강도 statin 즉시 병행]
    D --> G
    E --> H[생활 습관 중재 우선 ± 중등강도 statin]
    F --> H
