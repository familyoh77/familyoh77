...
### <mark style="color:orange;">한국지질·동맥경화학회 권고안 (2022, 5판)</mark>

#### <mark style="color:$primary;">관리 목표치</mark>

* 1차 관리 대상 - LDL; 2차 관리 대상 - non-HDL
* 관상동맥질환(초고위험군) 및 뇌혈관질환·말초동맥질환·복부대동맥류·고위험 당뇨병군(고위험군)은 **절대 목표치**와 **기저치 대비 ≥50% 감소**를 동시에 달성하는 것이 원칙임 - 절대 목표치에 도달했더라도 감소율이 부족하면 추가 강화를 고려
...
_✽<sup>\*</sup>LDL 콜레스테롤 기저치 대비 ≥50% 감소를 동시에 권고(초고위험군, 고위험군 상단 행에 적용). <sup>1)</sup>급성심근경색증은 기저치 LDL 농도와 무관하게 즉시 스타틴 투약 권고. <sup>2)</sup>표적장기손상(알부민뇨, 만성콩팥병[eGFR &#x3C;60], 망막병증, 신경병증, 좌심실비대) 또는 주요 위험인자 3개 이상을 동반한 당뇨병은 LDL &#x3C;55 ㎎/㎗을 선택적으로 고려 가능. <sup>†</sup>주요 위험인자 : 연령(남 ≥45세, 여 ≥55세), 조기 관상동맥질환 가족력, 고혈압, 흡연, 낮은 HDL(&#x3C;40 ㎎/㎗). Ref. 한국지질·동맥경화학회. 이상지질혈증 진료지침 제5판(2022), 표 2-4_
