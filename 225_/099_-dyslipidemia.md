...
2018년 가이드라인의 Pooled Cohort Equations(PCE)를 대체하여 [**PREVENT-ASCVD 방정식**](https://professional.heart.org/en/guidelines-and-statements/prevent-calculator)을 1차 예방 위험도 산출에 사용하도록 권고함(30\~79세 적용). PCE 대비 위험도가 40\~50% 낮게 산출되는 경향이 있어 위험 구간 자체를 하향 재조정함\
...
#### <mark style="color:$primary;">2차성 이상지질혈증 원인별 지질 패턴 (선별 체크리스트)</mark>

<table data-search="false"><thead><tr><th width="342">원인</th><th>특징적 지질 패턴</th></tr></thead><tbody><tr><td>갑상선저하증(hypothyroidism)</td><td>LDL↑</td></tr><tr><td>신증후군(nephrotic syndrome)</td><td>LDL↑↑(현저한 상승)</td></tr><tr><td>만성콩팥병(CKD)</td><td>TG↑</td></tr><tr><td>담즙정체(cholestasis)</td><td>TC↑</td></tr><tr><td>과음(alcohol)</td><td>TG↑</td></tr><tr><td>steroid</td><td>LDL↑, TG↑</td></tr><tr><td>HIV 치료제(protease inhibitor 등)</td><td>TG↑</td></tr></tbody></table>

_✽새롭게 발견된 이상지질혈증에서 이 패턴에 해당하는 병력·검사 소견이 있으면 2차성 원인을 우선 감별_

### <mark style="color:orange;">위험 인자</mark>

#### <mark style="color:$primary;">LDL을 제외한 ASCVD의 주요 위험 인자</mark>

_\*위험 인자의 정량적으로 개수를 셀때 적용되는 목록_

1. 흡연
2. 고혈압 : SBP ≥140 ㎜Hg 또는 DBP ≥90 ㎜Hg 또는 항고혈압제 복용
3. 낮은 HDL : ＜40 ㎎/㎗
   * HDL ≥60 ㎎/㎗ 이상 시 보호 인자로 간주하여 총 위험 인자 개수에서 한 개를 차감함
4. 연령 : 남 ≥45세, 여 ≥55세
5. 조기 관상동맥병 가족력 : 부모나 형제자매 중 남 ＜55세, 여 ＜65세에서 관상동맥병 발병

#### <mark style="color:$primary;">관상동맥에 영향을 주는 위험 인자 \[ESC/EAS]</mark>

_\*정량적으로 개수를 세는 위험 인자가 아니라, 경계/중등위험군 환자의 위험도를 상향 재분류할지 판단할 때 참고하는 정성적 위험 수정 인자(risk modifier)_
...
* 만성 염증질환(류마티스관절염, 건선 등)은 지속적 염증 신호전달을 통해 ASCVD 위험을 증폭시킴; 암, 심부전, HIV 감염도 위험 증폭 동반질환으로 함께 고려 [2026 ACC/AHA]
...
* 가족성 고콜레스테롤혈증(FH) 등 중증·유전성 이상지질혈증 시사 소견
  ...
  * xanthelasma(눈꺼풀 황색종)
  * corneal arcus(각막환) - 특히 ＜45세에서 관찰 시
...
* 심와부 통증 + 오심/구토를 동반한 중증 고중성지방혈증(TG ≥1,000 ㎎/㎗) → 급성 췌장염
* 흉통 또는 신경학적 결손 → 급성 관상동맥증후군, 급성 뇌졸중
...
* 직접 측정 또는 계산
* [Friedewald 계산](https://www.mdcalc.com/calc/70/friedewald-equation-low-density-lipoprotein-cholesterol-ldl-c) 공식 : LDL = TC − HDL − (TG÷5)
  * TG가 증가할수록 정확도가 떨어지며, TG ＞400 ㎎/㎗에서는 적용 불가
  * [Martin-Hopkins equation](https://www.msdmanuals.com/professional/multimedia/clinical-calculator/martin-equation-for-low-density-lipoprotein-ldl-c), [Sampson equation](https://www.mdcalc.com/calc/10669/sampson-equation-low-density-lipoprotein-cholesterol-ldl-c) 등 TG 수준에 따라 보정 계수를 달리하는 계산식이 Friedewald 공식보다 정확도가 높은 것으로 알려져 있음
...
* 더 적극적인 ASCVD 위험 평가 및 교정 목적으로 다음 검사들을 고려
...
### <mark style="color:orange;">가족성 고콜레스테롤혈증(FH) 진단</mark>

* LDL ＞190 ㎎/㎗이거나 조기 ASCVD/조기 가족력이 있는 경우 FH를 감별을 요함

#### [<mark style="color:$primary;">DLCN(Dutch Lipid Clinic Network) Score</mark>](https://www.mdcalc.com/calc/3818/dutch-criteria-familial-hypercholesterolemia-fh)

* 항목별 점수를 합산하여 진단 확실성을 분류하는 도구. Simon Broome 기준과 함께 국제적으로 가장 널리 쓰임

<table data-search="false"><thead><tr><th width="572">항목</th><th align="center">점수</th></tr></thead><tbody><tr><td>1촌 이내 조기 관상동맥질환(남 &#x3C;55세, 여 &#x3C;60세) 가족력</td><td align="center">1</td></tr><tr><td>1촌 이내 LDL ＞95th percentile 가족력</td><td align="center">1</td></tr><tr><td>1촌 이내 건황색종(tendon xanthoma) 및/또는 각막환(조기) 가족력, 또는 소아 자녀의 LDL ＞95th percentile</td><td align="center">2</td></tr><tr><td>본인의 조기 관상동맥질환(남 &#x3C;55세, 여 &#x3C;60세)</td><td align="center">2</td></tr><tr><td>본인의 조기 뇌혈관/말초혈관질환</td><td align="center">1</td></tr><tr><td>건 황색종(tendon xanthoma)</td><td align="center">6</td></tr><tr><td>각막환(45세 미만)</td><td align="center">4</td></tr><tr><td>LDL ≥330 ㎎/㎗</td><td align="center">8</td></tr><tr><td>LDL 250~329 ㎎/㎗</td><td align="center">5</td></tr><tr><td>LDL 190~249 ㎎/㎗</td><td align="center">3</td></tr><tr><td>LDL 155~189 ㎎/㎗</td><td align="center">1</td></tr><tr><td>LDLR/ApoB/PCSK9 유전자 변이 확인</td><td align="center">8</td></tr></tbody></table>

* 판정 : ≥8점=확정(definite) FH; 6\~7점=가능성 높음(probable); 3\~5점=가능성 있음(possible); 0\~2점=가능성 낮음(unlikely)
* Probable 이상(6점 이상)이면 1촌 이내 가족 캐스케이드 선별검사(지질 검사 ± 유전자 검사)를 강력히 권고하며, 특히 확정(definite, 8점 이상) FH에서는 필수적으로 시행
...
### <mark style="color:orange;">한국지질·동맥경화학회 권고안 (2022)</mark>

#### <mark style="color:$primary;">관리 목표치</mark>

* 1차 관리 대상 - LDL; 2차 관리 대상 - non-HDL
* 관상동맥질환(초고위험군) 및 뇌혈관질환·말초동맥질환·복부대동맥류·고위험 당뇨병군(고위험군)은 절대 목표치와 기저치 대비 ≥50% 감소를 동시에 달성하는 것이 원칙임 - 절대 목표치에 도달했더라도 감소율이 부족하면 추가 강화를 고려
* 당뇨병(유병기간 ＜10년, 주요 위험인자 없음)·중등도위험군·저위험군은 별도의 감소율 목표 없이 절대 목표치 도달을 우선함

<table data-header-hidden><thead><tr><th width="114"></th><th width="300"></th><th width="110"></th><th width="110"></th></tr></thead><tbody><tr><td><strong>위험도 분류</strong></td><td><strong>해당 동반 질환</strong></td><td><strong>LDL 목표치</strong></td><td><strong>non-HDL</strong><br><strong>목표치</strong></td></tr><tr><td><strong>초고위험군</strong></td><td>관상동맥질환(CAD)<sup>1)*</sup></td><td>&#x3C;55 ㎎/㎗</td><td>&#x3C;85 ㎎/㎗</td></tr><tr><td><strong>고위험군</strong></td><td>죽상경화성 허혈뇌졸중 &#x26; TIA, 경동맥질환, 말초동맥질환, 복부대동맥류<sup>*</sup>; 당뇨병(유병기간 ≥10년 또는 주요 위험인자<sup>†</sup>·표적장기손상<sup>2)</sup> 동반)</td><td>&#x3C;70 ㎎/㎗</td><td>&#x3C;100 ㎎/㎗</td></tr><tr><td><strong>고위험군</strong><br>(당뇨병·저위험)</td><td>당뇨병(유병기간 &#x3C;10년, 주요 위험인자<sup>†</sup> 없음)</td><td>&#x3C;100 ㎎/㎗</td><td>&#x3C;130 ㎎/㎗</td></tr><tr><td><strong>중등도위험군</strong></td><td>LDL을 제외한 주요 위험인자<sup>†</sup> 2개 이상</td><td>&#x3C;130 ㎎/㎗</td><td>&#x3C;160 ㎎/㎗</td></tr><tr><td><strong>저위험군</strong></td><td>LDL을 제외한 주요 위험인자<sup>†</sup> 1개 이하</td><td>&#x3C;160 ㎎/㎗</td><td>&#x3C;190 ㎎/㎗</td></tr></tbody></table>

_✽_<sup>_\*_</sup>_LDL 콜레스테롤 기저치 대비 ≥50% 감소를 동시에 권고(초고위험군, 고위험군 상단 행에 적용).&#x20;_<sup>_1)_</sup>_급성심근경색증은 기저치 LDL 농도와 무관하게 즉시 스타틴 투약 권고.&#x20;_<sup>_2)_</sup>_표적장기손상(알부민뇨, 만성콩팥병\[eGFR ＜60], 망막병증, 신경병증, 좌심실비대) 또는 주요 위험인자 3개 이상을 동반한 당뇨병은 LDL ＜55 ㎎/㎗을 선택적으로 고려 가능.&#x20;_<sup>_†_</sup>_주요 위험인자 : 연령(남 ≥45세, 여 ≥55세), 조기 관상동맥질환 가족력, 고혈압, 흡연, 낮은 HDL(＜40 ㎎/㎗). Ref. 한국지질·동맥경화학회. 이상지질혈증 진료지침 제5판(2022), 표 2-4_

* 다른 지질 목표치(진단 분류상 적정 수준 기준, 별도의 근거 등급 없음) : TC ＜200 ㎎/㎗, TG ＜150 ㎎/㎗, HDL ＞40 ㎎/㎗
...
* 초고위험군(very high-risk) 정의
  * 주요 ASCVD 사건(최근 12개월 내 ACS, 그 외 심근경색·허혈성 뇌졸중 병력, 증상성 말초동맥질환) ≥2회 또는
  * 주요 사건 1회 + 고위험 조건(65세 초과, 관상동맥 재관류술 병력, 현재 흡연, 당뇨병, 심부전 병력, 고혈압, 최대 내약 용량 statin+ezetimibe 투여 중에도 LDL-C ＞100 ㎎/㎗) ≥2개 동반
* 초고위험군 관리 : 목표 LDL-C ＜55 ㎎/㎗ & non-HDL-C ＜85 ㎎/㎗
  * 고강도 statin 우선; ezetimibe &/or PCSK9 억제제 병용 강력 권고
  * Statin+bempedoic acid 또는 statin+inclisiran 병용 권고
    * Inclisiran은 evolocumab/alirocumab 사용이 어렵거나 불내성이거나 투여 빈도가 적은 것을 선호하는 환자에서 선택적으로 고려 (상대적으로 임상 근거가 아직 충분히 축적되지 않았기 때문)
...
#### <mark style="color:$primary;">초고위험 ASCVD 정의</mark>&#x20;
...
<table data-header-hidden data-search="false"><thead><tr><th width="115"></th><th></th><th></th><th></th></tr></thead><tbody><tr><td><strong>구분</strong></td><td><strong>ESC/EAS (2025 Focused Update)</strong></td><td><strong>2026 ACC/AHA</strong></td><td><strong>한국지질·동맥경화학회 (2022)</strong></td></tr><tr><td><strong>위험도 도구</strong></td><td><a href="https://www.mdcalc.com/calc/10499/systematic-coronary-risk-evaluation-score2">SCORE2</a>/<a href="https://www.mdcalc.com/calc/10503/score2-older-persons-score2-op">SCORE2-OP</a></td><td><a href="https://professional.heart.org/en/guidelines-and-statements/prevent-calculator">PREVENT-ASCVD</a>(30~79세)</td><td><a href="https://appcardio.com/systematic-coronary-risk-evaluation-score-calculator/">SCORE</a> 등 수치화된 위험도 점수 대신 동반질환·위험인자 개수 기반 4단계 분류</td></tr><tr><td><strong>초고위험군 LDL 목표</strong></td><td>&#x3C;55 ㎎/㎗ (기저치 대비 ≥50% 강하)</td><td>&#x3C;55 ㎎/㎗ (very high-risk: major ASCVD ≥2회 또는 1회+고위험 조건 ≥2개)</td><td>&#x3C;55 ㎎/㎗ (관상동맥질환만 해당, 기저치 대비 ≥50% 강하)</td></tr><tr><td><strong>2차예방(비-초고위험)</strong></td><td>&#x3C;55 ㎎/㎗ (ASCVD 전반에 적용)</td><td>&#x3C;70 ㎎/㎗ (유럽보다 완화)</td><td>&#x3C;70 ㎎/㎗ (뇌혈관·말초동맥·복부대동맥류·고위험 당뇨병, 기저치 대비 ≥50% 강하 동시 적용)</td></tr><tr><td><strong>1차 병용 비스타틴</strong></td><td>Ezetimibe 조기 병용 강조</td><td>Ezetimibe COR 1(2차예방 초고위험군)</td><td>Ezetimibe 병용, 목표 달성률 향상 목적</td></tr><tr><td><strong>PCSK9 억제제</strong></td><td>초고위험군 우선 권고</td><td>초고위험군 COR 1, 그 외 COR 2a</td><td>권고, 초고위험군 우선</td></tr><tr><td><strong>Inclisiran</strong></td><td>근거 반영(6개월 간격 투여)</td><td>COR 2a - PCSK9i 불내성/접근성 문제/저빈도 선호 시</td><td>국내 허가·급여 상태 유동적</td></tr><tr><td><strong>Bempedoic acid</strong></td><td>근거 반영(LDL ↓17~28%)</td><td>SAMS 환자 COR 1, 병용 COR 2a</td><td>국내 미도입</td></tr><tr><td><strong>영상/CAC 활용</strong></td><td>Plaque·CAC를 risk modifier로 사용</td><td>CAC 1~99/100~299/300~999/≥1000 AU별 목표치 세분화(COR 1~2a)</td><td>명시적 기준 없음</td></tr><tr><td><strong>TG 관련 추가 고려</strong></td><td>TG ≥150 ㎎/㎗ 고위험군에서 EPA 단독 제제(icosapent ethyl) 고려</td><td>지속적 TG 상승 시 statin 우선, 이후 icosapent ethyl 등 고려</td><td>TG ≥200 ㎎/㎗ 시 fibrate 또는 omega-3 병용</td></tr></tbody></table>
...
### <mark style="color:orange;">생활습관 중재 실천 로드맵</mark>

1. **평가 단계** : 체중·허리둘레·혈압·혈당·지질 수치 측정, 흡연·음주·식습관·신체활동 수준 평가, 심혈관질환 위험도 분류
2. **식이 중재 단계**
   * LDL 저하 : 포화지방·트랜스지방 제한, 식이섬유·phytosterol 섭취 증가, 지중해식 식사
   * TG 저하 : 단당류·이당류 제한, 오메가-3 지방산 섭취, 체중 감량
   * HDL 상승 : 불포화지방 섭취, 금연, 규칙적 운동
3. **신체 활동 단계** : 유산소 운동(주 5회 이상, 30\~60분 - 걷기, 자전거, 수영 등), 근력 운동(주 2\~3회 병행), 좌식 생활 감소(1시간 이상 앉아 있을 경우 5분 이상 스트레칭)
4. **체중 및 음주 관리 단계** : BMI 목표 ＜25 ㎏/㎡, 허리둘레 목표(남성 ＜90 ㎝, 여성 ＜85 ㎝), 음주는 HDL 상승 효과보다 전체 심혈관 위험을 고려하여 절주 또는 금주 권장
5. **추적 및 강화 단계** : 3\~6개월 후 지질 수치 재평가, 개선 미흡 시 영양사·운동 전문가 연계, 필요 시 약물치료 병행

## <mark style="color:green;">약물 치료</mark>

### <mark style="color:orange;">약물 치료 방침</mark>

#### <mark style="color:$primary;">약물 치료 대상</mark>
...
* 목표 수준에 도달하기 위하여 최대 내약 용량의 고강도 statin 투여를 권고
  ...
  * → statin & ezetimibe로 목표 달성에 실패한 다음의 경우 PCSK9i 병용을 고려 또는 권고
    ...
    2. FH가 아닌 초고위험군 : 1차 예방을 위하여 PCSK9i 병용 고려
    3. 초고위험군 : 2차 예방을 위하여 PCSK9i 병용 권고
* statin을 투여할 수 없는 경우 : ezetimibe 고려 또는 ezetimibe에 PCSK9i 추가 고려
* 목표 달성 실패 시 statin과 bile acid sequestrant 병용 고려

#### <mark style="color:$primary;">TG 조절을 위한 약물 요법 - 단계별 접근</mark>

* **TG 150\~199 ㎎/㎗ (경계)** : 약물 치료 대상 아님 - 생활 습관 중재(체중 감량, 탄수화물·알코올 제한, 운동)로 시작
* **TG 200\~499 ㎎/㎗ (높음)** : CVD 예방을 위한 1차 약제로 statin을 우선 사용(보험 기준 주의); statin 투여 중에도 고위험군에서 TG가 지속 상승하면 icosapent ethyl(EPA 단독 제제) 병용 고려
* **TG ≥500 ㎎/㎗ (매우 높음)** : 1차 목표는 급성 췌장염 예방으로 전환; 2차 원인(음주, 조절 안 된 당뇨병, 약물 등) 평가와 함께 fibrate를 우선 고려, omega-3 병용 및 엄격한 지방 제한 식이 병행
* Statin 투여에도 TG 135\~499 ㎎/㎗인 고위험군에 대하여 icosapent ethyl(EPA 단독 제제) 2\~4 g/d 병용 고려&#x20;

### <mark style="color:orange;">지질 저하제 효과 비교</mark>

<table data-header-hidden data-search="false"><thead><tr><th width="130"></th><th width="102"></th><th width="102"></th><th width="102"></th><th></th></tr></thead><tbody><tr><td><strong>약물군</strong></td><td><strong>LDL 변화</strong></td><td><strong>HDL 변화</strong></td><td><strong>TG 변화</strong></td><td><strong>비고</strong></td></tr><tr><td><strong>Statin</strong></td><td>↓ 21–55%</td><td>↑ 2–10%</td><td>↓ 6–30%</td><td>중등강도 ≈30%, 고강도 ≈50%, 고강도+ezetimibe ≈65%</td></tr><tr><td><strong>Ezetimibe</strong></td><td>↓ 10–18%</td><td>-</td><td>-</td><td>단독 시 15%, statin 병용 시 추가 15%</td></tr><tr><td><strong>Fibrate</strong></td><td>↓ 10–25%</td><td>↑ 6–18%</td><td>↓ 20–25%</td><td>TG 중심 개선, LDL은 변동 가능</td></tr><tr><td><strong>Niacin</strong></td><td>↓ 10–25%</td><td>↑ 10–35%</td><td>↓ 20–30%</td><td>HDL 상승 효과 뚜렷하나 부작용으로 사용 제한</td></tr><tr><td><strong>Bile acid sequestrant</strong></td><td>↓ 15–25%</td><td>-</td><td>↑(경향)</td><td>TG 상승 가능성 주의</td></tr><tr><td><strong>PCSK9 억제제(단클론항체)</strong></td><td>↓ 48–71%</td><td>-</td><td>-</td><td>단독 ≈60%, 고강도 statin 병용 ≈75%, +ezetimibe ≈85%</td></tr><tr><td><strong>Inclisiran(siRNA)</strong></td><td>↓ 약 50%</td><td>-</td><td>-</td><td>statin 병용 시 지속적 LDL 감소; 연 2회 투여</td></tr><tr><td><strong>Bempedoic acid</strong></td><td>↓ 17–28%</td><td>-</td><td>-</td><td>Statin 불내성 환자에서 고려; 국내 미도입</td></tr><tr><td><strong>Omega-3 지방산</strong></td><td>↑(경향)</td><td>-</td><td>↓ 27–45%</td><td>TG 저하 중심, LDL은 약간 상승 가능</td></tr></tbody></table>
...
<table data-header-hidden><thead><tr><th width="91"></th><th width="90"></th><th></th><th width="220"></th></tr></thead><tbody><tr><td><strong>강도 분류</strong></td><td><strong>LDL</strong> <br><strong>강하율</strong></td><td><strong>약제 및 용량</strong></td><td><strong>비고</strong></td></tr><tr><td><strong>고강도</strong></td><td>≥50%</td><td>atorvastatin 40–80 ㎎, rosuvastatin 20–40 ㎎</td><td>심혈관질환 2차 예방에 우선 사용</td></tr><tr><td><strong>중등강도</strong></td><td>30–50%</td><td>atorvastatin 10–20 ㎎, rosuvastatin 5–10 ㎎, simvastatin 20–40 ㎎, pravastatin 40–80 ㎎, lovastatin 40–80 ㎎, fluvastatin XL 80 ㎎(또는 40 ㎎ bid), pitavastatin 1–4 ㎎</td><td>RCT에서 주요 심혈관 사건 감소 입증된 용량대</td></tr><tr><td><strong>저강도</strong></td><td>&#x3C;30%</td><td>simvastatin 10 ㎎, pravastatin 10–20 ㎎, lovastatin 20 ㎎, fluvastatin 20–40 ㎎</td><td>고령·저위험군에서 고려 가능</td></tr></tbody></table>
...
* 효과 : LDL 17\~28%↓; ezetimibe와 복합제(국외)로도 사용됨 (국내 미승인)
...
#### <mark style="color:$primary;">Creatinine (fibrate 투여 시)</mark>

* fibrate 투약 전 및 투약 1\~3개월 후 혈중 Cr 검사, 정기적 추적 관찰

#### <mark style="color:$primary;">HbA1c 또는 혈당</mark>
...
### <mark style="color:orange;">Statin 불내성(intolerance) 시 대처 순서</mark>

&#x20;   _\*근육통 등으로 statin 지속이 어려운 경우 아래 순서로 접근_

1. 근육통 등 증상 확인 → CK 측정으로 근육병증 여부 감별
...
6. 그래도 불내성이 지속되면 ezetimibe로 대체 또는 병용
