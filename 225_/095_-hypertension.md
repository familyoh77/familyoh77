...
* 목표 혈압 (☞ [만성콩팥병](../227_/112_-chronic-kidney-disease-ckd.md))
  ...
  * 표준화 측정법(AOBP)으로 측정 시 SBP <120 ㎜Hg 고려 가능
...
* **SGLT2 억제제** : 만성콩팥병 동반 고혈압 환자에서 권고 (심혈관 보호 및 신장 보호 효과 입증; 평균 SBP 3\~5 ㎜Hg 부가 강압 효과)
* **Finerenone** - 비스테로이드성 MRA : 당뇨병 + 고혈압 + 알부민뇨 + eGFR ≥25인 만성콩팥병 환자에서 권고
* **Chlorthalidone** : eGFR <30에서도 혈압 조절 목적으로 고려 가능 (IIa/B)
* **목표 혈압** : 모든 만성콩팥병 환자에서 <130/80 ㎜Hg; 표준화 측정법(AOBP)으로는 SBP <120 ㎜Hg 고려
{% endhint %}

### <mark style="color:orange;">관상동맥병</mark>

* ≥130/80 ㎜Hg에서 치료 시작, 목표 혈압 <130/80 ㎜Hg \[2026 대한고혈압학회]; 목표 맥박수 60\~80/분 \[ESH]
