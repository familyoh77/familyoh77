...
* **정의** : 앙와위 또는 좌위에서 기립 후 **3분 이내**에 SBP ≥ 20 ㎜Hg **또는** DBP ≥ 10 ㎜Hg 감소하는 상태 (둘 중 하나만 충족해도 진단 가능); 증상 유무와 관계없이 진단 가능하며, 어지럼·실신·시야 흐림 등의 증상이 동반될 수 있음
...
### <mark style="color:orange;">OH의 아형</mark>

* **Initial OH** : 기립 후 **15초 이내**에 SBP ≥ 40 ㎜Hg 또는 DBP ≥ 20 ㎜Hg 급감 후 30~60초 내 자연 회복되는 형태; 청소년·젊은 성인에서 흔하나 **임상적 의미는 제한적**인 경우가 많음; 일반적인 1분·3분 측정으로는 놓칠 수 있으므로 과잉 검사를 유발하지 않도록 주의
* **Classical OH** : 기립 후 3분 이내에 OH 기준(SBP ≥ 20 또는 DBP ≥ 10 ㎜Hg 감소, 둘 중 하나) 충족
  * ※ 앙와위 고혈압(SBP ≥ 160 ㎜Hg) 동반 환자에서는 **SBP ≥ 30 ㎜Hg 감소**를 진단 기준으로 적용하도록 권고 (자율신경학회 공통 권고안) — 과진단 방지
* **Delayed OH** : 기립 후 3분 이후 **최대 10분 사이**에 **새롭게** SBP ≥ 20 ㎜Hg 또는 DBP ≥ 10 ㎜Hg 감소가 발생하는 형태; sympathetic adrenergic dysfunction의 경미하거나 초기 형태; 3분 측정 정상이나 증상 지속 시 5~10분까지 연장 측정
