# B형간염 Hepatitis B Viral Infection (HBV)
...
* **resolved CHB** : HBsAg(+) 환자의 HBsAg(-) 전환 후 지속; HBV DNA 검출 안 됨, 활동성 바이러스 감염의 임상적·조직학적 증거 없음
...
_¹⁾ 최근 AASLD·EASL·KASL은 "immune tolerant"·"inactive carrier" 같은 전통 용어 대신 **HBeAg-positive/negative chronic infection/hepatitis** 표현으로의 전환을 권장하고 있다. 본 문서에서는 임상 현장 친숙도를 위해 두 용어를 병기한다._\
_²⁾ 전통적으로 간 손상이 경미하다고 알려졌으나, 최근 데이터에서는 ALT 정상이더라도 **유의한 간섬유화·간세포 clonal expansion·HCC 위험**이 존재할 수 있음이 강조된다. 특히 ≥30\~40세에서 중요._\
_³⁾ HBeAg(-) 원인 : precore 또는 basal core promoter 유전자 변이로 HBeAg 생성 불가_\
_⁴⁾ HBsAg 50세 이후 소실, 소실 시 이미 간경변증 동반인 경우, 남성에서는 HCC 발생 위험이 지속됨_
...
<table><thead><tr><th width="160">항목</th><th width="130">TDF<br>[비리어드]</th><th width="130">TAF<br>[베믈리디]</th><th width="130">ETV<br>[바라크루드]</th><th>Besifovir<br>[베시포]</th></tr></thead><tbody><tr><td>항바이러스 효능</td><td>매우 강함</td><td>매우 강함</td><td>매우 강함</td><td>강함</td></tr><tr><td>내성 장벽</td><td>높음</td><td>높음</td><td>높음</td><td>높음</td></tr><tr><td>신독성</td><td>상대적 ↑</td><td>낮음</td><td>낮음</td><td>낮음(TDF 대비)</td></tr><tr><td>골밀도 감소</td><td>가능</td><td>적음</td><td>적음</td><td>적음(TDF 대비)</td></tr><tr><td>임신 데이터</td><td>가장 풍부</td><td>제한적</td><td>제한적</td><td>제한적</td></tr><tr><td>LAM 내성 시</td><td>사용 가능</td><td>사용 가능</td><td>불리 (교차내성)</td><td>사용 가능</td></tr><tr><td>공복 복용</td><td>불필요</td><td>식사와 함께</td><td>필요 (공복)</td><td>불필요</td></tr><tr><td>체중·지질 증가</td><td>적음</td><td>가능성 보고</td><td>적음</td><td>정보 적음</td></tr><tr><td>특이 주의</td><td>신장·골 모니터링</td><td>대사 지표 추적</td><td>HIV 검사 필수</td><td>L-carnitine 병용</td></tr><tr><td>대표 적합 대상</td><td>젊고 건강, 임신부</td><td>CKD·골질환 위험</td><td>고령·renal concern</td><td>국내 신약·TDF 불가 시</td></tr></tbody></table>
...
```mermaid
flowchart TD
    Start([면역억제제 / 항암치료 예정]) --> Screen[HBsAg + Anti-HBc 검사 시행]
    ...
    HBcAb -- yes --> Risk{위험도 평가}

    Risk --> High["<b>고위험 (&gt;10%)</b>\nRituximab·HSCT·Anti-CD20\n고용량 화학요법"]
    Risk --> Mod["<b>중등위험 (1~10%)</b>\nTNF 억제제·JAK 억제제\nSteroid ≥10mg ≥4주"]
    Risk --> Low["<b>저위험 (&lt;1%)</b>\nMTX·AZA·저용량 스테로이드"]

    High --> ProB[예방적 항바이러스제 권고\nETV / TAF / TDF]
    Mod --> MonB[예방 또는 면밀한 모니터링\n공유 의사결정]
    Low --> MonC[정기 ALT·HBV DNA 모니터링]

    style Start fill:#e3f2fd,stroke:#1565c0
    style ProA fill:#e8f5e9,stroke:#2e7d32,stroke-width:2px
    style ProB fill:#e8f5e9,stroke:#2e7d32,stroke-width:2px
    style Safe fill:#f3e5f5,stroke:#6a1b9a
    style High fill:#fce4ec,stroke:#880e4f
    style Mod fill:#fff3e0,stroke:#e65100
    style Low fill:#e8f5e9,stroke:#1b5e20
```
...
<table><thead><tr><th width="120">위험도</th><th width="240">해당 약제 / 상황</th><th>HBsAg(+)<br>또는 resolved HBV¹⁾</th><th>예방 기간²⁾</th></tr></thead><tbody><tr><td><mark style="color:$danger;"><strong>고위험</strong><br>(&gt;10%)</mark></td><td>B세포 고갈제 (rituximab 등 Anti-CD20); 조혈모세포이식(HSCT); 고용량 스테로이드 ≥20 mg/d + 항암화학요법; 면역관문억제제(checkpoint inhibitor) + HBsAg(+)</td><td><strong>HBsAg(+)</strong> → 항바이러스제 예방적 투여<br><strong>Resolved HBV</strong> (HBsAg(-)/HBcAb(+)) → 예방적 투여 강력 권고</td><td>면역억제 종료 후 <strong>12~18개월</strong> 이상 유지<br>(rituximab: 최소 12개월; 지연 재활성화 보고 있음)</td></tr><tr><td><mark style="color:$warning;"><strong>중등위험</strong><br>(1~10%)</mark></td><td>TNF 억제제, IL-6 억제제, JAK 억제제; 스테로이드 ≥10 mg/d ≥4주; 세포독성 항암화학요법; 칼시뉴린 억제제</td><td><strong>HBsAg(+)</strong> → 예방적 투여 권고<br><strong>Resolved HBV</strong> → 예방 또는 면밀한 모니터링 (공유 의사결정)</td><td>면역억제 종료 후 <strong>6개월</strong> 이상</td></tr><tr><td><mark style="color:$info;"><strong>저위험</strong><br>(&lt;1%)</mark></td><td>스테로이드 &lt;10 mg/d 단기; methotrexate, azathioprine, hydroxychloroquine; 관절강 내 스테로이드 주사</td><td><strong>HBsAg(+)</strong> → 개별 판단; 모니터링<br><strong>Resolved HBV</strong> → 통상적 모니터링</td><td>—</td></tr></tbody></table>
...
> ```
>
> _✽ 경증의 경우 경구 섭취 가능하면 특별한 치료 없이 충분한 수분 섭취와 안정을 권고한다. 심한 구역·구토 또는 경구 섭취가 어려운 경우 포도당 수액을 고려. 안정제가 필요한 경우 옥사제팜(oxazepam) 선택(간 대사 없음)._
