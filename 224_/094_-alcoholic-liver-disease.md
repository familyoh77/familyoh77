...
* FIB-4 score (비침습적 섬유화 지수) : = \[나이 × AST] ÷ \[혈소판 × √ALT] — 1.30 미만이면 진행성 섬유화 낮음
...
```mermaid
graph TD
    A([음주력 있는 환자\n황달·간기능 이상]) --> B{타 간질환 배제\nHBsAg·HCV Ab\nHA Ab·자가항체}
    B -->|이상 없음/배제| C[알코올 연관 간질환 진단\nAUDIT 시행, 영상·Lab]
    C --> D{임상 양상 분류}
    D -->|무증상 + 지방간| E[금주 상담 + 영양 지원\n4\~8주 후 외래 재평가]
    D -->|황달·간염 소견| F{중증도 점수\nmDF / MELD 계산}
    F -->|경증\nmDF<32, MELD<20| G[금주 + 지지 치료\n영양·비타민 공급\n단기 입원 또는 외래]
    F -->|중증\nmDF≥32 또는 MELD≥20| H{활동성 감염 배제\nWBC·CRP·혈액배양\n복수천자·흉부X선\n소변배양}
    H -->|감염 확인| I[감염 치료 우선\nSteroid 보류]
    H -->|감염 없음| J[prednisolone 40 ㎎/d 시작\n+ N-acetylcysteine IV 5일]
    J --> K{7일 후 Lille score}
    K -->|Lille ≤0.45\n반응 양호| L[4주 코스 완료\n2주간 점진적 감량]
    K -->|Lille >0.45\n비반응| M{조기 간이식 적응증\n평가}
    M -->|선발 기준 충족| N[조기 간이식 의뢰\n6개월 단독 금주 불요]
...
* **알코올 사용 장애(AUD) 치료 통합** : 행동 치료(동기 강화 면담) + 약물 치료(naltrexone, acamprosate 등); 금주 유지가 장기 예후 결정
* **약물 주의** : NSAIDs는 신기능·위장관 출혈 위험으로 가능한 피함; acetaminophen은 완전 금주 상태에서 1일 총 2 g 이하로 제한적 사용 가능 — 지속 음주 중이면 피하는 것이 안전; 간독성 약물·건강보조식품 주의

### <mark style="color:orange;">영양 지원</mark>

<table><thead><tr><th width="160">항목</th><th width="200">권장 목표</th><th>임상 포인트</th></tr></thead><tbody><tr><td>총 열량</td><td>35\~40 ㎉/㎏/d</td><td>저영양 교정 핵심</td></tr><tr><td>단백질</td><td>1.2\~1.5 g/㎏/d</td><td>간성 뇌병증 있어도 제한 불요 — 오히려 근육 소실 악화</td></tr><tr><td>식사 패턴</td><td>소량씩 자주(4\~6회/d)</td><td>야간 공복 최소화; late evening snack 적극 권장</td></tr><tr><td>Thiamine</td><td>최소 100 ㎎/d</td><td>포도당 투여보다 먼저 투여; Wernicke 의심 시 200\~500 ㎎ IV tid</td></tr><tr><td>아연</td><td>zinc sulfate 220 ㎎ bid<br>(elemental zinc 50 ㎎ 해당)</td><td>간성 뇌병증·미각 저하 개선 가능</td></tr><tr><td>엽산/B 복합제</td><td>보충 권장</td><td>결핍 매우 흔함</td></tr><tr><td>경관 영양</td><td>경구 불가 시 조기 시행</td><td>TPN보다 장관 영양 선호</td></tr></tbody></table>
...
* 5일간 IV 투여 : Day 1 150 ㎎/㎏ over 1시간 → 이후 표준 프로토콜 (병원별 프로토콜 따름)
...
* **ACG 2024 업데이트** : 중증 알코올 간염으로 steroid 비반응 시, **6개월 금주 기준 충족 없이도** 조기 간이식 고려 가능 — 신중한 다학제 정신사회 평가 기반 선발 필요
* Lille score >0.45 (steroid 비반응) + 4개 이상 장기 부전 시 간이식 불가 → 완화 치료 적절
...
* ✽ MASLD와 유의한 알코올 섭취(남 30\~60 g/d, 여 20\~50 g/d)가 동반된 경우 **MetALD** 개념으로 분류 가능 (AASLD/EASL 2023 신규 명칭)
...
> ※ 간경변증 동반 시 long-acting BZD(diazepam) 축적 위험
>    → lorazepam 또는 oxazepam 으로 대체 고려 (간 대사 부담 적음)
...
>
> N-acetylcysteine 주사 (병원 프로토콜에 따라 5일 IV)
> 티아민 100 ㎎ IV qd  × 3~5일 (이후 경구로 전환)
> 아연 (zinc sulfate 220 ㎎/T = elemental zinc 50 ㎎)  1T  bid  (식사 중)
>
> ※ 7일째 Lille score 계산: >0.45 시 steroid 중단, 간이식 평가 의뢰
> ※ 투여 중 격일 WBC, CRP, 체온 모니터링 (감염 감시)
> ※ 혈당 상승 시 조절 병행
> ```
>
> _✽활동성 감염(자발성 세균성 복막염, 폐렴, 요로감염 등) 확인 후 스테로이드 시작. 감염 의심 시 항생제 투여 우선._
...
* 🚫 **아세트아미노펜(타이레놀류)**을 음주 중에는 임의 복용하지 마세요. 과량 복용은 간에 심각한 손상을 줄 수 있으며, 반드시 의료진과 상의 후 제한 용량(1일 2 g 이하) 내에서 사용하세요.
