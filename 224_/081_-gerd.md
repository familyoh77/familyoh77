...
<table><thead><tr><th width="190">아형</th><th width="160">비율</th><th>특징</th></tr></thead><tbody><tr><td><strong>NERD</strong><br/>(Non-erosive reflux disease)</td><td>GERD의 50~85%</td><td>내시경상 점막 손상 없음; 비전형·식도 외 증상 주; 심각한 상태로의 진행 위험 낮음</td></tr><tr><td><strong>ERD</strong><br/>(Erosive reflux disease)</td><td>GERD의 약 30~40%<br/>(연구·지역마다 차이 있음)</td><td>내시경상 reflux esophagitis; 증상 중증도 더 높음; PPI 치료 반응이 NERD보다 양호</td></tr><tr><td><strong>바렛 식도</strong><br/>(Barrett's esophagus)</td><td>만성 GERD의 5~15%</td><td>식도 원주상피 화생; 식도 선암 위험 10~55배 ↑; 이형성 정도에 따라 감시 간격 조정</td></tr></tbody></table>

{% hint style="info" %}
**GERD = "산 과다 질환"이 아니다**: GERD 증상은 강한 산 역류만으로 발생하는 것이 아니며, weakly acidic reflux, non-acid reflux, **reflux hypersensitivity**(식도 지각 과민), **기능성 가슴쓰림** 등이 동등하게 중요한 병태생리로 작용한다. 특히 NERD 환자의 상당수(~40%)는 산 억제제에 반응이 낮은 기능성 기전이 주된 원인이며, 동일한 "GERD"라도 표현형(phenotype)에 따라 최적 치료 전략이 달라진다.
{% endhint %}

**바렛 식도 감시 내시경 권고 간격**

{% hint style="info" %}
국내 및 아시아권에서는 바렛 식도 진단 시 조직검사상 **장상피화생(intestinal metaplasia, IM)** 확인을 핵심으로 보는 경향이 강하다. IM 음성 바렛 식도는 선암 위험이 낮아 감시 간격이 달라질 수 있다.
{% endhint %}

<table><thead><tr><th width="340">상태</th><th>감시 내시경 간격</th></tr></thead><tbody><tr><td>이형성 없음 — 길이 ＜3 cm (short-segment)</td><td>5년</td></tr><tr><td>이형성 없음 — 길이 ≥3 cm (long-segment)</td><td>3년</td></tr><tr><td>저등급 이형성 (low-grade dysplasia, LGD)</td><td>6~12개월 (내시경 치료 또는 집중 감시)</td></tr><tr><td>고등급 이형성 (high-grade dysplasia, HGD)</td><td>내시경 절제술 또는 고주파 절제 치료 고려</td></tr></tbody></table>
...
* ✽ H. pylori 제균 후 위산 분비가 정상화되거나, 감염으로 인한 위축성 위염(위산 분비 감소)이 사라지면서 GERD가 새로 발생하거나 악화될 수 있음; 헬리코박터 유병률 감소가 GERD 증가와 관련된다는 보고 있음
...
* 임신
* 유발 약물 : NSAID, aspirin, opioid, 항콜린제, theophylline, nitrate, CCB, quinidine, progesterone, benzodiazepine, TCA, 도파민 작용제, 철분제, potassium chloride, doxycycline·tetracycline (pill esophagitis 유발 가능), GLP-1 수용체 작용제 (위 배출 지연과의 관련성이 보고되었으나 GERD와의 직접적 인과관계는 제한적)
  * bisphosphonate : 충분한 물(200 ㎖ 이상)과 함께 복용 후 30분간 눕지 않아야 함 — 식도염·pill esophagitis 예방
  * ✽ β-차단제는 일부 보고 있으나 LES 직접 억제 근거는 약함

## <mark style="color:green;">임상 양상</mark>

<table><thead><tr><th width="180">분류</th><th>주요 증상</th></tr></thead><tbody><tr><td><strong>전형적 증상</strong></td><td>위산 역류(신맛), 가슴쓰림(작열감), 삼킴곤란 — 주로 식후, 앙와위, 전굴 자세에서 악화</td></tr><tr><td><strong>비전형 증상</strong></td><td>상복부 압박감/통증, 소화불량, 구역, 복부 팽만, 트림, 입 냄새, 흉통, 목구멍 이물감(globus)</td></tr><tr><td><strong>식도 외 증상</strong><br/>(LPR 포함)</td><td>만성 기침, throat clearing, 쉰 목소리, 인후염, 천식·쌕쌕거림, 기관지 경련, dental erosion (치과적 합병증); 중이염·비부비동염과의 연관성도 보고되나 근거 강도는 낮음</td></tr></tbody></table>

{% hint style="info" %}
인후 증상, 만성 기침, 쉰 목소리 등은 GERD와 연관될 수 있으나, GERD가 단독 원인인 경우는 제한적이며 과진단에 주의해야 한다. 전형적 GERD 증상이 없는 경우 식도 외 증상을 GERD만으로 귀인하기 전에 이비인후과·호흡기 질환을 먼저 평가하는 것이 중요하다.
{% endhint %}
...
* 토혈 또는 흑색변 (상부 위장관 출혈 의심)
* 급격한 연하곤란 + 고형식 불통과 (식도 종양·폐쇄 의심)
* 심한 흉통 — 급성 관동맥 증후군 배제 먼저
...
* 50세 이상 + ＞5년 만성 GERD 증상 (바렛 식도 선별 목적)
...
### <mark style="color:orange;">내시경 검사</mark>

* 유의미한 수준의 민감도 및 특이도 없음; 가슴쓰림 환자의 ⅔에서 내시경으로 진단 안 됨
* 일률적 시행은 권고하지 않음

#### <mark style="color:$primary;">내시경 검사 적응증</mark>
...
**GERD 표현형별 역류 감별 (Rome IV 기반)**

<table><thead><tr><th width="230">구분</th><th width="190">역류 검사</th><th width="220">증상-역류 연관성</th><th>특징 및 치료 접근</th></tr></thead><tbody><tr><td><strong>True GERD</strong></td><td>비정상 acid exposure</td><td>있음</td><td>전형적 GERD; PPI/P-CAB 반응 양호</td></tr><tr><td><strong>Reflux hypersensitivity</strong></td><td>정상 acid exposure</td><td>있음 (증상-역류 상관 양성)</td><td>식도 지각 과민; acid suppression 일부 효과; neuromodulator 도움 가능</td></tr><tr><td><strong>Functional heartburn</strong></td><td>정상</td><td>없음 (상관 음성)</td><td>기능성 통증; acid suppression 효과 제한적; neuromodulator, behavioral approach 중심</td></tr></tbody></table>
...
```mermaid
graph TD
    Start1["이전에 객관적 검사 없이 PPI 경험적 치료"]
    PPI1["적절한 PPI 치료"]
    ...
    Scope1 -- "정상" --> Monitor1["역류 모니터링<br/>(PPI 중단)"]
    Scope1 -- "비정상 (EE C/D)" --> Impedance1["pH-impedance monitoring<br/>고려 (on PPI bid)"]

    Monitor1 --> NoEvidence["• GERD 증거 없음<br/>• 다른 원인 조사"]
    Monitor1 --> GERD1["GERD 확진 → 치료 강화"]

    Start2["검사로 GERD 확진 (LA grade B/C/D)"]
    PPI2["적절한 PPI 치료"]

    PPI2 -- "호전" --> Success2["• GERD 치료 유지<br/>• 장기 관리 방향 상담"]
    PPI2 -- "호전 안 됨<br/>(주 증상: 역류)" --> Fail2["MSA/TIF/fundoplication 고려"]
    PPI2 -- "호전 안 됨" --> Impedance2["pH-impedance monitoring<br/>(on PPI bid)"]

    Impedance2 -- "정상" --> Other2["• 다른 원인 조사<br/>• 기능성 질환 치료"]
    Impedance2 -- "비정상" --> Surgery["• 수술 등 침습적 중재 고려<br/>• 약물 치료 강화"]

    style Success1 fill:#e0e0e0,stroke:#333
    style Scope1 fill:#e8f5e9,stroke:#c8e6c9
    style Monitor1 fill:#e8f5e9,stroke:#c8e6c9
    style Impedance1 fill:#f1f8e9,stroke:#dcedc8
    style NoEvidence fill:#ffebee,stroke:#ffcdd2
    style Success2 fill:#e0e0e0,stroke:#333
    style Fail2 fill:#fff3e0,stroke:#ffe0b2
    style Impedance2 fill:#f1f8e9,stroke:#dcedc8
    style Other2 fill:#ffebee,stroke:#ffcdd2
    style Surgery fill:#ffebee,stroke:#ffcdd2
    style PPI1 fill:#e3f2fd,stroke:#bbdefb
    style PPI2 fill:#e3f2fd,stroke:#bbdefb
    style Other1 fill:#e3f2fd,stroke:#bbdefb
```
...
{% hint style="info" %}
**생활습관 5가지 실천 시 약물 복용 50% 감소** 보고 : ① 금연, ② 카페인 ≤2컵/일, ③ 'prudent' 식단 (채소·과일·콩류·생선·전곡류), ④ 중등도 이상 신체 활동 ≥30분/일, ⑤ 정상 체중 (BMI ＜25) 유지
{% endhint %}
...
* **PPI 제제 간 임상적 치유율은 거의 차이가 없음** — 약제 선택은 비용·순응도·약물 상호작용 위주로 결정. 산 억제 효능 상대치 (omeprazole 기준, 연구마다 차이 있음) : lansoprazole 0.90, pantoprazole 0.23, esomeprazole 1.60, rabeprazole ~1.60

<table><thead><tr><th width="220">성분명</th><th width="120">표준 용량</th><th>상품명</th></tr></thead><tbody><tr><td>omeprazole</td><td>20 ㎎ qd</td><td><mark style="color:blue;">[오엠피]</mark></td></tr><tr><td>esomeprazole</td><td>40 ㎎ qd</td><td><mark style="color:blue;">[넥시움]</mark></td></tr><tr><td>lansoprazole</td><td>30 ㎎ qd</td><td><mark style="color:blue;">[란스톤]</mark></td></tr><tr><td>dexlansoprazole</td><td>60 ㎎ qd</td><td><mark style="color:blue;">[덱실란트 디알]</mark> — 이중 지연 방출, 식사 무관 복용 가능</td></tr><tr><td>pantoprazole</td><td>40 ㎎ qd</td><td><mark style="color:blue;">[판토록]</mark></td></tr><tr><td>rabeprazole</td><td>20 ㎎ qd</td><td><mark style="color:blue;">[파리에트]</mark></td></tr></tbody></table>
...
{% hint style="danger" %}
**PPI 장기 사용 관련 부작용**: 골절, *Clostridioides difficile* 감염, 저마그네슘혈증, Vit B12 결핍, 신질환 등과의 연관성이 보고되어 있으나, **대부분 observational data 기반이며 인과관계는 명확하지 않다**. 명확한 적응증이 있다면 PPI 지속의 이득이 위험을 상회하는 경우가 많다. 다만 장기 사용 시 정기적 재평가를 권고. **CYP450 약물 상호작용**: omeprazole·esomeprazole + 클로피도그렐 병용 시 항혈소판 효과 감소 가능 (CYP2C19 경쟁 억제); pantoprazole·rabeprazole은 상대적으로 안전하여 클로피도그렐 병용 시 대안으로 권고. 중단 시 반동성 위산 과다 분비 주의 (서서히 감량 또는 H2RA로 전환 고려).
{% endhint %}

### <mark style="color:orange;">P-CAB (Potassium-Competitive Acid Blocker)</mark>

{% hint style="info" %}
PPI와 달리 활성화에 산성 환경이 불필요하여 **식사 무관 복용**, **빠른 효과 발현** (PPI 대비 초기 산 억제 우월), CYP2C19 유전자형에 따른 개인차 적음 [AGA Clinical Practice Update, 2024].
...
<table><thead><tr><th width="200">성분명</th><th width="200">용량</th><th>상품명</th></tr></thead><tbody><tr><td>cimetidine</td><td>200~400 ㎎ bid</td><td><mark style="color:blue;">[에취투비]</mark></td></tr><tr><td>famotidine</td><td>10~20 ㎎ bid</td><td><mark style="color:blue;">[가스터]</mark></td></tr><tr><td>lafutidine</td><td>10 ㎎ qd~bid</td><td><mark style="color:blue;">[스토가]</mark></td></tr></tbody></table>
...
* **alginic acid** : 1~3 g tid~qid <mark style="color:blue;">[라미나지]</mark>
  * 위 내용물 위에 부유하는 gel barrier를 형성하여 **acid pocket**을 중화·차단 — 식후 및 postprandial reflux에 특히 유효; alginate + 제산제 병용 시 효과 증대
...
## <mark style="color:green;">난치성 GERD</mark>

{% hint style="info" %}
**Refractory GERD 정의** : 적절한 복약 순응도 하에서 **PPI bid 8주 이상**에도 증상이 지속되는 경우.
{% endhint %}

{% hint style="warning" %}
**Refractory GERD ≠ 지속적인 산 역류**

PPI bid 8주 이상에도 증상이 지속될 때, 무조건적인 PPI 증량이나 반복 교체 전에 원인을 재평가하는 접근이 중요하다. 실제 원인은 복약 오류, 기능성 질환 overlap, reflux hypersensitivity, supragastric belching, rumination syndrome, 기능성 소화불량, 불안·과각성 상태 등 다양하다.
{% endhint %}

**PPI 불응처럼 보일 때 가장 먼저 확인할 것**

<table><thead><tr><th width="260">확인 사항</th><th>임상적 의미</th></tr></thead><tbody><tr><td><strong>복용 시간 오류</strong></td><td>PPI를 식후 복용하는 경우 매우 흔함 — 반드시 식전 30~60분 복용 확인</td></tr><tr><td><strong>복약 순응도 부족</strong></td><td>간헐적 복용, 조기 중단 여부 확인</td></tr><tr><td><strong>야식·야간 음주</strong></td><td>야간 reflux 지속의 흔한 원인</td></tr><tr><td><strong>과식·비만·체중 증가</strong></td><td>복압 증가 → 역류 악화</td></tr><tr><td><strong>Regurgitation predominance</strong></td><td>volume reflux는 acid suppression만으로 불충분 가능</td></tr><tr><td><strong>기능성 질환 overlap</strong></td><td>FD, IBS overlap 시 bloating·불편감 지속 가능</td></tr><tr><td><strong>Reflux hypersensitivity</strong></td><td>acid exposure는 정상이나 식도 지각 과민 존재 가능</td></tr><tr><td><strong>Functional heartburn</strong></td><td>GERD가 아닌 기능성 통증일 수 있음</td></tr><tr><td><strong>Supragastric belching / rumination</strong></td><td>식도로 공기를 빨아들였다 즉시 내뱉는 behavioral disorder; 반복적 트림·역류감 유발 — **약물이 아닌 인지행동치료·언어치료(speech therapy)가 우선**; baclofen 보조 고려</td></tr><tr><td><strong>비GERD 질환</strong></td><td>호산구성 식도염, achalasia, 심질환 등 감별 필요</td></tr></tbody></table>
...
{% hint style="info" %}
수술적·내시경적 치료는 약물 치료에 반응하면서도 장기 약물 부작용이 우려되거나, 약물 중단 시 증상 재발이 반복되는 경우에 고려. 수술 전 반드시 객관적 역류 증거 (내시경 또는 pH 검사)를 확인해야 함.
{% endhint %}
