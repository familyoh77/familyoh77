...
* 상부 GI 질환 : 기능성 소화불량(가장 흔함 (IBS 환자의 약 30\~40%), GERD
* 전신 기능성 질환 : 섬유근육통, 만성 피로 증후군, 두통/편두통, 간질성 방광염
* 자율신경 관련 : 기립성 빈맥 증후군, 과호흡 증후군
* 정신건강 문제동반 : **불**안 장애·우울장애  IBS  환자의 40\~60%에서 동반; 신체화 장애도 흔히 공존
* 불안 장애, 우울장애, 신체화 장애 - IBS 환자의 40\~60%에서 동반
...
* **야간 설사 또는 야간 복통**으로 수면 장애 - 기능성 장 질환은 수면 중 증상이 드묾; 야간 증상은 기질적 질환을 시사
* **공복 시(48시간 이상 금식 후) 지속되는 설사** - IBS보다 분비성 설사·기질적 원인에서 지속
* 지사제에 반응하지 않는 설사
* 설명할 수 없는 발열
* 복부 종괴 또는 림프절 종대
...
* ≥50세에서 처음 발생한 IBS 증상 → 국가 대장암 선별 권고에 따라 대장내시경 포함 평가 계획
* 설명할 수 없는 체중 감소
* 원인 불명의 철결핍빈혈
...
{% hint style="info" %}
**IBS는 적극적(positive) 진단이 가능한 질환이다**\
IBS는 반드시 광범위한 검사로 모든 기질적 질환을 배제한 후에만 진단하는 '배제 진단'이 아니다. **Rome IV 기준 충족 + alarm feature 부재 + 제한적 혈액·대변 검사 정상** 시 적극적으로 진단 가능하다 (2025 서울 컨센서스 포함 국제 지침에서 일관되게 강조).\
불필요한 반복 영상·내시경 검사는 환자 불안을 오히려 강화하고 의료 이용을 증가시킬 수 있다.
{% endhint %}

* 특이 진단 검사법 없음; 실험실 검사는 정상
* 환자의 불안감 해소를 위한 검사는 고려하되 **과잉 검사를 지양**
...
* 다음 중 **≥2개**와 관련되는, **평균 ≥1일/주** 발생하는 재발성 복통
  * ① 배변과 관련
  * ② 배변 빈도의 변화와 관련
  * ③ 대변 형태(모양)의 변화와 관련
...
* 모든 환자에게 효과적인 단일 요법은 없음 - **증상 아형 + 증상 군집 + 중증도**에 따른 맞춤 치료 선택
...
<table><thead><tr><th width="165">중증도</th><th width="250">특징</th><th>치료 접근</th></tr></thead><tbody><tr><td><strong>경증 (Mild)</strong></td><td>간헐적 증상; 일상생활 유지</td><td>식이·안심·음식 일기 / 필요 시 prn 진경제·loperamide</td></tr><tr><td><strong>중등증 (Moderate)</strong></td><td>삶의 질 영향; 규칙적 증상; 직장·사회활동 지장</td><td>아형별 약물 치료 (지속 투여); 수용성 섬유·low-FODMAP</td></tr><tr><td><strong>중증/난치성 (Severe)</strong></td><td>일상 기능 저하; 기존 치료 무반응; 정신사회적 동반</td><td>중추성 신경조절제(TCA/SSRI); CBT·최면·디지털 CBT; Overlap 재평가; 전문의 의뢰</td></tr></tbody></table>

### <mark style="color:orange;">증상 군집별 처방 (Symptom-cluster Prescribing)</mark>

IBS 아형보다 **지배적인 증상 군집**에 따른 처방이 실제 외래에서 더 실용적

<table><thead><tr><th width="230">증상 군집</th><th>우선 고려 약물 / 치료</th></tr></thead><tbody><tr><td><strong>복통·경련 우세</strong></td><td>진경제(antispasmodic), 페퍼민트 오일, TCA 저용량</td></tr><tr><td><strong>복부 팽만·가스 우세</strong></td><td>low-FODMAP 식이, rifaximin (IBS-D), simethicone, probiotics 시험적</td></tr><tr><td><strong>절박변·빈도 우세</strong></td><td>loperamide prn, ondansetron, ramosetron</td></tr><tr><td><strong>변비 우세</strong></td><td>psyllium (수용성 섬유), PEG 하제, linaclotide, prucalopride</td></tr><tr><td><strong>불안·과민 우세</strong></td><td>TCA 저용량, CBT, gut-directed hypnotherapy, SSRI (공존 불안·우울 시)</td></tr></tbody></table>
...
graph TD
    ...
    classDef top fill:#ECE7F2,stroke:#D0C1E3,stroke-width:2px;
    classDef green fill:#E2F0D9,stroke:#A9D18E,stroke-width:1px;
    classDef yellow fill:#FFF2CC,stroke:#FFD966,stroke-width:1px;
    classDef red fill:#FCE4D6,stroke:#F8CBAD,stroke-width:1px;
    classDef blue fill:#DDEBF7,stroke:#BDD7EE,stroke-width:1px;

    Start["만성 IBS 증상<br>(복통·변비·설사)"]
    Step1["병력·신체검사<br>Rome IV 기준 + 기본 혈액·대변 검사<br>± fecal calprotectin"]
    Cond1{"경고 증상?"}
    Sub1["Positive Diagnosis 가능<br>• 설명 및 안심<br>• 식이·생활습관 조절<br>• 증상 군집별 약물 (4주)"]
    Cond2{"증상 지속?"}
    Colonoscopy["대장내시경<br>± calprotectin"]
    Cond3{"기질적 이상?"}
    NonIBS["Non-IBS:<br>IBD, BAD, 대장암 등"]
    IBS["IBS 확진"]
    End1["유지 치료·추적 관찰"]
    Treat1["중증도·아형별 약물 조정 (2~4주 간격)<br>• IBS-C: psyllium → PEG → linaclotide<br>• IBS-D: loperamide → ramosetron → rifaximin<br>• 공통: 진경제·페퍼민트 오일·TCA"]
    Refractory["난치성 IBS<br>(Overlap 재평가)"]
    Treat2["• 중추성 신경조절제(TCA/SSRI)<br>• CBT·최면·디지털 CBT<br>• BAD·SIBO·FD overlap 검토<br>• 소화기내과 의뢰"]

    Start --> Step1
    Step1 --> Cond1
    Cond1 -- "없음" --> Sub1
    Cond1 -- "있음" --> Colonoscopy
    Sub1 --> Cond2
    Cond2 -- "호전" --> End1
    Cond2 -- "지속" --> Colonoscopy
    Colonoscopy --> Cond3
    Cond3 -- "있음" --> NonIBS
    Cond3 -- "없음" --> IBS
    IBS --> Treat1
    Treat1 -- "호전" --> End1
    Treat1 -- "지속" --> Refractory
    Refractory --> Treat2

    class Start top
    class Step1,IBS,End1,Colonoscopy green
    class Cond1,Cond2,Cond3 yellow
    class NonIBS,Refractory red
    class Sub1,Treat1,Treat2 blue
```

<p align="center"><strong>과민대장증후군 진단 및 치료 알고리듬</strong></p>

<p align="center"><em><mark style="color:$info;">Ref. 대한소화기기능성질환·운동학회. 과민대장증후군 임상진료지침, 2017; AGA 2022; ACG 2021.</mark></em></p>

***

## <mark style="color:green;">비-약물 치료 및 예방</mark>

### <mark style="color:orange;">식이 조절 - Low-FODMAP 3단계 접근</mark>
...
{% hint style="danger" %}
⚠️ **과도한 음식 제한 주의**\
장기간·광범위한 음식 제한은 영양 불균형, 체중 감소, 삶의 질 저하(orthorexia-like 양상)를 초래할 수 있다. **가능한 최소 제한 원칙**으로 접근하며, 증상과 무관한 식품은 단계적 재도입으로 제한을 풀도록 안내한다.
{% endhint %}

**Low-FODMAP 3단계 접근 - ACG 2021 조건부 권고**

```mermaid
graph TD
    classDef default fill:#fff,stroke:#333,stroke-width:1px,color:#000;
    classDef top fill:#ECE7F2,stroke:#D0C1E3,stroke-width:2px;
    classDef phase1 fill:#FCE4D6,stroke:#F8CBAD,stroke-width:1.5px;
    classDef phase2 fill:#FFF2CC,stroke:#FFD966,stroke-width:1.5px;
    classDef phase3 fill:#E2F0D9,stroke:#A9D18E,stroke-width:1.5px;
    classDef note fill:#F2F2F2,stroke:#D9D9D9;

    Start["Low-FODMAP 식이요법 시작<br>(개인별 유발 음식 탐색)"]
    P1["1단계: 전면 제한기 (4~8주)<br>고FODMAP 식품 전면 제한<br>음식 일기 작성·증상 기록"]
    Cond1{"증상 호전?"}
    P1_Fail["기질적 질환 재평가<br>또는 다른 유발 인자 탐색<br>(BAD, SIBO, 스트레스 등)"]
    P2["2단계: 단계적 재도입기 (3~6주)<br>FODMAP 군별 1가지씩 3일간 시험<br>증상 발현 시 즉시 중단 후 재시도"]
    P3["3단계: 맞춤형 식단 안착기 (장기)<br>내성 확인 식품 재도입<br>유발 식품만 최소 제한<br>영양 균형 유지"]
    End2["지속 가능한 삶의 질 향상"]
    ...
    class P1_Fail note
    class P2 phase2
    class P3,End2 phase3
```

<p align="center"><strong>Low-FODMAP 3단계 식이 접근</strong></p>

{% hint style="info" %}
**Low-FODMAP 제한 식품 예시**\
과당 : 옥수수 시럽·사과·배·꿀·수박·건포도 / 유당 : 유제품 / Fructan : 마늘·양파·부추·아스파라거스·아티초크·밀 제품(빵·파스타·시리얼) / 소르비톨 : stone fruits(복숭아·자두·체리) / 라피노오스 : 콩류·양배추.\
전면 제한은 4\~8주로 제한; 이후 단계적 재도입으로 개인별 불내성 식품 특정. (☞ 저FODMAP 식품 목록 p.385)
{% endhint %}
...
### <mark style="color:orange;">페퍼민트 오일 (Peppermint Oil)</mark>
...
### <mark style="color:orange;">Opiate성 지사제</mark>
...
### <mark style="color:orange;">중추성 신경조절제 (Central Neuromodulators)</mark>

{% hint style="info" %}
**왜 '항우울제'가 아닌 '중추성 신경조절제'인가?**\
최신 로마 재단(Rome Foundation) 지침 및 기능성 위장관 질환(DGBI) 트렌드는 환자의 낙인 효과(stigma)를 줄이기 위해 '항우울제' 대신 **'중추성 신경조절제'** 라는 용어 사용을 강력히 권장한다. IBS에서의 사용 목적은 우울증 치료가 아닌 **장-뇌 축 과민성 조절 및 내장 통각 억제**임을 환자에게 명확히 설명한다.
{% endhint %}
...
* **5\~10 ㎎ hs 시작** → 1\~2주 간격으로 점진적 증량; **보통 10\~25 ㎎/d에서 유지**
...
* **\[AGA 2022]** IBS-C·IBS-D 모두에서 **조건부 반대** (저근거); 전반적 삶의 질 개선은 일부 보고되나 복통 감소 근거는 약함

{% hint style="danger" %}
⚠️ AGA 2022는 IBS에서 SSRI에 대해 **조건부 권고 반대**를 표명 (저근거 수준). 단, 다음의 경우 선택적으로 고려할 수 있음:\
① **불안·우울 등 정신과적 공존 질환**이 있는 경우\
② **난치성 IBS-C**에서 장 통과 단축 효과를 기대하는 경우 (중추성 통증 개선보다 운동 효과 목적)\
...
### <mark style="color:orange;">Serotonin 5-HT4 Receptor Agonist</mark>

* **작용** : GI motility 조절 (대장 통과 시간 단축)
* **대상** : 다른 하제에 반응 없는 IBS-C
* **부작용** : 두통, 복통
* **주의/금기** : 신장 기능 저하, 장폐쇄·천공 의심, 심한 IBD
* prucalopride 1\~2 ㎎ qd <mark style="color:blue;">\[레졸로]</mark> (여성, 고령자에서 허가; 보험기준 ☞ p.1183)
* tegaserod 6 ㎎ bid - 허혈성 혈관 질환 문제로 사용 제한

### <mark style="color:orange;">Serotonin 5-HT3 Receptor Antagonist</mark>
...
### <mark style="color:orange;">Bile Acid Sequestrant</mark>

* **작용** : 담즙산 흡수 장애(BAD) 조절

{% hint style="info" %}
**IBS-D와 Bile Acid Diarrhea (BAD) Phenotype**\
IBS-D 환자 중 상당수가 실제로 BAD phenotype에 해당할 수 있다. 특히 **식후 급박변, 담낭절제술 병력, 아침 설사**가 두드러지는 환자에서 BAD를 의심한다.\
**확인 방법** : serum 7α-C4 또는 FGF19 측정, 48-h fecal bile acid excretion - 그러나 국내 일차의료 환경에서는 검사 접근성이 제한적인 경우가 많다.\
**현실적 진단 팁** : 검사가 여의치 않은 경우 **cholestyramine 2\~4 g/d × 3\~5일간 시험적 투여** 후 설사 증상의 극적 호전 여부로 BAD를 추정 진단할 수 있다.
{% endhint %}
...
### <mark style="color:orange;">GC-C Agonist (Guanylate Cyclase-C 작용제)</mark>
...
### <mark style="color:orange;">Chloride Channel Activator (Lubiprostone)</mark>
...
{% hint style="danger" %}
⚠️ **국내 허가 주의**\
Lubiprostone <mark style="color:blue;">\[아미티자]</mark>은 국내에서 **'성인 만성 특발성 변비'에만 허가**되어 있으며, IBS-C 적응증은 없음 (오프라벨 또는 처방 제한 확인 필요).
{% endhint %}

* **부작용** : 오심 (식사와 함께 복용 시 경감)
* lubiprostone 8 ㎍ bid (식사와 함께)

### <mark style="color:orange;">NHE3 Inhibitor (Tenapanor)</mark>

* **작용** : 장 상피세포 Na⁺-H⁺ 교환체 억제 → 장액 분비 증가, 복통 감소
* **대상** : IBS-C - AGA 2022 조건부 권고 (중등도 근거)

{% hint style="danger" %}
⚠️ **국내 미출시** (2025년 기준): 미국 FDA 승인(Ibsrela®)은 완료되었으나 국내 출시 미정; 처방 전 가용성 확인 필요.
{% endhint %}

* **부작용** : 설사
* tenapanor 50 ㎎ bid

### <mark style="color:orange;">췌장 효소</mark>
