...
* 설명할 수 없는 체중 감소
* 원인을 알 수 없는 철결핍빈혈
* 대장암, polyposis, IBD, 셀리악병 등의 병력 또는 가족력
...
* GI 기능 평가(선택적 시행)
  ...
  * 설사 : 대변 배양 검사, serial colonic biopsy, 48-h fecal bile acid excretion, serum 7α C4, fecal calprotectin/lactoferrin, lactose/glucose breath test
* 대장암 선별 : 대상이 되거나(예: ≥45세) 경고 증상이 있는 경우 대장 내시경 등 선별 검사 고려
  * 변비 우세형이 아닌 IBS 466명에 대한 연구에서 대장암은 없고 ＜2%에서 IBD가 관찰되었다는 보고가 있음

### 감별

* 셀리악병 (Gluten enteropathy) : 만성 설사, 성장 장애, 피로, 빈혈, 골 통증, 구내염, 불임, 성 기능 저하, 저혈당, 빵(밀가루)/보리 등 글루텐이 많은 음식을 먹으면 설사
...
* Microscopic colitis : 고령에서의 설명할 수 없는 만성 재발성 물 설사; 복통/체중 감소 발생 가능; 자가면역성 질환(예: 관절통, 갑상선질환, 건선, 쇼그렌병) 동반 가능
...
graph TD
    ...
    %% 노드 구조
    Start["만성 IBS 증상 (복통, 변비, 설사)"]:::top
    Step1["병력, 신체검사, <br>routine blood test"]:::green
    Cond1{"경고 증상"}:::yellow
    
    %% Uninvestigated IBS 분기
    Sub1["<b>Uninvestigated IBS</b><br>• 설명 및 안심시킴<br>• 식이/생활습관 조절<br>(운동, low FODMAP diet 포함)<br>+<br>• 약물 치료 (4주까지)"]:::blue
    
    Cond2{"기질적 이상"}:::yellow
    NonIBS["Non-IBS:<br>GI malignancy,<br>IBD, etc"]:::red
    
    IBS["IBS"]:::red
    Treat1["약물 치료 반복"]:::blue
    
    Refractory["난치성 IBS"]:::red
    Treat2["항우울제 or 항불안제 추가"]:::blue
    
    Referral["의뢰"]:::blue
    Final["GI 기능, 사회정신적 요인 평가  ➔  다른 병리적 요인 탐색"]:::blue
    ...
    Cond1 -- 없음 --> Sub1
    Cond1 -- 있음 --> Colonoscopy["Colonoscopy"]:::green
    
    Sub1 -- 증상 지속 --> Colonoscopy
    ...
    IBS --> Treat1
    Treat1 -- 증상 지속 --> Refractory
    
    Refractory --> Treat2
    Treat2 -- 증상 지속 --> Referral
    
    Referral --> Final
```

과민대장증후군 진단 및 치료 알고리듬\
Ref. 대한소화기기능성질환·운동학회. Clinical Practice Guidelines for Irritable Bowel Syndrome.2017. Fig.
...
* low-FODMAP(Fermentable Oligo-, Di-, Mono-saccharide, And Polyol) diet
  * 다음 식품들의 섭취를 줄임 : 과당(옥수수 시럽, 사과, 배, 꿀, 수박, 건포도), 유당, fructan(마늘, 양파, 부추, 아스파라거스, 아티초크), 밀 제품(빵, 파스타, 시리얼, 케이크), 소르비톨(stone fruits), 라피노오스(콩류, 양배추) 식품을 피함 (☞ p.385)
...
* conditional recommendations : (moderate certainty) tenapanor, plecanatide, tegaserod, lubiprostone (low certainty) polyethylene glycol laxatives, TCA, antispasmodics
...
* 매 식전 or 필요시 투여
* dicyclomine \[스파토민], trimebutine \[포리부틴], cimetropium \[알기론], pinaverium \[디세텔], scopolamine \[부스코판], tiropramide \[티로파]
...
* 작용 : 장내 세균에 의한 가스 형성과 염증을 억제 (논란) •\[AGA] 유익성과 안전성에 대한 증거가 부족하여 권고 안 함; \[BSG] 최대 12주까지 시도하며 증상 호전 없으면 중단
* 대상 : IBS-C, IBS-D
...
* TCA : 항콜린 작용이 있어 IBS-D에서 효과; 4주 내에 효과가 명백하지 않으면 중단 고려
  ...
  * amitriptyline \[에트라빌], nortriptyline \[센시발], imipramine \[이미프라민]; 10 ㎎ hs, 1\~2주마다 10 ㎎ 씩 증량, 최대 30\~50 ㎎/d
...
* guanylate cyclase-C agonist
  * 대상 : 난치성 IBS-C
  * 부작용: 설사&#x20;
  * linaclotide 145 ㎍ qd, plecanatide 3 ㎎ qd
