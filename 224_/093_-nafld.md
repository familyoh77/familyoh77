...
* 비장비대(splenomegaly) 또는 혈소판 감소(<150,000/μL) 동반 → 진행성 문맥 고혈압
* AFP 상승 + 영상검사에서 간내 결절
* 체중 감량 없이 지속적인 ALT 악화 (6개월 이상)

<mark style="color:$info;">**외래 추적 / 추가 평가 계획**</mark> <mark style="color:$info;">- 즉각 위험 낮으나 호전 없으면 의뢰</mark>

* FIB-4 1.3∼2.67 (중간 위험)&#x20;
...
#### <mark style="color:$primary;">MASLD 진단 기준</mark>
...
&#xNAN;**⚠️ F4 (간경변증)에서는 현재 적응증 없음** - 실제 임상에서 흔한 혼동 주의.\
