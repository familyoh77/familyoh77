...
* **domperidone** — CYP3A4 억제제(macrolide, azole계) 병용 금기
...
<tr><td>PPI</td><td>반동성 위산 과분비(중단 후 최대 2개월), 영양 결핍(B12·Ca·Mg·Fe), C. difficile·폐렴 위험, 급만성 신질환</td><td>확실한 적응증 없는 장기 투여 지양; AGA 2022 권고에 따라 정기 재평가</td></tr>
...
<tr><td>P-CAB (tegoprazan 등)</td><td>CYP3A4 대사 + 위산 억제</td><td>atazanavir·rilpivirine 등 위산 의존 흡수 약제 농도 감소; CYP3A4 억제제와 병용 시 P-CAB 혈중 농도↑</td></tr>
</tbody></table>
...
{% hint style="danger" %}
⚠️ **metoclopramide** : 비가역적 지연운동이상증(tardive dyskinesia) — 3개월 이상 투여 시 20%에서 발생. FDA 블랙박스 경고(2009). 가능한 최단 기간 사용; 고령자 만성 투여 금지.
{% endhint %}
...
* 임상 적용 : 공복기 MMC(migrating motor complex) 촉진 → 위마비(gastroparesis)·SIBO에 적용
...
{% hint style="info" %}
rifaximin은 SIBO에 400 ㎎ tid × 7~14일. 간성 뇌증(hepatic encephalopathy) 예방 목적 시 550 ㎎ bid 장기 투여(최대 6개월) 허가.
{% endhint %}
...
* prucalopride : 1~2 ㎎ qd <mark style="color:blue;">[레졸로]</mark>; 부작용-두통, 복통 (보험기준: 기존 완하제에 반응 없는 만성 특발성 변비 성인 여성)
...
* 부작용 : 폐렴(단기), 소장 세균 증식, C. difficile 감염 위험, 영양 결핍(B12·Fe·Ca·Mg), 급만성 신질환, 당뇨병 위험 증가 보고(?)
...
* 주의/금기 : 간·신 장애, 고령, 임부·수유부; 위산 의존 흡수 약제(atazanavir, nelfinavir, rilpivirine) 농도 감소

{% hint style="info" %}
**P-CAB 임상적 장점** — 식전 복용 불필요, 빠른 초회 산 억제, H. pylori 제균 성공률 PPI 대비 개선(vonoprazan 연구), 야간 산 돌파 감소. 장기 안전성 데이터는 PPI 대비 축적 중.
{% endhint %}
