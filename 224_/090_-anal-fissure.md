...
graph TD
    ...
    G2 --> H2[4~6주 후 평가]
    H2 -- 호전 --> Z
    H2 -- 미호전 --> I[<u>변실금 고위험?</u><br/>고령·다산부·괄약근 손상력]
    I -- "YES" --> J[보툴리눔 독소 주사]
    I -- NO --> K[수술: Lateral internal sphincterotomy]
    J --> L[치유?]
    L -- YES --> Z
    L -- NO --> K
...
* NTG 대비 두통 발생이 적어 순응도가 더 높으며, 1차 선택제로 선호
...
* acetaminophen 또는 NSAIDs 경구 : 급성 통증 시 단기 사용 (☞ [통증](../220_/001_-pain.md#undefined-8))
  * 항문 출혈 환자, 위궤양·위장관 출혈 위험 환자에서 NSAIDs 사용 주의
