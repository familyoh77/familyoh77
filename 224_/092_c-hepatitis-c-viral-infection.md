...
```mermaid
flowchart TD
    A([HCV Ab 검사 •양성 또는 <br/>•음성 + '고위험군 또는 증상 의심']) --> C[<u>추가 검사</u><br/>HCV RNA 또는 HCV cAg]
    C -- "양성" --> E["HCV 감염 확인<br/>(급성 또는 만성)"]
    C -- "음성" --> F["HCV 감염 없음<br/>고위험군은 3~6개월 후 재검"]
    E --> G["<u>치료 전 평가</u><br/>• 비침습적 간섬유화 검사: APRI, FIB-4<br/>• HCV 유전자형<br/>• HBsAg / anti-HBc 검사<br/>• 임신, 약물 상호작용, 동반 질환 확인"]
    G --> H[간경변증 여부]
    H -- "비경변성<br/>≥18세 또는 3~17세" --> I["<u>1차 권고</u><br/>Glecaprevir/Pibrentasvir 8주<br/>또는 Sofosbuvir/Velpatasvir 12주"]
    H -- "대상성 간경변증<br/>≥18세 또는 3~17세" --> J["Glecaprevir/Pibrentasvir 8주<br/>또는 Sofosbuvir/Velpatasvir 12주"]
    H -- "비대상성 간경변증" --> K["SOF/VEL ± ribavirin<br/>전문의 의뢰 필수<br/>NS3/4A PI 금기"]
    I --> L["<u>모니터링</u><br/>SVR12: 치료 종료 후 12주<br/>HCV RNA 검사"]
    J --> L
    K --> L
    L --> M[간경변증?]
    M -- "있음" --> N["6개월마다<br/>간초음파 + AFP"]
    M -- "없음" --> O["SVR 확인 후 종료"]

style A fill:#eeeeee,stroke:#888888,stroke-width:2px
classDef yellow fill:#fff9c4,stroke:#ffe082
class B,D,H,M yellow
classDef blue fill:#d0e8ff,stroke:#1a6abf
class F,O blue
classDef lightGreen fill:#e8f8e8,stroke:#4caf50
class N,L,G,C lightGreen
classDef sky fill:#e3f2ff,stroke:#2196f3
class I,J,K sky
style E fill:#fde8f0,stroke:#e91e8c
```
