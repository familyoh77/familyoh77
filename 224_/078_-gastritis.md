...
상복부 통증·속쓰림·더부룩함이 있다고 해서 모두 "위염"은 아니다. 실제 외래에서는 **기능성 소화불량(FD)**, **GERD**, **소화성 궤양**, **약물 유발 증상**, **담도 질환** 등이 흔히 혼재하며, 이들이 진짜 원인인 경우가 많다.

내시경상 **단순 발적(erythema, "minimal change gastritis")은 임상적으로 무의미한 경우가 매우 흔하다.** 경미한 점막 발적은 정상 변이 또는 비특이 변화일 수 있으며, 증상과의 연관성은 낮다. 내시경 소견이 곧 증상의 원인이라고 단정하지 말 것.
{% endhint %}
...
{% hint style="info" %}
최근 **H. pylori 감염률 감소, 장기 PPI 사용 증가, 고령화**로 인해 H. pylori 음성 위염의 비중이 증가하고 있다. 담즙 역류, 자가면역 위염, NSAID 관련 위병증의 상대적 중요성이 커지고 있다.
{% endhint %}

### <mark style="color:orange;">분류</mark>

<table><thead><tr><th width="210">유형</th><th width="250">특징 및 원인</th><th>임상적 의의</th></tr></thead><tbody>
<tr><td>Patchy erythema</td><td>위 점막의 국소 발적; "minimal change gastritis"</td><td><strong>대부분 임상적으로 무의미.</strong> 과잉 진단·치료 주의</td></tr>
<tr><td>Erosive gastritis / Reactive gastropathy</td><td>NSAID, 알코올 등 유해 인자</td><td>점막 손상; 출혈 가능</td></tr>
<tr><td>Hemorrhagic gastritis</td><td>저혈량, 저산소증 등 혈역학적 이상</td><td>스트레스 궤양과 연속선상</td></tr>
<tr><td>Reflux gastritis</td><td>담즙·췌장액의 역류; 유문 기능 장애와 관련</td><td>주로 antrum-predominant 패턴; body까지 침범 가능</td></tr>
<tr><td>Infectious gastritis</td><td>H. pylori, 기타 감염</td><td>가장 흔한 만성 위염 원인</td></tr>
<tr><td>Atrophic gastritis</td><td>선(gland) 구조 소실; 고령, 장기 PPI, 자가면역</td><td>위암 전구 병변 위험</td></tr>
</tbody></table>
...
{% hint style="info" %}
**OLGA/OLGIM 병기**: 조직검사를 기반으로 위암 위험도를 Stage I–IV로 분류. Stage III–IV는 3년마다 감시 내시경 권고 (MAPS II, 2019). 1차 의료에서는 병기 판단보다 내시경 의뢰 결정이 실질적으로 중요하다.

**OLGIM(장상피화생 기반) vs OLGA(위축 기반)**: OLGIM이 관찰자 간 일치도가 더 높고 위암 발생 위험 예측력이 우수하여 최근 임상적으로 더 선호된다.
{% endhint %}
...
* **진행 순서 주의**: **철결핍빈혈이 B12 결핍보다 먼저 나타나는 경우가 흔하다** - 위산 저하로 비헴철 흡수 장애 → 이후 내인자 결핍으로 Vit B12 흡수 장애(악성빈혈) 순으로 진행
...
* 토혈(hematemesis) 또는 흑색변(melena) - 상부 소화관 출혈 의심
* 급격하고 심한 복통 + 복막 자극 징후(반발압통, 근긴장) - 천공 의심
...
* H. pylori 1차 제균 실패 → 2차 요법 또는 소화기내과 의뢰
* 조직검사상 위축성 위염·장상피화생 확인 → 감시 내시경 일정 수립
* 자가면역 위염 의심 (악성빈혈, 갑상선 질환 동반)

{% hint style="info" %}
✽ 연령 cutoff는 국가별 위암 유병률에 따라 다르다. 한국의 높은 위암 발생률과 내시경 접근성을 고려하면 **50세** 기준이 적절하나, 국제 가이드라인에 따라 55~60세 기준도 병용된다.
{% endhint %}
...
* **위암 가족력이 있는 경우 40세 미만이라도 적극적인 내시경 시행 고려**
...
### <mark style="color:orange;">Kyoto 내시경 분류 (Kyoto Classification)</mark>
...
### <mark style="color:orange;">혈액 및 기타 검사</mark>
...
### <mark style="color:orange;">위염 vs 기능성 소화불량 vs GERD - 감별 요점</mark>

"위염"으로 진단되어 오는 환자의 상당수에서 FD 또는 GERD가 실제 원인이다. 아래 비교표를 임상 감별의 참고로 활용한다.

<table><thead><tr><th width="170">특징</th><th width="195">위염 (Gastritis)</th><th width="195">기능성 소화불량 (FD)</th><th>GERD</th></tr></thead><tbody>
<tr><td>진단 기반</td><td>조직학적 염증</td><td>증상 기반, 구조적 이상 없음</td><td>증상 + 내시경/pH 검사</td></tr>
<tr><td>내시경-증상 연관</td><td>낮음</td><td>없음 (정상 내시경 흔함)</td><td>일부 존재 (미란성 식도염)</td></tr>
<tr><td>조기 포만감</td><td>±</td><td>+++ (PDS 핵심 증상)</td><td>±</td></tr>
<tr><td>식후 팽만감</td><td>+</td><td>+++</td><td>+</td></tr>
<tr><td>신물 역류·흉부 작열감</td><td>드묾</td><td>드묾</td><td>+++ (핵심)</td></tr>
<tr><td>누울 때·야간 악화</td><td>드묾</td><td>드묾</td><td>흔함</td></tr>
<tr><td>스트레스 연관</td><td>±</td><td>+++</td><td>++</td></tr>
<tr><td>H. pylori 연관</td><td>강함</td><td>일부 overlap</td><td>약함</td></tr>
<tr><td>NSAID 연관</td><td>강함</td><td>약함</td><td>약함</td></tr>
<tr><td>PPI 반응</td><td>일부 호전</td><td>Variable (불충분한 경우 많음)</td><td>비교적 좋음</td></tr>
<tr><td>Prokinetic 반응</td><td>제한적</td><td>좋음 (PDS 아형)</td><td>일부 overlap</td></tr>
<tr><td>치료 핵심</td><td>원인 제거 (H. pylori, NSAID)</td><td>Brain-gut axis 조절, 교육</td><td>산 역류 억제, 생활 교정</td></tr>
</tbody></table>
...
graph TD
    A([상복부 증상 내원])
    B[경고 징후<br/>Red Flag?]
    C[즉각 처치 또는<br/>응급 내시경 의뢰]
    D[내시경 적응증?<br/>50세 이상·경고 증상<br/>치료 불응·가족력]
    E[내시경 + 조직검사<br/>+ H. pylori 검사]
    F[H. pylori<br/>비침습적 검사<br/>UBT / SAT]
    G[H. pylori 양성?]
    H[제균 요법<br/>☞ 헬리코박터 챕터]
    I[증상 Phenotype<br/>분류]
    J[제균 확인<br/>치료 종료 4주 후 UBT]
    K[추적 관찰<br/>위험도별 감시 내시경]
    L[2차 제균 또는<br/>소화기내과 의뢰]
    M[PPI 또는 P-CAB<br/>± 점막보호제]
    N[운동 촉진제<br/>+ 교육·스트레스 관리]
    O[NSAID 중단 또는<br/>COX-2 전환 + PPI]
    P[4~6주 후 평가]
    Q[내시경 재검<br/>FD·GERD·PUD 재평가]
    R[Neuromodulator 고려<br/>저용량 TCA·mirtazapine<br/>소화기내과 협진]
    ...
    J -->|성공| K
    J -->|실패| L
    I -->|쓰림·통증 위주<br/>EPS 양상| M
    I -->|조기 포만·더부룩함<br/>PDS 양상| N
    I -->|NSAID 관련| O
    M --> P
    N --> P
    O --> P
...
<p align="center"><em><mark style="color:$info;">Ref. ACG Clinical Guideline (2017); MAPS II European Guidelines (2019); 대한소화기학회 H. pylori 진료지침 (2023)</mark></em></p>
...
{% hint style="info" %}
위염 치료의 핵심은 **원인 제거**이다. H. pylori 양성이면 제균이 최우선이며, NSAID 관련이면 중단·대체가 선행되어야 한다. 약물 치료는 증상 완화와 점막 회복을 보조하는 역할이다.
{% endhint %}
...
{% hint style="info" %}
**외래 현실**: 내시경상 경미한 위염 소견이 있어도 증상의 주 원인이 **기능성 소화불량(FD)**인 경우가 매우 흔하다. H. pylori 음성이고 NSAID를 복용하지 않는 환자에서 위염과 소화불량 증상이 공존한다면 FD overlap을 항상 고려해야 한다.
{% endhint %}
...
* 위축성 위염 (antrum + body 모두 침범) : **3~5년**마다 내시경
...
* 자가면역 위염 : **3년**마다 내시경; Vit B12·CBC 정기 모니터링; **위저선 폴립(fundic gland polyp) 및 신경내분비종양(NET, Type 1) 발생 위험 증가** - 내시경 시 주의 깊게 관찰

{% hint style="info" %}
**국가 암검진**: 만 40세 이상은 2년마다 위내시경 무료 검진 가능. 적극적으로 안내할 것.
{% endhint %}
...
### <mark style="color:orange;">제산제 (Antacids)</mark>

* 위산 중화를 통한 즉각적 증상 완화; 궤양 치유 효과는 없음; 식후 1시간 및 취침 시 복용
* aluminum hydroxide <mark style="color:blue;">\[암포젤]</mark>
* almagate <mark style="color:blue;">\[알마겔 에프]</mark>

{% hint style="danger" %}
⚠️ Al 함유 제산제는 신부전 시 장기 사용에 알루미늄 축적 독성; Mg 함유 제제는 신부전 시 고마그네슘혈증 주의. 다른 약(항생제, 철분제, 갑상선 약 등)의 흡수를 방해하므로 **2시간 간격** 복용.
{% endhint %}

### <mark style="color:orange;">H2-수용체 차단제 (H2RAs)</mark>

* 야간 위산 분비 억제에 효과적; PPI 대비 효과 제한적이나 단기·경증에 활용

{% hint style="danger" %}
⚠️ Cimetidine은 CYP1A2·CYP2C9·CYP2D6·CYP3A4 억제로 warfarin, theophylline, phenytoin 등 다수의 약물 상호작용 위험. **Famotidine이 상호작용 적어 더 안전한 대안.**
{% endhint %}
...
### <mark style="color:orange;">양성자 펌프 억제제 (PPI)</mark>
...
{% hint style="danger" %}
⚠️ **PPI 장기 복용 주의**: 저마그네슘혈증, 골다공증(골절 위험), C. difficile 감염, 폐렴 위험. H. pylori 감염이 동반된 corpus-predominant gastritis에서 PPI 장기 사용 시 위축성 변화의 진행 가능성이 제기되어 왔다 - 불필요한 장기 복용은 피하고 최소 유효 용량을 유지한다. (PPI 단독이 위암을 직접 유발한다는 인과관계는 확립되지 않음)
{% endhint %}

### <mark style="color:orange;">P-CAB (칼륨경쟁적 위산 분비 억제제)</mark>

* PPI 대비 빠른 산 억제 발현, 식사 영향 적음, **CYP2C19 유전형의 영향을 받지 않아** 개인 간 반응 편차가 적음
* H. pylori 제균 요법 병용 시 PPI 대비 강력한 산 억제로 항생제 안정성을 높여 **제균 성공률 향상**에 기여
* 특히 **야간 산 돌파(nocturnal acid breakthrough)** 및 빠른 증상 조절이 필요한 경우에 유용
* tegoprazan 20~40 ㎎ qd <mark style="color:blue;">\[케이캡]</mark>
* vonoprazan 10~20 ㎎ qd <mark style="color:blue;">\[타케캡]</mark>
* fexuprazan 40 ㎎ qd <mark style="color:blue;">\[펙수클루]</mark> - 국내 개발 P-CAB; 최근 임상 사용 증가

### <mark style="color:orange;">점막 보호제 (Mucosal Protective Agents)</mark>
...
{% hint style="danger" %}
⚠️ **고령자 prokinetic 주의**: D2 수용체 길항 작용이 있는 약제(metoclopramide, domperidone 등)는 고령자에서 추체외로 증상(EPS: 손 떨림, 근경직, 지연성 운동이상증)을 유발할 수 있다. 1차 의료에서 고령자에게는 EPS 위험이 낮은 mosapride 또는 itopride를 우선 선택하고, 증상 발생 시 즉시 중단할 것.
{% endhint %}

### <mark style="color:orange;">증상 Phenotype별 처방 방향</mark>

{% hint style="info" %}
단일 '위염 처방'보다 **증상 중심(phenotype-based)**으로 접근하면 실제 외래 효율이 높다. 감별이 애매한 경우 우선 phenotype에 맞는 1차 약제를 선택하고 4~6주 후 반응을 재평가한다.
{% endhint %}

<table><thead><tr><th width="185">중심 증상</th><th width="190">가능성 높은 진단</th><th width="205">우선 약제</th><th>핵심 생활 교정</th></tr></thead><tbody>
<tr><td>타는 듯 쓰림·공복·야간 악화</td><td>Acid-related dyspepsia / 미란성 위염 / GERD</td><td>PPI 또는 P-CAB ± 점막보호제</td><td>자극 음식·음주 제한, 야식 금지</td></tr>
<tr><td>조기 포만감</td><td>FD-PDS / 위배출 지연</td><td>운동 촉진제 우선 (mosapride, itopride)</td><td>소량 빈식, 저지방 식사</td></tr>
<tr><td>식후 팽만감·더부룩함</td><td>FD / IBS overlap</td><td>운동 촉진제 ± 점막보호제</td><td>과식 금지, 탄산음료 제한, 천천히 먹기</td></tr>
<tr><td>구역·메스꺼움</td><td>위배출 지연 / FD / 약물 유발</td><td>운동 촉진제 ± 제토제</td><td>metformin·GLP-1 agonist·철분제 등 유발 약물 확인</td></tr>
<tr><td>NSAID 복용 후 시작</td><td>Reactive gastropathy / 미란성 위염</td><td>NSAID 중단·감량 + PPI; 고위험 시 COX-2 억제제 + PPI</td><td>공복 복용 금지, 충분한 수분</td></tr>
<tr><td>신물·흉부 작열감·눕거나 야간 악화</td><td>GERD / LPR</td><td>PPI 또는 P-CAB (표준 용량)</td><td>야식 금지, 식후 눕지 않기, 체중 조절</td></tr>
<tr><td>스트레스 연관·증상 변동성·검사 정상</td><td>FD / Gut-brain axis disorder</td><td>환자 교육 + 운동 촉진제 ± neuromodulator 고려</td><td>스트레스 관리, CBT, 수면 교정</td></tr>
</tbody></table>
...
> ```
>
> _✽제균 요법 전 반드시 항생제 알레르기 확인. 클래리스로마이신 내성 지역(국내 내성률 ~30%)에서는 비스무트 4제 또는 레보플록사신 기반 요법 고려. 상세 요법은_ ☞ _[헬리코박터](080_-helicobacter-pylori-infection.md)_ _챕터 참조. 치료 종료 4주 후 UBT로 제균 확인 필수._
