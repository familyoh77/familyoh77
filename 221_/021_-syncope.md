...
* Classic OH : 기립 후 3분 이내 지속적으로 수축기 혈압 ≥20 ㎜Hg 또는 이완기 혈압 ≥10 ㎜Hg 감소하거나 수축기 혈압 ＜90 ㎜Hg로 저하 (☞ [기립성 저혈압](../225_/096_-orthostatic-hypotension.md))
  * 앙와위 고혈압이 있는 환자에서는 수축기 혈압 ≥30 ㎜Hg 감소 기준을 고려
...
* 원인 : 1차성 자율 신경 장애(pure autonomic failure), 2차성 자율 신경 장애(예: 당뇨, spinal cord injury, 파킨슨병), 약물(예: 술, 혈관 확장제, 이뇨제, adrenergic blocker, 진정제), hypovolemia(예: 탈수, 출혈)&#x20;
* 특징
...
* 원인 : 부정맥/전도 장애(가장 흔한 심장 원인), 심혈관 구조 이상(예: 급성 심근허혈·심근경색에 따른 부정맥 또는 혈역학적 장애, 심근증, 대동맥협착증, 비후성심근증), 기타 심폐질환(예: 폐색전증, 폐동맥고혈압)
* 특징
...
graph TD
    ...
    S2 -->|만성 기립불내성·빈맥<br/>유의한 OH 없음| POTS[10분 능동기립검사·기립경사검사<br/>POTS 감별]
...
* 심박동기·제세동기 기능 이상 또는 장치 관련 부정맥이 의심되면 장치 interrogation 시행
* 구조적 심질환 의심 : 심초음파
...
* Carotid sinus massage : 40세 초과의 원인불명 실신 중 반사성 기전에 합당한 경우, 지속 ECG 및 beat-to-beat 혈압 모니터링과 응급소생이 가능한 환경에서 고려
  * 시행법 : 좌·우 경동맥동을 각각 앙와위(supine)에서 먼저 마사지(약 10초)하고, 음성이면 기립경사대를 이용해 세운 자세(upright)에서 재시행(Six-Step Method; 2018 ESC 지침, 2024 Europace)
...
* 적용 범위와 한계
  ...
  * 이 연구에서 CSRS ＜0의 민감도는 91.9%, 음성예측도는 97.5%였으므로 저위험 점수만으로 퇴원을 결정하거나 중대한 원인을 배제하지 않음. 40세 미만이나 연구와 다른 진료환경에 결과를 그대로 일반화하지 않음
* 원 문헌
  ...
  * 미국 외부 검증 : Suh EH, et al. _JAMA Netw Open_. 2026;9:e2617362.
...
* 실신의 myoclonic jerk는 대개 의식 소실 이후 시작하고 불규칙·비동기·비대칭적이며 흔히 10회 미만; 뇌전증성 강직–간대발작은 의식 소실과 거의 동시에 시작하고 동기성·대칭성 운동이 흔하며 20회 이상이면 발작을 더 시사
  * 운동 횟수와 지속시간은 목격 상황에 따라 부정확할 수 있으므로 절대적인 감별 기준으로 사용하지 않고, 운동의 시작 시점·양상과 의식 회복 과정을 함께 평가
