...
타이레놀8시간이알서방정 650 ㎎/T  2T  두통 시작 시 필요시 (ibuprofen 사용이 어렵거나 대안이 필요한 경우)
```

**처방례 2.** 급성기 - NSAIDs 금기 (위장 장애, 신기능 저하, 임부 등)

```
타이레놀8시간이알서방정 650 ㎎/T  2T  두통 시작 시 필요시
※ 국내에서는 즉시방출형(500 ㎎)보다 8시간 지속형(650 ㎎) 서방정이 보험 급여상 일반적이며, 허가 용법상 성인 1회 2T(1,300 ㎎)
※ 서방형 제제는 효과 발현이 상대적으로 느리므로, 신속한 진통이 필요한 환자에게는 이 점을 설명
