...
![image](../.gitbook/assets/c760bce1-0813-43c8-bce7-8fb0b14ff66d.JPG)
...
## 원인![image](../.gitbook/assets/f92d71b2-de74-426f-a69d-95eca570fd92.JPG)
...
```
0~5일(MIDAS Ⅰ)=장애가 없거나 미약; 6~10일(MIDAS Ⅱ)=경도 장애;

11~20일(MIDAS Ⅲ)=중등도 장애; 20일 이상(MIDAS Ⅳ)=심도 장애
```

### Migraine without aura (무조짐 편두통)
...
> 1. 무조짐편두통의 모든 진단 기준을 충족하지만 ＜5번의 발작만 있었으면 개연무조짐편두통(Probable migraine without aura)으로

> ```
> 분류
> ```

2. 편두통 상태에서 잠이 들었다가 잠에서 깰 때 두통이 없었다면 깨어날 때까지의 시간을 발작 시간으로 간주 Migraine with aura (조짐 편두통)
...
> 1. 예: 한 번의 조짐 동안 3가지 증상이 생길 때 최대 허용 시간은 3×60분; 운동 증상은 72시간까지 지속 가능

2. 실어증은 항상 편측 증상으로 간주함; 구음장애는 때에 따라 다름
3. 섬광암점과 따끔거림은 조짐의 양성 증상임

### Chronic migraine (만성 편두통)
...
*   주의/금기 : 뇌혈관/심혈관/말초혈관 질환, 조절되지 않는 고혈압, SSRI, ergotamine
    ...
    ![image](../.gitbook/assets/5f8fef10-9660-4258-8b94-dd9cb6375d30.JPG)

#### Ergotamine

* 불확실한 효과 및 부작용으로 인하여 2차 선택; 급성기 치료제로는 권고하지 않음. triptan 치료 실패 시 고려
...
*   dexamethasone : 두통 재발 위험도가 유의미하게 줄어든다는 보고가 있음 \[덱타손 주]
    ...
    ![image](../.gitbook/assets/4a893339-2626-473f-84b2-445786760a89.JPG)
...
*   두통 빈도와 무관하게 환자가 편두통 예방 치료를 선호하거나 의사가 예방 치료가 필요하다고 판단(예: 뇌간 조짐 편두통
...
*   flunarizine : 5\~10 ㎎/d \[씨베리움]; \[부] 체중 증가, 졸림, 입마름, 어지럼, 저혈압, 우울; \[주/금] 심한 우울, 파킨슨병,

    기타 피라미드외로 증상
* candesartan : 4\~16 ㎎/d \[아타칸]; \[부] 저혈압, CHF 악화; \[주/금] 혈관 부종, 임신, 수유
*   lisinopril : 10\~20 ㎎/d \[제스트릴]; \[부 어지럼, 두통, 기침, 피로, 근육 경련, 설사, 저혈압; \[주/금] 혈관 부종,
...
*   monoclonal antibody : erenumab, fremanezumab\[아조비], galcanezumab\[앰겔러티], eptinezumab; 매달 또는 분기마다 주사;

    \[부] 주사 부위 통증/발적, 상기도 감염, 변비; \[주/금] 약물 과민, 심혈관 질환, 조절되지 않는 고혈압, 임신
*   대체 요법 : 효과에 대한 입증은 불충분; Mg 600 ㎎/d, riboflavin 400 ㎎/d, feverfew(MIG-99 extract) 6.25 ㎎ tid,

    coenzyme Q10 100 ㎎ tid
...
![image](../.gitbook/assets/e532da82-c171-48c1-a603-1080796a3657.JPG)
