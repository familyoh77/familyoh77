...
* 반복적인 발작성 두통을 특징으로 하는 만성 신경계 질환
  * 전형적으로 편측성·박동성의 중등도-중증 통증이 4\~72시간 지속되며 구역·구토, 빛공포증·소리공포증을 동반; 환자의 약 1/3에서 시각·감각 등의 조짐(aura)이 선행
...
* 음식 영향은 개인차가 크고 근거가 일관되지 않으므로 특정 음식 또는첨가제(숙성 치즈, 가공육, 초콜릿, MSG, 인공감미료 등)를 일률적으로 제한하지 않으며, 반복적으로 연관성이 확인되는 경우에만 제한
...
* 조짐 증상으로 구음장애, 현훈, 이명, 청력저하, 복시, 운동실조, 의식저하 중 ≥2가지 동반  `뇌간조짐`&#x20;
* 편측 motor weakness이 조짐으로 동반  `반신마비편두통`&#x20;
...
> ```
>
> _✽전조(aura) 단계가 아닌 두통이 실제로 시작되는 시점에 복용; 허혈성 심혈관·뇌혈관 질환, 조절되지 않는 고혈압, hemiplegic/brainstem aura migraine에서는 금기. 트립탄·복합진통제는 월 10일 미만으로 사용_
