...
| -------- | ----------------------- | ------------------------------ |
| 분류       | 원발성 두통                  | 2차성 두통 (경추 질환 기인)              |
| 통증 부위    | 양측성 (전두부, 측두부, 후두부 전체)  | 심한 단측성 (고정된 한쪽)                |
| 통증 양상    | 압박감, 조이는 느낌 (Band-like) | 비박동성, 후두부→안구 방사                |
| 발생 기전    | 근육 긴장, 스트레스, 중추 감작      | C1\~C3 신경근 연관통 (Referred pain) |
| 유발 요인    | 스트레스, 피로, 수면 부족         | **목의 움직임**, 특정 자세, 경추 압박       |
| 경추 가동 범위 | 대개 정상 (근육 경직은 있을 수 있음)  | **ROM 감소** 뚜렷함                 |
| 동반 증상    | 빛/소리 공포(드묾), 구역(없음)     | 같은 쪽 어깨/팔 통증, 어지럼증             |
| 진찰 소견    | 두개주위 근육의 광범위한 압통        | 상부 경추(C1\~C3) 분절 가동성 저하        |
| 확진적 검사   | 임상적 진단 (신경학적 검사 정상)     | **신경 차단술(Block)** 시 통증 즉시 소실   |
