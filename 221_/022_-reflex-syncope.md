...
* 저-정상 혈압이고 고혈압·심부전·신장질환이 없는 환자에서 수분 ≥2 L/d 및 식염 6\~9 g/d 정도를 개별적으로 고려. 다만 VVS 재발 예방에 대한 직접 근거는 제한적임
  * 식염과 나트륨 양을 혼동하지 않도록 하고, 식염 6\~9 g/d는 평소 식사를 포함한 총 섭취량의 목표 범위이며 일률적으로 이 양을 추가하라는 의미가 아님. 임신부·고령자·고혈압 환자는 혈압과 동반질환에 따라 조정
* 전조 증상이 시작되면 즉시 앉거나 눕고 다리를 올리며, 가능하면 counter-pressure maneuver를 지체 없이 시행
* 물 500 ㎖의 빠른 섭취는 효과가 즉시 나타나는 구조요법이 아니므로, 예측 가능한 유발 상황 약 15\~30분 전에 예방적 보조요법으로 고려할 수 있음. 전조 증상이 이미 시작되었다면 물을 마시는 것보다 즉시 안전한 자세를 취하는 것이 우선
...
* 압박 스타킹은 일반적인 VVS에서 재발 예방 효과가 입증되지 않음
  * 2025 COMFORTS-II에서 허벅지 길이 25\~30 ㎜Hg 압박 스타킹은 VVS 재발을 유의하게 줄이지 못함
...
* 운전 제한 : 확립된 국내 법적 기준은 없으므로, 전조 없이 발생한 실신·운전 중 발생·짧거나 없는 전조 등 고위험 소견이 있으면 원인 평가와 증상 조절이 확인될 때까지 운전을 개별적으로 제한하고, 직업 운전자는 더 보수적으로 판단
...
* 국내 허가효능은 저혈압(기립성·본태성·증후성)이며, 허가 용법은 성인 1회 2.5 ㎎, 1일 2\~3회; 증상과 혈압에 따라 최소 유효량 사용
* VVS는 국내 허가효능에 별도 적응증으로 명시되어 있지 않으므로, 처방 시 최신 허가사항과 급여 인정 여부를 확인
* 마지막 복용은 앙와위 고혈압을 줄이기 위해 늦어도 취침 4시간 전. 식전 복용을 요구하는 국내 허가 근거는 없음
* 앙와위·기립 혈압, 배뇨 증상 및 신기능을 확인. 고혈압, 심한 심질환, 급성 신장염, 배뇨장애 등 국내 금기 확인
* [midodrine](../225_/096_-orthostatic-hypotension.md#midodrine) <mark style="color:blue;">\[미드론]</mark>
...
* 소수의 소규모 RCT와 메타분석에서 재발 감소 가능성이 보고되었으나 근거가 제한적이며 routine 권고 약물이 아님 (☞ [항우울제](../231_/213_-antidepressants-and-anxiolytics.md))
...
* fluoxetine <mark style="color:blue;">\[프로작]</mark>
...
* 대규모 확증 3상 교차시험 POST VII(80 ㎎/d 목표용량, 목표 n＝180)가 진행 중임. ClinicalTrials.gov에는 예상 1차 완료 시점이 2026년 9월, 전체 연구 완료가 2027년 9월로 등록되어 있으며, 2026년 9월 현재 공개된 결과는 없음
* 국내 허가효능은 ADHD로 한정되며 VVS에 대한 적응증은 없음(비허가 처방); 심혈관계 부작용(혈압·맥박 상승) 고려해 routine 권고 약물이 아님
* atomoxetine <mark style="color:blue;">\[스트라테라]</mark> (VVS 비허가)

## <mark style="color:green;">시술 및 기타 처치</mark>

#### <mark style="color:$primary;">심박동기 Pacemaker</mark>

* 심박동기는 일반적인 VVS 치료가 아니며 혈관확장·저혈압을 직접 막지 못하지만, 서맥·무수축이 실신의 주된 기전으로 문서화된 고도 선별 환자에서는 근거 기반 기전 치료로 고려
* 2021 ESC Class I 적응 : 40세 초과, 중증·예측 불가능·재발성 실신이며 다음 중 하나가 확인된 경우 dual-chamber pacemaker로 재발 감소
  ...
  * tilt test로 유발된 asystolic syncope
    * ✽이전에는 Class IIb였으나, BIOSync CLS 무작위·이중맹검·대조 시험 결과를 반영해 2021 ESC 지침에서 Class I(LOE A)로 상향됨
