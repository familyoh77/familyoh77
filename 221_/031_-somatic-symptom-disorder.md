...
graph TD
    ...
    IAD --> Screen
    FNSD --> Screen
    Screen --> Framing[<u>진단 설명</u><br/>❌ '이상 없습니다'<br/>✔ '신경계가 과민해져<br/>증상이 실제로 강하게 느껴지는 상태입니다']
    Framing --> Treatment[<u>치료 전략</u><br/>• 단일 주치의 + 정기 방문<br/>• 기능 회복 중심 목표<br/>• CBT 1차<br/>• SSRI/SNRI, 통증 시 duloxetine
    • 불필요 검사 지양<br/>• 불필요 약물 점진적 중단]
...
단순 reassurance("검사 정상입니다")는 오히려 역효과를 낼 수 있음. 환자는 "의사가 내 증상을 찾지 못했다"로 해석하여 불안이 증폭되고 Doctor shopping으로 이어짐. 구조화된 설명(structured explanation) 과 기능적 진단 프레이밍(functional diagnosis framing)이 효과적

**금지 문장 vs 권장 문장**

<table><thead><tr><th width="280">❌ 피해야 할 표현</th><th>✔ 권장 표현</th></tr></thead><tbody><tr><td>"검사 다 정상입니다"</td><td>"검사에는 큰 문제가 없지만, 증상은 분명히 실재합니다"</td></tr><tr><td>"아무 이상이 없어요"</td><td>"몸의 구조는 괜찮은데, 신경계가 과민해진 상태입니다"</td></tr><tr><td>"스트레스 때문입니다"</td><td>"스트레스가 몸과 뇌의 연결에 영향을 주어 실제 증상을 만들어낼 수 있습니다"</td></tr><tr><td>"정신과 가세요"</td><td>"지금 약물과 생활 관리로 제가 함께 보고, 필요하면 심리치료도 같이 고려해 봅시다"</td></tr><tr><td>"꾀병 아니에요" <em>(부정적 프레이밍은 오히려 의심을 암시)</em></td><td>"이런 증상은 실제 많은 분들이 경험하고, 치료로 좋아지는 질환입니다"</td></tr></tbody></table>

**Doctor behavior checklist**

<table><thead><tr><th width="302">✔ 해야 할 것</th><th>❌ 하지 말 것</th></tr></thead><tbody><tr><td>계획된 정기 방문 스케줄링 (4~6주)</td><td>"증상 있을 때 오세요" - 증상-방문 연결 강화</td></tr><tr><td>단일 주치의 유지</td><td>다른 의사/병원으로 쉽게 의뢰</td></tr><tr><td>환자 호소 경청 + 진찰은 꼭 수행</td><td>reassurance 반복 ("아무 이상 없어요" 되풀이)</td></tr><tr><td>기능(일상 활동, 직장 복귀) 체크</td><td>증상 점수만 체크</td></tr><tr><td>증상을 "신경계 과민화"로 설명</td><td>"검사 정상"으로만 설명하고 귀가</td></tr><tr><td>불필요 약물·검사의 점진적 중단</td><td>새 증상마다 새 검사 추가</td></tr></tbody></table>
