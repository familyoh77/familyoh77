...
* 약물 중단 후 보통 2\~10일간 기존보다 심한 반동 두통이 발생할 수 있음. 이 시기를 견뎌야 MOH에서 벗어날 수 있음을 사전에 충분히 설명하는 것이 치료 순응도에 결정
* 반동 두통 기간 중에는 naproxen 또는 단기 steroid를 브릿지 요법으로 활용 가능

※ **진단 확정**&#x20;

* 약물 중단 2개월 후 두통 빈도·강도를 재평가하여 MOH 진단을 확정하고 이후 치료 방향을 결정
