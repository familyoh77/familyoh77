...
{% hint style="danger" %}
**⚠️ 주의 — 반드시 이차성 원인 배제 후 진단**

50세 이후 처음 발생하는 수면 중 두통은 두개 내 종양(특히 후두와 종양), 수면무호흡증(OSA), 야간 고혈압을 먼저 배제해야 합니다. **뇌 MRI 시행 후 이차성 원인이 배제된 경우에만 수면두통으로 진단**합니다.
{% endhint %}
...
* **반동 두통 기간** : 약물 중단 후 2\~10일간 기존보다 심한 반동 두통이 발생함. 이 기간을 사전에 충분히 설명하는 것이 치료 순응도에 결정적이며, 이 고비를 넘겨야 MOH에서 벗어날 수 있음
* **진단 확정** : 약물 중단 **2개월 후** 두통 빈도·강도를 재평가하여 MOH 진단을 확정하고 이후 치료 방향을 결정. 중단 후에도 만성 두통이 지속되면 기저 원발 두통(만성 편두통 등)의 예방 치료를 강화
{% endhint %}
