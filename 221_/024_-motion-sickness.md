...
* 빈도 : 교통수단 및 노출 조건에 따라 다르나, 일반적으로 자동차 ＞ 배 ＞ 비행기 순으로 흔함 (연구에 따라 약 20\~40% 범위)

### <mark style="color:$danger;">🚩 Red Flags!</mark>

<mark style="color:$danger;">**즉각 응급 조치 및 이송**</mark> <mark style="color:$danger;"></mark><mark style="color:$danger;">- 멀미로 오인하기 쉬운 중추성 병변</mark>

* 복시, 구음장애, 연하곤란, 사지 위약·감각 이상, 보행 실조 등 신경학적 결손 동반 → 뇌간·소뇌 병변 즉각 배제
* 수직 안진(vertical nystagmus) → 중추성 병변 강력 시사; 즉각 MRI
* 갑작스럽고 심한 후두부 두통(특히 thunderclap 양상) 또는 신경학적 증상 동반 → 후두와 병변(소뇌출혈, Arnold-Chiari 기형 등) 고려
* 고에너지 외상 후 발생하는 심한 어지럼·구토 → 두개내 병변 배제

<mark style="color:$warning;">**긴급 평가 권고**</mark> <mark style="color:orange;">- 평소와 다른 양상이거나 감별이 필요한 경우</mark>

* 처음으로 발생한 심한 어지럼·구토 (기존 멀미 병력 없음)
* 움직임과 무관하게 발생하는 구역·구토·어지럼증 → 중추성 어지럼증, 미로염, 메니에르병
* 이명·청력 소실 동반 → 메니에르병, 청신경종
* 멀미약에 전혀 반응하지 않음 → 다른 원인 고려
...
* 시각 자극(가상현실·사이버멀미) - 실제 움직임 없이도 발생 가능; VR·게임 환경에서 발생하는 사이버멀미 사례 최근 증가 추세
...
* PPPD(지속성 체위지각 어지럼증) : 지속적(＞3개월)이며 시각 자극·자세 변화에 의해 악화되는 만성 어지럼증; 움직임과 무관한 지속적 증상·불안 동반이 멀미와의 감별점
...
 ✽ Ondansetron(세로토닌 길항제)은 전정-시각 불일치 기전에 작용하지 않아 멀미 **예방** 효과는 제한적이며 권장되지 않음. 구토 증상 완화에는 일부 보조적 역할 가능.
...
* meclizine : 25\~50 ㎎ q24h, 여행 60분 전 복용; 1일 1회 투여로 편리하고 dimenhydrinate보다 졸림이 적음 <mark style="color:blue;">\[염산메클리진]</mark> (✽12세 미만에서는 안전성 자료 제한으로 일반적으로 사용 권장되지 않음)
* cyclizine : 일부 연구에서 dimenhydrinate과 효과는 비슷하며 덜 졸림
* promethazine : 12.5\~25 ㎎ bid; 중증 멀미에서 효과적이나 진정 작용이 강함 (✽2세 미만 금기 - 호흡 억제 위험으로 FDA 블랙박스 경고; 2세 이상도 주의; 소아·청소년 및 고령자에서 acute dystonia 등 추체외로 증상 주의)

#### <mark style="color:$primary;">Cinnarizine</mark>

* 칼슘 채널 차단 + H1 수용체 길항 이중 기전; 전정계 과민성 억제
* 부작용 : 졸음, 체중 증가, 드물게 가역적 파킨슨 증후군 (장기 복용을 피함)
* 주의 : 파킨슨병(추체외로 부작용 위험), 중증 관상동맥질환; 고령자에서 추체외로 증상 주의; 임부·수유부 권장하지 않음
...
> ※ 다른 항히스타민제·스코폴라민과 병용 시 항콜린 부작용 증가 → 주의
> ※ 파킨슨병·중증 관상동맥질환 환자 주의 (추체외로 부작용 위험); 임부·수유부 권장하지 않음
> ```
