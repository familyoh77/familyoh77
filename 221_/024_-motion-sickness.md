...
* 움직임이나 움직임 인식을 줄이기 위한 좌석 선택 : 비행기- 날개 부분; 자동차- 앞좌석, 앞을 향한 좌석; 배- 파도를 보는 자리, 노 젓는 곳에서 떨어진 자리, 물에 가까운 자리
...
* scopolamine 경피제 : 1\~1.5 ㎎ patch, 출발 4시간 전에 귀 뒤의 털 없는 건조한 피부 표면에 부착(72시간 동안 효과); ≥8세 허가 \[키미테 패취]\(성인용 1.5 ㎎/매; 3일 이상 적용해야 할 경우 첫 번째 것은 제거하고 다른 패취를 반대편 귀 뒤에 부착) (비보험)
...
처방례 2.\
키미테 패취 1.5 ㎎/P 출발 4시간 전 귀 뒤 부착 (3일간 유효)
