...
* 기립 시 심박수 ≥30회/분 증가(10분 이내), 단 유의미한 혈압 저하(수축기 ≥20 ㎜Hg)가 없어야 함 - 혈압 저하가 동반되면 기립성 저혈압으로 분류
* 주로 젊은 여성
* 어지럼, 심계항진, 피로, 인지 저하
* 자가면역, Long COVID 후 발생 가능 - Long COVID 환자의 상당수에서 POTS 증상이 보고되며 자율신경절 수용체에 대한 자가항체 관련 기전이 유력하게 제시됨

**순수 자율신경 부전증 (Pure Autonomic Failure, PAF)**&#x20;

* 기립성 저혈압이 주증상; 서서히 진행; 파킨슨병·MSA로 이행 가능
...
* 기립성 저혈압 측정 : 앙와위 후 1·3·5분 혈압/맥박 측정; 수축기혈압 ≥20 mmHg 또는 이완기혈압 ≥10 mmHg 감소 시 양성
  * ✽초기 기립성 저혈압(Initial OH) : 기립 15초 이내 혈압이 급격히 하강(수축기 ≥40 또는 이완기 ≥20 mmHg)했다가 곧 회복 — 표준 혈압계로 포착 어려움; "일어나는 순간 즉시 증상을 느끼는&#xC9C0;**"** 문진으로 선별; 확진은 연속 혈압 모니터링(Finometer 등) 필요
...
* 10분 기립검사 (POTS 선별) : 기립 후 10분 내 심박수 ≥30회/분 증가 시 양성
  * ✽12\~19세 청소년 : ≥40회/분을 기준으로 적용 (2015 Heart Rhythm Society)
...
| 원인 | 심혈관 | 소화기 | 비뇨기 | 발한 | 특징적 단서 |
|------|--------|--------|--------|------|------------|
| 당뇨병성 | 기립성 저혈압, 운동 불내성 | 위마비, 변비, 설사 | 배뇨 지연, 요실금 | 발한 감소(하지) | 장기 당뇨 병력, HbA1c ↑ |
| POTS | 기립 시 빈맥(≥30 bpm), 혈압 유지 | 경도 복통, 팽만감 | — | 과발한 가능 | 젊은 여성, Long COVID 후 |
| 파킨슨병/MSA | 기립성 저혈압(특히 MSA) | 변비, 삼킴곤란 | 배뇨 장애 | 과발한 | 운동 증상 동반; MSA는 stridor |
| 순수 자율신경 부전(PAF) | 기립성 저혈압(심함) | 변비 | 배뇨 장애 | 발한 감소 | 서서히 진행; 파킨슨·MSA 이행 가능 |
| 알코올성 | 기립성 저혈압 | 소화 장애, 설사 | — | 발한 이상 | 음주 병력, 말초신경병증 동반 |
{% endhint %}
...
* 소량 자주 식사 (식후 저혈압 예방)
* 단계적 운동 (Levine/Dallas Protocol) : 초기부터 직립 운동 시 증상 악화·치료 포기 위험 높음
  * 1단계 (4\~6주) : 수평 운동 — 수영, 로잉 머신, 누워서 하는 저항 운동 (심장이 머리와 같은 높이)
  * 2단계 (4\~6주) : 경사도 운동 — 사이클, 경사 트레드밀
  * 3단계 : 직립 운동 — 걷기, 달리기로 이행
* 앙와위 고혈압 완화 — 침대 머리 높이기 (Head-up tilt sleeping) : 잠잘 때 침대 머리 부분을 **10\~20도(약 15\~25 cm)** 높임; 신장 압력 수용체 자극으로 야간 배뇨 감소, 아침 기립 시 혈압 강하 완화 효과
* 고온 환경·알코올 회피
...
* droxidopa : 노르에피네프린 전구체; 신경인성 기립성 저혈압(파킨슨병·MSA·PAF)에서 midodrine과 함께 고려; 100\~600 ㎎ tid; \[부작용] 앙와위 고혈압, 두통, 어지럼
  * ⚠️ 급여기준 미확인 — 파킨슨병·MSA 동반 신경인성 기립성 저혈압에는 신경과 의뢰 후 처방 권고; 당뇨병성 자율신경병증이나 일시적 약물 부작용에 의한 기립성 저혈압에는 비급여로 처방
...
* **처음에는 누워서 하는 운동부터 시작하세요** — 수영, 로잉 머신, 누워서 하는 근력 운동처럼 심장과 머리가 같은 높이에 있는 운동이 안전합니다
* 4\~6주 후 증상이 안정되면 실내 자전거 등 경사도 운동으로 넘어가고, 이후 서서 하는 운동(걷기, 달리기)으로 서서히 이행하세요
* 초기부터 오래 서서 하는 운동을 하면 증상이 악화될 수 있으므로 단계를 지켜 진행하는 것이 중요합니다
