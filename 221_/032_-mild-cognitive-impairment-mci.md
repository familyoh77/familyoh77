...
{% hint style="info" %}
**p-tau217 혈액 검사** — 최근 1\~2년간 가장 비약적인 발전 분야
...
* 2025년 FDA, 최초 혈액 기반 알츠하이머 진단 보조 검사 허가; 국내 도입 여부는 별도 확인 필요
...
{% hint style="warning" %}
**콜린알포세레이트(choline alfoscerate) 급여 주의 — 2025년 9월부터 변경 적용**

* 심평원 급여적정성 재평가(2020) 및 대법원 확정(2024) → 보건복지부 고시 2020-183호 2025.9.21부터 본격 시행
* **치매 진단 환자(F00\~F02, G30 등)** : 기존 급여(본인부담 30%) 유지
* **경도인지장애(F06.7) 포함 치매 외 적응증** : 선별급여 전환, **본인부담 80%**
* MCI에 대한 치매 예방 효과 입증 불충분 — 경도인지장애에 처방 시 반드시 환자에게 급여 변경 사전 안내
* 임상재평가(식약처) 진행 중; 효능 입증 실패 시 품목 취소 가능성 있음
{% endhint %}

* 일부 연구에서 약간의 증상 완화
* choline alfoscerate : 800\~1200 ㎎/d \[글리아티린] (**MCI에서는 본인부담 80%; 처방 전 환자 안내 필수**)
...
* **ARIA(Amyloid-Related Imaging Abnormalities)** : 뇌 부종(ARIA-E) 또는 미세출혈(ARIA-H) — 발생률 약 20\~24%; ApoE ε4 보인자에서 더 높음
  * ApoE ε4 동형접합자(homozygote)는 고위험군 — **투여 전 ApoE 유전자 검사 권고**
  * ARIA 모니터링을 위한 정기적 MRI 필수 (예: 2, 5, 7, 14회차 투여 전 등 프로토콜에 따라); 대부분 첫 6개월 이내 발생
  * ARIA 발생 시 일시 중단 또는 중단 여부를 전문의가 판단
