...
* 학대·방임·금전 착취가 의심되거나 혼자 지내기 위험한 상태 `안전 문제`
...
* 미국 FDA 허가 현황 (2026년 9월 기준 4종)
  * 2025년 5월 : Lumipulse G pTau217/β-amyloid 1-42 plasma ratio - 55세 이상 인지 저하 유증상자, 전문진료 환경의 진단 보조
  * 2025년 10월 : Elecsys pTau181 - 55세 이상 인지 저하 유증상자, 일차 진료에서 아밀로이드 병리 rule-out 중심
  * 2026년 8월 20일 : PrecivityAD2 (질량분석 기반 다중 비율) - 40세 이상 인지 저하 유증상자, 인지장애 평가 경험이 있는 의료진이 임상 평가와 함께 사용
  * 2026년 8월 24일 : Elecsys pTau217 - 55세 이상 인지 저하 유증상자, 일차·전문진료 환경에서 아밀로이드 병리의 rule-in/rule-out을 보조하는 단일 바이오마커 검사
* 모두 무증상 인구 선별이나 단독 임상진단을 위한 검사가 아니다. 결과 구간 체계는 검사별로 다르므로(예: **rule-out(음성)·intermediate/grey zone(중간)·rule-in(양성)**의 3구간 또는 rule-out 중심 판정) 해당 검사의 검증된 기준에 따라 임상정보와 함께 해석한다.
* Alzheimer's Association 혈액 바이오마커 진료지침(2025, 전문진료 환경 대상) : 민감도 ≥90%·특이도 ≥75% 검사는 분류(triage) 목적으로, 민감도·특이도 모두 ≥90% 검사는 아밀로이드 PET·CSF 검사의 대체 확인검사로 사용할 수 있다.
* 국내에서는 FDA 허가 혈액검사의 식약처 허가(2026년 9월 기준 일부 제품 허가 심사 중)·가용성·수가와 항아밀로이드 치료 전 인정 검사를 제품별로 확인한다. 일차 의료에서는 알츠하이머병 병리 확인이 진료 결정을 바꿀 유증상 환자를 선별하여 전문의와 협진한다.
...
* 정상 노화 및 주관적 인지 저하
* 섬망
* 우울·불안 등 정신질환과 관련된 인지 저하 (☞ [우울증](027_-depression.md))
* 알츠하이머병, 레비소체병, 혈관성 인지장애, 전두측두엽변성, 파킨슨병 관련 인지장애 (☞ [치매](033_-dementia.md))
* 약물·물질, 수면무호흡증(☞ [불면증](029_-insomnia-sleep-disorder.md)), 감각 저하, 갑상선기능 이상, Vit B12 결핍 및 기타 전신질환
...
flowchart LR
    ...
    subgraph R["판정과 조치"]
        direction TB
        E["즉각 조치<br/>섬망·뇌졸중·감염 등"]
        F["SCD 또는 정상 범위<br/>원인 관리·위험도별 추적"]
        G["MCI<br/>원인 평가·관리·6~12개월 추적"]
        H["치매 또는 비전형·급속 진행<br/>당일~수일 내 평가·전문의 의뢰"]
    end
    B -->|예| E
    D -->|객관적 저하 없음·독립 유지| F
    D -->|객관적 저하·독립 유지| G
...
<p align="center"><em><mark style="color:$info;">저자 재구성 (참고 문헌 : Alzheimer’s Association DETeCD-ADRD 2024-2025; Revised Criteria for Diagnosis and Staging of Alzheimer’s Disease 2024)</mark></em></p>
...
* 교정하거나 악화를 줄일 수 있는 동반 질환과 약물을 우선 관리한다.
...
* 환자의 심폐기능·낙상 위험·동반 질환을 고려하여 규칙적인 유산소운동과 근력·균형운동을 권한다.
...
* FINGER 연구는 치매 위험이 높은 지역사회 고령자에서 운동·식이·인지훈련·혈관 위험 관리를 결합한 다중영역 중재의 예방적 가능성을 보여주었으나, MCI 환자만을 대상으로 한 질병수정 치료시험은 아니다.
  * U.S. POINTER(JAMA 2025)에서도 인지 저하 위험이 있는 고령자에게 구조화된 다중영역 중재가 자기주도형 중재보다 전반적 인지를 소폭 더 개선하였으나, MCI 대상 시험이나 치매 발생을 평가한 시험은 아니다.

### <mark style="color:orange;">혈관·생활습관 관리</mark>

* 고혈압, 당뇨병, 이상지질혈증, 비만, 심방세동·뇌혈관질환을 해당 지침에 따라 관리한다.
* SPRINT-MIND에서 특정 심혈관 고위험·비당뇨 성인의 SBP ＜120 ㎜Hg 집중치료군은 ＜140 ㎜Hg군보다 MCI 발생이 감소했으나, 1차 결과인 probable dementia 감소는 통계적 유의성에 도달하지 못했다. 이를 모든 MCI 환자의 일률적 목표로 적용하지 않는다. 기립저혈압, 허약, 낙상, 신장기능과 전체 심혈관 위험을 고려하여 개별화한다.
* 금연하고 과음을 피한다. 인지 보호를 목적으로 음주를 시작하도록 권하지 않는다.
* 균형 잡힌 식사와 지중해식 또는 MIND 식사 패턴을 고려한다.\
  ✽MIND diet RCT(NEJM 2023)에서는 대조 식이 대비 3년 인지 변화에 유의한 차이가 없었으므로, 인지 저하 예방효과가 입증된 식사법으로 설명하지 않는다.
...
* 코그테라(Cogthera) <mark style="color:blue;">\[코그테라]</mark>
  * 55\~85세 MCI 환자에게 전문의 처방으로 12주간(1일 2회) 제공하는 모바일 메타기억훈련 디지털 치료기기
  * 확증임상에서 치료 반응률 59.2%로 대조군(28%)보다 높았으며, 이상사례 빈도는 군간 차이가 없었다.
  * 2025년 5월 식약처 허가, 2025년 10월 말부터 처방 시작; 보건복지부 고시 제2026-114호에 따라 2026년 6월 1일부터 건강보험 비급여 항목 TX013으로 적용
...
* MCI 대상 RCT(ADCS, NEJM 2005)에서 Vit E 2,000 IU/d는 3년간 알츠하이머병 진행을 늦추지 못했다.
* NSAID, estrogen, testosterone, selegiline, 비내 인슐린, growth hormone-releasing hormone, semaglutide(EVOKE/EVOKE+ 2025, 초기 알츠하이머병에서 음성) 등을 MCI 예방·치료 목적으로 사용하지 않는다.
...
* donepezil 등 acetylcholinesterase inhibitor는 MCI에서 인지·기능 저하 또는 치매 전환 예방효과가 확립되지 않았고 부작용이 있어 일반적으로 사용하지 않는다.\
  ✽같은 ADCS 시험에서 donepezil은 초기 12개월에만 진행 감소 경향을 보였고 3년 시점에는 위약과 차이가 없었다.
...
* 2026년 제출된 국내 퇴행성·혈관성 MCI 임상재평가(852명 통합 분석, 3건의 임상 중 2건)의 전체 분석에서 사전 지정 1차 유효성 평가변수(인지기능 유지·개선 비율)는 통계적 유의성 기준을 충족하지 못했다. 일부 사전 계획 보조분석·순응군 분석에서 개선 신호가 있었으나 해석 논쟁이 있으며, **식약처의 최종 판단은 아직 나오지 않았다(2026년 하반기 발표 예정). 현재 허가 효능이 임상재평가로 최종 확정된 것으로 해석하지 않는다.**
* 급여 : 치매 외 적응증인 MCI(F06.7)에서는 2025년 9월 21일부터 선별급여 본인부담 80%가 적용되므로 처방 전 비용과 근거의 불확실성을 설명한다. 경구용 뇌대사개선제는 원칙적으로 1종만 급여가 인정되어 병용 처방이 제한된다.
...
* donanemab <mark style="color:blue;">\[키썬라]</mark> : 미국 등 해외 허가(유럽은 APOE ε4 비보유자·이형접합자로 적응증 제한); **국내 미허가(2026년 9월 2일 기준, 식약처 허가 심사 중이며 연내 출시는 업계 전망)**. 국내 허가 시 적응증 범위를 확인한다.
