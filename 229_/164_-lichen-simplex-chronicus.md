...
```mermaid
graph TD
    A([태선화된 판상 병변 + 가려움-긁음 악순환]) --> B{종양성 병변 의심?<br/>궤양·출혈·급속 성장·단단한 침윤}
    B -- 있음 --> C[조기 피부과 의뢰<br/>생검 고려]
    B -- 없음 --> D{진균/2차 감염 의심?}
    D -- 있음 --> E[KOH 또는 배양 검사 후 치료]
    D -- 없음 --> F{병변 부위}
    F -- 외음부/항문 --> G[Lichen sclerosus, lichen planus,<br/>Paget disease, candidiasis 등 배제]
    F -- 얼굴/피부가 얇은 겹치는 부위 --> H[저~중등도 역가 국소 steroid<br/>단기간 적용]
    F -- 일반 부위의 두꺼운 판 --> I[고역가 국소 steroid<br/>bid ×약 2주]
    G --> J{진단 불확실 또는 비전형적?}
    J -- 예 --> K[피부생검 + 피부과/산부인과 의뢰]
    J -- 아니오 --> V{중증/뚜렷한 태선화?}
    V -- 아니오 --> W[중간 역가 국소 steroid로 시작<br/>임상 반응에 따라 조정]
    V -- 예 --> X[potent/superpotent 국소 steroid<br/>예: clobetasol 0.05% qd~bid]
    H --> L[약 2주 후 재평가]
    I --> L
    W --> Y[약 4주 후 재평가]
    X --> Y
    L --> M{호전?}
    Y --> M
    M -- 예 --> N[사용 횟수/역가 감량 또는 중단<br/>보습·자극 회피 유지]
    M -- 아니오 --> O[진단 재평가<br/>대증/2차 치료 또는 의뢰]
