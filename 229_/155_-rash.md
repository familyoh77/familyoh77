...
flowchart TD
    ...
    %% URI 증상 = no
    Q1 -- "no" --> Roseola["<b>Roseola (Exanthem subitum)</b><br>•잠복기: 5~15일<br>•발열 호전 후 발진 발생<br>•발진: erythematous maculopapular; 몸통 → 목/얼굴로 진행(사지에는 드묾)<br>•호발 연령: 7~13개월"]
    ...
    %% 점막 이환 = no
    Q2 -- "no" --> Q3_1["수포?"]
    Q3_1 -- "no" --> Erythema["<b>Erythema infectiosum</b><br>•잠복기: 4~14일<br>•발진: 심한 malar rash → 1~2일 후 몸통/사지/엉덩이의 reticular erythematous maculopapular rash<br>•전구: 경증 감기/두통 증상 1~4일"]
    Q3_1 -- "yes" --> Varicella["<b>Varicella</b><br>•잠복기: 14~16일<br>•발진: 몸통 → 얼굴/사지; macule → vesicle → crust<br>•전구: 열 1~2일<br>•격리: 모든 병변에 가피가 형성될 때까지(가피가 생기지 않는 돌파감염은 24시간 이상 새 병변이 없을 때까지)"]

    %% 점막 이환 = yes
    Q2 -- "yes" --> Q3_2["수포?"]
    Q3_2 -- "yes" --> HFMD["<b>Hand-Foot-Mouth Dz</b><br>•잠복기: 3~6일<br>•전구: 기침, 발열 등 12~36시간<br>•발진: 손발바닥, 구강; erythematous maculopapular → 수포<br>•등원: 해열되고 전신상태가 양호하며 구강 병변으로 조절되지 않는 침 흘림이 없으면 가능"]

    Q3_2 -- "no" --> Q4["Koplik spots?"]
    Q4 -- "yes" --> Measles["<b>Measles</b><br>•잠복기: 10~12일<br>•발진: erythematous maculopapular; 얼굴부터 하강<br>•전구: 기침, 콧물, 결막염, 발열; 3~4일<br>•점막: Koplik spots<br>•격리: 발진 발생 후 4일간(발진일 day 0); 의료기관에서는 airborne precautions"]

    Q4 -- "no" --> Q5["빠르게 확산 되는 발진?"]
    Q5 -- "no" --> Rubella["<b>Rubella</b><br>•잠복기: 14~17일<br>•발진: erythematous maculopapular; 얼굴부터 하강<br>•전구: malaise; 1~7일<br>•특징: 귀 뒤/후두골 림프절종대<br>•점막: Forchheimer spots<br>•격리 기간: 발진 후 7일간"]
    Q5 -- "yes" --> Scarlet["<b>Scarlet fever</b><br>•잠복기: 1~5일<br>•발진: erythematous macule, pinpoint, blanchable papule; sandpaper texture, 접히는 부위, 빠른 진행, 열과 함께 발생<br>•전구: 열, 인두통, 복통; 1~2일<br>•점막: white~red strawberry tongue<br>•등원: 해열되고 적절한 항생제 치료 시작 후 ≥12~24시간"]

    classDef question fill:#fff9c4,stroke:#ffe082,stroke-width:2px
    classDef diagnosis fill:#f96,stroke:#e65100,stroke-width:2px
    class Q1,Q2,Q3_1,Q3_2,Q4,Q5 question
    class Roseola,Erythema,Varicella,HFMD,Measles,Rubella,Scarlet diagnosis
```

<p align="center"><strong>소아 발진 감별 알고리듬</strong></p>

<p align="center"><em><mark style="color:$info;">Ref. 5minuteconsult.com</mark></em></p>
