...
flowchart TD
    ...
    C --> D["6–12시간 이내<br/>수술적 탐색·변연절제<br/>영상 때문에 수술 지연 금지"]

    B -- "No" --> E{"농양·fluctuation·<br/>purulent drainage?"}

    E -- "Yes" --> F["Purulent SSTI<br/>I&D 우선"]
    F --> G{"항생제 적응증?<br/>광범위 cellulitis/전신증상/<br/>면역저하/치료 실패"}
    G -- "No" --> H["I&D 후 상처 관리<br/>임상 추적"]
    G -- "Yes" --> I["경험적 항생제 추가<br/>MRSA 병력/위험 평가<br/>배양 결과로 조정"]

    E -- "No" --> J["Non-purulent cellulitis / erysipelas"]
    J --> K{"중증/IV 적응증?<br/>심한 전신증상·불안정/<br/>중증 면역저하"}
    K -- "Yes" --> L["입원/IV 항생제<br/>중등증: Cefazolin 등<br/>중증/MRSA 고위험: MRSA coverage ± broad-spectrum"]
    K -- "No" --> M["경구 β-lactam 우선<br/>Cephalexin 등<br/>단독은 Amoxicillin 고려"]
    ...
    N --> O{"호전 시작?"}
    O -- "Yes" --> P["Cellulitis: 보통 5일<br/>필요 시 7–10일까지 연장<br/>재발 위험인자 교정"]
    O -- "No/악화" --> Q["진단 재평가<br/>농양/source control<br/>내성균·심부/괴사성 감염 확인"]
```
