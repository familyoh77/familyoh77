...
* 몸니 : 의복의 솔기/주름/이음매 등에서 성충/충란 관찰; 먹이를 먹을 때만 피부로 올라오기 때문에 몸에서는 찾기 어려움
* 주변에서 환자 발생
...
* 머릿니 물리적 제거 : 참빗 등 0.2\~0.3 ㎜ 간격의 촘촘한 빗으로 서캐 제거(특히 두피에서 1 ㎝ 이내 근위부). 정전기 발생을 피하기 위하여 머리카락이 젖은 상태로 시행; 약물 치료와 함께 3\~4일마다 2주간 시행
...
* 용법 : 두피와 머리카락에 약물이 충분히 젖도록 마사지 → 도포한 후 10분간 유지 → 따듯한 물로 거품을 내어 세척 → 7\~10일 후 살아 있는 균이 있는 경우 반복 [감마린 디 액](../%EB%B9%84%EB%B3%B4%ED%97%98/)
...
* 용법 및 주의 사항 : pyrethrin과 동일 오메크린 크림(비급여); ≥2개월 연령 사용
...
* 용법 : 10분 적용 후 세척, 반복하지 않음; ≥6개월 연령 사용 [수란트라 크림](../%EB%B9%84%EB%B3%B4%ED%97%98/)
* 부작용 : 피부 자극, 건조
...
* permethrin 5% : 머리 부분 제외 전신 도포 → 10(8\~14)시간 후 세척 [오메크린 크림](../%EB%B9%84%EB%B3%B4%ED%97%98/)
...
* permethrin 1% 크림 : 10분 적용 후 세척 → 7\~10일 후 살아 있는 균이 있는 경우 반복 오메크린 크림(비급여)
* pyrethrin 0.33% & piperonyl butoxide 4% : permethrin과 동일 [감마린 디 액](../%EB%B9%84%EB%B3%B4%ED%97%98/)
...
처방례 1. 머릿니\
감마린 디 액 120 g/병 (비보험)\
•두피와 머리카락까지 약물이 충분히 젖도록 마사지\
→ 완전히 도포한 후 10분간 유지 → 따듯한 물로 거품을 내어 세척\
→ 7~~10일 후 반복~~\
~~•사용량(1회량, 성인 기준)~~\
~~어깨선보다 짧은 모발 : 1회 사용량 28~~60g (총 56~~120g)~~\
~~어깨선 정도의 모발 : 1회 사용량 60~~85g (총 120~~170g)~~\
~~어깨선보다 긴 모발 : 1회 사용량 85~~110g (총 170~~220g)~~\
~~처방례 2. 몸니~~\
~~오메크린 크림 30 g/tube (비보험)~~\
~~•목 아래 모든 신체 부위 도포(성인은 1 튜브 모두 사용) → 10~~12 시간 후 세척\
처방례 3. 사면발니\
감마린 디 액 120 g/병 (비보험)\
•외음부, 항문, 겨드랑이 등 체모 부위에 도포 → 10분 적용 후 세척\
→ 7\~10일 후 살아 있는 균이 있는 경우 반복
