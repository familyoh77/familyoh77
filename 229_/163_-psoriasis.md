...
```mermaid
graph TD
    Start["판형 건선 진단"] --> Q1{"건선관절염 의심?"}

    Q1 -->|yes| PsA["류마티스내과 조기 의뢰<br/>피부 건선 중증도와 무관하게 PsA 평가"]
    Q1 -->|no| Q2{"전신치료/광선치료 후보?"}

    Q2 -->|no| Local["국소 치료 중심<br/>• 국소 corticosteroid<br/>• Vit D 유도체<br/>• 부위별 calcineurin inhibitor 등"]
    Q2 -->|yes| Derm["피부과 의뢰/협진<br/>• NB-UVB 등 광선치료<br/>• 경구 전신치료<br/>• 생물학적 제제"]

    Q2 -. 판단 기준 .-> Criteria["다음 중 하나 이상이면 적극 고려<br/>• BSA >10%의 광범위 병변<br/>• 얼굴·두피·손발바닥·생식기·조갑 등 고영향 부위 침범<br/>• 적절한 국소치료 실패<br/>• 증상·기능장애·삶의 질 영향이 큼"]

    Local --> Reassess["반응·순응도 재평가"]
    Reassess -->|조절 불충분| Derm
    ...
    class Start,PsA pinkNode
    class Q1,Q2 yellowNode
    class Local,Derm,Criteria,Reassess blueNode
```
