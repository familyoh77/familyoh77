...
```mermaid
graph TD
    A([접촉 부위 피부염 의심]) --> B{노출력·분포가<br/>접촉 패턴과 일치?}
    B -->|아니오| C[다른 원인 감별<br/>아토피피부염·백선·건선 등]
    B -->|예| D{Red Flags 존재?}
    D -->|예| E[응급/조기 평가·의뢰]
    D -->|아니오| F{뚜렷한 자극 노출력 &<br/>감작 소견 없음?}
    F -->|예| G[임상적 ICD 진단<br/>회피 + 보습 + 국소 steroid]
    F -->|아니오/불명확| H{원인 불명·반복·만성<br/>또는 직업성?}
    H -->|예| I[Patch test 의뢰]
    H -->|아니오| G
    I --> J{양성 & 임상적 연관성 확인}
    J -->|예| K[임상적으로 관련된 contact allergy 확인<br/>ACD 진단 지지/확립 + 항원 회피 교육]
    J -->|아니오| L[ICD·미검사 항원·기타 피부질환<br/>또는 false negative 가능성 재평가]
    G --> M{적절한 회피·치료에도<br/>지속·재발?}
    K --> M
    M -->|예| N[피부과 의뢰<br/>재평가·치료 단계 상승]
    M -->|아니오| O[유지 관리 및 재발 방지 교육]
