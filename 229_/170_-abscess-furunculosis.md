...
(☞ [피부감염](165_-skin-and-soft-tissue-infection.md#undefined))
...
* epidermal inclusion cyst : 갑자기 발생하여 빠르게 커지는(하루\~수일) 붉은 압통; 동일한 부위에 이전 발생 병력, 악취가 나는 치즈 같은 분비물
...
* 대상 : 전신 증상(예: 발열), 주변 조직으로 확대(cellulitis), 다발 병소, 면역 저하, 큰 병소(＞2 ㎝), 국소 항생제 치료 48시간에 반응 없음
