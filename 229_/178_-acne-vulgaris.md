...
```mermaid
flowchart TD
    A["중증도·흉터 위험·정신사회적 부담 평가"] --> B["경증～중등증"]
    A --> C["중등증～중증 또는 몸통 침범"]
    A --> D["중증·흉터 위험·표준치료 실패"]
    B --> E["12주 국소 병합치료: adapalene/BPO 등"]
    C --> F["12주 병합치료: doxycycline + 비항생제 국소제"]
    C --> G["적절한 여성: 복합 경구피임제 또는 spironolactone"]
    D --> H["피부과 의뢰·isotretinoin 고려"]
    E --> I["12주 평가"]
    F --> I
    G --> I
    I --> J["완전 호전: 항생제 중단·retinoid±BPO 유지"]
    I --> K["부분 호전: 경구 항생제 최대 12주 추가 고려"]
    I --> L["불충분 반응: 순응도·진단 재평가 후 변경/의뢰"]
    M["큰 통증성 결절: 병변 내 corticosteroid 보조"] -.-> I
