...
* 전염 경로 : 신체 접촉, 특히 성 접촉에 의하여 기생충 전파(감염자와 15\~20분 동안 밀착된 신체 접촉이 있으면 전염될 수 있음); 드물게 환자가 사용한 물품에 의하여 전염
...
* 의심 : 옴의 두 가지 특징 중 하나가 있는 전형적 부위의 전형적 병변 OR 옴의 두 가지 특징이 있는 비전형적 부위 또는 비전형적 병변
...
* 2차 선택 : malathion 0.5% 로션, ivermectin 1% 로션, pyrethrin([이감염증](185_-pediculosis-lice.md#undefined-13) 치료제로 허가), sulfur 6\~33% 로션/연고
...
*   용법 : 목 아래 모든 신체 부위 도포(성인 30 g) → 10(8~~14) 시간 후 세척 → 7~~14일 후 반복;
    ...
    ≥2개월 연령 사용 [오메크린 크림](../%EB%B9%84%EB%B3%B4%ED%97%98/)
...
* 용법 : 1일째 및 2일째 도포, 7일 후 반복 [안식향산벤질 로오숀](../%EB%B9%84%EB%B3%B4%ED%97%98/)

\*\* Crotamiton 10%\*\*

* 작용 : scabies 사멸 및 가려움 완화
*   용법 : 다양; 목 아래 모든 신체 부위 도포 → 24시간 후 세척 및 건조 후 재도포 → 24\~48시간 후 세척 [유락신 연고](../%EB%B9%84%EB%B3%B4%ED%97%98/);
...
* 용법 : 이환된 피부에 얇게 도포 → 7일 후 반복 [수란트라 크림](../%EB%B9%84%EB%B3%B4%ED%97%98/)
* 부작용 : 피부 자극
...
(☞ [만성가려움증](157_-chronic-pruritus.md))
...
* calamine/zinc oxide : 필요시 1일 수회 [칼라민](../%EB%B9%84%EB%B3%B4%ED%97%98/)
...
* 항생제 : 긁음에 의한 2차 감염(발적, 부종, 농, 통증) 시 고려 (☞ [피부감염](165_-skin-and-soft-tissue-infection.md#undefined-14))
...
처방례 1. 표준 치료\
오메크린 크림 30 g/tube (비보험)\
목 아래 모든 신체 부위 도포(성인은 1 튜브 모두 사용)\
→ 10~~12 시간 후 세척 → 7~~14일 후 반복\
아디팜 10 ㎎/T 4T #4 가려움에 대하여 (졸음 주의)\
칼라민 로션 100 ㎖ 필요시 가려운 부위에 도포 (비보험)\
처방례 2. Permethrin을 사용할 수 없는 경우 또는 특정 부위 증상\
수란트라 크림 15 g/tube (비보험) 이환된 부위에 얇게 도포 → 7일 후 반복\
페니라민 2 ㎎/T 8T #4 (졸음 주의)\
칼라민 로션 100 ㎖ 필요시 가려운 부위에 도포 (비보험)
